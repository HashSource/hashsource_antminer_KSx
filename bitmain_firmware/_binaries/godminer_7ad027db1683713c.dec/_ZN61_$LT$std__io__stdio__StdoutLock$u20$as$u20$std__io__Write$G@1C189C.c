int __fastcall <std::io::stdio::StdoutLock as std::io::Write>::write_all(int a1, _DWORD *a2, char *buf, size_t n)
{
  ...
  v6 = (_DWORD *)(*a2 + 12);
  if ( *v6 )
    core::result::unwrap_failed((int)aAlreadyBorrowe, 16, (int)&v26, (int)&off_2C92E8, (int)&off_2C9B24);
  v7 = v4 + 4;
  v8 = n;
  v9 = buf;
  v4[3] = -1;
  if ( n && (v10 = memrchr(buf, 10)) != 0 )
  {
    v11 = v10 - (_DWORD)v9 + 1;
    if ( v11 > v8 )
      core::panicking::panic((int)aAssertionFaile, 35, (int)&off_2C9A10);
    v12 = v4[6];
    if ( v12 )
    {
      if ( *v7 - v12 <= v11 )
      {
        sub_7820C((int)&v26, (int)(v4 + 4), v9, v11);
        v14 = v26;
        if ( v26 != 4 )
          goto LABEL_32;
      }
...
LABEL_34:
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v16 < v19 )
          core::slice::index::slice_start_index_len_fail(v19, v16, (int)&off_2C9C18);
        v16 -= v19;
        v15 += v19;
        if ( !v16 )
          goto LABEL_26;
      ...
      if ( (unsigned __int8)std::sys::unix::decode_error_kind((int)v17) != 35 )
        break;
      if ( !v16 )
        goto LABEL_26;
    }
