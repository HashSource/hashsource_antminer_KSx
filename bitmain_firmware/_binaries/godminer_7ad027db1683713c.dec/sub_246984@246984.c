int __fastcall sub_246984(int a1, int a2)
{
  int v2; // r2
  int v3; // r3
  int v4; // r3
  ...
  else
  {
    if ( (v2 & 0x20) == 0 )
    {
      if ( (unsigned __int8)a1 <= 0x63u )
      {
        ...
        {
          v3 = 37;
          v10 = word_29F267[(unsigned __int8)a1];
      ...
      {
        v3 = 36;
        v10 = word_29F267[(unsigned __int8)a1 % 0x64u];
  ...
  if ( (unsigned int)(128 - v4) >= 0x81 )
    core::slice::index::slice_start_index_len_fail(128 - v4, 128, (int)&off_2CF1FC);
