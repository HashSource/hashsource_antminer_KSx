int __fastcall <object::pe::ImageSymbolEx as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2CB638;
  v3[1] = &off_2CB5B0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aImagesymbolex, 13, (int)&off_2CBE30, 6, (int)v3, 6);
}
