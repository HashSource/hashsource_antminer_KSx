int __fastcall <object::pe::ImageDebugDirectory as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2CB110;
  v3[5] = &off_2CB110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_294B68, 19, (int)&off_2CC3C8, 8, (int)v3, 8);
}
