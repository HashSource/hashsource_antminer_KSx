int __fastcall std::sys::unix::fs::copy(int a1, _BYTE *a2, size_t n, _BYTE *a4, size_t a5)
{
  int *v8; // r8
  int v9; // r10
  int v10; // r5
...
LABEL_6:
    ...
    sub_1D9278((int)&v43, SHIDWORD(v45), v46, (int)&v40);
    v8 = (int *)(a1 + 4);
    if ( (unsigned __int8)v43 == 4 )
      goto LABEL_6;
  }
...
LABEL_26:
    ...
    std::sys::unix::kernel_copy::copy_regular_files((int)&v40, v9, v13, v17, 0xFFFFFFFFFFFFFFFFLL);
    v18 = 1;
...
LABEL_44:
        if ( v23 > 0x2000 )
          core::slice::index::slice_end_index_len_fail(v23, 0x2000, (int)&off_2C9A20);
        if ( !v23 )
        {
        ...
        do
        {
          while ( 1 )
          {
            ...
            {
              v30 = 2;
              v31 = (unsigned int)&off_2C9C28 >> 8;
              v32 = (_DWORD)&off_2C9C28 << 24;
              goto LABEL_57;
            }
            if ( v23 < v29 )
              core::slice::index::slice_start_index_len_fail(v29, v23, (int)&off_2C9C18);
            v23 -= v29;
