int __fastcall std::process::Child::wait_with_output(int a1, _DWORD *a2)
{
  ...
  unsigned int v35; // [sp+10h] [bp-4Ch] BYREF
  void *v36; // [sp+14h] [bp-48h]
  int v37; // [sp+18h] [bp-44h]
  unsigned int v38; // [sp+20h] [bp-3Ch] BYREF
    ...
    if ( v6 != -1 )
    {
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( v11 < v9 )
            core::slice::index::slice_start_index_len_fail(v9, v11, (int)&off_2C9AB4);
          v12 = (char *)ptr + v8;
...
LABEL_47:
            v45 = v10;
            buf = 0;
            core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&buf, (int)&off_2C9308, (int)&off_2CA094);
          }
        }
        v15 = v14;
        if ( v11 > v14 )
        ...
        if ( !v14 )
          break;
        if ( v11 < v14 )
          core::slice::index::slice_end_index_len_fail(v15, v11, (int)&off_2C9AA4);
        v8 += v14;
        v9 = v15 - v14;
        v40 = v8;
        if ( !(v8 | v7) )
  ...
  else if ( v6 == -1 )
  {
    ...
    if ( (unsigned __int8)v42 != 4 )
    {
      buf = v42;
      v45 = v43;
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&buf, (int)&off_2C9308, (int)&off_2CA084);
    }
    close(fd);
  }
  else
  {
    sub_1DD728((int)&v42, v5, &v35, v6, &v38);
    if ( (unsigned __int8)v42 != 4 )
    {
      buf = v42;
      v45 = v43;
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&buf, (int)&off_2C9308, (int)&off_2CA074);
    }
  }
