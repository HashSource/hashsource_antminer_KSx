unsigned __int8 *__fastcall sub_1DCD2C(int *a1)
{
  ...
  unsigned __int8 *v18; // [sp+3Ch] [bp-4h]

  libc_version = gnu_get_libc_version();
  v3 = core::ffi::c_str::CStr::from_ptr::strlen_rt(libc_version);
  core::ffi::c_str::CStr::to_str((int)v12, (int)libc_version, v3 + 1);
  if ( v12[0] )
  {
    *a1 = 0;
    return 0;
  ...
  result = (unsigned __int8 *)sub_19D718(v14);
  if ( result )
  {
