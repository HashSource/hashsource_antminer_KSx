_DWORD *__fastcall <std::io::stdio::StdinLock as std::io::Read>::read_vectored(
        int a1,
        _DWORD *a2,
        struct iovec *iovec,
        unsigned int a4)
...
LABEL_12:
  ...
  if ( v13 >= v14 )
  {
    v18 = v4[6];
    if ( v12 < v18 )
      core::slice::index::slice_start_index_len_fail(v18, v12, (int)&off_2C9AB4);
    v17 = (char *)v4[2];
    v13 = 0;
