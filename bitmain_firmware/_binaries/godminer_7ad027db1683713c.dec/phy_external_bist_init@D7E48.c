int __fastcall phy_external_bist_init(int a1, unsigned int a2, unsigned __int8 a3, int a4, int a5)
{
  ...
  const char *v10; // lr
  int v11; // r9
  int v13; // [sp+3Ch] [bp-10D8h]
  int v14; // [sp+40h] [bp-10D4h]
  ...
  zlog(
    ...
    60,
    v30);
  sub_CF420(a1, v17, 86, 3670024);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 85, 109905420);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 101, -268374016);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 64, 256);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 80, 33423870);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 81, 832516511);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 88, -1);
  usleep(0x12Cu);
  ...
  phy_eq_main_set_by_apb(a1, a2, (char *)&v17, 1, v8);
  phy_eq_pre_set_by_apb(a1, a2, (char *)&v17, 1, v14);
  phy_eq_post_set_by_apb(a1, a2, (char *)&v17, 1, v16);
  sub_CF420(a1, v17, 86, 137889800);
  usleep(0x12Cu);
  sub_CF420(a1, v17, 80, 0);
  usleep(0x12Cu);
