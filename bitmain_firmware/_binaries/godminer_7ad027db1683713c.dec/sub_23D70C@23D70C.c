...
LABEL_54:
  ...
  if ( !a4 )
LABEL_114:
    core::panicking::panic((int)aAttemptToDivid, 25, (int)&off_2CF558);
  v16 = sub_25ABA8(a3, a4);
  v17 = a3 - v16 * a4;
  LOBYTE(v71[0]) = v16 + 48;
  if ( !v17 )
  {
...
LABEL_29:
  ...
  if ( a4 < 0xF4240 )
    goto LABEL_114;
  BYTE2(v71[1]) = sub_25A94C((unsigned __int16)v17, v18) + 48;
  if ( !v24 )
  {
    v27 = 7;
    goto LABEL_52;
  ...
  if ( a4 < 0x989680 )
    goto LABEL_114;
  HIBYTE(v71[1]) = sub_25A94C((unsigned __int16)v24, a4 / 0x989680) + 48;
  if ( !v25 )
  {
    v27 = 8;
    goto LABEL_52;
  ...
  if ( a4 < 0x5F5E100 )
    goto LABEL_114;
  LOBYTE(v71[2]) = sub_25A94C((unsigned __int16)v25, a4 / 0x5F5E100) + 48;
  if ( !v64 )
  {
    a2 = v65;
    v13 = v67;
  ...
  {
    if ( a4 >= 0x3B9ACA00 )
      core::panicking::panic_bounds_check(9, 9, (int)&off_2CF568);
    goto LABEL_114;
  }
  a2 = v65;
  v13 = v67;
  v17 = (unsigned __int16)v64;
  v18 = (unsigned int)(((a4 >> 9)
...
LABEL_56:
  ...
  v77[0] = &v73;
  if ( v35 != 1 )
    return sub_23DE50((int)v77, (int *)a1);
  v68 = v13;
  if ( a8 >= 0x10 )
  {
  ...
  if ( !(!v33 | v32) )
  {
    ...
    if ( v75 )
    {
      v42 = sub_25A4F8(v75, HIDWORD(v75), 0x2540BE400uLL);
      v66 = v36;
      v44 = v43;
      ...
      v46 = sub_25A4F8(v42, v44, (unsigned int)&elf_hash_chain[4398]);
      if ( (unsigned int)&elf_hash_chain[4397] + 3 >= __PAIR64__(v44, v42) )
        v46 = v42;
      v47 = ((unsigned int)&loc_DFC18 + v46) & (v46 + 514288);
      v48 = (unsigned int)&aZn68LtRustcDem[v46 + 3] & (v46 + 524188);
      if ( v41 > 0x2540BE3FFLL )
        v45 = 10;
      v49 = v48 ^ v47;
      if ( (unsigned int)&elf_hash_chain[4397] + 3 < __PAIR64__(v44, v42) )
...
LABEL_94:
  ...
  if ( v58 == 1114112 || sub_23DE50((int)v77, (int *)a1) )
    return 1;
  v62 = 0;
  while ( v56 != v62 )
  {
