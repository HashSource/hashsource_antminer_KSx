void *__fastcall core::num::flt2dec::strategy::grisu::format_exact_opt(
        _DWORD *a1,
        __int64 *a2,
        _BYTE *a3,
        unsigned int a4,
        __int16 a5)
{
  ...
  unsigned int v59; // r4
  unsigned int v60; // r7
  unsigned __int64 v61; // [sp+10h] [bp-44h]
  unsigned __int64 v62; // [sp+18h] [bp-3Ch]
  int v63; // [sp+20h] [bp-34h]
  int v64; // [sp+24h] [bp-30h]
  unsigned __int64 v65; // [sp+28h] [bp-2Ch]
  _DWORD *v66; // [sp+30h] [bp-24h]
  unsigned int v67; // [sp+34h] [bp-20h]
  int v68; // [sp+38h] [bp-1Ch]
  int v69; // [sp+3Ch] [bp-18h]
  char v70; // [sp+40h] [bp-14h]
  int v71; // [sp+44h] [bp-10h]
  char v72; // [sp+48h] [bp-Ch]

  v6 = *a2;
  if ( !*a2 )
    core::panicking::panic((int)aAssertionFaile_32, 28, (int)&off_2CED64);
  if ( HIDWORD(v6) > 0x1FFFFFFF )
    core::panicking::panic((int)aAssertionFaile_40, 36, (int)&off_2CED74);
  if ( !a4 )
    core::panicking::panic((int)aAssertionFaile_39, 33, (int)&off_2CED84);
  ...
  if ( v15 >= 0x51 )
    core::panicking::panic_bounds_check(v15, 81, (int)&off_2CEC94);
  ...
  if ( v37 <= a5 )
  {
    LODWORD(v44) = sub_25A4F8(v27, v29, 0xAu);
    v45 = v35 >> v70;
    LODWORD(v62) = v33;
    if ( v71 >= 0 )
      v45 = v35 << v71;
    ...
    if ( v71 >= 0 )
      v46 = 0;
    LODWORD(v61) = v46;
    return sub_22F758((int)a1, a3, a4, 0, v37, a5, v44, v61, v62);
  }
  else
  {
    v63 = v25;
    v65 = __PAIR64__(v32, v33);
    LODWORD(v39) = v27 & v69;
    v38 = a4;
    HIDWORD(v39) = v29 & v68;
    LOWORD(v40) = -13107;
    ...
    if ( v37 - a5 < a4 )
      v38 = (__int16)(v37 - a5);
    v41 = v38 - 1;
    v64 = (__int16)(v34 - v23 + 1);
    v42 = 0;
    HIWORD(v40) = -13108;
    v67 = v38;
    while ( 1 )
    {
      v43 = sub_25ABA8(v31, v35);
      if ( a4 == v42 )
        core::panicking::panic_bounds_check(a4, a4, (int)&off_2CEDA4);
      v31 -= v43 * v35;
      a3[v42] = v43 + 48;
      if ( v41 == v42 )
      {
        ...
        return sub_22F758((int)v66, a3, a4, v67, v64, a5, __PAIR64__(v48, v51) + v39, __PAIR64__(v49, v50), v65);
      }
      if ( v34 == v42 )
        break;
      ++v42;
      ...
      if ( !v26 )
        core::panicking::panic((int)aAttemptToDivid, 25, (int)&off_2CED94);
    }
    v52 = v42 + 1;
    v53 = a4;
    v54 = 1;
    ...
    while ( 1 )
    {
      ...
      if ( v57 )
        break;
      if ( v53 == v52 )
        core::panicking::panic_bounds_check(v53, a4, (int)&off_2CEDB4);
      v58 = v54;
      v54 *= 10;
      v59 = (10 * v39) >> 32;
      v56 = (10 * __PAIR64__(v56, v58)) >> 32;
      v60 = ((unsigned int)(10 * v39) >> v72) | (v59 << v70);
      if ( v71 >= 0 )
        v60 = v59 >> v71;
      a3[v52++] = v60 + 48;
      LODWORD(v39) = (10 * v39) & v69;
      HIDWORD(v39) = v59 & v68;
      if ( v67 == v52 )
        return sub_22F758((int)v66, a3, a4, v67, v64, a5, v39, v65, __PAIR64__(v56, v54));
    }
    *v66 = 0;
    return 0;
  }
