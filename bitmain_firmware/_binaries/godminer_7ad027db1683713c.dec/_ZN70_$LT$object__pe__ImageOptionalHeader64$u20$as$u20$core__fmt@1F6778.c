int __fastcall <object::pe::ImageOptionalHeader64 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[5] = &off_2CB0D0;
  v3[3] = &off_2CB0D0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_293D38, 21, (int)&off_2CBBA8, 29, (int)v3, 29);
}
