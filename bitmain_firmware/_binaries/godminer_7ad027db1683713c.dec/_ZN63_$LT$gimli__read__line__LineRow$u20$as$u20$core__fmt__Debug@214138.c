int __fastcall <gimli::read::line::LineRow as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[13] = &off_2CCC74;
  v3[11] = &off_2CCC74;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_29ABCD, 7, (int)&off_2CCE8C, 12, (int)v3, 12);
}
