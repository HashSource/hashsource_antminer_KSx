int __fastcall <adler::Adler32 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  return core::fmt::Formatter::debug_struct_field2_finish(
           ...
           (int)&v3,
           (int)&off_2CE6C4,
           (int)"b_URC_FAILURE_URC_CONTINUE_UNWIND_URC_INSTALL_CONTEXT_URC_HANDLER_FOUND_URC_END_OF_STACK_URC_NORMAL_STOP_URC_FATAL_PHASE1_ERROR_URC_FATAL_PHASE2_ERROR_URC_FOREIGN_EXCEPTION_CAUGHT_URC_NO_REASON",
           1u,
           (int)&v4,
           (int)&off_2CE6C4);
}
