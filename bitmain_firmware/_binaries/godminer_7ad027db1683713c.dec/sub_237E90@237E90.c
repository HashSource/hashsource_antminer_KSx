int __fastcall sub_237E90(int a1, int a2, _DWORD *a3)
{
  int v6; // r1
  int result; // r0
  int v8; // r0
  ...
  while ( 1 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( (unsigned int)*v19 >= 6 )
        core::slice::index::slice_end_index_len_fail(*v19, 5, (int)&off_2CF238);
      if ( !v15 )
      {
        v15 = 0;
LABEL_33:
...
LABEL_21:
    if ( v16 <= 0x3F && a00000000000000_0[v16] <= -65 )
      core::str::slice_error_fail(a00000000000000_0, 0x40u, 0, v16, (int)&off_2CF248);
