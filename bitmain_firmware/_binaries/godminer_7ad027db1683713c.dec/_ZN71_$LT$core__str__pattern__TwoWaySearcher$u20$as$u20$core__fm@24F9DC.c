int __fastcall <core::str::pattern::TwoWaySearcher as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[0] = &v4;
  v3[7] = &off_2CF10C;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2A2E5A, 14, (int)&off_2CFB90, 8, (int)v3, 8);
}
