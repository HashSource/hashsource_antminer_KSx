unsigned int __fastcall sub_17408C(unsigned int *a1, char a2, char a3, _BYTE *a4, int a5)
{
  unsigned int v5; // lr
  int v7; // r6
  unsigned int v8; // r8
  ...
  unsigned int v206; // [sp+5Ch] [bp-48h]
  int v207; // [sp+5Ch] [bp-48h]
  unsigned int v208; // [sp+60h] [bp-44h]
  unsigned int v209; // [sp+64h] [bp-40h]
  int v210; // [sp+64h] [bp-40h]
  unsigned int v211; // [sp+68h] [bp-3Ch]
  unsigned int v212; // [sp+6Ch] [bp-38h]
  int v214; // [sp+74h] [bp-30h]
  int v215; // [sp+78h] [bp-2Ch]
  int v216; // [sp+7Ch] [bp-28h]
  int v217; // [sp+80h] [bp-24h]
  int v218; // [sp+84h] [bp-20h]
  unsigned int *v219; // [sp+8Ch] [bp-18h]
  ...
  *((_BYTE *)a1 + v5) = (128 >> a3) | a2 & -(128 >> a3);
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v34 == 8 )
        break;
      v161 = dword_28D398[v34];
      v35 = dword_28D3B8[v34];
    }
    v211 = v32;
    v70 = 23617341;
    v206 = v30;
    ...
    while ( 1 )
    {
      ...
      if ( v71 == 8 )
        break;
      v162 = dword_28D3D8[v71];
      v70 = dword_28D3F8[v71];
    }
    v195 = v72;
    v197 = v73;
    v199 = v74;
    ...
    while ( 1 )
    {
      ...
      if ( v110 == 8 )
        break;
      v163 = dword_28D418[v110];
      v111 = dword_28D438[v110];
    }
    v186 = v114;
    v182 = v112;
    v184 = v113;
