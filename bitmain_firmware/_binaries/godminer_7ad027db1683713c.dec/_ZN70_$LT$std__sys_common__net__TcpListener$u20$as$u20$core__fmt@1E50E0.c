int __fastcall <std::sys_common::net::TcpListener as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  int v3; // r8
  int v4; // r5
  ...
  core::fmt::Formatter::debug_struct((int)v7, a2, (int)aTcplistener, 11);
  v3 = *a1;
  sub_1E4F6C((int)&v8, *a1);
  ...
  else
  {
    ...
    v16[6] = v14;
    v16[7] = v15;
    core::fmt::builders::DebugStruct::field(v7, (int)aAddr, 4u, (int)v16, (int)&off_2CAE44);
  }
  v16[0] = v3;
  v5 = core::fmt::builders::DebugStruct::field(v7, (int)aFd, 2u, (int)v16, (int)&off_2C9A5C);
