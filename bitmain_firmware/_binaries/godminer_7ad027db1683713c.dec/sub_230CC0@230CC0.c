int __fastcall sub_230CC0(int result, unsigned __int8 *a2, unsigned int a3, unsigned int a4)
{
  int v4; // r7
  bool v5; // cf
  unsigned int v6; // r12
  ...
  if ( a4 - 2 > 0x22 )
  {
    ...
    v56[0] = &v54;
    core::panicking::panic_fmt((int)v55, (int)&off_2CEF1C);
  }
  if ( !a3 )
  {
    *(_BYTE *)(result + 1) = 0;
        ...
        if ( a4 <= 0xA )
        {
          ...
          while ( 1 )
          {
            ...
            v52 = (__CFADD__(__CFADD__((_DWORD)v48, HIDWORD(v47)), (_DWORD)v43)
                ...
                + (unsigned __int64)(HIDWORD(v43) + v46);
            v53 = v50 - 48;
            if ( !is_mul_ok(v45, a4) )
              v44 = 1;
            if ( v53 >= a4 )
              break;
            if ( v44 | ((HIDWORD(v43) + (unsigned __int64)v46) >> 32) | HIDWORD(v52)
              || (v6 = v47 + v53,
      ...
      else
      {
        ...
        else
        {
          while ( 1 )
          {
            ...
            v7 = ((unsigned __int64)v25 + v23) >> 32;
            v6 = v25 + v23;
