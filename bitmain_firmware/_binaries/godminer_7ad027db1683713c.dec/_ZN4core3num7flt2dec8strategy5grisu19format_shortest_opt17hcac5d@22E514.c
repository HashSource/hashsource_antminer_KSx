int __fastcall core::num::flt2dec::strategy::grisu::format_shortest_opt(int a1, int a2, int a3, unsigned int a4)
{
  ...
  int v124; // [sp+3Ch] [bp-40h]
  unsigned int v125; // [sp+40h] [bp-3Ch]
  char v126; // [sp+40h] [bp-3Ch]
  unsigned int v127; // [sp+40h] [bp-3Ch]
  int v128; // [sp+40h] [bp-3Ch]
  unsigned int v130; // [sp+48h] [bp-34h] BYREF
  unsigned int v131; // [sp+4Ch] [bp-30h]
  __int16 v132; // [sp+50h] [bp-2Ch]
  int v133; // [sp+58h] [bp-24h] BYREF
  int v134; // [sp+5Ch] [bp-20h]
  _DWORD v135[6]; // [sp+64h] [bp-18h] BYREF
...
LABEL_142:
  ...
  {
    core::panicking::panic((int)aAssertionFaile_35, 54, (int)&off_2CECD4);
  }
  v8 = v4 - v5;
  v9 = v4 >= __PAIR64__(v6, v5);
  v10 = (v4 - __PAIR64__(v6, v5)) >> 32;
  if ( !v9 )
    core::panicking::panic((int)aAssertionFaile_36, 55, (int)&off_2CECE4);
  if ( a4 < 0x11 )
  {
...
LABEL_148:
  ...
  v130 = v125;
  v132 = v13;
  if ( __PAIR64__(v4, v27) < __PAIR64__(v122, v125) )
  {
LABEL_138:
    v135[2] = 0;
    sub_7C0C8((int)&v133, (int)&v130, v135);
  }
  v30 = (int)&elf_hash_chain[20 * (__int16)(-96 - v120) + 1138] / 2126;
  if ( v30 >= 0x51 )
    core::panicking::panic_bounds_check(v30, 81, (int)&off_2CEC94);
  v31 = v22 << v24;
  v32 = (v21 << v24) | (v22 >> 1 >> (v24 ^ 0x1F));
  v112 = v29;
  v33 = core::num::flt2dec::strategy::grisu::CACHED_POW10[4 * v30];
  v116 = &core::num::flt2dec::strategy::grisu::CACHED_POW10[4 * v30];
  v34 = v116[1];
  v35 = v34 * (v22 << v24);
  ...
  while ( 1 )
  {
    v70 = sub_25ABA8(v43, v59);
    if ( a4 == v69 )
      core::panicking::panic_bounds_check(a4, a4, (int)&off_2CED24);
    v43 -= v70 * v59;
    v71 = v70 + 48;
    *(_BYTE *)(a3 + v69) = v70 + 48;
    v72 = v43 >> v121;
    ...
    if ( __PAIR64__(v72, v73) + __PAIR64__(v66, v64) < v65 )
    {
      ...
      v124 = v69 + 1;
      if ( v69 >= a4 )
        core::slice::index::slice_end_index_len_fail(v124, a4, (int)&off_2CED34);
      ...
      if ( v74 < __PAIR64__(v127, v78) && v77 )
      {
        v80 = a3;
        if ( v74 + __PAIR64__(v75, v76) < __PAIR64__(v127, v78) )
          goto LABEL_133;
        v81 = v74;
        if ( __PAIR64__(v127, v78) - v74 >= v74 + __PAIR64__(v75, v76) - __PAIR64__(v127, v78) )
          goto LABEL_133;
      }
      else
      {
...
LABEL_120:
    ...
    v59 /= 0xAu;
    if ( !v9 )
      core::panicking::panic((int)aAttemptToDivid, 25, (int)&off_2CED14);
  }
  result = v69 + 1;
  ...
  {
    if ( v118 == result )
      core::panicking::panic_bounds_check(v118, a4, (int)&off_2CED44);
    v85 = v83;
    v86 = v64;
    LODWORD(v64) = 10 * v64;
    HIDWORD(v64) *= 5;
    ...
    v92 = ((10 * v86) >> v126) | ((10 * __PAIR64__(v66, v86)) >> 32 << v121);
    if ( v123 >= 0 )
  ...
  v119 = v85;
  if ( result - 1 >= a4 )
    core::slice::index::slice_end_index_len_fail(result, a4, (int)&off_2CED54);
  v94 = 0;
