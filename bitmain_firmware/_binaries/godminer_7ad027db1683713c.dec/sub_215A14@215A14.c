int __fastcall sub_215A14(_DWORD *a1, int a2)
{
  _DWORD *v2; // r10
  int v3; // r5
  unsigned int v4; // lr
    ...
    *(_BYTE *)(a2 + 12) = v14 ^ 1;
    if ( v15 )
    {
      if ( HIDWORD(v16) <= v15 )
      {
        if ( HIDWORD(v16) != v15 )
LABEL_10:
          core::str::slice_error_fail((char *)v16, HIDWORD(v16), v15, HIDWORD(v16), (int)&off_2CD9D4);
      }
...
LABEL_81:
      ...
      do
      {
        ...
        if ( --v29 >= v5 )
          core::panicking::panic_bounds_check(v29, v5, (int)&off_2CD974);
        if ( v29 + v3 >= v4 )
        {
          v42 = v29 + v3;
          v43 = &off_2CD984;
