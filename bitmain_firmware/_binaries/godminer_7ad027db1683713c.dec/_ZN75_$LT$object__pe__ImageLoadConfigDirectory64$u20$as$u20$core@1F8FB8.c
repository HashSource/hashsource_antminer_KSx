int __fastcall <object::pe::ImageLoadConfigDirectory64 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2CB110;
  v3[5] = &off_2CB110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_29488D, 26, (int)&off_2CC150, 42, (int)v3, 42);
}
