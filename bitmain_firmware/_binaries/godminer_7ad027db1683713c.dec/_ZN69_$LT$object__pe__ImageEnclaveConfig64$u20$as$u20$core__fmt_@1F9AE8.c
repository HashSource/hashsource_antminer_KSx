int __fastcall <object::pe::ImageEnclaveConfig64 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[15] = &off_2CB4B8;
  v3[13] = &off_2CB4B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_294AEF, 20, (int)&off_2CC328, 13, (int)v3, 13);
}
