unsigned int __fastcall std::fs::read_to_string::inner(int a1, _BYTE *a2, size_t n)
{
  int v5; // r5
  unsigned int v6; // r0
  int v7; // r6
...
LABEL_6:
  ...
  *((_BYTE *)&dest + n) = 0;
  ...
  if ( !v28[0] )
  {
    sub_1D9278((int)&v22, v28[1], v28[2], (int)&v18);
    if ( (unsigned __int8)v22 != 4 )
      goto LABEL_8;
    goto LABEL_6;
  }
...
LABEL_19:
  ...
  sub_1C3E70(&v18, v5, (unsigned int *)&dest);
