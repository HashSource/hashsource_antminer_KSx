void __fastcall sub_1E0D70(_DWORD *a1, _BYTE *a2, int a3)
{
  void **v3; // r5
  int v4; // r0
  char *v5; // r6
  ...
  unsigned int v85; // [sp+208h] [bp-Ch] BYREF
  ...
  core::ffi::c_str::CStr::from_bytes_with_nul(&v85, v83, 0x15u);
  if ( v85 )
  {
    v82 = (void **)&off_2CA14C;
    v81 = dword_2CA158;
...
LABEL_3:
  ...
  {
    sub_1D9278((int)&v81, (int)ptr, v87, (int)&v71);
...
LABEL_10:
    ...
    do
    {
      ...
      if ( v7 >= v8 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (unsigned __int8)std::sys::unix::decode_error_kind(v14) != 35 )
          {
            v72 = v14;
            v71 = 0;
            core::str::converts::from_utf8((int)v83, (int)v67, v68);
            goto LABEL_36;
          }
        }
        v8 = v13;
      ...
      if ( v18 )
      {
        ...
        v21 = v68;
        if ( v19 - v16 == -1 )
          core::slice::index::slice_end_index_overflow_fail((int)&off_2C9CB8);
        if ( v20 >= v17 )
          core::slice::index::slice_end_index_len_fail(v19 - v16 + 1, v8 - v7, (int)&off_2C9CB8);
        if ( v85 - v68 <= v20 )
        {
          sub_77DD8(&v85, v68, v19 - v16 + 1);
          v22 = (char *)ptr;
          v21 = v87;
        }
        else
...
LABEL_78:
    ...
    v72 = v28;
    v71 = 0;
    if ( !sub_19D718((size_t *)&v71) || !sub_19D718((size_t *)&v71) || !sub_19D718((size_t *)&v71) )
      goto LABEL_82;
    v30 = (_BYTE *)sub_19D718((size_t *)&v71);
    v31 = v61;
    if ( v30 )
      v31 = v29;
    v61 = v31;
    if ( !v30 )
      goto LABEL_82;
    v33 = (const void *)sub_19D718((size_t *)&v71);
    v34 = size;
    if ( v33 )
      v34 = v32;
    size = v34;
    ...
    if ( v36 )
      v37 = v35;
    v60 = v37;
    if ( !v36 || !sub_19DA64(&v71) )
      goto LABEL_82;
    v38 = (const void *)sub_19DA64(&v71);
    v40 = v62;
    if ( v38 )
      v40 = v39;
    v62 = v40;
    ...
    if ( v40 == 6 && !bcmp(v38, aCgroup, 6u) )
    {
      ...
      if ( v41 )
      {
        ...
        v43 = std::path::Path::_strip_prefix(v30, v61, asc_290477, 1);
        v45 = v43;
        if ( !v43 )
          goto LABEL_82;
        v46 = v44;
        if ( std::path::Path::_starts_with(a2, a3, v43, v44) )
        {
          ...
          {
            v52 = v50;
            sub_1A3D88((signed int *)v83, v33, size);
            v53 = v83[0];
            v54 = v83[1];
            v55 = v83[2];
            *a1 = 1;
