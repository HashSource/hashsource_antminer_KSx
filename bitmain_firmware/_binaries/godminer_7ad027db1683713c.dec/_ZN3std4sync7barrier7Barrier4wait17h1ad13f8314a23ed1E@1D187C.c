...
LABEL_34:
    v19 = v3;
    v18 = a1;
    core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&v18, (int)&off_2C9338, (int)&off_2CA0A4);
  }
...
LABEL_21:
        v19 = v17;
        v18 = a1;
        core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&v18, (int)&off_2C9338, (int)&off_2CA0B4);
      }
    }
  }
  if ( !v17
