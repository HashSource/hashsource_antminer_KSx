int __fastcall <object::pe::ImageSectionHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[15] = &off_2CB110;
  v3[1] = &off_2CB5B0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_293E4A, 18, (int)&off_2CBDE0, 10, (int)v3, 10);
}
