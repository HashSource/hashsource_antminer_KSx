bool __fastcall sub_19F6AC(_BYTE *s1, size_t n, void *s2, unsigned int a4)
{
  unsigned int v5; // r11
  unsigned int v6; // r5
  unsigned int v7; // r3
...
LABEL_84:
            if ( v58 > v46 )
              v46 = v58;
            core::panicking::panic_bounds_check(v46, v58, (int)&off_2C91B0);
          }
        ...
        while ( v19 != -1 )
        {
          if ( v53 - 1 >= v60 )
LABEL_81:
            core::panicking::panic_bounds_check(v19, v60, (int)&off_2C91C0);
          v20 = v34 + v19;
          if ( v34 + v19 >= v58 )
LABEL_82:
            core::panicking::panic_bounds_check(v20, v58, (int)&off_2C91D0);
  ...
  for ( i = (unsigned __int8)v52 == 0; ; i = 0 )
  {
    if ( v21 )
    {
      if ( v58 <= v21 )
      {
        if ( v58 != v21 )
LABEL_87:
          core::str::slice_error_fail(v57, v58, v21, v58, (int)&off_2C9648);
      }
      else if ( v57[v21] < -64 )
      {
        goto LABEL_87;
