unsigned int __fastcall sub_25C96C(unsigned int a1, unsigned int a2, unsigned __int64 a3)
{
  unsigned int v3; // r7
  unsigned int v4; // r9
  unsigned int v5; // r6
  ...
  if ( (_DWORD)a3 && !HIDWORD(a3) )
  {
    ...
    if ( a2 == (_DWORD)a3 )
      return sub_25ABA8(a1, a2);
    v28 = a2 - sub_25ABA8(a2, a3) * a3;
    if ( v4 < 0x10000 )
    {
      v29 = sub_25ABA8((v28 << 16) | HIWORD(v6), v4);
      return sub_25ABA8((unsigned __int16)v6, v4) | (v29 << 16);
    }
