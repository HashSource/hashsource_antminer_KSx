int __fastcall <object::pe::ImageExportDirectory as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2CB110;
  v3[5] = &off_2CB110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2940E8, 20, (int)&off_2CBEF8, 11, (int)v3, 11);
}
