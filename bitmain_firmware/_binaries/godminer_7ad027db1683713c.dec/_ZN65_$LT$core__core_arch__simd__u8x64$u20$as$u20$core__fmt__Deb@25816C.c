bool __fastcall <core::core_arch::simd::u8x64 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v8[0] = &v9;
  v3 = 0;
  v75 = (*(int (__fastcall **)(_DWORD, void *, int))(a2[1] + 12))(*a2, &unk_2B0577, 5);
  v74 = a2;
  v76 = 0;
  v4 = &v73;
  v73 = 0;
  do
  {
    v4 = core::fmt::builders::DebugTuple::field(v4, (int)&v8[v3], (int)&off_2CF268);
    v3 += 2;
  }
  while ( v3 != 128 );
  if ( v73 )
  {
    ...
    if ( !v75 )
    {
      ...
      if ( v73 != 1
        || !v76
        || (v74[6] & 4) != 0
        || (v5 = 1, !(*(int (__fastcall **)(_DWORD, const char *, int))(v74[1] + 12))(*v74, asc_29F19F, 1)) )
      {
        v5 = (*(int (__fastcall **)(_DWORD, const char *, int))(v6[1] + 12))(*v6, asc_29ECA9, 1);
      }
    }
  }
  else
