// Alternative name is '_ZN3std2os4unix3net6stream10UnixStream12read_timeout17haf24e4927738322fE'
int __fastcall std::os::unix::net::datagram::UnixDatagram::read_timeout(_DWORD *a1, int *a2)
{
  int v3; // r0
  int v4; // r0
