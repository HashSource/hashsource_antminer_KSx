int __fastcall <std::net::socket_addr::SocketAddrV4 as core::fmt::Display>::fmt(int a1, int *a2)
{
    ...
    || (unsigned int)core::fmt::Formatter::width((int)a2) == 1 )
  {
    ...
    v13 = a1;
    v15 = &v6;
    v17 = (unsigned int **)&off_2C9D98;
    v16[0] = 0;
    if ( core::fmt::write((int)&v15, (int)&off_2C90B0, v16) )
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)v16, (int)&off_2C9318, (int)&off_2C9DA8);
    if ( v6 >= 0x16 )
      core::slice::index::slice_end_index_len_fail(v6, 21, (int)&off_2C9CC8);
