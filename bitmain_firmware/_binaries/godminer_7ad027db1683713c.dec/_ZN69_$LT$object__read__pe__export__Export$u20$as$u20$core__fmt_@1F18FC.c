int __fastcall <object::read::pe::export::Export as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  ...
  v3 = core::fmt::builders::DebugStruct::field(v8, (int)aOrdinal, 7u, (int)(a1 + 2), (int)&off_2CB278);
  v4 = *a1;
  v9[1] = a1[1];
  v9[0] = v4;
  v5 = core::fmt::builders::DebugStruct::field(v3, (int)aName_1, 4u, (int)v9, (int)&off_2CB288);
  v6 = core::fmt::builders::DebugStruct::field(v5, (int)aTarget, 6u, (int)(a1 + 3), (int)&off_2CB298);
