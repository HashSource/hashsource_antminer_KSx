bool __fastcall sub_1E0944(unsigned int *a1, int a2, _BYTE *src, size_t n)
{
  int v5; // r1
  _BOOL4 v9; // r0
  int v10; // r4
  ...
  unsigned int v35; // [sp+14h] [bp-1ACh]
...
LABEL_21:
    ...
    {
      sub_1D9278((int)&v32, v39[1], v39[2], (int)fd);
      if ( (unsigned __int8)v32 != 4 )
        goto LABEL_21;
    }
  }
...
LABEL_23:
  ...
  if ( *(_DWORD *)a2 - v28 < v27 )
    sub_77DD8((unsigned int *)a2, v28, v27);
  sub_1C3E70((int *)&dest, fd[0], (unsigned int *)a2);
  if ( (unsigned __int8)dest == 4 )
  {
    close(fd[0]);
    v29 = (unsigned __int8 *)sub_19D448(*(char **)(a2 + 4), *(_DWORD *)(a2 + 8));
    core::num::<impl core::str::traits::FromStr for usize>::from_str((int)&dest, v29, v30);
    return !(_BYTE)dest;
  }
