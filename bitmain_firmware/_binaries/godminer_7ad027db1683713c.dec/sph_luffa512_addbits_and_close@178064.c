void *__fastcall sph_luffa512_addbits_and_close(unsigned int *a1, char a2, char a3, _BYTE *a4)
{
  ...
  int j; // [sp+4h] [bp-120h]
  int k; // [sp+4h] [bp-120h]
  unsigned int v292; // [sp+10h] [bp-114h]
  ...
  unsigned int v301; // [sp+18h] [bp-10Ch]
  int v302; // [sp+18h] [bp-10Ch]
  int v303; // [sp+18h] [bp-10Ch]
  unsigned int v304; // [sp+1Ch] [bp-108h]
  int v305; // [sp+1Ch] [bp-108h]
  int v306; // [sp+1Ch] [bp-108h]
  unsigned int v307; // [sp+20h] [bp-104h]
  ...
  unsigned int v313; // [sp+28h] [bp-FCh]
  ...
  unsigned int v321; // [sp+30h] [bp-F4h]
  ...
  unsigned int v341; // [sp+44h] [bp-E0h]
  ...
  unsigned int v349; // [sp+4Ch] [bp-D8h]
  ...
  unsigned int v371; // [sp+64h] [bp-C0h]
  ...
  unsigned int v379; // [sp+6Ch] [bp-B8h]
  ...
  unsigned int v401; // [sp+84h] [bp-A0h]
  ...
  unsigned int v408; // [sp+8Ch] [bp-98h]
  ...
  *((_BYTE *)a1 + v4) = (128 >> a3) | a2 & -(128 >> a3);
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v72 == 8 )
        break;
      v283 = dword_28D398[v72];
      v71 = dword_28D3B8[v72];
    }
    v292 = v77;
    v297 = v73;
    v433 = v68;
    ...
    while ( 1 )
    {
      ...
      if ( v108 == 8 )
        break;
      v284 = dword_28D3D8[v108];
      v109 = dword_28D3F8[v108];
    }
    v325 = v115;
    v307 = v110;
    v310 = v111;
    ...
    v155 = v363;
    v156 = v336;
    for ( i = -497126719; ; i = dword_28D438[v148] )
    {
      v157 = v150 ^ v152;
      v158 = v153 ^ v155;
      v159 = v157 ^ v154 & v152;
    ...
    v194 = v394;
    v195 = v366;
    for ( j = -534197825; ; j = dword_28D518[v187] )
    {
      v196 = v189 ^ v191;
      v197 = v192 ^ v194;
      v198 = v196 ^ v193 & v191;
    ...
    v233 = v423;
    v234 = v397;
    for ( k = 1351669111; ; k = dword_28D558[v226] )
    {
      v235 = v228 ^ v230;
      v236 = v231 ^ v233;
      v237 = v235 ^ v232 & v230;
...
LABEL_21:
  ...
  a4[61] = BYTE2(v272);
  a4[62] = BYTE1(v272);
  result = memcpy(a1 + 9, &unk_28D458, 0xA0u);
  a1[8] = 0;
  return result;
}
