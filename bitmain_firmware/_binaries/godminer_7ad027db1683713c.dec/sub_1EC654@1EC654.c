const char *__fastcall sub_1EC654(int *a1, unsigned int *a2, char *a3, unsigned int a4)
{
  int v4; // r7
  unsigned int v5; // r6
  int v6; // r11
...
LABEL_14:
    v17 = 0;
    if ( a4 >= 7 && !bcmp(&unk_292569, a3, 7u) )
    {
      if ( a4 >= 8 && a3[7] <= -65 )
        core::str::slice_error_fail(a3, a4, 7u, a4, (int)&off_2CAEC4);
      if ( v52 )
      {
        if ( *a1 )
        {
          ...
          {
            v26 = *(v24 - 4);
            v27 = __CFADD__(v22, v26) + (unsigned __int64)(unsigned int)v23;
            if ( !HIDWORD(v27) )
            {
              ...
              if ( bytes_at_until )
              {
                ...
                {
                  v31 = bytes_at_until;
                  v32 = bcmp(&unk_290218, bytes_at_until, 8u);
                  v33 = v32 == 0;
                  if ( !v32 )
                    v33 = v30 - 1 == a4;
          ...
          {
            v43 = (unsigned __int8 *)(bytes_at + 12);
            v42 = *(_DWORD *)(bytes_at + 8);
            v44 = v41 - 12;
            if ( v41 < 0xC )
              v44 = 0;
            v45 = sub_1E5EF8(a2, bswap32(v42));
            v17 = sub_1ECDDC(v43, v44, v45, HIDWORD(v45));
            if ( v17 )
  ...
  {
    v39 = sub_1E5EF8(a2, *((_DWORD *)v16 + 1));
    v38 = v39;
