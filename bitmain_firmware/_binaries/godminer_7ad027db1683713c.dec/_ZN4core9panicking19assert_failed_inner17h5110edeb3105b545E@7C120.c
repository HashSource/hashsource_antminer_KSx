        ...
        int a7)
{
  ...
  int (__fastcall *v20)(int, int *); // [sp+34h] [bp-34h]
  _DWORD *v21; // [sp+38h] [bp-30h]
  int (__fastcall *v22)(_DWORD *); // [sp+3Ch] [bp-2Ch]
  _DWORD *v23; // [sp+40h] [bp-28h]
  int (__fastcall *v24)(_DWORD *); // [sp+44h] [bp-24h]
  _DWORD *v25; // [sp+48h] [bp-20h]
  bool (__fastcall *v26)(int *, int *); // [sp+4Ch] [bp-1Ch]
