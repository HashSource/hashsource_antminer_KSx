int __fastcall <object::pe::ImageAuxSymbolSection as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2CB638;
  v3[1] = &off_2CB638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aImageauxsymbol, 21, (int)&off_2CBE80, 8, (int)v3, 8);
}
