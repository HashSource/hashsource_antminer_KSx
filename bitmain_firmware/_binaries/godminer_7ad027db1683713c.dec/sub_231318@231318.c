_BYTE *__fastcall sub_231318(_BYTE *result, unsigned __int8 *a2, unsigned int a3, unsigned int a4)
{
  int v4; // r7
  unsigned int v6; // r12
  unsigned int v7; // lr
  ...
  unsigned int v87; // [sp+Ch] [bp-28h]
  unsigned int v88; // [sp+Ch] [bp-28h]
  ...
  if ( a4 - 2 > 0x22 )
  {
    ...
    v91[0] = &v89;
    core::panicking::panic_fmt((int)v90, (int)&off_2CEF1C);
  }
  if ( !a3 )
  {
    v28 = 0;
      ...
      if ( !_CF )
      {
        ...
        else
        {
          while ( 1 )
          {
            ...
            v7 = ((unsigned __int64)v50 + v48) >> 32;
            v6 = v50 + v48;
