_WORD *__fastcall std::path::Path::file_prefix(_BYTE *a1, int a2)
{
  ...
  switch ( v13 )
  {
    case 2u:
      ...
      break;
    case 0u:
      core::slice::index::slice_start_index_len_fail(1, 0, (int)&off_2C9ECC);
    case 1u:
      return result;
  }
  v11 = 1;
  ...
  if ( v11 - 1 >= v13 )
    core::slice::index::slice_end_index_len_fail(v11, v13, (int)&off_2C9EDC);
  if ( v11 + 1 > v13 )
    core::slice::index::slice_start_index_len_fail(v11 + 1, v13, (int)&off_2C9EEC);
  return result;
}
