unsigned int __fastcall sub_1C5F98(unsigned __int8 **a1, int a2, unsigned int a3, unsigned int a4)
{
  unsigned int v4; // lr
  _WORD *v5; // r7
  unsigned int v7; // r4
  ...
  unsigned __int8 *v37; // [sp+4h] [bp-20h]
  unsigned __int8 *v39; // [sp+Ch] [bp-18h]
  unsigned __int8 *v40; // [sp+10h] [bp-14h]
  unsigned __int8 *v41; // [sp+10h] [bp-14h]
  unsigned __int8 *v42; // [sp+14h] [bp-10h]
...
LABEL_45:
  ...
  v9 = *a1;
  v10 = a1[1];
  if ( v8 && (!v10 || (v11 = *v9, *a1 = v9 + 1, a1[1] = v10 - 1, v11 != 58)) || (sub_1C5534((int)&v44, a1), !v44) )
  {
    *a1 = v9;
    a1[1] = v10;
    v12 = v10;
  ...
  if ( v8 >= a3 )
    core::panicking::panic_bounds_check(v8, a3, (int)&off_2C9D48);
  v35 = v45;
  *(v5 - 1) = __rev16(v45);
  if ( v8 + 1 >= a3 )
    core::panicking::panic_bounds_check(v8 + 1, a3, (int)&off_2C9D58);
  *v5 = bswap32(v35);
  return v8 + 2;
}
