unsigned int __fastcall core::num::dec2flt::lemire::compute_product_approx(
        int a1,
        int a2,
        unsigned int a3,
        unsigned int a4,
        unsigned int a5)
{
  ...
  if ( (unsigned int)(a1 + 342) > 0x28A )
    core::panicking::panic_bounds_check(v5, 651, (int)&off_2CEB24);
  v8 = *((_DWORD *)&unk_2A0100 + 4 * v5);
  v9 = *((_DWORD *)&unk_2A0100 + 4 * v5 + 1);
  result = v8 * a3;
