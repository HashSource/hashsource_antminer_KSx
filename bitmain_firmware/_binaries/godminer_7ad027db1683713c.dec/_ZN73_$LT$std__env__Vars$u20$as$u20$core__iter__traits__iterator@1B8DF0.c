unsigned int __fastcall <std::env::Vars as core::iter::traits::iterator::Iterator>::next(unsigned int *a1, int a2)
{
  ...
  else
  {
    ...
    if ( !v13 )
    {
      ...
      v22 = v42;
      v23 = v43;
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&v21, (int)&off_2C993C, (int)&off_2C9864);
    }
    v34 = v5;
    v33 = v4;
    v32 = v6;
    ...
    if ( v21 )
    {
      ...
      if ( (unsigned __int8)v23 != 2 )
      {
        ...
        v22 = v42;
        v23 = v43;
        core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&v21, (int)&off_2C993C, (int)&off_2C9874);
      }
    }
    else
    {
