int *__fastcall std::process::Command::output(int *a1, int a2)
{
  int *v3; // r6
  unsigned int v4; // r10
  unsigned int v5; // r7
  ...
  if ( v11 )
  {
    if ( v10 == -1 )
      goto LABEL_14;
    fd = v10;
    std::sys::unix::fd::FileDesc::read_to_end(&v31, &fd, (unsigned int *)&v17);
    if ( (unsigned __int8)v31 != 4 )
    {
      stat_loc = v31;
      v34 = v32;
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&stat_loc, (int)&off_2C9308, (int)&off_2CA1C4);
    }
    goto LABEL_13;
  }
  if ( v10 == -1 )
  {
    fd = v9;
    std::sys::unix::fd::FileDesc::read_to_end(&v31, &fd, (unsigned int *)&v27);
    if ( (unsigned __int8)v31 != 4 )
    {
      stat_loc = v31;
      v34 = v32;
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&stat_loc, (int)&off_2C9308, (int)&off_2CA1B4);
    }
LABEL_13:
    close(fd);
    goto LABEL_14;
  }
  sub_1DD728((int)&v31, v9, (unsigned int *)&v27, v10, (unsigned int *)&v17);
  if ( (unsigned __int8)v31 != 4 )
  {
    stat_loc = v31;
    v34 = v32;
    core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&stat_loc, (int)&off_2C9308, (int)&off_2CA1A4);
  }
LABEL_14:
  if ( v3 == (int *)1 )
    goto LABEL_19;
...
LABEL_30:
  result = (int *)((unsigned __int8)v4 | (v6 << 8));
  a1[2] = 0;
  *a1 = (int)result;
  a1[1] = v5;
  return result;
