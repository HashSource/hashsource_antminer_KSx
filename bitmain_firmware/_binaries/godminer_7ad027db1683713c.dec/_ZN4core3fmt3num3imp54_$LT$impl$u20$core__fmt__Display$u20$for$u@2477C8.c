...
int __fastcall core::fmt::num::imp::<impl core::fmt::Display for usize>::fmt(unsigned int *a1, int a2)
{
  unsigned int v2; // r3
  int v4; // lr
  int v5; // r2
...
LABEL_8:
    ...
    *(_WORD *)&v14[v4] = word_29F267[(unsigned __int16)(v8 - 100 * v11)];
    if ( v11 >= 0xA )
      goto LABEL_6;
LABEL_9:
    v12 = v4 - 1;
...
LABEL_6:
  v12 = v4 - 2;
  *(_WORD *)&v14[v4 - 2] = word_29F267[v11];
  return core::fmt::Formatter::pad_integral(a2, 1, aLibraryCoreSrc, 0, (int)&v14[v12], 39 - v12);
}
