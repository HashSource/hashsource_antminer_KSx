int __fastcall sub_246B1C(int a1, int a2)
{
  int v2; // r2
  unsigned int v3; // r2
...
LABEL_20:
      ...
      else
      {
        ...
        v7 = 37;
        v17 = word_29F267[(unsigned __int16)(a1 - 100 * v3)];
  ...
  if ( (unsigned int)(128 - v8) >= 0x81 )
    core::slice::index::slice_start_index_len_fail(128 - v8, 128, (int)&off_2CF1FC);
