char **__fastcall std::thread::available_parallelism(_DWORD *a1)
{
  ...
  unsigned __int8 *v159; // r6
  unsigned int v160; // r7
  size_t v161; // r0
  unsigned int v162; // r1
  unsigned __int8 *v163; // r5
  ...
  unsigned int v211; // [sp+68h] [bp-1F4h] BYREF
  ...
  unsigned int v233; // [sp+244h] [bp-18h]
  ...
  *(_WORD *)v235 = 0;
  ...
  core::ffi::c_str::CStr::from_bytes_with_nul(&v217, s, 0x12u);
  if ( !v217 )
  {
    sub_1D9278((int)&v224, v218, v219, (int)&v232);
    v201 = a1;
    ...
    *(_WORD *)&v235[1] = v224;
    ...
    if ( v10 - 1 != v13 )
    {
      ...
      if ( !v24 )
        goto LABEL_29;
LABEL_47:
      core::str::converts::from_utf8((int)&v217, (int)(v14 + 1), v24);
      if ( !v217 )
      {
        LOWORD(s[9]) = 1;
        s[5] = v219;
        ...
        s[1] = v219;
        s[0] = 0;
        for ( i = (const void *)sub_19D718(s); i; i = (const void *)sub_19D718(s) )
        {
...
LABEL_30:
    ...
    {
      if ( !v23 )
        core::slice::index::slice_start_index_len_fail(1, 0, (int)&off_2CAB3C);
      v1 = v23 - 1;
      v198 = v19;
      if ( v23 == 1 )
      {
...
LABEL_14:
  ...
  if ( (v8 & 1) == 0 )
  {
    ...
    while ( 2 )
    {
      ((void (__fastcall *)(size_t *, _BYTE *, int))off_2CAB4C[v31])(s, ptr, v1);
      if ( s[0] == 2 )
        goto LABEL_72;
      v33 = 0;
      v34 = s[3];
...
LABEL_92:
          ...
          if ( !v44 && v43 != 0 )
          {
            ...
            {
              v126 = sub_1E0944(&v221, (int)&v224, &unk_29061C, 0x10u);
              v128 = v127;
              v129 = sub_1E0944(&v221, (int)&v224, aCpuCfsPeriodUs, 0x11u);
              v131 = v126;
              if ( v126 )
                v131 = v129;
              if ( v131 && v130 )
              {
                v132 = sub_25ABA8(v128, v130);
                v133 = nb;
                if ( nb >= v132 )
                  v133 = v132;
                nb = v133;
              ...
              if ( (unsigned __int8)v234 != 10 )
              {
                ...
                if ( (unsigned int)(unsigned __int8)_R0 - 2 < 3
                  && std::path::Components::as_path((int)s)
                  && v134 >= v142 )
                {
                  v223 = v142;
                }
...
LABEL_136:
  ...
  s[0] = (size_t)v121;
  LOWORD(s[7]) = 512;
  <std::path::Components as core::iter::traits::double_ended::DoubleEndedIterator>::next_back((int)&v232, (int)s);
  _R0 = (unsigned __int8)v234;
  if ( (unsigned __int8)v234 != 10 )
  {
    _R1 = 5;
    __asm { UQSUB8          R0, R0, R1 }
    if ( (unsigned int)(unsigned __int8)_R0 - 2 < 3 && std::path::Components::as_path((int)s) && v122 >= v148 )
    {
      v122 = v148;
      v223 = v148;
    }
    ...
    *(_WORD *)v235 = 0;
    ...
    if ( (unsigned int)(v150 + 7) >> 7 <= 2 )
    {
      ...
      *((_BYTE *)s + v122) = 0;
      ...
      {
        v229 = dword_2CA158;
        v230 = (void **)&off_2CA14C;
        if ( (unsigned __int8)dword_2CA158 == 4 )
          goto LABEL_207;
        goto LABEL_198;
      }
      sub_1D9278((int)&v229, v218, v219, (int)&v232);
    }
    else
    {
      sub_79A60(&v229, v222, v150 + 7, (int)&v232);
    }
...
LABEL_208:
    s[0] = v151;
    v155 = sub_1BB2FC((int *)s);
    if ( v224 - v226 < v155 )
      sub_77DD8((unsigned int *)&v224, v226, v155);
    sub_1C3E70(&v227, s[0], (unsigned int *)&v224);
    close(s[0]);
    v152 = v227 & 7;
    if ( v152 == 4 )
    {
LABEL_200:
      ...
      s[1] = v154;
      s[0] = 0;
      v159 = (unsigned __int8 *)sub_19D718(s);
      v149 = v158;
      if ( !v159 )
        break;
      v160 = v158;
      v161 = sub_19D718(s);
      v163 = (unsigned __int8 *)v161;
      v157 = (_BYTE *)v162;
      if ( !v161 )
        break;
      v164 = v162;
      core::num::<impl core::str::traits::FromStr for usize>::from_str((int)&v217, v159, v160);
      core::num::<impl core::str::traits::FromStr for usize>::from_str((int)&v232, v163, v164);
      v165 = (v217 & 1) == 0;
      if ( (v217 & 1) == 0 )
        v165 = (v232 & 1) == 0;
      if ( v165 && v233 )
      {
        v166 = sub_25ABA8(v218, v233);
        v167 = nb;
        if ( nb >= v166 )
          v167 = v166;
        nb = v167;
...
LABEL_231:
    ...
    if ( (unsigned __int8)v234 != 10 )
    {
      _R1 = 5;
      __asm { UQSUB8          R0, R0, R1 }
      if ( (unsigned int)(unsigned __int8)_R0 - 2 < 3 && std::path::Components::as_path((int)s) && v122 >= v172 )
      {
        v122 = v172;
        v223 = v172;
      }
    ...
    v120 = v149;
    v6 = v157;
    if ( std::path::Components::as_path((int)s) )
    {
      v120 = v149;
      v6 = v157;
      if ( v122 >= v177 )
