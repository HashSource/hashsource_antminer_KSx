int __fastcall <std::net::ip_addr::Ipv4Addr as core::fmt::Display>::fmt(int *a1, int *a2)
{
    ...
    || (unsigned int)core::fmt::Formatter::width((int)a2) == 1 )
  {
    ...
    v19 = &v7;
    v17 = &off_2C9CD8;
    if ( core::fmt::write((int)&v15, (int)&off_2C90C8, v16) )
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)v16, (int)&off_2C9318, (int)&off_2C9CF8);
    if ( v5 >= 0x10 )
      core::slice::index::slice_end_index_len_fail(v5, 15, (int)&off_2C9CC8);
