bool __fastcall <core::panic::panic_info::PanicInfo as core::fmt::Display>::fmt(_DWORD *a1, int *a2)
{
  int v2; // r4
  int v3; // r5
  int v5; // r7
  ...
  void *v11; // [sp+Ch] [bp-2Ch]
  _DWORD *v12; // [sp+10h] [bp-28h]
  int (__fastcall *v13)(unsigned int *, int); // [sp+14h] [bp-24h]
  _DWORD *v14; // [sp+18h] [bp-20h]
  int (__fastcall *v15)(unsigned int *, int); // [sp+1Ch] [bp-1Ch]
  int v16[2]; // [sp+20h] [bp-18h] BYREF
