int __fastcall sub_2302FC(int result, unsigned __int8 *a2, unsigned int a3, unsigned int a4)
{
  unsigned int v4; // lr
  int v5; // r7
  char v6; // r1
  ...
  if ( a4 - 2 > 0x22 )
  {
    ...
    v29[0] = &v27;
    core::panicking::panic_fmt((int)v28, (int)&off_2CEF1C);
  }
  if ( a3 )
  {
    v5 = *a2;
...
LABEL_47:
          ...
          else
          {
            ...
            while ( 1 )
            {
              ...
              LODWORD(v8) = ((((unsigned int)v8 * (unsigned __int64)a4) >> 32) + v13) >> 32;
              if ( !is_mul_ok(v12, a4) )
                HIDWORD(v8) = 1;
              if ( v14 >= 0xA )
              {
