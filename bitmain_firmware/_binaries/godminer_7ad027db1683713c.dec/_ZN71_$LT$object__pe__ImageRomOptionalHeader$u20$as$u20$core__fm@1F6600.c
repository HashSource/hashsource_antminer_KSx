int __fastcall <object::pe::ImageRomOptionalHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2CB0D0;
  v3[1] = &off_2CB110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_293D22, 22, (int)&off_2CBB30, 13, (int)v3, 13);
}
