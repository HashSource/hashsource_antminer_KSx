int __fastcall serdes_external_loop_ate_init(int a1, int a2, int a3, int a4)
{
  ...
  sub_CF994(a1, a3, 24642, a4 | 0x700);
  ...
  zlog(
    ...
    60,
    v134);
  sub_CF420(a1, a3, 77, 20971840);
  sub_CF420(a1, a3, 78, -2144251901);
  sub_CF420(a1, a3, 77, 88606024);
  sub_CF420(a1, a3, 78, -2144251901);
  V_LOCK();
