int __fastcall core::num::dec2flt::decimal::Decimal::right_shift(int result, char a2)
{
  ...
  {
    if ( v4 == 768 )
      core::panicking::panic_bounds_check(768, 768, (int)&off_2CEAC4);
...
LABEL_19:
  ...
  *(_DWORD *)(result + 772) = v19;
  ...
  if ( v4 < v2 )
  {
    ...
    {
      if ( v26 == v25 )
        core::panicking::panic_bounds_check(v4 + v25, 768, (int)&off_2CEAD4);
      v27 = (v8 >> v3) | (v6 << (32 - v3));
      v28 = v8 & v24;
      if ( v21 >= 0 )
        v27 = v6 >> v21;
...
LABEL_43:
  v34 = v25 - 1;
  if ( v34 >> 8 > 2 )
    core::panicking::panic_bounds_check(v34, 768, (int)&off_2CEA84);
  do
  {
    if ( *(_BYTE *)(result + v34) )
      break;
