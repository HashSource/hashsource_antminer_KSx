int __fastcall sub_1A7DDC(__int64 a1)
{
  __int64 v1; // r4
  unsigned int v2; // r0
  int v3; // r1
  ...
  if ( v2 <= 0x2130 )
  {
    switch ( *(_WORD *)(HIDWORD(a1) + 16) )
    {
      ...
      case 0x4D:
        goto LABEL_43;
      case 9:
        LODWORD(a1) = sub_1A8750((_DWORD *)HIDWORD(a1));
        if ( (a1 & 1) == 0 )
          goto LABEL_79;
        v8 = 43;
        goto LABEL_62;
...
LABEL_75:
      ...
      case 0x57:
      case 0x59:
        if ( !sub_1A86B8((_DWORD *)HIDWORD(a1)) )
          goto LABEL_79;
        goto LABEL_41;
      case 0x13:
        LODWORD(a1) = (unsigned __int16)sub_1A87F4((_DWORD *)HIDWORD(a1));
...
LABEL_79:
    LODWORD(a1) = sub_1AAFF4(v1, (_DWORD *)HIDWORD(v1));
    return a1;
  }
  if ( !sub_1A86B8((_DWORD *)HIDWORD(a1)) )
    goto LABEL_79;
