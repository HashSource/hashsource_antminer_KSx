...
LABEL_26:
    ...
    *(_BYTE *)(a1 + 21) = v7;
    if ( v7 >= 4u )
      core::panicking::panic_bounds_check(v7, 4, (int)&off_2CEF5C);
    return 1;
  }
  *(_BYTE *)(a1 + 15) = 0;
LABEL_5:
...
LABEL_19:
          if ( v2 - 32 >= 0x5F )
          {
            v3 = (byte_29ECFF[v2 >> 4] << 16) | (byte_29ECFF[v2 & 0xF] << 24) | 0x785C;
            LOBYTE(v1) = 4;
          }
          else
          {
...
LABEL_11:
  ...
  else
  {
    *(_BYTE *)(a1 + 14) = v4 - 1;
    ...
    if ( v5 >= 4 )
      core::panicking::panic_bounds_check(v5, 4, (int)&off_2CEF5C);
    return 1;
  }
}
