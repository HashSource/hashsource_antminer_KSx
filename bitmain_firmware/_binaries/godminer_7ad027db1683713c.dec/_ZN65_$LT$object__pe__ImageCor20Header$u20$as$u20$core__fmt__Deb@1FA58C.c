int __fastcall <object::pe::ImageCor20Header as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[5] = &off_2CB110;
  v3[3] = &off_2CB110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_29314C, 16, (int)&off_2CC558, 12, (int)v3, 12);
}
