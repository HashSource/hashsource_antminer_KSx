int __fastcall work_2_packet_dcr(int a1, _DWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  _DWORD v27[2]; // [sp+10h] [bp-1004h] BYREF
  __int64 v28; // [sp+18h] [bp-FFCh]
  ...
  *v6 = (v22 + 1) & 0x7F;
  ...
  {
    V_LOCK();
    logfmt_raw((char *)v27, 0x1000u, 0, "found repeat work");
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  *a4 = 186;
  ...
  V_LOCK();
  logfmt_raw((char *)v27, 0x1000u, 0, "bridge reset %s %02x", "ChipSetting_bridge_reset_DCR_1727", 68);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  v27[0] = 2;
  v28 = 0;
  v25 = *(void (__fastcall **)(int, _DWORD *))(a1 + 248);
  LOBYTE(v28) = 1;
  WORD1(v28) = 68;
  v25(a1, v27);
  usleep(0x14u);
