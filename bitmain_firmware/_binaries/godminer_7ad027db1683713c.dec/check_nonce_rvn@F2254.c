int __fastcall check_nonce_rvn(int a1, _DWORD *a2)
{
  ...
  _DWORD v34[8]; // [sp+30h] [bp-1064h] BYREF
  _QWORD v35[4]; // [sp+50h] [bp-1044h] BYREF
  _QWORD v36[4]; // [sp+70h] [bp-1024h] BYREF
  ...
  ethash_quick_hash(v37, (int)v33, *(_DWORD *)((char *)a2 + 26), *(_DWORD *)((char *)a2 + 30), (int)v34);
