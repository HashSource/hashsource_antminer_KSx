bool __fastcall sub_23DE50(int a1, int *a2)
{
  _QWORD *v3; // r0
  int v5; // r8
  int v6; // r6
  ...
  int (__fastcall *v15)(int, int *); // [sp+14h] [bp-24h]
  int *v16; // [sp+18h] [bp-20h]
  void *v17; // [sp+1Ch] [bp-1Ch]
  ...
  {
    if ( v9 >= 0xA )
      core::slice::index::slice_end_index_len_fail(v9, 9, (int)&off_2CF598);
