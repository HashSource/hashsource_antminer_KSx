unsigned int __fastcall sub_1A5D9C(int a1, unsigned int *a2, unsigned int a3, int a4)
{
  char *v4; // r4
  int v5; // r8
  unsigned int i; // r1
...
LABEL_212:
      ...
      case 5:
        ...
        *a2 = i;
        ...
        goto LABEL_203;
      case 6:
        if ( (a3 & 0xFF00) == 0x400 && gimli::read::unit::allow_section_offset(*(_WORD *)(a4 + 8), SHIWORD(a3)) )
        {
...
LABEL_216:
        ...
        *a2 = (unsigned int)(v54 + 2);
        ...
        goto LABEL_203;
      case 7:
        if ( (a3 & 0xFF00) == 0x800 && gimli::read::unit::allow_section_offset(*(_WORD *)(a4 + 8), SHIWORD(a3)) )
        {
          v57 = *a2;
          v58 = a2[1];
          if ( v58 < 8 )
...
LABEL_258:
      ...
      case 16:
        if ( i == 2 )
          sub_1A8C2C((int)&v195, a2, a3);
        else
          sub_1A8B4C((int)&v195, a2, SBYTE1(a3));
