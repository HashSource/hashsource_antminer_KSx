        ...
        int a6)
{
  ...
  unsigned int *v51; // [sp+1Ch] [bp-80h]
  void *base; // [sp+20h] [bp-7Ch]
  char *v53; // [sp+28h] [bp-74h]
    ...
    case 0:
      ...
      if ( (v11 & 0x80) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          v25 = strlen(v24);
          sub_8DAFC(v24, v25, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
          v26 = a5(v42, v21, a6) == 0;
          v27 = v22;
          v22 = v23;
          if ( !v26 )
          ...
          if ( sub_8DE8C(v28, v9, v50, v7, a5, a6) )
            return -1;
          if ( !v23 )
          {
            v14 = 0;
            if ( !sub_8DD84(v9, v45, 0, a5, a6) )
              goto LABEL_65;
            return -1;
          }
          if ( a5(&word_25DF88, 1, a6) || sub_8DD84(v9, v50, 1, a5, a6) )
            return -1;
        }
      }
      ...
      while ( v34 );
      v7 = v51;
      qsort(base, nmemb, 4u, (__compar_fn_t)sub_8DAF0);
      if ( nmemb )
      {
        v48 = v8;
        v36 = v53;
        ...
        do
        {
          ...
          v40 = strlen(v38);
          sub_8DAFC(v38, v40, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
          if ( a5(v42, v44, a6) || (v41 = sub_8DE8C(v39, v9, v50, v51, a5, a6)) != 0 )
          {
LABEL_70:
            v14 = -1;
            jsonp_free(base);
          ...
          else if ( sub_8DD84(v9, a3, v41, a5, a6) )
          {
            goto LABEL_70;
          }
        }
...
LABEL_47:
    ...
    case 2:
      ...
      return sub_8DAFC(v16, (int)v17, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
    case 3:
  ...
  do
  {
    ...
    v14 = sub_8DE8C(v31, v9, v30, v7, a5, a6);
    if ( v14 )
      return -1;
    v32 = (unsigned int)v43 - 1 > v29++;
    if ( v32 )
    {
      if ( a5(&word_25DF88, 1, a6) || sub_8DD84(v9, v30, 1, a5, a6) )
        return -1;
    }
    else if ( sub_8DD84(v9, v46, v14, a5, a6) )
    {
      return -1;
    }
  }
