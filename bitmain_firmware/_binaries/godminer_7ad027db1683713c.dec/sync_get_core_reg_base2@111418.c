int __fastcall sync_get_core_reg_base2(
        pthread_mutex_t *a1,
        int a2,
        int a3,
        int a4,
        ...
        unsigned int a8)
{
  ...
  char v27[2]; // [sp+14h] [bp-10h] BYREF
  ...
  *(_WORD *)&src[4] = reverse_byte_order_16(v14);
  ...
  send_command_packet(a1, (int)v24, 9u);
  sub_25A4F8(a7, a8, 0x3E8u);
  v23[1] = 1000000 * v18;
  v23[0] = sub_25A4F8(a7, a8, 0x3E8u);
  while ( v17 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, v27, 0xCu, v23) == 110 )
      {
        v9 = 3;
        goto LABEL_14;
      }
      if ( (unsigned __int8)v27[0] != 170 || v27[1] != 85 || (v28[0] & 0xEF) != 1 )
      {
        v9 = 1;
        *a5 = v17;
