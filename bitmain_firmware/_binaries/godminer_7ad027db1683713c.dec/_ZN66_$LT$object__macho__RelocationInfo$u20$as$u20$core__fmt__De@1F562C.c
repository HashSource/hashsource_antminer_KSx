int __fastcall <object::macho::RelocationInfo as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2CB308;
  v3[1] = &off_2CB308;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aRelocationinfo, 14, (int)&off_2CB678, 6, (int)v3, 6);
}
