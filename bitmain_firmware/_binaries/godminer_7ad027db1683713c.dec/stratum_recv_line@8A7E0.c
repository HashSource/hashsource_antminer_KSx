char *__fastcall stratum_recv_line(pthread_mutex_t *a1)
{
  ...
  int v12; // r0
  int v13; // r3
  time_t v14; // [sp+34h] [bp-5028h] BYREF
  _DWORD v15[7]; // [sp+38h] [bp-5024h] BYREF
  int v16; // [sp+54h] [bp-5008h]
  _DWORD v17[7]; // [sp+58h] [bp-5004h] BYREF
  int v18; // [sp+74h] [bp-4FE8h]
  char v19[16388]; // [sp+1058h] [bp-4004h] BYREF
...
LABEL_2:
  v4 = strlen(spins);
  v5 = strtok(spins, (const char *)&word_28253C);
  if ( v5 )
  {
    v6 = _strdup(v5);
    v7 = strlen(v6);
