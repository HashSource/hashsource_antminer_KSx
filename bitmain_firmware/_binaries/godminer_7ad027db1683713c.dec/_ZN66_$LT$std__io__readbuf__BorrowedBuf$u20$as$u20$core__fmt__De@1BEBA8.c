int __fastcall <std::io::readbuf::BorrowedBuf as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3 = core::fmt::builders::DebugStruct::field(v7, (int)aInit, 4u, a1 + 12, (int)&off_2C9748);
  v4 = core::fmt::builders::DebugStruct::field(v3, (int)aFilled, 6u, a1 + 8, (int)&off_2C9748);
  v8 = *(_DWORD *)(a1 + 4);
  v5 = core::fmt::builders::DebugStruct::field(v4, (int)aCapacity_0, 8u, (int)&v8, (int)&off_2C9748);
