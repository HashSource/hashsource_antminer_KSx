const char *__fastcall sub_910C0(int a1, size_t **a2, const char *a3, size_t *a4, _DWORD *a5, int a6)
{
  _DWORD *v6; // r5
  _DWORD *v9; // r7
  int v10; // r1
  ...
  *a5 = 0;
  if ( v15 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !*v28 )
      {
        sub_90F20((int *)a1, "<args>", 12, "NULL %s", a3);
        *(_DWORD *)(a1 + 76) = 1;
      }
      sub_90F80(a1);
...
LABEL_21:
      ...
      *v6 = *v13;
      ...
      if ( !v20 )
      {
        v27 = strlen(v29);
LABEL_14:
        if ( strbuffer_append_bytes((const void **)&v50, v29, v27) == -1 )
        {
          sub_90F20((int *)a1, "<internal>", 1, "Out of memory");
          *(_DWORD *)(a1 + 76) = 1;
        }
...
LABEL_16:
        ...
        *v6 = *v13;
        ...
        else
        {
          ...
          if ( v40 )
          {
            *a4 = v51;
            *a5 = 1;
            return (const char *)strbuffer_steal_value(&v50);
          }
          else
          {
            sub_90F20((int *)a1, "<args>", 5, "Invalid UTF-8 %s", a3);
            strbuffer_close((int)&v50);
            *(_DWORD *)(a1 + 76) = 1;
          }
        }
  ...
  {
    v43 = strlen(*v42);
    v19 = utf8_check_string((int)v40, v43);
    if ( v19 )
    {
      *a4 = v43;
      return v40;
...
LABEL_36:
    v40 = (const char *)v19;
    sub_90F20((int *)a1, v44, v45, v46, v47);
    *(_DWORD *)(a1 + 76) = 1;
    return v40;
  }
  if ( !a6 )
