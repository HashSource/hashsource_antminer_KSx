void __fastcall __noreturn sub_1D5DEC(_DWORD *a1)
{
  _DWORD *v2; // r0
  int v3; // r2
  int v4; // r1
...
LABEL_5:
      ...
      std::panicking::rust_panic_with_hook((int)&v18, (int)&off_2CA3C4, v9, v8, can_unwind);
    }
    v13 = 0;
    v12 = aRustc9eb3afe9e;
  }
  ...
  std::panicking::rust_panic_with_hook((int)&v18, (int)&off_2CA3D8, v15, v16, v17);
}
