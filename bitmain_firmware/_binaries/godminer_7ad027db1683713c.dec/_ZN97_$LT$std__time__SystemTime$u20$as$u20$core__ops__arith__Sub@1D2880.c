int __fastcall <std::time::SystemTime as core::ops::arith::SubAssign<core::time::Duration>>::sub_assign(
        int result,
        __int64 a2,
        int a3)
{
  ...
  {
LABEL_11:
    core::option::expect_failed((int)aOverflowWhenSu, 47, (int)&off_2CA134);
  }
