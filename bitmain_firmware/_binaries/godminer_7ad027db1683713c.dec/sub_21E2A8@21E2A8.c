int __fastcall sub_21E2A8(int a1, int *a2, int a3, int a4)
{
  int v4; // r4
  int v6; // r11
  int v7; // r1
  ...
  if ( a4 )
  {
    ...
    *(_DWORD *)(v6 + 3772) = 84215045;
    sub_21D5A8(v6, 0, 0x120u, 0xFu, 1u);
    sub_21D5A8(v6, 1, 0x20u, 0xFu, 1u);
    v7 = a2[4];
    v8 = v7 + 2;
    v9 = a2[3] | (1 << (v7 & 0x1F));
    a2[3] = v9;
...
LABEL_7:
  ...
  v83 = 0;
  *(_WORD *)(a1 + 512) = 1;
  sub_21D5A8(a1, 0, 0x120u, 0xFu, 0);
  sub_21D5A8(v6, 1, 0x20u, 0xFu, 0);
  v84 = 0;
  if ( !*(_BYTE *)(v6 + 3741) )
  {
    v84 = 1;
...
LABEL_294:
    a2[4] = v8;
    core::panicking::panic_bounds_check(v13, v10, (int)&off_2CDDC4);
  }
  v10 = a2[1];
  v136 = a2[2];
LABEL_260:
...
LABEL_261:
  ...
  if ( v119 )
  {
    ...
    while ( v144 >> 6 <= 4 )
    {
      ...
      if ( v145 > 0x12 )
        core::panicking::panic((int)aAssertionFaile_26, 43, (int)&off_2CDFA4);
...
LABEL_298:
        a2[4] = v8;
        core::panicking::panic_bounds_check(v148, v10, (int)&off_2CDDC4);
      }
LABEL_280:
      v149 = v144 + 1;
      a2[4] = v8;
...
LABEL_315:
        ...
        v180[0] = 2;
        if ( v145 - 16 >= 3 )
          core::panicking::panic_bounds_check(v145 - 16, 3, (int)&off_2CDFC4);
        v151 = v180[v145 - 16];
        if ( v150 >> (v151 & 0x1F) )
          goto LABEL_317;
        v9 |= v150 << v8;
...
LABEL_8:
  ...
  if ( v14 > 0x10000 )
    core::slice::index::slice_end_index_len_fail(*(_DWORD *)(a3 + 0x10000), 0x10000, (int)&off_2CE064);
  v15 = 0;
  if ( v14 )
  {
    v16 = 0;
...
LABEL_307:
        ...
        v50 = word_29C120[v49];
        if ( v50 >= 0x120 )
          core::panicking::panic_bounds_check(word_29C120[v49], 288, (int)&off_2CE024);
        v51 = byte_29C364[v49];
        if ( v51 >= 0x11 )
        {
          v153 = byte_29C364[v49];
          v154 = &off_2CE034;
          goto LABEL_311;
        }
        v158 = *(unsigned __int8 *)(a3 + v16 + 2);
        v161 = *(unsigned __int8 *)(a3 + v21) | (v158 << 8);
        v52 = dword_29C320[v51] & v49;
        v53 = v8 & 0x3F;
        ...
        if ( v161 >= 0x200 )
        {
          v62 = v173;
          if ( (__int16)v161 <= -1 )
            core::panicking::panic_bounds_check(v158, 128, (int)&off_2CE044);
          v61 = (unsigned __int8 *)&unk_29C8E4 + v158;
          v63 = (char *)&unk_29C864 + v158;
        }
        else
        {
          v61 = (unsigned __int8 *)&unk_29C664 + v161;
          v62 = v173;
          v63 = (char *)&unk_29C464 + v161;
        }
        v64 = *v61;
        if ( v64 >= 0x11 )
        {
...
LABEL_302:
      ...
      if ( v168 > 0xFFFFFFF7 )
        core::slice::index::slice_index_order_fail(v168, v168 + 8, (int)&off_2CDDD4);
      v16 = (unsigned int)v172;
      if ( v168 + 8 > v163 )
        core::slice::index::slice_end_index_len_fail(v168 + 8, v163, (int)&off_2CDDD4);
      v17 = v168 + (v31 >> 3);
...
LABEL_293:
    a2[4] = v101;
    core::panicking::panic_bounds_check(v108, v103, (int)&off_2CDDC4);
  }
LABEL_193:
  ...
  if ( v110 >> (v109 & 0x1F) )
LABEL_317:
    core::panicking::panic((int)aAssertionFaile_25, 48, (int)&off_2CDDB4);
  v111 = v15 | (v110 << v101);
  v112 = v101 + v109;
  a2[3] = v111;
  if ( v101 + v109 >= 8 )
...
LABEL_301:
    a2[4] = v112;
    core::panicking::panic_bounds_check(v116, v113, (int)&off_2CDDC4);
  }
LABEL_199:
  a2[4] = v112;
  return 1;
