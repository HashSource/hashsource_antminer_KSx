int __fastcall <gimli::constants::DwLns as core::fmt::Display>::fmt(_BYTE *a1, int *a2)
{
  ...
  v3 = *a1 - 1;
  if ( v3 <= 0xBu )
    return core::fmt::Formatter::pad(a2, (char *)*(&off_2CD8B0 + (char)v3), dword_29BB44[(char)v3]);
  v11[2] = a1;
  v11[0] = &off_2CCD74;
  v12[5] = 2;
  v12[3] = 2;
