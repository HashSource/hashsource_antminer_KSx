int __fastcall <std::time::SystemTime as core::ops::arith::AddAssign<core::time::Duration>>::add_assign(
        int result,
        __int64 a2,
        int a3)
{
  ...
  {
LABEL_10:
    core::option::expect_failed((int)aOverflowWhenAd, 40, (int)&off_2CA124);
  }
