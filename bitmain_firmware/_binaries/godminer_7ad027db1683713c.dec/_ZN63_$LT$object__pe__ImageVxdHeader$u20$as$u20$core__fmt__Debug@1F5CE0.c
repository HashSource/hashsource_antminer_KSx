int __fastcall <object::pe::ImageVxdHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[5] = &off_2CB0D0;
  v3[3] = &off_2CB0D0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_293A29, 14, (int)&off_2CB870, 51, (int)v3, 51);
}
