  ...
  if ( _ZF && *((unsigned __int8 *)a1 + 28) == *((unsigned __int8 *)a2 + 28) )
  {
    ...
    while ( v39 != v40 )
    {
      ...
      if ( v44 != v43 )
      {
        v39 = v40 - 1;
        if ( v40 - 1 > v42 )
          core::slice::index::slice_end_index_len_fail(v40 - 1, v42, (int)&off_2C9FEC);
        goto LABEL_33;
      }
    }
    v23 = 0;
...
LABEL_33:
    ...
    while ( v45 )
    {
      ...
      {
        if ( v42 < 1 - v45 )
          core::slice::index::slice_start_index_len_fail(1 - v45, v42, (int)&off_2C9FFC);
        *((_BYTE *)a1 + 28) = 2;
        *a1 = v41 - v45 + 1;
        a1[1] = v42 + v45 - 1;
        if ( v38 < 1 - v45 )
          core::slice::index::slice_start_index_len_fail(1 - v45, v38, (int)&off_2CA00C);
        *((_BYTE *)a2 + 28) = 2;
        *a2 = v37 - v45 + 1;
        a2[1] = v38 + v45 - 1;
        break;
