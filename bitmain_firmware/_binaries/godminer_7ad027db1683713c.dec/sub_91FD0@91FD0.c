double *__fastcall sub_91FD0(int a1, int **a2)
{
  double *v4; // r6
  int v6; // r7
  bool v7; // zf
  ...
  double *v57; // [sp+8h] [bp-14h]
  double *v58; // [sp+Ch] [bp-10h]
  ...
  {
    case 'I':
      v43 = ((unsigned int)*a2 + 7) & 0xFFFFFFF8;
      *a2 = (int *)(v43 + 8);
      v4 = (double *)json_integer(*(_QWORD *)v43);
      if ( v4 )
        return v4;
      goto LABEL_49;
    case 'O':
      return (double *)sub_91EF4(a1, a2, 1);
    case '[':
      v30 = (_DWORD *)(a1 + 40);
...
LABEL_95:
                  ...
                  {
                    sub_90F20((int *)a1, "<internal>", 1, "Unable to append to array");
                    *(_DWORD *)(a1 + 76) = 1;
                  }
                }
              }
    ...
    case 'f':
      *a2 = (int *)((((unsigned int)*a2 + 7) & 0xFFFFFFF8) + 8);
      ...
      if ( json_real_set((int)v44) )
      {
        ...
        sub_90F20((int *)a1, "<args>", 15, "Invalid floating point value");
        v4 = 0;
        *(_DWORD *)(a1 + 76) = 1;
      }
      return v4;
...
LABEL_49:
    ...
    case 'o':
      return (double *)sub_91EF4(a1, a2, 0);
    case 's':
      sub_90F80(a1);
      ...
      if ( v7 )
      {
        v15 = (char *)sub_910C0(a1, (size_t **)a2, "string", &v59, v60, v8);
        if ( !v15 )
        {
      ...
      else
      {
        ...
        *(_DWORD *)(a1 + 32) = v13;
        *(_DWORD *)(a1 + 36) = v14;
        v15 = (char *)sub_910C0(a1, (size_t **)a2, "string", &v59, v60, v56);
        if ( !v15 )
          return 0;
      }
      if ( *(_DWORD *)(a1 + 76) )
        return 0;
      if ( v60[0] )
        return (double *)jsonp_stringn_nocheck_own(v15, v59);
      else
        return (double *)json_stringn_nocheck(v15, v59);
    case '{':
      v4 = (double *)json_object();
      sub_90F80(a1);
      break;
    default:
      sub_90F20((int *)a1, "<format>", 9, "Unexpected format character '%c'", *(unsigned __int8 *)(a1 + 36));
      v4 = 0;
      *(_DWORD *)(a1 + 76) = 1;
      return v4;
  }
  while ( 1 )
  {
    ...
    if ( v16 != 115 )
      break;
    v17 = (char *)sub_910C0(a1, (size_t **)a2, "object key", &v59, v60, 0);
    sub_90F80(a1);
    sub_90F80(a1);
...
LABEL_16:
        ...
        {
          sub_90F20((int *)a1, "<internal>", 1, "Unable to add key \"%s\"", v17);
          *(_DWORD *)(a1 + 76) = 1;
        }
      }
      if ( !v60[0] )
...
LABEL_32:
    ...
    if ( v18 != 42 )
    {
      sub_90F20((int *)a1, "<args>", 12, "NULL object value");
      *(_DWORD *)(a1 + 76) = 1;
    }
LABEL_19:
    sub_90F80(a1);
  }
  sub_90F20((int *)a1, "<format>", 9, "Expected format 's', got '%c'", *(unsigned __int8 *)(a1 + 36));
LABEL_85:
  if ( v4 && *((_DWORD *)v4 + 1) != -1 )
  {
