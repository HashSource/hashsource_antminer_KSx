int __fastcall <object::pe::ImageDelayloadDescriptor as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2CB638;
  v3[1] = &off_2CB638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2942BB, 24, (int)&off_2CBF80, 8, (int)v3, 8);
}
