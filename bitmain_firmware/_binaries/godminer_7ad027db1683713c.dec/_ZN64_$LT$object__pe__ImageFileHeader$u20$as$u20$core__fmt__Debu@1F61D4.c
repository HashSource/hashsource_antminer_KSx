int __fastcall <object::pe::ImageFileHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2CB638;
  v3[5] = &off_2CB638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aImagefileheade, 15, (int)&off_2CBA08, 7, (int)v3, 7);
}
