int __fastcall sub_1E45B4(int a1, __int16 a2, char *name)
{
  int v5; // r0
  int v6; // r6
  _BOOL4 v7; // r2
  ...
  if ( v6 != -11 )
  {
    ...
    core::str::converts::from_utf8((int)&v32, (int)v10, v11);
    if ( v32 )
    {
      v28 = src;
      v29 = n;
      core::result::unwrap_failed((int)&unk_28F6DA, 43, (int)&v28, (int)&off_2C9328, (int)&off_2CA868);
    }
    v12 = n;
    v13 = src;
    v14 = 1;
    ...
    n = (size_t)&off_2CA878;
    v32 = 0;
    alloc::fmt::format::format_inner((signed int *)&v28, (int *)&v32);
    v15 = (void *)v29;
    v25 = v28;
    v26 = v29;
    v27 = size;
    sub_1BDA70(&v32, (const void *)v29, size);
    v16 = v32;
