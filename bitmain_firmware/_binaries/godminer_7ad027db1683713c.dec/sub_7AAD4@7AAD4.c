unsigned int __fastcall sub_7AAD4(int **a1)
{
  ...
  while ( 2 )
  {
    switch ( result )
    {
      case 0u:
      case 1u:
        v3 = __ldrex((unsigned int *)&dword_2E95CC);
        if ( v3 != result )
        {
          __clrex();
LABEL_11:
        ...
        if ( __strex(2u, (unsigned int *)&dword_2E95CC) )
          goto LABEL_11;
        __dmb(0xBu);
        v4 = **a1;
        **a1 = 0;
        ...
        *(_BYTE *)(v4 + 4) = 0;
        ...
        __dmb(0xBu);
        do
          v6 = __ldrex((unsigned int *)&dword_2E95CC);
        while ( __strex(4u, (unsigned int *)&dword_2E95CC) );
        if ( v6 == 3 )
          return syscall(240, v10, 129, 0x7FFFFFFF);
        return result;
      case 2u:
        result = __ldrex((unsigned int *)&dword_2E95CC);
        if ( result != 2 )
        {
          __clrex();
LABEL_13:
        ...
        if ( __strex(3u, (unsigned int *)&dword_2E95CC) )
          goto LABEL_13;
LABEL_14:
        v9 = 0;
        while ( dword_2E95CC == 3 && syscall(240, &dword_2E95CC, 137, 3, v9, 0, -1) <= -1 && *_errno_location() == 4 )
          ;
        result = dword_2E95CC;
        __dmb(0xBu);
        continue;
