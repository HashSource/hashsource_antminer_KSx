        ...
        int a5)
{
  ...
  int (__fastcall *v45)(unsigned int *, int); // [sp+4Ch] [bp-24h]
  char **v46; // [sp+50h] [bp-20h]
  void *v47; // [sp+54h] [bp-1Ch]
  char **v48; // [sp+58h] [bp-18h]
  void *v49; // [sp+5Ch] [bp-14h]
  char **v50; // [sp+60h] [bp-10h]
  int (__fastcall *v51)(int, int *); // [sp+64h] [bp-Ch]
  _DWORD *v52; // [sp+68h] [bp-8h]
  int (__fastcall *v53)(int, int *); // [sp+6Ch] [bp-4h]
...
LABEL_53:
            if ( v10 >= a2 )
            {
              if ( v10 != a2 )
LABEL_55:
                core::str::slice_error_fail(a1, a2, v10, a2, a5);
            }
            else if ( a1[v10] <= -65 )
            {
              goto LABEL_55;
...
LABEL_58:
            ...
            v49 = sub_232354;
            v48 = (char **)v38;
            v47 = <char as core::fmt::Debug>::fmt;
            v46 = (char **)&v37;
            v45 = core::fmt::num::imp::<impl core::fmt::Display for usize>::fmt;
            v9 = &v36;
LABEL_18:
...
LABEL_34:
          ...
          if ( a3 < 3 )
            v11 = 0;
          if ( v12 < v11 )
            core::slice::index::slice_index_order_fail(v11, a3 + 1, (int)&off_2CF4F0);
          if ( v11 != v12 )
          {
            v13 = &a1[v11];
            v14 = &a1[a3];
...
LABEL_23:
      core::str::slice_error_fail(a1, a2, 0, v5, a5);
    }
    if ( v5 != a2 )
      goto LABEL_23;
    v34 = v5;
