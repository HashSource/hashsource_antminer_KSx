// Alternative name is '_ZN3std2os4unix3net8datagram12UnixDatagram13write_timeout17hfa99c48b7ea2b3d1E'
int __fastcall std::os::unix::net::stream::UnixStream::write_timeout(_DWORD *a1, int *a2)
{
  int v3; // r0
  int v4; // r0
  ...
  else if ( optval )
  {
    ...
    v5 = ((unsigned int)(1000 * HIDWORD(optval)) >> 9)
       * (unsigned __int64)(unsigned int)"FromBytesWithNulErrorKind$u20$as$u20$core..fmt..Debug$GT$3fmt17h177e3efef8767ab6E";
    ...
    if ( HIDWORD(v6) == 1 )
    {
      ...
      LODWORD(optval) = 0;
      v12 = aRustc9eb3afe9e;
      core::panicking::panic_fmt((int)&optval, (int)&off_2C91E8);
    }
