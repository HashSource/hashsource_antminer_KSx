int __fastcall serdes_internal_loop_ate_init_rvn(int a1, unsigned int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    60,
    v26);
  v7 = (unsigned __int8 *)malloc(0x300u);
  sub_F2F24(a1, a3, 240, 0x80000000);
  sub_F2F74(a1, (unsigned __int16)a3, 240, v7);
  V_LOCK();
  ...
  sub_F2F74(a1, (unsigned __int16)a3, 86, v7);
  V_LOCK();
  ...
  sub_F3498(a1, a3, 24642, a4 | 7);
  sub_F2F24(a1, a3, 77, 16777472);
  sub_F2F24(a1, a3, 78, -2144247741);
  sub_F3498(a1, a3, 24644, (a4 << 7) | 0x8000);
  sub_F2F24(a1, a3, 77, 0);
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v9) = 501;
  sub_F2F24(a1, a3, 77, v9);
  sub_F2F24(a1, a3, 78, -2144247559);
  sub_F2F24(a1, a3, 77, 25166208);
  sub_F2F24(a1, a3, 78, -2144251901);
  sub_F2F24(a1, a3, 77, 92800392);
  sub_F2F24(a1, a3, 78, -2144251901);
  sub_F2F24(a1, a3, 77, 0);
  sub_F2F24(a1, a3, 78, -2144251900);
  sub_F2F24(a1, a3, 77, 541073472);
  sub_F2F24(a1, a3, 78, -2144251900);
  sub_F2F24(a1, a3, 77, 0);
  ...
  sub_F2F24(a1, a3, 77, (int)&loc_E000C + 2);
  sub_F2F24(a1, a3, 78, -2144247768);
  sub_F2F24(a1, a3, 77, (int)&loc_E000C + 2);
  sub_F2F24(a1, a3, 78, -2144247768);
