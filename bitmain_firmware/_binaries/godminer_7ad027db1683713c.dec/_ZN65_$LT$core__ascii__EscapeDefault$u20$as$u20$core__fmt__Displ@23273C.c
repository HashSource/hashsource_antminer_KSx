int __fastcall <core::ascii::EscapeDefault as core::fmt::Display>::fmt(int a1, _DWORD *a2)
{
  ...
  if ( v4 < v3 )
    core::slice::index::slice_index_order_fail(v3, *(unsigned __int8 *)(a1 + 5), (int)&off_2CEF6C);
  if ( v4 > 4 )
    core::slice::index::slice_end_index_len_fail(*(unsigned __int8 *)(a1 + 5), 4, (int)&off_2CEF6C);
