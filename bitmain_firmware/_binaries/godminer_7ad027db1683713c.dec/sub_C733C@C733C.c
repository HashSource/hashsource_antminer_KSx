int __fastcall sub_C733C(_DWORD *a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  int v7; // r10
  int v9; // r9
  int v12; // r3
  ...
  int v23; // r0
  signed int v24; // r1
  char v25[4080]; // [sp+10h] [bp-1000h] BYREF
  ...
  *(_BYTE *)(a3 + 65) = v9;
  *(_BYTE *)(a3 + 64) = v17;
  v18 = sub_25ABA8(*(unsigned __int8 *)(a2 + 3), a1[101]);
  if ( v18 >= a1[78] )
  {
    v23 = rand();
  ...
  *(_DWORD *)(a3 + 12) = (*(unsigned __int8 *)(a2 + 5) >> 6) + 4 * *(unsigned __int8 *)(a2 + 4);
  ...
  {
    V_LOCK();
    logfmt_raw(v25, 0x1000u, 0, "get nonce crc error calc value %04x expected value %04x", v21, v20);
    V_UNLOCK();
    zlog(
      g_zc,
