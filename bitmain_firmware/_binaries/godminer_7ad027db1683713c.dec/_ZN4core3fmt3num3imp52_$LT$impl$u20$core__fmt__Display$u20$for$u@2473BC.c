int __fastcall core::fmt::num::imp::<impl core::fmt::Display for i16>::fmt(unsigned __int16 *a1, int a2)
{
  unsigned int v2; // r2
  int v4; // r4
  unsigned int v5; // r1
  ...
  __int16 v12; // [sp+2Ch] [bp-4h]
  __int16 v13; // [sp+2Eh] [bp-2h]
  ...
  if ( v2 > 0x270F )
  {
    ...
    v8 = 35;
    v12 = word_29F267[v7];
    v13 = word_29F267[(unsigned __int16)(v6 - 100 * v7)];
LABEL_9:
    v9 = v8 - 1;
    v11[v9] = v5 + 48;
  ...
  else
  {
    ...
    v13 = word_29F267[(unsigned __int16)(v2 - 100 * v5)];
    if ( v5 < 0xA )
      goto LABEL_9;
  }
  v9 = v8 - 2;
  *(_WORD *)&v11[v9] = word_29F267[v5];
  return core::fmt::Formatter::pad_integral(a2, v4 > -1, aLibraryCoreSrc, 0, (int)&v11[v9], 39 - v9);
}
