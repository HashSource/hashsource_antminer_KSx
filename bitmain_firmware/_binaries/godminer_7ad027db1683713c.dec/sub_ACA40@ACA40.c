int __fastcall sub_ACA40(int a1, __int64 *a2)
{
  __int64 v2; // r2
  const char *v5; // r1
  __int64 *v6; // r3
  ...
  int v16; // r2
  int v17; // r3
  void (__fastcall *v18)(int, __int64 *); // r8
  int v19; // r1
  int v20; // r2
  int v21; // r3
  int v22; // r1
  ...
  *(_DWORD *)&v24[87] = 0;
  v24[89] = 0;
  V_LOCK();
  logfmt_raw((char *)v39, 0x1000u, 0, "start nonce: %08x", dword_2D3518);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
    "odminer-origin_godminer-new/dhash_content/dcr/dcr_1727/dcr_1727_content.c",
    189,
    "push_work_dcr_1727",
    18,
    64,
  ...
  v12 = *(_BYTE *)v6;
  v13 = dword_2D3518 | (*(_DWORD *)(a1 + 228) << 22);
  *v7 = v12;
  v39[0] = v13;
  v24[70] = v13;
