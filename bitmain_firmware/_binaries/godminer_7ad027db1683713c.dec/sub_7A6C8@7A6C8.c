unsigned int *__fastcall sub_7A6C8(unsigned int *a1, int **a2)
{
      ...
      case 0u:
        ...
        **a2 = 0;
        ...
        if ( *(_BYTE *)(v5 + 20) )
          goto LABEL_33;
        *(_BYTE *)(v5 + 20) = 1;
        while ( !__ldrex(&dword_2E9600) )
        {
          if ( !__strex(1u, &dword_2E9600) )
          {
            __dmb(0xBu);
            goto LABEL_23;
          }
        ...
        __clrex();
        std::sys::unix::locks::futex_mutex::Mutex::lock_contended(&dword_2E9600);
LABEL_23:
        v7 = 0;
        ...
        {
          v13[0] = v9 + 4;
          sub_1E6E98(v9, (size_t)v13, (size_t)&off_2CA49C);
          v10 -= 28;
          v9 += 7;
        }
        while ( v10 );
LABEL_27:
        ...
        __dmb(0xBu);
        do
          v11 = __ldrex(&dword_2E9600);
        while ( __strex(0, &dword_2E9600) );
        if ( v11 == 2 )
          syscall(240, &dword_2E9600, 129, 1);
LABEL_33:
        result = v16;
        v15 = 4;
        __dmb(0xBu);
      ...
      case 1u:
        ...
        v15 = 0;
        v19 = aRustc9eb3afe9e;
        core::panicking::panic_fmt((int)&v15, (int)&off_2C9854);
      case 2u:
        result = (unsigned int *)__ldrex(a1);
...
LABEL_11:
      ...
      default:
        ...
        v19 = aRustc9eb3afe9e;
        v15 = 0;
        core::panicking::panic_fmt((int)v13, (int)&off_2C9854);
    }
  }
}
