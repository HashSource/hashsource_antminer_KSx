...
int __fastcall core::fmt::num::imp::<impl core::fmt::Display for i32>::fmt(unsigned int *a1, int a2)
{
  signed int v2; // lr
  int v3; // r6
  int v4; // r2
...
LABEL_10:
    ...
    *(_WORD *)&v15[v4] = word_29F267[(unsigned __int16)(v9 - 100 * v12)];
    if ( v12 >= 0xA )
      goto LABEL_8;
LABEL_11:
    v13 = v4 - 1;
  ...
  do
  {
    ...
    *(_WORD *)(v7 + 35) = word_29F267[v11];
    *(_WORD *)(v7 + 37) = word_29F267[(unsigned __int16)(v10 - 100 * v11)];
  }
  while ( v8 );
  v3 = a2;
  v4 = v6 + 39;
...
LABEL_8:
  v13 = v4 - 2;
  *(_WORD *)&v15[v4 - 2] = word_29F267[v12];
  return core::fmt::Formatter::pad_integral(v3, v2 >= 0, aLibraryCoreSrc, 0, (int)&v15[v13], 39 - v13);
}
