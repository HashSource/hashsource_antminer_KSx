...
LABEL_33:
        v6 = 1;
        if ( !sub_1D45A0(a3, (unsigned __int8 *)(a1 + v10), a2 - v10) )
...
LABEL_9:
      ...
      if ( v11 < v10 )
        core::slice::index::slice_index_order_fail(v10, v11, (int)&off_2CA1FC);
      if ( v11 > a2 )
        core::slice::index::slice_end_index_len_fail(v11, a2, (int)&off_2CA1FC);
      v18 = (int)v8;
      v19 = (int)v9;
      if ( sub_1D45A0(a3, (unsigned __int8 *)(a1 + v10), v11 - v10) )
        return 1;
      v22[3] = 2;
      v22[5] = 1;
      v22[0] = 0;
      ...
      v8 = (_DWORD *)v18;
      if ( v11 + 3 > a2 )
        core::slice::index::slice_start_index_len_fail(v10, a2, (int)&off_2CA22C);
    }
  }
  return v6;
}
