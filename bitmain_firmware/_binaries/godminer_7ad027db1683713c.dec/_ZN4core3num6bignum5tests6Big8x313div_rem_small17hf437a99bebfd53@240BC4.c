unsigned int *__fastcall core::num::bignum::tests::Big8x3::div_rem_small(unsigned int *a1, __int16 a2)
{
  ...
  if ( !(_BYTE)a2 )
    core::panicking::panic((int)aAssertionFaile_51, 27, (int)&off_2CF618);
  v4 = a1 + 1;
  v3 = *a1;
  if ( v3 >= 4 )
  ...
  v9 = sub_25ABA8(*(unsigned __int8 *)v7, (unsigned __int8)a2);
  *(_BYTE *)v7 = v9;
  if ( v4 != v7 )
  {
    ...
    v12 = v11 | ((v8 - v9 * a2) << 8);
    v13 = sub_25ABA8(v12, v5);
    *(_BYTE *)v10 = v13;
    if ( v4 != v10 )
      *((_BYTE *)v10 - 1) = sub_25ABA8(
