int __fastcall check_nonce_kda(int a1, int a2)
{
  ...
  blake2s_update((_DWORD *)((unsigned int)v49 & 0xFFFFFFC0), dest, 278);
  blake2s_update((_DWORD *)((unsigned int)v49 & 0xFFFFFFC0), (char *)&src, 8);
...
LABEL_20:
        ...
        zlog(
          ...
          "uild/godminer-origin_godminer-new/backend/backend_kda_2110/backend_kda_2110.c",
          187,
          "check_nonce_kda",
          15,
          623,
...
LABEL_8:
      v16 = *(unsigned __int8 *)(a2 + 89) + 1456;
      v43[0] = v41[0];
      v43[1] = v41[1];
      v43[2] = v41[2];
      v43[3] = v41[3];
