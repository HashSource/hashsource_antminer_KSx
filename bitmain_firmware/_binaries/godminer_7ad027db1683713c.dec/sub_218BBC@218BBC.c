int __fastcall sub_218BBC(int a1)
{
  char *v2; // r0
  int v3; // r8
  int v4; // r6
  ...
  while ( 1 )
  {
    ...
    if ( v7 )
      goto LABEL_11;
    if ( <str as core::fmt::Display>::fmt(asc_29BEDB, 2u, v5) )
      return 1;
    v2 = *(char **)a1;
    if ( *(_DWORD *)a1 )
    {
      ...
      if ( v9 < v8 && v2[v9] == 115 )
      {
        ...
        *(_DWORD *)(a1 + 8) = v9 + 1;
        if ( v9 + 1 >= v8 || v2[v10] != 95 )
        {
          ...
          v24 = *(int **)(a1 + 16);
          if ( !v24 || (v4 = 1, !<str as core::fmt::Display>::fmt(aInvalidSyntax, 0x10u, v24)) )
          {
            v4 = 0;
            *(_BYTE *)(a1 + 4) = 0;
            *(_DWORD *)a1 = 0;
...
LABEL_36:
      sub_217894((int)&v25, (char **)a1);
      if ( v25 )
      {
        v18 = *(int **)(a1 + 16);
        if ( v18
          && (<rustc_demangle::v0::Ident as core::fmt::Display>::fmt(&v25, v18)
           || <str as core::fmt::Display>::fmt(asc_29BF1B, 2u, v18)) )
        {
          return 1;
        }
        v4 = 1;
    ...
    else
    {
      ...
      if ( !v11 )
        return 0;
      v4 = 1;
      if ( <str as core::fmt::Display>::fmt(asc_29BED9, 1u, v11) )
        return v4;
LABEL_4:
      v2 = *(char **)a1;
      ++v3;
