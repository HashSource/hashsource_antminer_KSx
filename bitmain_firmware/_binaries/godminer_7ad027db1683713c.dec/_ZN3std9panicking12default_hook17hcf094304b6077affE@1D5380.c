void __fastcall std::panicking::default_hook(int a1)
{
  ...
  if ( !v4 )
    core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2CA34C);
  v38 = v4;
...
LABEL_43:
    v32 = 0;
    sub_1D5898(v42, (int)&v45, (int)&off_2CA2FC);
    goto LABEL_44;
  }
  byte_2E95C8 = 1;
  addr = (_DWORD *)_tls_get_addr(&dword_2D041C);
  v21 = *addr;
  ...
  if ( !v21 )
  {
    v20 = sub_1B5168(0);
    if ( !v20 )
      core::result::unwrap_failed((int)aCannotAccessAT, 70, (int)&v45, (int)&off_2C92F8, (int)&off_2C9778);
  }
  v22 = (int)*v20;
  *v20 = 0;
...
LABEL_26:
  ...
  sub_1D5898(v42, v22 + 16, (int)&off_2CA324);
  if ( !v25
  ...
  v27 = v44;
  byte_2E95C8 = 1;
  v28 = (_DWORD *)_tls_get_addr(&dword_2D041C);
  v45 = v27;
