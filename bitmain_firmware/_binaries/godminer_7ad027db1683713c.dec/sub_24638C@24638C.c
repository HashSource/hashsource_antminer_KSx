int __fastcall sub_24638C(int a1, int a2)
{
  int v2; // r2
  int v3; // r12
  unsigned int v4; // r2
  ...
  else
  {
    if ( (v2 & 0x20) == 0 )
    {
      ...
      {
        v5 = &word_29F267[(unsigned __int8)v4 % 0x64u];
        LOBYTE(v4) = 1;
        v13 = *v5;
        v6 = 36;
      }
  ...
  if ( (unsigned int)(128 - v7) >= 0x81 )
    core::slice::index::slice_start_index_len_fail(128 - v7, 128, (int)&off_2CF1FC);
