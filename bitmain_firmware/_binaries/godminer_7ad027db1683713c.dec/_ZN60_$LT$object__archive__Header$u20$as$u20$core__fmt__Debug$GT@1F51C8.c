int __fastcall <object::archive::Header as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2CB590;
  v3[1] = &off_2CB4B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_29360E, 6, (int)&off_2CB558, 7, (int)v3, 7);
}
