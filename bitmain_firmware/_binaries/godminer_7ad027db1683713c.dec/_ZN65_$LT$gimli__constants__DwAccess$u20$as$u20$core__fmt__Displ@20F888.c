int __fastcall <gimli::constants::DwAccess as core::fmt::Display>::fmt(_BYTE *a1, int *a2)
{
  ...
  v3 = *a1 - 1;
  if ( v3 <= 2u )
    return core::fmt::Formatter::pad(a2, (char *)*(&off_2CD860 + (char)v3), dword_29BB14[(char)v3]);
  v11[2] = a1;
  v11[0] = &off_2CCD14;
  v12[5] = 2;
  v12[3] = 2;
