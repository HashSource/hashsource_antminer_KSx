unsigned int __fastcall core::num::bignum::Big32x40::div_rem(int a1, int *a2, _DWORD *s, _DWORD *a4)
{
  ...
  v4 = a2[40];
  if ( v4 >= 0x29 )
    core::slice::index::slice_end_index_len_fail(v4, 40, (int)&off_2CF600);
  v6 = s;
  v7 = a2;
  v8 = 4 * v4;
  do
  {
    if ( !v8 )
      core::panicking::panic((int)aAssertionFaile_52, 30, (int)&off_2CF600);
    v9 = *a2++;
    v8 -= 4;
  }
  while ( !v9 );
  ...
  if ( result > 0x28 )
    core::slice::index::slice_end_index_len_fail(result, 40, (int)&off_2CF600);
  v12 = 4 - 4 * result;
  v13 = 32 * result;
  while ( v12 != 4 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( result != -1 )
      {
        ...
        do
        {
          ...
          if ( v34 >= 0x500 )
            core::panicking::panic_bounds_check(result, 40, (int)&off_2CF600);
          v19 = v7[40];
          v20 = v7;
          if ( a4[40] > v19 )
            v19 = a4[40];
          *a4 |= (*(_DWORD *)(v10 + 4 * result) >> (v16 & 0x1F)) & 1;
          if ( v19 >= 0x29 )
            core::slice::index::slice_end_index_len_fail(v19, 40, (int)&off_2CF600);
          v21 = -4 * v19;
          while ( v21 )
          {
