int __fastcall <std::backtrace_rs::symbolize::Symbol as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  ...
  if ( v6[0] != 3 )
  {
    ...
    v7[8] = v6[8];
    v7[9] = v6[9];
    core::fmt::builders::DebugStruct::field(v5, (int)aName_0, 4u, (int)v7, (int)&off_2CA4B0);
  }
  v3 = a1[4];
  if ( v3 != 3 )
  {
    v7[0] = a1[8];
    core::fmt::builders::DebugStruct::field(v5, (int)aAddr, 4u, (int)v7, (int)&off_2CA478);
    if ( v3 == 1 )
    {
      v7[0] = a1[5];
      core::fmt::builders::DebugStruct::field(v5, (int)aLineno, 6u, (int)v7, (int)&off_2CA4C0);
    }
  }
