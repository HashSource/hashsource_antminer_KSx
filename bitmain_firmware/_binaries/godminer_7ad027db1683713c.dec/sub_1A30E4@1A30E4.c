unsigned int __fastcall sub_1A30E4(int *a1, int *a2, _BYTE *a3)
{
  int v3; // r5
  int v4; // r8
  int v5; // r9
  ...
  int v14; // r1
  bool (__fastcall *v15)(int *, int *); // r2
  int v16; // r5
  int v17; // r6
  int v18; // r7
  int v19; // r1
  ...
  int v49; // [sp+20h] [bp-5Ch]
  int v50; // [sp+24h] [bp-58h]
  int *v51; // [sp+28h] [bp-54h] BYREF
  bool (__fastcall *v52)(int *, int *); // [sp+2Ch] [bp-50h]
  char **v53; // [sp+30h] [bp-4Ch]
  int v54; // [sp+38h] [bp-44h] BYREF
  bool (__fastcall *v55)(int *, int *); // [sp+3Ch] [bp-40h]
  ...
  v8 = *v7;
  v9 = 3 * v3 + 3;
  v10 = *(unsigned __int16 *)(v4 + 270);
  v11 = (char **)v7[2];
  v52 = (bool (__fastcall *)(int *, int *))v7[1];
  v53 = v11;
  v51 = v8;
  v41 = v3;
  memmove(v7, (const void *)(v4 + 4 + 4 * v9), 12 * (v10 + ~v3));
  v12 = (int *)(v4 + 136 + 12 * v3);
  v42 = *v12;
  v44 = (const char *)v12[1];
  v46 = v12[2];
  memmove(v12, (const void *)(v4 + 136 + 4 * v9), 12 * (v10 + ~v3));
  v13 = v10 - 1;
  v14 = (int)v51;
  v15 = v52;
  *(_WORD *)(v4 + 270) = v10 - 1;
...
LABEL_31:
      ...
      v58 = v38;
      v59 = 1;
      core::panicking::panic_fmt((int)&v54, (int)&off_2C9428);
    }
    v23 = *(_DWORD *)(v19 + 276);
...
LABEL_12:
  v53 = (char **)v24;
  v52 = (bool (__fastcall *)(int *, int *))v4;
  v51 = (int *)v5;
LABEL_13:
  v25 = v51;
  v4 = (int)v52;
  ...
  while ( 1 )
  {
    ...
    if ( *(_WORD *)(v27 + 268) )
    {
      ...
      v56 = (char **)v28;
      v55 = (bool (__fastcall *)(int *, int *))v32;
      v33 = *(unsigned __int16 *)(v32 + 270);
      v54 = v28;
      if ( v29 + v33 + 1 >= 0xC )
      {
        sub_1A1B64(&v54, 5 - v29);
        goto LABEL_28;
      }
    }
    else
    {
      ...
      v57 = v34;
      v56 = (char **)v28;
      v55 = (bool (__fastcall *)(int *, int *))v27;
      v54 = v28;
      if ( v29 + v35 + 1 >= 0xC )
      {
        sub_1A20E4(&v54, 5 - v29);
        goto LABEL_28;
      }
    }
    v61 = v54;
