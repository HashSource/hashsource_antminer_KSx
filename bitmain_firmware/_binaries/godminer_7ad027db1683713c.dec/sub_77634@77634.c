bool __fastcall sub_77634(unsigned __int64 *a1, unsigned int a2)
{
  ...
  unsigned __int64 *v65; // [sp+18h] [bp-2Ch]
...
LABEL_20:
      if ( v12 == a2 )
        return 1;
      if ( v12 - 1 >= a2 )
        core::panicking::panic_bounds_check(v12 - 1, a2, (int)&off_2C9248);
      if ( !v18 )
        core::panicking::panic_bounds_check(v12, a2, (int)&off_2C9248);
      v66 = v11;
      v23 = &v2[3 * v12 - 3];
      v68 = *(_DWORD *)v23;
      v71 = *((_DWORD *)v23 + 1);
