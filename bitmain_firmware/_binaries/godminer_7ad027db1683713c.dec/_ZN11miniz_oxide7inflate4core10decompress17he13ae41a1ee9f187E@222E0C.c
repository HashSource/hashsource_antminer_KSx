        ...
        char a8)
{
  ...
  char v248; // r0
  char **v249; // r3
  unsigned int v250; // [sp+Ch] [bp-88h]
  unsigned int v251; // [sp+10h] [bp-84h]
  unsigned __int8 *v252; // [sp+14h] [bp-80h]
  unsigned int v253; // [sp+18h] [bp-7Ch]
  unsigned __int8 *v254; // [sp+18h] [bp-7Ch]
  void *v255; // [sp+1Ch] [bp-78h]
  unsigned int v256; // [sp+20h] [bp-74h]
  unsigned __int16 *v257; // [sp+24h] [bp-70h]
  char v258; // [sp+28h] [bp-6Ch]
  char v259; // [sp+2Ch] [bp-68h]
  int v260; // [sp+30h] [bp-64h]
  unsigned int v261; // [sp+34h] [bp-60h]
  int v262; // [sp+38h] [bp-5Ch]
  int v263; // [sp+40h] [bp-54h]
  void *v265; // [sp+48h] [bp-4Ch]
  void *v266; // [sp+4Ch] [bp-48h]
  _DWORD *v267; // [sp+50h] [bp-44h]
  int v268; // [sp+54h] [bp-40h]
  int v269; // [sp+58h] [bp-3Ch]
  char *srca; // [sp+5Ch] [bp-38h]
  _DWORD *dest; // [sp+60h] [bp-34h]
  void *s; // [sp+64h] [bp-30h]
  unsigned int *v273; // [sp+68h] [bp-2Ch]
  char v274; // [sp+6Ch] [bp-28h]
  unsigned int v275; // [sp+6Ch] [bp-28h]
  unsigned int v276; // [sp+70h] [bp-24h] BYREF
  unsigned int v277; // [sp+74h] [bp-20h]
  unsigned int v278; // [sp+78h] [bp-1Ch]
  size_t n; // [sp+7Ch] [bp-18h]
  unsigned int v280; // [sp+80h] [bp-14h]
  int v281; // [sp+88h] [bp-Ch] BYREF
  int v282; // [sp+8Ch] [bp-8h]
  int v283; // [sp+90h] [bp-4h]
  ...
  v262 = a8 & 4;
  v256 = v10 + 1;
  v257 = (unsigned __int16 *)(a2 + 10520);
  v12 = *(_DWORD *)(a2 + 10492);
  v13 = &src[a4];
  v14 = *(_DWORD *)(v8 + 10496);
  v273 = (unsigned int *)(v8 + 10464);
  v15 = *(_DWORD *)(v8 + 10500);
  v277 = *(_DWORD *)(v8 + 10464);
  v278 = v12;
  n = v14;
  v280 = v15;
  dest = (_DWORD *)(v8 + 6688);
...
LABEL_463:
        *v234 = v235;
        ...
        v239 = v280;
        v234[7] = v278;
        *(_DWORD *)(v269 + 12) = v237 & ~(-1 << (v235 & 0x1F));
        v240 = v19;
        if ( v274 != 23 )
          v240 = 2;
        if ( v11 != a6 )
...
LABEL_480:
        ...
        if ( v11 < a7 )
          core::slice::index::slice_index_order_fail(a7, v11, (int)&off_2CE4A4);
        if ( v11 > a6 )
          core::slice::index::slice_end_index_len_fail(v11, a6, (int)&off_2CE4A4);
        v242 = v11 - a7;
        v281 = v234[6];
        adler::Adler32::write_slice((unsigned __int16 *)&v281, a5 + a7, v11 - a7);
        v243 = v281;
        v234[6] = v281;
        if ( (a8 & 1) == 0 )
          goto LABEL_480;
      ...
      case 7:
        ...
        if ( v37 )
        {
          ...
          if ( v39 >= n )
            v39 = n;
          if ( v39 > v37 )
            core::slice::index::slice_end_index_len_fail(v39, v37, (int)&off_2CE494);
          v40 = v39 + v11;
          if ( __CFADD__(v39, v11) )
            core::slice::index::slice_index_order_fail(v11, v39 + v11, (int)&off_2CE4B4);
          if ( v40 > a6 )
            core::slice::index::slice_end_index_len_fail(v39 + v11, a6, (int)&off_2CE4B4);
...
LABEL_60:
        ...
        v48 = v45 >> (v43 & 0x1F);
        v276 = v48;
        *(_DWORD *)(v8 + 4 * n + 10504) = v47 + word_29D036[n];
        v49 = v44 - v43;
        v50 = v42 + 1;
        v277 = v49;
        n = v42 + 1;
...
LABEL_402:
      ...
      case 9:
        while ( 2 )
        {
          while ( n >= *(_DWORD *)(v269 + 8) )
          {
            *(_DWORD *)(v269 + 8) = 19;
            v54 = v11;
            LOWORD(v55) = sub_222424(v8, (int)&v276);
...
LABEL_71:
            ...
            v276 = v57 >> 3;
            if ( n >= 0x13 )
              core::panicking::panic_bounds_check(n, 19, (int)&off_2CE4F4);
            v59 = byte_29C0E2[n++];
      ...
      case 10:
        ...
        while ( 1 )
        {
          ...
          if ( v61 > 0x120 )
          {
            v249 = &off_2CE474;
LABEL_509:
            core::slice::index::slice_end_index_len_fail(v61, 288, (int)v249);
          }
          v67 = *v60;
          v68 = v61 + *v60;
          if ( v68 < *v60 )
            core::slice::index::slice_index_order_fail(v67, v68, (int)&off_2CE484);
          if ( v68 >> 1 > 0xE4 )
            core::slice::index::slice_end_index_len_fail(v61 + *v60, 457, (int)&off_2CE484);
          memcpy(dest, &srca[v67], v61);
          --v273[5];
          LOWORD(v55) = sub_222424(v8, (int)&v276);
          v18 = (unsigned __int16)v55;
          v11 = v66;
          ...
          else
          {
            ...
            if ( v64 <= -1 )
            {
              if ( v277 >= 0xB )
              {
                ...
                do
                {
                  v72 = ((v276 >> ((v71 - 2) & 0x1F)) & 1) + ~v64;
                  if ( v72 >> 6 > 8 )
LABEL_494:
                    core::panicking::panic_bounds_check(v72, 576, (int)&off_2CE224);
            ...
            v70 = v277 + 8;
            v277 += 8;
            v63 = v276 | (v73 << (v62 & 0x1F));
            v276 = v63;
            if ( v62 <= 6 )
            {
              v74 = *(__int16 *)(v268 + 2 * (v63 & 0x3FF));
              if ( v74 <= -1 )
              {
                if ( v62 < 3 )
                  goto LABEL_125;
...
LABEL_116:
        ...
        if ( (v18 & 0x80000000) != 0 )
        {
          ...
          do
          {
            ...
            if ( v78 >> 6 > 8 )
              core::panicking::panic_bounds_check(v78, 576, (int)&off_2CE204);
            ++v77;
        ...
        if ( v18 >= 0x10 )
        {
          ...
          if ( !v158 )
          {
            ...
            v159 = v18 - 16;
            if ( v18 - 16 > 2 )
              core::panicking::panic_bounds_check(v159, 3, (int)&off_2CE514);
            v18 = (unsigned int)&v281;
            LOBYTE(v17) = 11;
            v280 = *(&v281 + v159);
          }
          continue;
        ...
        if ( n > 0x1C8 )
          core::panicking::panic_bounds_check(n, 457, (int)&off_2CE504);
        v79 = v8 + n++;
        LOBYTE(v55) = 0;
        *(_BYTE *)(v79 + 10524) = v18;
        goto LABEL_76;
...
LABEL_131:
            ...
            v281 = 3;
            if ( (v278 & 3) == 3 )
              core::panicking::panic_bounds_check(3, 3, (int)&off_2CE524);
            v18 = 0;
            if ( v278 == 16 )
            {
              if ( n - 1 > 0x1C8 )
                core::panicking::panic_bounds_check(n - 1, 457, (int)&off_2CE534);
              v18 = *(unsigned __int8 *)(v8 + n - 1 + 10524);
            }
            v84 = *(&v281 + (v278 & 3)) + (v82 & ~(-1 << (v280 & 0x1F)));
            v85 = n + v84;
            if ( __CFADD__(n, v84) )
              core::slice::index::slice_index_order_fail(n, n + v84, (int)&off_2CE544);
            if ( v85 >> 1 > 0xE4 )
              core::slice::index::slice_end_index_len_fail(n + v84, 457, (int)&off_2CE544);
            v86 = v11;
            if ( v84 )
...
LABEL_514:
                  core::slice::index::slice_end_index_len_fail(2, v18, (int)&off_2CE214);
                }
LABEL_360:
                v198 = ((_BYTE)v190 - 1) & 0x1F;
                v199 = (unsigned __int8)byte_29CBFB[v198];
                v200 = word_29CC3C[v198];
                v250 = v199;
                if ( v199 )
                {
                  v189 -= v199;
                ...
                v190 = v200;
                v203 = *(__int16 *)(v260 + 2 * (v188 & 0x3FF));
                if ( v203 > -1 )
                {
...
LABEL_370:
                    ...
                    {
                      v206 = byte_29CC1B[v205];
                      v251 = *((unsigned __int16 *)&off_29CC7C + v205);
                      if ( byte_29CC1B[v205] )
                      {
                        if ( v189 < 0xF )
                        {
                      ...
                      if ( !v209 )
                      {
                        v19 = v200;
                        v210 = v11;
                        sub_222CEC(a5, a6, v11, v251, v200, v261);
                        v190 = v19;
                        v11 = v19 + v210;
                        v18 = 259;
                        v211 = a6 - (v19 + v210);
...
LABEL_484:
                core::panicking::panic_bounds_check(v98, 576, (int)&off_2CE204);
              }
              v18 = a6;
              if ( v105 >= a6 )
                goto LABEL_500;
              ...
              *(_BYTE *)(a5 + v105) = v194;
              v18 = 259;
              if ( a6 - v11 < 0x103 || (unsigned int)(v254 - v9) < 0xE )
                goto LABEL_451;
            }
            v18 = 10;
            while ( 1 )
...
LABEL_163:
          ...
          if ( v11 >= v18 )
LABEL_498:
            core::panicking::panic_bounds_check(v11, v18, (int)&off_2CE444);
          *(_BYTE *)(a5 + v11) = v96;
          v105 = v11 + 1;
          if ( (v103 & 0x100) != 0 )
          {
          ...
          if ( v105 >= v18 )
LABEL_500:
            core::panicking::panic_bounds_check(v105, v18, (int)&off_2CE444);
          v11 += 2;
          *(_BYTE *)(a5 + v105) = v103;
          v87 = v13 - v9;
          if ( (unsigned int)(v13 - v9) < 4 )
...
LABEL_503:
          core::panicking::panic_bounds_check(v11, a6, (int)&off_2CE444);
        }
        LOBYTE(v19) = 2;
        v247 = 13;
        goto LABEL_493;
...
LABEL_254:
        ...
        v111 = *(__int16 *)(v260 + 2 * (v276 & 0x3FF));
        if ( v111 <= -1 )
        {
          if ( v277 >= 0xB )
          {
            ...
            do
            {
              v161 = ((v276 >> ((v160 - 2) & 0x1F)) & 1) + ~v111;
              if ( v161 >> 6 > 8 )
LABEL_497:
                core::panicking::panic_bounds_check(v161, 576, (int)&off_2CE224);
        ...
        v163 = v277 + 8;
        v277 += 8;
        v18 = v276 | (v162 << (v110 & 0x1F));
        v276 = v18;
        if ( v110 <= 6 )
        {
          v164 = *(__int16 *)(v260 + 2 * (v18 & 0x3FF));
          if ( v164 <= -1 )
          {
            if ( v110 < 3 )
              goto LABEL_420;
...
LABEL_410:
        ...
        if ( v225 )
        {
          ...
          {
            LOBYTE(v17) = 16;
            v18 = byte_29CC1B[v224];
            v278 = *((unsigned __int16 *)&off_29CC7C + v224);
            v280 = v18;
            if ( !v18 )
              LOBYTE(v17) = 22;
          }
...
LABEL_493:
      ...
      case 19:
        ...
        while ( v11 != a6 )
        {
          ...
          v125 = v9;
          v126 = v11;
          sub_222988(a5, a6, (v11 - v275) & v261, v11, v124, v261);
          v11 = v124 + v126;
          v9 = v125;
          v8 = v17;
          v92 = v122 > v123;
      ...
      case 20:
        ...
        if ( v273[4] )
        {
          ...
          if ( v128 > v277 >> 3 )
            v129 = v277 >> 3;
          v130 = (v277 & 0xFFFFFFF8) - 8 * v129;
          v131 = v128 - v129;
          v277 = v130;
          if ( v131 > a4 )
            core::slice::index::slice_start_index_len_fail(v131, a4, (int)&off_2CE454);
          LOBYTE(v17) = 24;
          v276 = (v276 >> (v127 & 7)) & ~(-1 << (v130 & 0x18));
          v18 = (unsigned int)v252;
          v9 = &v252[v131];
          if ( (a8 & 1) != 0 )
          {
            LOBYTE(v17) = 23;
      ...
      case 21:
        ...
        if ( v18 != 256 )
        {
          ...
          {
            v133 = (v132 - 1) & 0x1F;
            v18 = (unsigned int)word_29CC3C;
            LOBYTE(v17) = 14;
            v134 = (unsigned __int8)byte_29CBFB[v133];
            v135 = word_29CC3C[v133];
            v280 = v134;
            n = v135;
            if ( !v134 )
              LOBYTE(v17) = 15;
        ...
        continue;
      case 22:
        if ( (a8 & 4) == 0 || (LOBYTE(v17) = 29, v11 >= v278) )
        {
          v18 = a6;
          v136 = n + v11;
          if ( n + v11 > a6 || (v137 = v261 & (v11 - v278), v65 = v137 >= v11, v18 = v137 - v11, v65) && v18 < n )
          {
            LOBYTE(v17) = 19;
            if ( !n )
              LOBYTE(v17) = 12;
          ...
          {
            sub_222CEC(a5, a6, v11, v278, n, v261);
            LOBYTE(v17) = 12;
            v11 = v136;
          }
        }
      ...
      case 23:
        ...
        if ( v277 )
        {
          ...
          v277 = v151 - 8;
          v276 = v152 >> 8;
          v155 = (unsigned __int8)v152 | (v273[3] << 8);
        }
        else
        {
          if ( v9 == v13 )
        ...
        if ( v277 )
        {
          ...
          v277 = v179 - 8;
          v276 = v180 >> 8;
          v183 = (unsigned __int8)v180 | (v273[3] << 8);
        }
        else
        {
          if ( v9 == v13 )
        ...
        if ( v277 )
        {
          ...
          v277 = v218 - 8;
          v276 = v219 >> 8;
          v18 = (unsigned __int8)v219 | (v273[3] << 8);
        }
        else
        {
          if ( v9 == v13 )
