void __fastcall sub_1E27D4(int **a1, int a2, int a3, int a4)
{
  int v8; // r3
  int v9; // r5
  ...
  sub_1DEBF0((int *)&attr.__flags, a2, a3, v8, a4);
  ...
  if ( *(unsigned __int8 *)(a2 + 13) | *(unsigned __int8 *)(a2 + 12) )
  {
    ...
    {
      v28 = core::slice::memchr::memchr_aligned(0x2Fu, v25, v26);
    }
    else if ( v24 == 1 )
    {
LABEL_50:
...
LABEL_11:
  ...
  v56 = (int *)posix_spawn_file_actions_init(&file_actions);
  if ( v56 )
  {
LABEL_133:
  ...
  if ( v10 )
  {
    v56 = (int *)posix_spawn_file_actions_adddup2(&file_actions, fd, 0);
    if ( v56 )
      goto LABEL_132;
  }
  if ( v102 )
  {
    v56 = (int *)posix_spawn_file_actions_adddup2(&file_actions, v103, 1);
    if ( v56 )
      goto LABEL_132;
  }
  if ( v104 )
  {
    v56 = (int *)posix_spawn_file_actions_adddup2(&file_actions, v105, 2);
    if ( v56 )
      goto LABEL_132;
  }
  if ( (v51 & 1) != 0 )
  {
    v56 = (int *)v83(&file_actions, v85);
    if ( v56 )
      goto LABEL_132;
  }
  v57 = 0;
  if ( v89 )
  {
    v56 = (int *)posix_spawnattr_setpgroup(&attr, v54);
    if ( v56 )
      goto LABEL_132;
    v57 = 2;
  }
  ...
  {
    v56 = (int *)*_errno_location();
    goto LABEL_132;
  }
  v56 = (int *)posix_spawnattr_setsigdefault(&attr, &set);
  if ( v56 )
  {
LABEL_132:
  ...
  v57 |= 4u;
LABEL_119:
  v56 = (int *)posix_spawnattr_setflags(&attr, v57);
  if ( v56 )
    goto LABEL_132;
  sub_1DC9E0();
  v59 = v58;
...
LABEL_9:
    ...
    {
      v22 = __ldrex((unsigned int *)&dword_2E966C);
      if ( v22 == dword_2E966C )
      {
...
LABEL_69:
      if ( !v31 )
      {
        ...
        *(_DWORD *)&attr.__flags = v100;
        ...
        if ( !ptr )
          v78 = 0;
        sub_1E35DC((int)&set, a2, (unsigned int *)&attr, (int)v78);
        v79 = set.__val[1];
        v107 = set.__val[1];
        v106 = set.__val[0];
        ...
        if ( write(v84, &buf, 8u) == -1 )
        {
          ...
          *(__int16 *)((char *)&attr.__flags + 1) = 0;
          ...
          sub_19C1B8((int)&attr);
          set.__val[3] = 2;
          set.__val[2] = (unsigned int)&off_2C96F8;
          ...
          attr.__sd.__val[1] = 1;
          attr.__sd.__val[0] = (unsigned int)&off_2CAD4C;
          attr.__sd.__val[3] = 0;
          attr.__sd.__val[2] = (unsigned int)aRustc9eb3afe9e;
          *(_DWORD *)&attr.__flags = 0;
          sub_1C4540(&v110, (int)v116, (int *)&set);
      ...
      do
      {
        v37 = __ldrex((unsigned int *)&dword_2E966C);
        v38 = v37 - 1;
      }
      while ( __strex(v38, (unsigned int *)&dword_2E966C) );
      if ( (v38 & 0xBFFFFFFF) == 0x80000000 )
        std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_2E966C, v38);
      close(v84);
      ...
      for ( i = read(v88, &buf, 8u); i == -1; i = read(v88, &buf, 8u) )
      {
        ...
        if ( (unsigned __int8)std::sys::unix::decode_error_kind(v40) != 35 )
        {
          LODWORD(v111) = v40;
          v110 = 0;
          sub_1E3A0C((int)&attr, &set);
          if ( LOBYTE(attr.__flags) == 4 )
          {
            v74 = 1;
            attr.__sd.__val[1] = 1;
            v75 = &off_2CACEC;
            attr.__sd.__val[0] = (unsigned int)&off_2CACE4;
            *(_DWORD *)&attr.__flags = 0;
          ...
          else
          {
            ...
            attr.__sd.__val[1] = 1;
            attr.__sd.__val[0] = (unsigned int)&off_2CACCC;
            v74 = 0;
            *(_DWORD *)&attr.__flags = 0;
          }
...
LABEL_84:
      ...
      if ( i == 8 )
      {
        ...
        if ( v109 != 1480937294 )
        {
          ...
          *(_DWORD *)&attr.__flags = 0;
          file_actions.__used = (int)sub_19DB34;
          file_actions.__allocated = (int)&buf;
          attr.__sd.__val[0] = (unsigned int)&off_2CAD24;
          sub_77D20((int)&v110, &attr);
        }
        v41 = buf;
        sub_1E3A0C((int)&attr, &set);
        if ( LOBYTE(attr.__flags) == 4 )
...
LABEL_63:
    *a1 = (int *)2;
    ...
    do
    {
      v35 = __ldrex((unsigned int *)&dword_2E966C);
      v36 = v35 - 1;
    }
    while ( __strex(v36, (unsigned int *)&dword_2E966C) );
    if ( (v36 & 0xBFFFFFFF) == 0x80000000 )
      std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_2E966C, v36);
    close(v84);
    v16 = 1;
LABEL_85:
    close(v88);
