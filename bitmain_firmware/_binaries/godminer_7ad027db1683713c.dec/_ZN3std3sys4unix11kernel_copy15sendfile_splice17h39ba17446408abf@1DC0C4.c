unsigned int __fastcall std::sys::unix::kernel_copy::sendfile_splice(
        unsigned int result,
        unsigned int a2,
        int a3,
        int a4,
