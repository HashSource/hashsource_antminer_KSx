...
LABEL_15:
  ...
  if ( v2 != 11 )
  {
    if ( v2 != 38 )
    {
      ...
      v15 = v22;
      core::panicking::panic_fmt((int)v21, (int)&off_2CAA50);
    }
LABEL_22:
    byte_2E9631 = 1;
  }
LABEL_23:
  ...
  v15 = 0;
  core::ffi::c_str::CStr::from_bytes_with_nul(v22, v21, 0xDu);
  if ( v22[0] )
  {
    fd = (int)&off_2CA14C;
    v19 = dword_2CA158;
...
LABEL_27:
    ...
    if ( (unsigned __int8)v19 != 4 )
    {
      v21[0] = v19;
      v21[1] = fd;
      core::result::unwrap_failed((int)aFailedToOpenDe, 27, (int)v21, (int)&off_2C9308, (int)&off_2CAA60);
    }
  }
  else
  {
    sub_1D9278((int)&v19, v22[1], v22[2], (int)&v15);
    if ( (unsigned __int8)v19 != 4 )
      goto LABEL_27;
LABEL_25:
    v3 = fd;
...
LABEL_41:
        v21[1] = v6;
        v21[0] = v11;
        core::result::unwrap_failed((int)&unk_291C97, 27, (int)v21, (int)&off_2C9308, (int)&off_2CAA70);
      }
      break;
    }
    if ( !v9 )
    ...
    if ( v5 < v9 )
      core::slice::index::slice_start_index_len_fail(v9, v5, (int)&off_2C9BD4);
    v5 -= v9;
