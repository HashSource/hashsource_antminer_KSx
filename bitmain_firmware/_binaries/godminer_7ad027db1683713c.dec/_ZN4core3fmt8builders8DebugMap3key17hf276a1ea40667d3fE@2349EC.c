...
LABEL_2:
  ...
  if ( a1[6] )
  {
    ...
    v21 = 0;
    v25 = aLibraryCoreSrc;
    core::panicking::panic_fmt((int)&v21, (int)&off_2CF1BC);
  }
  v6 = *(_DWORD **)a1;
  if ( (*(_BYTE *)(*(_DWORD *)a1 + 24) & 4) != 0 )
  {
    if ( !a1[5] && (*(int (__fastcall **)(_DWORD, const char *, int))(v6[1] + 12))(*v6, asc_29F1A0, 1) )
      goto LABEL_2;
    v4 = 1;
    a1[7] = 1;
    v11 = *v6;
  ...
  {
    if ( a1[5] && (*(int (__fastcall **)(_DWORD, const char *, int))(v6[1] + 12))(*v6, asc_29F184, 2)
  ...
  if ( !((int (__fastcall *)(_DWORD *, const char *, int))v10[3])(v9, asc_29F17D, 2) )
  {
    v4 = 0;
    a1[6] = 1;
  }
