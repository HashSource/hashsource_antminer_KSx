char *__fastcall rustc_demangle::demangle(int *a1, char *a2, unsigned int a3)
{
  ...
  v3 = a2;
  core::str::pattern::StrSearcher::new((int)&v112, (int)a2, a3, byte_29BF1F, 6u);
  v111 = (int)v3;
  if ( v112 )
  {
    v4 = v120;
          ...
          while ( 1 )
          {
            ...
            while ( v13 != v14 )
            {
              if ( v5 + v14 >= v122 )
              {
                ...
                if ( v122 > v12 + v5 )
                  v93 = v122;
                core::panicking::panic_bounds_check(v93, v122, (int)&off_2CD964);
              }
...
LABEL_35:
      ...
      if ( v116 )
      {
        v17 = v23;
LABEL_225:
        core::panicking::panic_bounds_check(v17, v124, (int)&off_2CD974);
      }
LABEL_185:
      v19 = a3;
      v20 = v5 + 6;
...
LABEL_216:
    core::str::slice_error_fail(v3, v19, 0, v5, (int)&off_2CDC94);
  }
  if ( v5 != v19 )
    goto LABEL_216;
LABEL_51:
...
LABEL_112:
                if ( v64 )
                {
                  if ( v65 <= v64 )
                  {
                    if ( v65 != v64 )
LABEL_115:
                      core::str::slice_error_fail(v62, v65, v64, v65, (int)&off_2CDB64);
                  }
                  else if ( v62[v64] <= -65 )
                  {
                    goto LABEL_115;
...
LABEL_119:
            ...
            core::result::unwrap_failed((int)aFmtErrorSShoul, 61, (int)&v125, (int)&off_2CD9A4, (int)&off_2CDB74);
          }
          v41 = v19;
          v20 = 1;
          v42 = &off_2CDB44;
