...
int __fastcall core::fmt::num::<impl core::fmt::UpperHex for u128>::fmt(unsigned int *a1, int a2)
{
  unsigned int v2; // lr
  unsigned int v3; // r2
  unsigned int v4; // r3
  ...
  v10 = v6 + 1;
  if ( v10 >= 0x81 )
    core::slice::index::slice_start_index_len_fail(v10, 128, (int)&off_2CF1FC);
  return core::fmt::Formatter::pad_integral(a2, 1, a0x_1, 2u, (int)&v12[v10], 128 - v10);
}
