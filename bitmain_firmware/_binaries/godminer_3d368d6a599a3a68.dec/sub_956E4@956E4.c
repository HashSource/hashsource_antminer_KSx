int __fastcall sub_956E4(int a1, int **a2)
{
  int v4; // r6
  int v6; // r7
  bool v7; // zf
...
LABEL_95:
                  ...
                  {
                    sub_94634((int *)a1, "<internal>", 1, "Unable to append to array");
                    *(_DWORD *)(a1 + 76) = 1;
                  }
                }
              }
    ...
    case 'f':
      *a2 = (int *)((((unsigned int)*a2 + 7) & 0xFFFFFFF8) + 8);
      ...
      if ( json_real_set() )
      {
        ...
        sub_94634((int *)a1, "<args>", 15, "Invalid floating point value");
        v4 = 0;
        *(_DWORD *)(a1 + 76) = 1;
      }
      return v4;
...
LABEL_49:
    ...
    case 's':
      ...
      if ( v7 )
      {
        v15 = sub_947D4(a1, (char ***)a2, "string", &v58, v59, v8);
        if ( !v15 )
        {
      ...
      else
      {
        ...
        *(_DWORD *)(a1 + 32) = v13;
        *(_DWORD *)(a1 + 36) = v14;
        v15 = sub_947D4(a1, (char ***)a2, "string", &v58, v59, v55);
        if ( !v15 )
          return 0;
      }
      if ( *(_DWORD *)(a1 + 76) )
    ...
    case '{':
      ...
      break;
    default:
      sub_94634((int *)a1, "<format>", 9, "Unexpected format character '%c'", *(unsigned __int8 *)(a1 + 36));
      v4 = 0;
      *(_DWORD *)(a1 + 76) = 1;
      return v4;
  }
  while ( 1 )
  {
    ...
    if ( v16 != 115 )
      break;
    v17 = (char *)sub_947D4(a1, (char ***)a2, "object key", &v58, v59, 0);
    sub_94694(a1);
    sub_94694(a1);
...
LABEL_16:
        ...
        {
          sub_94634((int *)a1, "<internal>", 1, "Unable to add key \"%s\"", v17);
          *(_DWORD *)(a1 + 76) = 1;
        }
      }
      if ( !v59[0] )
...
LABEL_32:
    ...
    if ( v18 != 42 )
    {
      sub_94634((int *)a1, "<args>", 12, "NULL object value");
      *(_DWORD *)(a1 + 76) = 1;
    }
LABEL_19:
    sub_94694(a1);
  }
  sub_94634((int *)a1, "<format>", 9, "Expected format 's', got '%c'", *(unsigned __int8 *)(a1 + 36));
LABEL_85:
  if ( v4 && *(_DWORD *)(v4 + 4) != -1 )
  {
