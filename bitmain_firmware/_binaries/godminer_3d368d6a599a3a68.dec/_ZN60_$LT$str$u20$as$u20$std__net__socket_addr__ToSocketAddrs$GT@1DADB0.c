int __fastcall <str as std::net::socket_addr::ToSocketAddrs>::to_socket_addrs(_DWORD *a1, unsigned int a2, int a3)
{
  _DWORD *v6; // r7
  __int16 v7; // r6
  int v8; // r1
  ...
  unsigned int v13; // [sp+20h] [bp-68h] BYREF
  ...
  v13 = a2;
  v14 = a3;
  sub_1D901C((int)v23, (int)&v13);
  if ( !*(_WORD *)v23 )
  {
    sub_1D9198((int)v23, &v13);
    if ( *(_DWORD *)v23 )
    {
