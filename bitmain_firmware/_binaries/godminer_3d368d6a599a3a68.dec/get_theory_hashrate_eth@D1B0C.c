int __fastcall get_theory_hashrate_eth(int a1, double *a2)
{
  ...
  {
    LODWORD(v4) = api_get_eeprom_nonce_response_rate(*(_DWORD *)(a1 + 244), &v10);
    if ( LODWORD(v4) )
    {
      v10 = 1.0;
      V_LOCK(LODWORD(v4));
      ...
      LODWORD(v4) = zlog(
                      ...
                      "mp/release/build/godminer-origin_godminer-kas_2382/backend/backend_eth_2280/backend_eth_2280.c",
                      192,
