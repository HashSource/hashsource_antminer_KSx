char *__fastcall rustc_demangle::demangle(int *a1, int a2, int a3)
{
  ...
  v3 = (char *)a2;
  core::str::pattern::StrSearcher::new((int)&v107, a2, a3, &unk_2B160F, 6);
  v106 = v3;
  if ( v107 )
  {
    v4 = v115;
