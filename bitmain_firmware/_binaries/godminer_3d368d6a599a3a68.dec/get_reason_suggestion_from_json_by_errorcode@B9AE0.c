int __fastcall get_reason_suggestion_from_json_by_errorcode(const char *a1, char *a2, char *a3, size_t a4)
{
  ...
  if ( byte_2E9AA4 || (result = miner_6060info_errorcode_init()) != 0 )
  {
    v9 = (_DWORD *)json_object_get((_DWORD *)dword_2E9AA8, "errorcode");
    v10 = v9;
    if ( !v9 || *v9 != 1 )
    {
      V_LOCK(v9);
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-kas_2382/miner_util/miner_monitor/miner_6060info.c",
        190,
