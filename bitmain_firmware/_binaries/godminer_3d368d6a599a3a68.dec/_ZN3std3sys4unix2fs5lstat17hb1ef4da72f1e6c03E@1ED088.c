void __fastcall std::sys::unix::fs::lstat(int a1, const void *a2, size_t n)
{
  int v5; // r7
  int v6; // r0
  ...
  else
  {
    ...
    {
      *(_QWORD *)a1 = 2;
      *(_QWORD *)(a1 + 8) = __PAIR64__(&off_2DF14C, dword_2DF158);
    }
    else
    {
      v5 = v9;
      sub_1F4A64(src, -100, v9, 256);
      if ( src[0] == 3 )
      {
        memset(s, 0, sizeof(s));
        if ( sub_26F858(v5, s) == -1 )
        {
          v6 = *_errno_location();
          *(_BYTE *)(a1 + 11) = 0;
          *(_WORD *)(a1 + 9) = 0;
