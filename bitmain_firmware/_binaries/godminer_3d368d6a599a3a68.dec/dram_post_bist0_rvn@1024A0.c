int __fastcall dram_post_bist0_rvn(int a1, char a2)
{
  ...
  sub_F9CD8(a1, a2, 252, 0);
  sub_F9CD8(a1, a2, 253, 0);
  sub_F9CD8(a1, a2, 254, (int)"4core3num7dec2flt5parse12parse_number17hea728ac0daa5e9acE");
  sub_F9CD8(a1, a2, 255, 401425);
  sub_F9CD8(a1, a2, 240, 769);
  usleep(0x4Cu);
  sub_F9CD8(a1, a2, 245, 0);
  sub_F9CD8(a1, a2, 246, 0);
  ...
  sub_F9CD8(a1, a2, 252, 0);
  sub_F9CD8(a1, a2, 253, 0);
  sub_F9CD8(a1, a2, 254, 14948360);
  sub_F9CD8(a1, a2, 255, 14948361);
  sub_F9CD8(a1, a2, 240, 769);
  usleep(0x249u);
