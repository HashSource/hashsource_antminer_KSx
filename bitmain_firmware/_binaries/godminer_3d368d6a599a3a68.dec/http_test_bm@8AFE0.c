int __fastcall http_test_bm(int a1, int a2, size_t a3)
{
  ...
  __int16 v32; // r2
  char v33; // r3
  int v34; // [sp+14h] [bp-101Ch] BYREF
  int v35; // [sp+18h] [bp-1018h] BYREF
  __int64 ptr; // [sp+1Ch] [bp-1014h] BYREF
  __int16 v37; // [sp+24h] [bp-100Ch]
  __int64 v38; // [sp+26h] [bp-100Ah]
  _BYTE v39[4096]; // [sp+30h] [bp-1000h] BYREF
...
LABEL_9:
    ...
    sub_8A820((char *)a2, a3, miner_sale_hashrate);
    return v7;
  }
  if ( !strstr(v3, "/test") )
  {
    ...
    if ( !v11 )
    {
      ...
      if ( v12 )
      {
        ...
        sub_8A820((char *)a2, a3, 102 * theory_hashrate / 100);
      }
      else
      {
