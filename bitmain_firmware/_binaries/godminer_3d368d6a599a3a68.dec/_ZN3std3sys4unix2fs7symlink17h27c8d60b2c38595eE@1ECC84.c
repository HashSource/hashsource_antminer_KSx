void __fastcall std::sys::unix::fs::symlink(_DWORD *a1, const void *a2, unsigned int a3, const void *a4, size_t n)
{
  const char *v8; // r7
  int v9; // r0
  ...
  if ( a3 >> 7 > 2 )
  {
    sub_7A624((int)a1, (int)a2, a3, a4, n);
  }
  else
  {
    memcpy(dest, a2, a3);
...
LABEL_5:
    ...
    else
    {
      ...
      if ( v14[0] )
        goto LABEL_5;
      if ( symlink(v8, (const char *)v14[1]) == -1 )
      {
        v9 = *_errno_location();
        *a1 = 0;
        a1[1] = v9;
