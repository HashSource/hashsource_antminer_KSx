...
LABEL_12:
  ...
  if ( opt_custom_voltage_swith || (v17 = is_eeprom_loaded(v17)) != 0 )
    dword_2E95E4 = opt_custom_voltage;
  byte_2E95DC = platform_is_adjustable_power(v17);
  byte_2E95E8 = platform_is_check_asic_voltage_enable();
  dword_2E95EC = platfrom_get_check_asic_voltage();
  V_LOCK(dword_2E95EC);
  ...
  if ( (unsigned int)(opt_algo - 11) > 1 )
  {
    ...
    if ( v101 > 0 )
    {
      for ( j = 0; j < v101; ++j )
      {
        ...
        v92 = usleep((__useconds_t)"x6thread6Thread3new17hcc793bb7c0096fa2E");
        v93 = dev_ctrl(v92);
        (*(void (__fastcall **)(int))(v93 + 36))(j);
        v94 = sleep(1u);
        v95 = dev_ctrl(v94);
        (*(void (__fastcall **)(int))(v95 + 40))(j);
        v96 = usleep((__useconds_t)"x6thread6Thread3new17hcc793bb7c0096fa2E");
        v97 = dev_ctrl(v96);
