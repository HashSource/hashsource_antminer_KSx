int __fastcall <object::pe::ImageHotPatchInfo as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2E0638;
  v3[1] = &off_2E0638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A9FC2, 17, &off_2E12A0, 7, v3, 7);
}
