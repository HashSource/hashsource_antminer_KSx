int __fastcall sub_7F144(int a1, int a2, const char *a3)
{
      ...
      if ( *a3 && ((v8 - 2) & 0xFFFFFFFD) == 0 && hex2bin(v34, a3, v8 >> 1) )
      {
        ...
        if ( v35 > 0 )
        {
          ...
          do
          {
            ...
            v15 = v12[1];
            ++v12;
            v16 = *(_DWORD *)(v15 + 336) * *(_DWORD *)(v15 + 332);
            v17 = v14;
            v18 = (unsigned int *)malloc(12 * v16);
            v19 = (char *)malloc(0x40u);
            (*(void (__fastcall **)(int, __int64 *, int, unsigned int *, int *, int, int, _DWORD))(v15 + 296))(
              v15,
              &v37,
              v16,
              v18,
            ...
            ++v13;
            v29 = (*(int (__fastcall **)(_DWORD))(v28 + 48))(*(_DWORD *)(*v12 + 244));
