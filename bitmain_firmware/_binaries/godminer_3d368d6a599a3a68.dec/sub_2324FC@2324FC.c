int __fastcall sub_2324FC(_DWORD *a1, _DWORD *a2, char a3)
{
  _DWORD *v4; // r10
  int *v5; // r12
  int v7; // r11
...
LABEL_37:
  ...
  if ( !v11 )
  {
    v33 = sub_230E20(v4[14], &v89, v87, (v15[2] < 0x30u) | ((*v4 & 0x40000u) >> 18));
    if ( v33 == 2 )
      return 1;
    v31 = n;
    v15 = v88;
...
LABEL_69:
    ...
    v92 = v25;
    n = v18;
    if ( (unsigned __int8)sub_230E20(v52, &v89, v87, 1) != 2 )
      goto LABEL_72;
    return 1;
  }
LABEL_44:
