int __fastcall hardware_init(int a1)
{
  ...
  int v89; // [sp+30h] [bp-103Ch] BYREF
  _DWORD v90[13]; // [sp+34h] [bp-1038h] BYREF
  char v91[4100]; // [sp+68h] [bp-1004h] BYREF

  v1 = (unsigned __int8)is_test_pool;
  if ( is_test_pool )
  {
    V_LOCK(a1);
    v6 = logfmt_raw((int)v91, 0x1000u);
    V_UNLOCK(v6);
    v7 = zlog(
           g_zc,
  ...
  v15 = 0;
  LOWORD(v90[0]) = 0;
  str2hex((int)v90, (int)ptr, 4);
  *(_DWORD *)v91 = 0;
  all_created_runtime = get_all_created_runtime(v91);
  if ( *(int *)v91 > 0 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(*v17 + 324) = (unsigned __int16)__rev16(LOWORD(v90[0]));
  ...
  platform_get_fan_control_info(v90);
  ...
  {
    V_LOCK(v36);
    v61 = logfmt_raw((int)v91, 0x1000u);
    V_UNLOCK(v61);
    v82 = g_zc;
    v83 = 100;
    v84 = 1145;
...
LABEL_32:
  ...
  do
  {
    ...
    v45 = logfmt_raw((int)v91, 0x1000u);
    V_UNLOCK(v45);
    v46 = zlog(
            g_zc,
            "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release"
  ...
  do
  {
    ...
    if ( eeprom_chain_load_state == -1 )
    {
      ...
      v64 = logfmt_raw((int)v91, 0x1000u);
      V_UNLOCK(v64);
    ...
    else if ( !eeprom_chain_load_state )
    {
      ...
      v55 = logfmt_raw((int)v91, 0x1000u);
      V_UNLOCK(v55);
      v56 = zlog(
              g_zc,
...
LABEL_43:
    ...
    zlog(v78, v80, 187, "hardware_init", 13, v79, 100, v91);
    return 32;
  }
  ...
  V_LOCK(max_voltage);
  v67 = logfmt_raw((int)v91, 0x1000u);
  V_UNLOCK(v67);
  v68 = zlog(
          g_zc,
          ...
          v91);
  V_LOCK(v68);
  v69 = logfmt_raw((int)v91, 0x1000u);
  V_UNLOCK(v69);
  zlog(
    g_zc,
    ...
    v91);
  v89 = 0;
  v70 = get_all_created_runtime(&v89);
  if ( v89 > 0 )
  {
    v71 = v70 - 4;
    do
