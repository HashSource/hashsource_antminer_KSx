void __fastcall sub_1F38E4(_DWORD *a1, _BYTE *a2, int a3)
{
  void **v3; // r5
  int v4; // r0
  char *v5; // r6
...
LABEL_3:
  ...
  {
    sub_1EBDEC((int)&v81, (int)ptr, v87, (int)&v71);
...
LABEL_78:
    ...
    v72 = v28;
    v71 = 0;
    if ( !sub_1B028C((size_t *)&v71) || !sub_1B028C((size_t *)&v71) || !sub_1B028C((size_t *)&v71) )
      goto LABEL_82;
    v30 = (_BYTE *)sub_1B028C((size_t *)&v71);
    v31 = v61;
    if ( v30 )
      v31 = v29;
    v61 = v31;
    if ( !v30 )
      goto LABEL_82;
    v33 = (const void *)sub_1B028C((size_t *)&v71);
    v34 = size;
    if ( v33 )
      v34 = v32;
    size = v34;
    ...
    if ( v36 )
      v37 = v35;
    v60 = v37;
    if ( !v36 || !sub_1B05D8(&v71) )
      goto LABEL_82;
    v38 = (const void *)sub_1B05D8(&v71);
    v40 = v62;
    if ( v38 )
      v40 = v39;
    v62 = v40;
    ...
    if ( v40 == 6 && !bcmp(v38, aCgroup, 6u) )
    {
      ...
      if ( v41 )
      {
        ...
        v43 = std::path::Path::_strip_prefix(v30, v61, asc_2A5B67, 1);
        v45 = v43;
        if ( !v43 )
          goto LABEL_82;
        v46 = v44;
        if ( std::path::Path::_starts_with(a2, a3, v43, v44) )
        {
          ...
          {
            v52 = v50;
            sub_1B68FC((signed int *)v83, v33, size);
            v53 = v83[0];
            v54 = v83[1];
            v55 = v83[2];
            *a1 = 1;
