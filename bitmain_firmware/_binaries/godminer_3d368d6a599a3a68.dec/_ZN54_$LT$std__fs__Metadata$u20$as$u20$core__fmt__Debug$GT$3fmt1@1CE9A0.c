int __fastcall <std::fs::Metadata as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v28 = *(_DWORD *)(a1 + 96);
  v3 = v28;
  v4 = core::fmt::builders::DebugStruct::field(v27, aFileType, 9, &v28, &off_2DE90C);
  v29 = (v3 & 0xF000) == 0x4000;
  v5 = core::fmt::builders::DebugStruct::field(v4, aIsDir, 6, &v29, &off_2DE758);
  v30 = (v3 & 0xF000) == 0x8000;
  v6 = core::fmt::builders::DebugStruct::field(v5, aIsFile, 7, &v30, &off_2DE758);
  v31 = v3;
  v7 = core::fmt::builders::DebugStruct::field(v6, aPermissions, 11, &v31, &off_2DE91C);
...
LABEL_7:
  ...
  v34 = v9;
  v33 = (void *)v11;
  v12 = core::fmt::builders::DebugStruct::field(v7, aModified, 8, &v32, &off_2DE92C);
...
LABEL_13:
  ...
  v37 = v13;
  v36 = (void *)v15;
  v16 = core::fmt::builders::DebugStruct::field(v12, aAccessed, 8, &v35, &off_2DE92C);
  if ( v8 )
  {
    v17 = &off_2DF7D0;
    goto LABEL_17;
...
LABEL_17:
  ...
  v38 = *(_QWORD *)(a1 + 8);
LABEL_20:
  v18 = core::fmt::builders::DebugStruct::field(v16, aCreated, 7, &v38, &off_2DE92C);
