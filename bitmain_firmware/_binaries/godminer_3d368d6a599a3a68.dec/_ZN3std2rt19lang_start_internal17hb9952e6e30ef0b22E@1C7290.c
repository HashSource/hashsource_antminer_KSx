...
LABEL_25:
      if ( signal(13, (__sighandler_t)v9) == (__sighandler_t)-1 )
      {
        ...
        fds.sa_handler = 0;
        sub_1D70B4(stacksize, stackaddr, v35);
        sub_1AFA90((int)stacksize);
        goto LABEL_46;
      }
LABEL_26:
      v10 = &fds;
      ...
      if ( !fds.sa_handler )
      {
        ...
        fds.sa_handler = (__sighandler_t)sub_1F28F4;
        sigaction(11, &fds, 0);
        byte_307C84 = 1;
      }
      sigaction(7, 0, &fds);
...
LABEL_49:
        v36 = 0;
        sub_79864(0, (int)&p_fds, (int)"", v35, (int)v25);
      }
      sub_26D4C4(v10, v12);
      if ( v16 )
...
LABEL_37:
      ...
      if ( v29 )
      {
        ...
        fds.sa_handler = 0;
        stacksize[1] = (size_t)sub_1BD8DC;
        stacksize[0] = (size_t)&p_p_fds;
        sub_1D70B4(v31, stackaddr, v35);
        v24 = v31[0];
        if ( v31[0] != 4 )
          sub_1AED2C((int)v31);
LABEL_46:
