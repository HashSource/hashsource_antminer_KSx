  ...
  *v2 = a1;
  ...
  if ( v3 )
  {
    if ( fread(&ptr, 0x11u, 1u, v3) )
    {
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-kas_2382/miner_util/check_sn.c",
        170,
        "check_sn",
        8,
        49,
    ...
    else
    {
      if ( (_BYTE)ptr )
      {
        ...
        zlog(
          ...
          "uild/godminer-origin_godminer-kas_2382/miner_util/check_sn.c",
          170,
          "check_sn",
          8,
          55,
  ...
  else
  {
    ...
    zlog(
      ...
      "/godminer-origin_godminer-kas_2382/miner_util/check_sn.c",
      170,
      "check_sn",
      8,
      23,
