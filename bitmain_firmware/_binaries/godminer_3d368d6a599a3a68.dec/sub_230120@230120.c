unsigned int __fastcall sub_230120(int a1, int a2, unsigned int a3, unsigned int a4, unsigned int a5)
{
...
LABEL_151:
          core::panicking::panic_bounds_check(v34, v22, (int)&off_2E2DE4);
        }
LABEL_30:
        if ( v110 != v22 )
        {
...
LABEL_69:
            ...
            {
              if ( v56 >= v22 )
                core::panicking::panic_bounds_check(v56, v22, (int)&off_2E2E94);
              v62 = v56 + 1;
...
LABEL_81:
                  ...
                  {
                    if ( v46 >= v22 )
                      core::panicking::panic_bounds_check(v46, v22, (int)&off_2E2EA4);
                    --v60;
                    *v65 = v61;
                    v65 -= 2;
                    --v46;
...
LABEL_70:
          ...
          while ( 2 )
          {
            ...
            if ( v50 >= v22 )
              goto LABEL_49;
            if ( v48 >= v22 )
              core::panicking::panic_bounds_check(v48, v22, (int)&off_2E2DF4);
            v52 = LOWORD(v15[v50]);
            if ( LOWORD(v15[v48]) >= v52 )
            {
              if ( v51 >= v22 )
                core::panicking::panic_bounds_check(v49 - 1, v22, (int)&off_2E2E24);
              ++v50;
              *v47 = v52;
              if ( v50 < v22 )
                goto LABEL_55;
LABEL_58:
              if ( v51 >= v22 )
                core::panicking::panic_bounds_check(v49 - 1, v22, (int)&off_2E2E44);
              if ( v48 >= v22 )
                core::panicking::panic_bounds_check(v48, v22, (int)&off_2E2E54);
              v54 = &v15[v48++];
              *v47 += *v54;
              *v54 = v51;
            }
...
LABEL_49:
              if ( v48 >= v22 )
                core::panicking::panic_bounds_check(v48, v22, (int)&off_2E2E04);
              if ( v51 >= v22 )
                core::panicking::panic_bounds_check(v49 - 1, v22, (int)&off_2E2E14);
              v53 = &v15[v48++];
              *v47 = *v53;
              *v53 = v51;
              if ( v50 >= v22 )
...
LABEL_55:
              ...
              {
                if ( v48 >= v22 )
                  core::panicking::panic_bounds_check(v48, v22, (int)&off_2E2E34);
                if ( LOWORD(v15[v48]) < (unsigned int)LOWORD(v15[v50]) )
                  goto LABEL_58;
              }
              if ( v51 >= v22 )
                core::panicking::panic_bounds_check(v49 - 1, v22, (int)&off_2E2E64);
              v55 = &v15[v50++];
              *v47 += *v55;
            }
            ++v49;
            ...
            if ( v22 == v49 )
            {
              ...
              if ( v22 != 2 )
              {
                ...
                do
                {
                  ...
                  if ( v22 <= v59 )
                    core::panicking::panic_bounds_check((unsigned __int16)*v58, v22, (int)&off_2E2E84);
                  ++v57;
...
LABEL_102:
          ...
          else
          {
            ...
            s[a4] += v71;
            if ( a4 == -1 )
              core::slice::index::slice_end_index_overflow_fail((int)&off_2E2EB4);
            if ( a4 >= 0x21 )
              core::slice::index::slice_end_index_len_fail();
            if ( a4 )
              goto LABEL_97;
