void *sub_1F2C4C()
{
  ...
  if ( byte_307C84 )
  {
    ...
    {
      v1 = sysconf(30);
      v2 = ((int (__fastcall *)(_DWORD, int, int, unsigned __int16 *, int))mmap64)(
             0,
             v1 + 0x2000,
             3,
             &stru_20014.st_shndx,
      ...
      if ( v2 == -1 )
      {
        ...
        v14 = &v16;
        core::panicking::panic_fmt((int)v9, (int)&off_2DFAA0);
      }
      v3 = (char *)v2;
      v4 = sysconf(30);
      if ( mprotect(v3, v4, 0) )
      {
        ...
        v15 = <std::io::error::Error as core::fmt::Display>::fmt;
        v14 = &v16;
        core::panicking::panic_fmt((int)v9, (int)&off_2DFAB8);
      }
