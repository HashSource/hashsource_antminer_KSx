void __fastcall sub_1FE108(int *a1, int *a2)
{
  int *v2; // r11
  void *v4; // r6
  size_t v5; // r7
...
LABEL_24:
    ...
    v88[6] = 0;
    v2 = v68;
    sub_1F8B6C(&v79, (int)&v73, dest, (int)v88);
    a1 = v67;
    v24 = v81;
    if ( v81 )
      goto LABEL_25;
