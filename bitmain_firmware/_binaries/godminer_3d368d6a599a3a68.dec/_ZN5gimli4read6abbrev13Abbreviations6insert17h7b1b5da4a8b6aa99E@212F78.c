int __fastcall gimli::read::abbrev::Abbreviations::insert(_DWORD *a1, void *src)
{
  ...
  _DWORD dest[32]; // [sp+110h] [bp-214h] BYREF
...
LABEL_17:
    ...
    if ( v12 )
    {
      for ( i = *v5; ; --i )
      {
        ...
        do
        {
          if ( 8 * *((unsigned __int16 *)v12 + 619) == v14 )
          {
            v15 = *((unsigned __int16 *)v12 + 619);
            goto LABEL_29;
          }
          ++v15;
          v17 = &v12[v14];
...
LABEL_29:
      ...
      if ( v12 )
      {
        ...
        if ( v31 < 0xB )
        {
          ...
          {
            memmove(v32 + 1, &v12[8 * v15], 8 * (v31 - v15));
            *v32 = v3;
            memcpy(dest, src, 0x68u);
            memmove(&v12[104 * v15 + 192], &v12[104 * v15 + 88], 104 * (v31 - v15));
          }
          memcpy(&v12[104 * v15 + 88], dest, 0x68u);
          *v105 = v31 + 1;
          goto LABEL_92;
        }
        ...
        *(_WORD *)(v34 + 1238) = v37;
        ...
        v109 = v35;
        memcpy(dest, &v12[104 * v33 + 88], 0x68u);
        if ( v37 > 0xB )
          core::slice::index::slice_end_index_len_fail();
        v38 = v33 + 1;
        v112 = v36;
        if ( v109 - (v33 + 1) != v37 )
          core::panicking::panic((int)aAssertionFaile_24, 40, (int)&off_2E1BA4);
        v39 = v117;
        memcpy(v117, &v12[8 * v38], 8 * v37);
        memcpy(v117 + 88, &v12[104 * v38 + 88], 104 * v37);
        v108 = dest[0];
        v107 = dest[1];
        v110 = dest[2];
        *v105 = v33;
        ...
        if ( !v101 )
          v39 = v12;
        v41 = v104 + 1;
        v42 = (unsigned __int64 *)&v39[8 * (_DWORD)v104];
        v43 = *((unsigned __int16 *)v39 + 619);
        if ( (unsigned int)(v104 + 1) <= v43 )
        {
          v102 = *((_WORD *)v39 + 619);
          v45 = v43 - (_DWORD)v104;
          memmove(&v39[8 * (_DWORD)v41], &v39[8 * (_DWORD)v104], 8 * (v43 - (_DWORD)v104));
          *v42 = v3;
          v44 = v102;
          memcpy(dest, src, 0x68u);
          v46 = 104 * v45;
          v40 = v104;
          memmove(&v39[104 * (_DWORD)v41 + 88], &v39[104 * (_DWORD)v104 + 88], v46);
        }
        else
        {
          *v42 = v3;
        ...
        memcpy(&v39[104 * (_DWORD)v40 + 88], dest, 0x68u);
        *((_WORD *)v39 + 619) = v44 + 1;
        ...
        if ( v49 )
        {
          ...
          while ( 1 )
          {
            ...
            *(_WORD *)(v62 + 1238) = v65;
            ...
            memcpy(v128, &v12[104 * v58 + 88], sizeof(v128));
            if ( v65 > 0xB )
              core::slice::index::slice_end_index_len_fail();
            v67 = v58 + 1;
            if ( v64 - (v58 + 1) != v65 )
              core::panicking::panic((int)aAssertionFaile_24, 40, (int)&off_2E1BA4);
            memcpy(v118, &v12[8 * v67], 8 * v65);
            memcpy(v63 + 44, &v12[104 * v67 + 88], 104 * v65);
            *((_WORD *)v12 + 619) = v58;
            ...
            if ( v98 - v58 != v68 + 1 )
              core::panicking::panic((int)aAssertionFaile_24, 40, (int)&off_2E1BA4);
            ++v106;
            memcpy(v63 + 620, &v12[4 * v67 + 1240], 4 * (v98 - v58));
            v69 = 0;
            do
            {
          ...
          if ( v56 <= v54 )
          {
            *(_DWORD *)v90 = v103;
            *((_DWORD *)v90 + 1) = v100;
            memcpy(&v12[104 * v54 + 88], v127, 0x68u);
          }
          else
          {
            memmove(&v12[8 * v91], &v12[8 * v54], 8 * (v56 - v54));
            *(_DWORD *)v90 = v103;
            *((_DWORD *)v90 + 1) = v100;
            memmove(&v12[104 * v91 + 88], &v12[104 * v54 + 88], 104 * (v56 - v54));
            memcpy(&v12[104 * v54 + 88], v127, 0x68u);
            memmove(&v12[4 * v54 + 1248], &v12[4 * v91 + 1240], 4 * (v56 - v54));
          }
          *v57 = v92;
...
LABEL_85:
        ...
        dest[29] = v12;
        if ( v80 )
          core::panicking::panic((int)aCalledOptionUn_0, 43, (int)&off_2E1B74);
        v81 = v77;
        v119 = v48;
        v82 = *v79;
        v83 = v79[1];
