int __fastcall memchr::memmem::Searcher::new(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  if ( a4 - 256 < 0xFFFFFF02 )
    goto LABEL_18;
  v8 = *a3;
  if ( byte_2AA74B[a3[1]] >= (unsigned int)byte_2AA74B[v8] )
  {
    v9 = a3[1];
    v82 = 0;
    v80 = 1;
