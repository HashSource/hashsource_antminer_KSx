int bitmain_get_sample_voltage()
{
  ...
  if ( dword_306CA8 != 255 )
  {
    result = sub_11987C(dword_306CA8, (unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u);
    if ( !result )
      return result;
...
LABEL_8:
  ...
  result = sub_1196DC((unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u);
  if ( result )
  {
    strcpy(s, "get sample N failed");
    V_LOCK(*(_DWORD *)"get sample N failed");
