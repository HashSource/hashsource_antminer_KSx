int __fastcall sub_ED6CC(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r8
  int v9; // r11
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 89) = v9;
  *(_BYTE *)(a3 + 88) = v17;
  v18 = sub_26D720(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 428));
  if ( v18 >= *(_DWORD *)(a1 + 332) )
  {
    v23 = rand();
    sub_26D414(v23, *(_DWORD *)(a1 + 332));
    v18 = v24;
  }
  *a6 = v18;
  *(_DWORD *)(a3 + 8) = v18;
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 7) & 3)
  ...
  if ( BM_CRC5(a2 + 2, 67) != (*(_BYTE *)(a2 + 10) & 0x1F) && *(_BYTE *)(a1 + 254) )
  {
    v21 = dword_2FEA2C++;
    if ( !(v21 % 0x3E8) )
    {
