        ...
        *a4 = 1;
        ...
        if ( v25[4] == 999 )
        {
          ...
          else
          {
            ...
            v36 = 2 * v24;
            v37 = *(_QWORD *)&dword_2F6958[2 * v24 + 20];
            if ( v37 >= v35 || v35 - v37 > 0x63 )
              goto LABEL_28;
            for ( i = 0; i < v29; ++i )
            {
              v39 = *v50;
              v40 = qword_2F6A28[256 * v24 + i];
              ++v50;
...
LABEL_28:
              v43 = (__int64 *)s;
              v44 = (char *)&qword_2F6A28[256 * v24 - 1];
              v45 = 0;
              do
              {
                ++v45;
          ...
          *(_QWORD *)&dword_2F6958[v36 + 20] = v33;
        }
        else
        {
          ++v25[4];
  ...
  v26 = &dword_2F6958[*(_DWORD *)(a1 + 248)];
  v27 = v26[1];
  v26[1] = v27 + 1;
  if ( v27 <= 9 )
  {
