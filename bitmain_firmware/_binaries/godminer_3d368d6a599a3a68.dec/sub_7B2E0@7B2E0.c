...
LABEL_17:
  ...
  if ( (unsigned int)dword_307C9C > 0x3FFFFFFF || (dword_307C9C & 0x3FFFFFFE) == 0x3FFFFFFE )
    goto LABEL_9;
  v4 = __ldrex((unsigned int *)&dword_307C9C);
  if ( v4 != dword_307C9C )
  {
    __clrex();
    goto LABEL_9;
  ...
  {
LABEL_9:
    std::sys::unix::locks::futex_rwlock::RwLock::read_contended(&dword_307C9C);
    goto LABEL_10;
  }
  __dmb(0xBu);
LABEL_10:
  ...
  *(_BYTE *)a1 = 4;
  ...
  do
  {
    v5 = __ldrex((unsigned int *)&dword_307C9C);
    v6 = v5 - 1;
  }
  while ( __strex(v6, (unsigned int *)&dword_307C9C) );
