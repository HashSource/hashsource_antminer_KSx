int __fastcall <object::pe::ImageDosHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[35] = &off_2E0750;
  v3[29] = &off_2E0740;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A8DFF, 14, &off_2E06A8, 19, v3, 19);
}
