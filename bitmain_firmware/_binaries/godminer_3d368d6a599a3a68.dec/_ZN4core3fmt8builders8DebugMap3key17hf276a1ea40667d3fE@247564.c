...
LABEL_2:
  ...
  {
    if ( !a1[5] && (*(int (__fastcall **)(_DWORD, const char *, int))(v6[1] + 12))(*v6, asc_2B4890, 1) )
      goto LABEL_2;
    v4 = 1;
    a1[7] = 1;
    v11 = *v6;
  ...
  {
    if ( a1[5] && (*(int (__fastcall **)(_DWORD, const char *, int))(v6[1] + 12))(*v6, asc_2B4874, 2)
  ...
  if ( !((int (__fastcall *)(_DWORD *, const char *, int))v10[3])(v9, asc_2B486D, 2) )
  {
    v4 = 0;
    a1[6] = 1;
  }
