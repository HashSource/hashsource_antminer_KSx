void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    do
    {
      ...
      while ( !*(_QWORD *)&dbl_2E9598 );
    }
    while ( *(_QWORD *)&dbl_2E9598 == *(_QWORD *)&dbl_2E95A0 );
    V_LOCK(LODWORD(dbl_2E9598));
    ...
    zlog(
      ...
      v97);
    v2 = dbl_2E9598;
    v3 = sub_26D070(LODWORD(dbl_2E9598), HIDWORD(dbl_2E9598), 3, 0);
    v4 = (char *)&v93 + 4;
    v5 = &v96;
    ...
    if ( v89 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          40,
          v97);
        v52 = sub_26D070(LODWORD(dbl_2E9598), HIDWORD(dbl_2E9598), 7500, 0);
        v53 = v48[1];
        ++v48;
        v63 = *(void (__fastcall **)(int, _DWORD, _DWORD, _DWORD))(v53 + 12);
        v54 = vshrd_n_u64(qword_2848C8[v52], 8u);
        printf("dag_load: %lx\n", v63);
