int __fastcall <core::ffi::c_str::FromBytesWithNulErrorKind as core::fmt::Debug>::fmt(_DWORD *a1, _DWORD *a2)
{
  ...
  v7 = 0;
  v8 = a2;
  core::fmt::builders::DebugTuple::field(&v7, (int)&v6, (int)&off_2E4908);
  if ( v7 )
  {
    v4 = 1;
    if ( !v9 )
    {
      ...
      if ( v7 != 1
        || !v10
        || (v8[6] & 4) != 0
        || (v4 = 1, !(*(int (__fastcall **)(_DWORD, const char *, int))(v8[1] + 12))(*v8, asc_2B488F, 1)) )
      {
        v4 = (*(int (__fastcall **)(_DWORD, const char *, int))(v5[1] + 12))(*v5, asc_2B4399, 1);
      }
    }
  }
  else
