void *__fastcall sub_1402EC(int a1, unsigned __int64 *src, size_t n)
{
  int v4; // r0
  int v5; // r8
  size_t v6; // r6
  ...
  int v14; // r0
  unsigned int v15; // r9
  unsigned __int64 *v16; // r7
  unsigned __int64 *v17; // r1
  __int64 v18; // r10
  __int64 v19; // r2
  bool v20; // cc
  int v21; // r0
  ...
  if ( v8 < n )
  {
    *(_DWORD *)(a1 + 224) = 0;
    v6 = n - v8;
    memcpy(v9, src, v8);
    v7 = (unsigned __int64 *)((char *)v7 + v8);
    ...
    *(_QWORD *)(a1 + 72) = v12 + (unsigned int)v14;
    sub_139BB0(a1, (unsigned __int64 *)(a1 + 96));
    if ( v6 > 0x80 )
    {
      v15 = (v6 - 129) >> 7;
      v16 = &v7[16 * v15 + 16];
