unsigned int __fastcall sub_1D8B0C(unsigned __int8 **a1, int a2, unsigned int a3, unsigned int a4)
{
  unsigned int v4; // lr
  _WORD *v5; // r7
  int v7; // r4
...
LABEL_45:
  ...
  v9 = *a1;
  v10 = a1[1];
  if ( v8 && (!v10 || (v11 = *v9, *a1 = v9 + 1, a1[1] = v10 - 1, v11 != 58)) || (sub_1D80A8((int)&v44, a1), !v44) )
  {
    *a1 = v9;
    a1[1] = v10;
    v12 = v10;
