char **__fastcall std::thread::available_parallelism(_DWORD *a1)
{
  ...
  *(_WORD *)v235 = 0;
  ...
  if ( !v217 )
  {
    sub_1EBDEC(&v224, v218, v219, &v232);
    v201 = a1;
...
LABEL_47:
      ...
      if ( !v217 )
      {
        ...
        s[1] = v219;
        s[0] = 0;
        for ( i = (const void *)sub_1B028C(s); i; i = (const void *)sub_1B028C(s) )
        {
...
LABEL_92:
          ...
          if ( !v44 && v43 != 0 )
          {
            ...
            {
              v126 = sub_1F34B8((int)&v221, (int)&v224, &unk_2A5D0C, 0x10u);
              v128 = v127;
              v129 = sub_1F34B8((int)&v221, (int)&v224, aCpuCfsPeriodUs, 0x11u);
              v131 = v126 == 1;
              if ( v126 == 1 )
                v131 = v129 == 1;
              if ( v131 && v130 )
              {
                v132 = sub_26D720(v128, v130);
                v133 = nb;
                if ( nb >= v132 )
                  v133 = v132;
                nb = v133;
    ...
    *(_WORD *)v235 = 0;
    ...
    if ( (v150 + 7) >> 7 <= 2 )
    {
      ...
      *((_BYTE *)s + v122) = 0;
      ...
      sub_1EBDEC(&v229, v218, v219, &v232);
    }
    else
    {
