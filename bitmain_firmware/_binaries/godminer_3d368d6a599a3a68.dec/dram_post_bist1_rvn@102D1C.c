int __fastcall dram_post_bist1_rvn(int a1, char a2)
{
  ...
  sub_F9CD8(a1, a2, 252, 0);
  sub_F9CD8(a1, a2, 253, 0);
  sub_F9CD8(a1, a2, 254, 14948376);
  sub_F9CD8(a1, a2, 255, 14948377);
  sub_F9CD8(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_F9CD8(a1, a2, 246, 0x40000);
  sub_F9CD8(a1, a2, 247, (int)"e..core_arch..simd..u8x64$u20$as$u20$core..fmt..Debug$GT$3fmt17h5e6688c276ff53baE");
