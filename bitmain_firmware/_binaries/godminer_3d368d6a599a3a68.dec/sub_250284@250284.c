...
LABEL_29:
  ...
  if ( a4 < 0xF4240 )
    goto LABEL_114;
  BYTE2(v71[1]) = sub_26D4C4((unsigned __int16)v17, v18) + 48;
  if ( !v24 )
  {
    v27 = 7;
    goto LABEL_52;
  ...
  if ( a4 < 0x989680 )
    goto LABEL_114;
  HIBYTE(v71[1]) = sub_26D4C4((unsigned __int16)v24, a4 / 0x989680) + 48;
  if ( !v25 )
  {
    v27 = 8;
    goto LABEL_52;
  ...
  if ( a4 < 0x5F5E100 )
    goto LABEL_114;
  LOBYTE(v71[2]) = sub_26D4C4((unsigned __int16)v25, a4 / 0x5F5E100) + 48;
  if ( !v64 )
  {
    a2 = v65;
    v13 = v67;
...
LABEL_56:
  ...
  if ( !(!v33 | v32) )
  {
    ...
    if ( v75 )
    {
      v42 = sub_26D070(v75, HIDWORD(v75), 1410065408, 2);
      v43 = v42;
      v66 = v36;
      v44 = HIDWORD(v42);
      ...
      v46 = sub_26D070(v43, v44, &elf_hash_chain[4398], 0);
      if ( (unsigned int)&elf_hash_chain[4397] + 3 >= __PAIR64__(v44, v43) )
        v46 = v43;
      v47 = ((unsigned int)phy_eq_pre_set_by_apb + v46) & (v46 + 514288);
...
LABEL_94:
  ...
  if ( v58 == 1114112 || sub_2509C8(v77, a1) )
    return 1;
  v62 = 0;
  while ( v56 != v62 )
  {
