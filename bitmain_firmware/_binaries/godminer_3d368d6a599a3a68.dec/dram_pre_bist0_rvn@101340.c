int __fastcall dram_pre_bist0_rvn(int a1, char a2)
{
  ...
  sub_F9CD8(a1, a2, 254, 6697992);
  sub_F9CD8(a1, a2, 255, 6697993);
  sub_F9CD8(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_F9CD8(a1, a2, 240, 769);
  usleep(0x249u);
  sub_F9CD8(a1, a2, 245, 270336);
  sub_F9CD8(a1, a2, 246, (int)"ZN5alloc6string6String10from_utf1617h8f0f017064ea565fE");
  sub_F9CD8(a1, a2, 247, (int)"ab0faE");
