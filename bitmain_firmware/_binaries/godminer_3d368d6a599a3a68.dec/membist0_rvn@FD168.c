int __fastcall membist0_rvn(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_F9C88(a1, v28, 28, 1);
      sub_F9C88(a1, v28, 160, 3);
      usleep((__useconds_t)"3c2aE");
      v6 = ptr;
      v7 = sub_FA000(a1, (unsigned __int16)v28, 161, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_10:
      v10 = ptr;
      v11 = sub_FA000(a1, (unsigned __int16)v28, 162, ptr);
      if ( v11 > 0 )
      {
        v12 = &ptr[12 * v11];
        do
...
LABEL_16:
      v14 = ptr;
      v3 = sub_FA000(a1, (unsigned __int16)v28, 163, ptr);
      if ( v3 > 0 )
      {
        v15 = &ptr[12 * v3];
        do
