int __fastcall sub_113E1C(unsigned int a1, int a2)
{
  int v4; // r7
  int v5; // r0
  int v6; // r0
  ...
  if ( v4 )
  {
    ...
    zlog(
      ...
      20,
      v18);
    if ( pthread_mutex_lock(&stru_306BA8) )
    {
      v8 = -1;
    ...
    else
    {
      ...
      else if ( a2 == 2 )
      {
        ...
        {
          v8 = -1;
          if ( exists_c_map(dword_306BC0, &v16) )
          {
            ...
            zlog(
              ...
              "se/build/godminer-origin_godminer-kas_2382/backend/device/hal/platform/cv183x/cv183x_ui.c",
              195,
      ...
      pthread_mutex_unlock(&stru_306BA8);
    }
  }
  else
  {
