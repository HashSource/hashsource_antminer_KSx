int __fastcall diff_to_be256_target_base(int a1)
{
  ...
  v5 = sub_26D430(COERCE_UNSIGNED_INT64(v4 * 1.59309191e-58), HIDWORD(COERCE_UNSIGNED_INT64(v4 * 1.59309191e-58)));
  v19 = bswap32(HIDWORD(v5));
  v20 = bswap32(v5);
  v6 = v4 - sub_26D270(v5, HIDWORD(v5)) * 6.27710174e57;
  v7 = sub_26D430(COERCE_UNSIGNED_INT64(v6 * 2.93873588e-39), HIDWORD(COERCE_UNSIGNED_INT64(v6 * 2.93873588e-39)));
  v21 = bswap32(HIDWORD(v7));
  v22 = bswap32(v7);
  v8 = v6 - sub_26D270(v7, HIDWORD(v7)) * 3.40282367e38;
  v9 = sub_26D430(COERCE_UNSIGNED_INT64(v8 * 5.42101086e-20), HIDWORD(COERCE_UNSIGNED_INT64(v8 * 5.42101086e-20)));
  v23 = _byteswap_uint64(v9);
  v10 = sub_26D270(v9, HIDWORD(v9));
  v11 = sub_26D430(
