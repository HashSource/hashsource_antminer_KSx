void __fastcall sub_1F5348(int **a1, int a2, int a3, int a4)
{
  int v8; // r3
  int v9; // r5
  ...
  sub_1F1764((int *)&attr.__flags, a2, a3, v8, a4);
...
LABEL_9:
    ...
    {
      v22 = __ldrex((unsigned int *)&dword_307C9C);
      if ( v22 == dword_307C9C )
      {
...
LABEL_69:
      ...
      do
      {
        v37 = __ldrex((unsigned int *)&dword_307C9C);
        v38 = v37 - 1;
      }
      while ( __strex(v38, (unsigned int *)&dword_307C9C) );
      if ( (v38 & 0xBFFFFFFF) == 0x80000000 )
        std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_307C9C, v38);
      close(v84);
...
LABEL_84:
      ...
      if ( i == 8 )
      {
        ...
        if ( v109 != 1480937294 )
        {
          ...
          *(_DWORD *)&attr.__flags = 0;
          file_actions.__used = (int)sub_1B06A8;
...
LABEL_63:
    *a1 = (int *)2;
    ...
    do
    {
      v35 = __ldrex((unsigned int *)&dword_307C9C);
      v36 = v35 - 1;
    }
    while ( __strex(v36, (unsigned int *)&dword_307C9C) );
    if ( (v36 & 0xBFFFFFFF) == 0x80000000 )
      std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_307C9C, v36);
    close(v84);
    v16 = 1;
LABEL_85:
    close(v88);
