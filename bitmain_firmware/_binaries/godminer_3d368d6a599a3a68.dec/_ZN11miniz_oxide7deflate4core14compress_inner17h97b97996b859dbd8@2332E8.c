...
LABEL_211:
        v143 = v104;
        sub_232F28(v140, v141, v134, v107);
        v104 = v143;
        v74 = 0;
        v144 = i;
LABEL_223:
...
LABEL_74:
    ...
    *((_BYTE *)v179 + v63) |= 0x80u;
    if ( v61 >= 0x200u )
    {
      ...
      v65 = (unsigned __int8 *)&unk_2B1F54 + HIBYTE(v61);
    }
    else
    {
      v65 = (unsigned __int8 *)&unk_2B1B54 + v61;
    }
    v15 = v185;
    v66 = v185[16] + 2 * *v65;
    ++*(_WORD *)(v66 + 576);
...
LABEL_251:
  ...
  {
    if ( sub_2324FC(v6, a3, *(_BYTE *)(v5 + 53)) )
    {
      v158 = -1;
      result = *(_DWORD *)(v5 + 28);
      v159 = *(_DWORD *)(v5 + 32);
