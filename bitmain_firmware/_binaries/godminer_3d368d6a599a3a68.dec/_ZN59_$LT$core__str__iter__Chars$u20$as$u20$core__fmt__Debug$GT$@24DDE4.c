bool __fastcall <core::str::iter::Chars as core::fmt::Debug>::fmt(char **a1, int *a2)
{
  ...
  if ( core::fmt::write(v3, v4, (int *)&v19) )
    return 1;
  v6 = (*(int (__fastcall **)(int, const char *, int))(v4 + 12))(v3, asc_2B4892, 1);
  v7 = *a1;
  v8 = a1[1];
  v21 = 0;
  v20 = v6;
...
LABEL_12:
      ...
      v18 = v9;
      sub_24736C((unsigned __int8 *)&v19, (int)&v18, (int)&off_2E4194);
      if ( v8 == v7 )
        goto LABEL_12;
    }
  }
  if ( v6 || (*(int (__fastcall **)(int, const char *, int))(v19[1] + 12))(*v19, asc_2B4893, 1) )
    return 1;
  v16 = *a2;
  v17 = a2[1];
  v22 = (char **)&off_2E4390;
