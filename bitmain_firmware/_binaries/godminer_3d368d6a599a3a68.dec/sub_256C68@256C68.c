...
void __fastcall sub_256C68(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  _DWORD *v8; // r4
  _DWORD *v9; // r5
  ...
  if ( v11 )
  {
    if ( !v13 )
    {
      ...
      if ( v11 != 1
        || !v14
        || (v12[6] & 4) != 0
        || !(*(int (__fastcall **)(_DWORD, const char *, int))(v12[1] + 12))(*v12, asc_2B488F, 1) )
      {
        (*(void (__fastcall **)(_DWORD, const char *, int))(v9[1] + 12))(*v9, asc_2B4399, 1);
      }
    }
  }
