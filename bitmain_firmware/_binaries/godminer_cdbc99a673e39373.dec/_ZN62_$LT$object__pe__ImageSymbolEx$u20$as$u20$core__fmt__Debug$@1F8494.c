int __fastcall <object::pe::ImageSymbolEx as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2CC638;
  v3[1] = &off_2CC5B0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aImagesymbolex, 13, &off_2CCE30, 6, v3, 6);
}
