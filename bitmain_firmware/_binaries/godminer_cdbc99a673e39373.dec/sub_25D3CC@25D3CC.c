int __fastcall sub_25D3CC(_DWORD *a1, unsigned __int64 a2, unsigned __int64 a3, unsigned __int64 a4, __int64 a5)
{
  unsigned int v6; // lr
  int v8; // r7
  int v9; // r12
