int __fastcall <object::read::RelocationTarget as core::fmt::Debug>::fmt(_DWORD *a1, int a2)
{
  ...
  if ( *a1 )
  {
    ...
    {
      v4 = a1 + 1;
      return core::fmt::Formatter::debug_tuple_field1_finish(a2, aSection, 7, &v4, &off_2CC478);
    }
    else
    {
  ...
  {
    v3 = a1 + 1;
    return core::fmt::Formatter::debug_tuple_field1_finish(a2, aSymbol_0, 6, &v3, &off_2CC4C8);
  }
}
