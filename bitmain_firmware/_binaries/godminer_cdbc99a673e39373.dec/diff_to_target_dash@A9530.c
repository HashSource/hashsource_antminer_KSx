int __fastcall diff_to_target_dash(__int64 *a1)
{
  ...
  else
  {
    ...
    v4 = 2.69595353e67 / v1 - sub_25B868(v3, HIDWORD(v3)) * 6.27710174e57;
    v5 = sub_25BA28(COERCE_UNSIGNED_INT64(v4 * 2.93873588e-39), HIDWORD(COERCE_UNSIGNED_INT64(v4 * 2.93873588e-39)));
    v6 = v4 - sub_25B868(v5, HIDWORD(v5)) * 3.40282367e38;
    v7 = sub_25BA28(COERCE_UNSIGNED_INT64(v6 * 5.42101086e-20), HIDWORD(COERCE_UNSIGNED_INT64(v6 * 5.42101086e-20)));
    v8 = sub_25B868(v7, HIDWORD(v7));
    v9 = sub_25BA28(
