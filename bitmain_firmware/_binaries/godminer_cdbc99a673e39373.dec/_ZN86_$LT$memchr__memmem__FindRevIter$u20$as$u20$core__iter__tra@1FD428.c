...
LABEL_120:
                ...
                if ( v19 )
                  core::panicking::panic_bounds_check(v77, v81, (int)&off_2CD7F8);
LABEL_38:
                if ( v81 )
                {
                  v30 = 0;
          ...
          else
          {
            ...
            while ( 1 )
            {
              ...
              if ( !v67 )
              {
                ...
                {
                  if ( v54 )
                    core::panicking::panic_bounds_check(v54 - 1, v81, (int)&off_2CD848);
                }
                else
                {
                  v55 = v54 + 1;
                ...
                if ( *v13 == v52 )
                {
                  ...
                  {
                    if ( v19 == v59 )
                      core::panicking::panic_bounds_check(v73, v81, (int)&off_2CD878);
                    if ( v19 + v58 >= v4 )
                    {
                      v71 = v19 + v58;
                      v70 = &off_2CD888;
...
LABEL_62:
        while ( v42 > v14 )
        {
          ...
          if ( !__CFADD__(v42, v40) )
            core::panicking::panic_bounds_check(v43, v42, (int)&off_2CD728);
          --v42;
