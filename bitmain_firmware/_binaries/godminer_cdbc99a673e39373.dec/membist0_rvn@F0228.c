        ...
        do
        {
          while ( (*(_DWORD *)v6 & 0x80) == 0 )
          {
            ...
            v7 = zlog(
                   ...
                   "release/build/godminer-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_2020.c",
                   187,
                   "membist0_rvn",
                   12,
                   608,
...
LABEL_10:
      v10 = ptr;
      v11 = sub_ECC68(a1, (unsigned __int16)v28, 162, ptr);
      if ( v11 > 0 )
      {
        v12 = &ptr[12 * v11];
        do
        {
          ...
          v11 = zlog(
                  ...
                  "elease/build/godminer-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_2020.c",
                  187,
                  "membist0_rvn",
                  12,
                  617,
...
LABEL_16:
      v14 = ptr;
      v3 = sub_ECC68(a1, (unsigned __int16)v28, 163, ptr);
      if ( v3 > 0 )
      {
        v15 = &ptr[12 * v3];
        do
...
LABEL_22:
  ...
  do
  {
    ...
    v22 = *v18++;
    ++v17;
    v23 = sprintf((char *)v38, "<mbist0 %08x> %lld", v22, v19);
  }
  while ( &s[5] != v17 );
  v24 = dev_ctrl(v23);
  (*(void (__fastcall **)(_DWORD))(v24 + 80))(*(_DWORD *)(a1 + 228));
  return 0;
}
