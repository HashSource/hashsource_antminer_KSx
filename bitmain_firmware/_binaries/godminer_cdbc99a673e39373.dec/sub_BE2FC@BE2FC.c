int __fastcall sub_BE2FC(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r9
  int v9; // r11
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v9;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = sub_25BD18(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 404));
  if ( v19 >= *(_DWORD *)(a1 + 312) )
  {
    v26 = rand();
    sub_25BA0C(v26, *(_DWORD *)(a1 + 312));
    v19 = v27;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 8) & 3)
  ...
  if ( BM_CRC5(a2 + 2, 75) != (*(_BYTE *)(a2 + 11) & 0x1F) && *(_BYTE *)(a1 + 238) )
  {
    v24 = dword_2E190C++;
    if ( !(v24 % 0x3E8) )
    {
