int __fastcall sub_DC694(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r7
  int v9; // r6
  int v12; // r3
  ...
  *(_BYTE *)(a3 + 57) = v9;
  *(_BYTE *)(a3 + 56) = v17;
  v18 = sub_25BD18(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 404));
  if ( v18 >= *(_DWORD *)(a1 + 312) )
  {
    v25 = rand();
    sub_25BA0C(v25, *(_DWORD *)(a1 + 312));
    *a6 = v19;
  }
  else
  {
  ...
  *(_DWORD *)(a3 + 12) = *(_BYTE *)(a2 + 8) & 0x3F;
  v20 = BM_CRC5(a2 + 2, 75);
  if ( v20 != (*(_BYTE *)(a2 + 11) & 0x1F) && *(_BYTE *)(a1 + 238) )
  {
    v22 = *(_DWORD *)(a1 + 232);
    v23 = dword_2E1940[v22];
    dword_2E1940[v22] = v23 + 1;
    if ( v23 <= 9 )
    {
      V_LOCK(v20);
      V_INT((int)&v26, "chain");
