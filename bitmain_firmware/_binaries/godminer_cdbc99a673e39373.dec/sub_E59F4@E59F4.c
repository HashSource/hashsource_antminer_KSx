int __fastcall sub_E59F4(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r8
  int v9; // r11
  int v13; // r3
  ...
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 7) & 3)
  ...
  if ( BM_CRC5(a2 + 2, 67) != (*(_BYTE *)(a2 + 10) & 0x1F) && *(_BYTE *)(a1 + 238) )
  {
    v21 = dword_2E9A24++;
    if ( !(v21 % 0x3E8) )
    {
