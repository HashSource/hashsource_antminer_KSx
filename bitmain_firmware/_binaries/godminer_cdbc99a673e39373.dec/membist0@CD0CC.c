...
LABEL_11:
      memset(ptr, 0, 0x600u);
      v13 = sub_C98DC(v3, (unsigned __int16)v43, 162, ptr);
      v14 = v13;
      if ( v13 == 8
        || (V_LOCK(v13),
            V_INT((int)v51, "chain"),
...
LABEL_19:
      memset(ptr, 0, 0x600u);
      v4 = (void *)sub_C98DC(v3, (unsigned __int16)v43, 163, ptr);
      v19 = (int)v4;
      if ( v4 == (void *)8
        || (V_LOCK(v4),
            V_INT((int)&v54, "chain"),
...
LABEL_26:
  ...
  v31 = dev_ctrl(v25);
  (*(void (__fastcall **)(_DWORD))(v31 + 80))(*(_DWORD *)(v3 + 228));
  return 0;
}
