int __fastcall sub_248114(unsigned int a1, unsigned int a2, _DWORD *a3)
{
  int v4; // r0
  _DWORD *v5; // r7
  unsigned int v6; // r6
...
LABEL_9:
            v13 = HIDWORD(v8) - 2;
            *(_WORD *)&v22[v13] = word_2A07B7[(_DWORD)v8];
...
LABEL_27:
      ...
      *(_WORD *)&v22[HIDWORD(v8)] = word_2A07B7[(unsigned __int16)(a1 - 100 * v8)];
