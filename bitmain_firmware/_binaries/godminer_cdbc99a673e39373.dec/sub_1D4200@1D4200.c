int __fastcall sub_1D4200(int a1, _DWORD *a2)
{
  _BYTE *v4; // r1
  int result; // r0
  int *v6; // r0
  ...
  **(_BYTE **)a1 = 1;
  ...
  if ( sub_1A081C(aRustBeginShort, 0x1Cu, v13, v14) )
  {
    result = *(_DWORD *)(a1 + 12);
    *(_BYTE *)result = 1;
    return result;
...
LABEL_24:
  if ( sub_1A081C(aRustEndShortBa, 0x1Au, v13, v14) )
  {
    *v15 = 1;
    return 1;
  }
LABEL_3:
  ...
  if ( **(_BYTE **)(a1 + 8) )
  {
    ...
    if ( v9 < 2 )
      v17 = v9;
    v18 = sub_1D7AD4(&v30, v8, v33, &v20, v17);
    v19 = v31;
    **(_BYTE **)(a1 + 16) = v18;
    result = v19[2] + 1;
    v19[2] = result;
