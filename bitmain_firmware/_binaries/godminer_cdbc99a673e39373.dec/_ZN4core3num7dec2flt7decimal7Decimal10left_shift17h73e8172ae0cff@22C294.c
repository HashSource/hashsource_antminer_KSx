unsigned int __fastcall core::num::dec2flt::decimal::Decimal::left_shift(unsigned int result, char a2)
{
  ...
  if ( v2 )
  {
    v3 = result;
    v4 = a2 & 0x3F;
    v5 = (unsigned __int16 *)((char *)&unk_29EFB2 + 2 * v4);
    v6 = *v5 & 0x7FF;
    if ( v6 >= 0x51D )
    ...
    while ( 1 )
    {
      ...
      if ( v12 == 768 )
        core::panicking::panic_bounds_check(768, 768, (int)&off_2CFB14);
    ...
    {
      if ( v29 >> 8 > 2 )
        core::panicking::panic_bounds_check(v16, 768, (int)&off_2CFAB4);
      v18 = v8;
      v19 = v8 + v16;
      ...
      if ( v4 - 32 >= 0 )
        LODWORD(v20) = 0;
      v21 = v20 + v17;
      v17 = sub_25B668(v21, HIDWORD(v21), 10, 0);
      v22 = -10 * v17 + v21;
      if ( v19 < 0x300 )
      {
        *(_BYTE *)(v28 + v16) = v22;
    ...
    if ( v21 >= 0xA )
    {
      ...
      do
      {
        v25 = HIDWORD(v17);
        v26 = v17;
        v17 = sub_25B668(v17, HIDWORD(v17), 10, 0);
