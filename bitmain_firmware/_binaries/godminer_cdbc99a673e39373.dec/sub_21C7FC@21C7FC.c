int __fastcall sub_21C7FC(int *a1, char a2)
{
  int v3; // r0
  unsigned int v5; // r1
  unsigned int v6; // r2
  ...
  if ( !v3 )
  {
    v15 = a1[4];
    if ( v15 )
      return <str as core::fmt::Display>::fmt(asc_29D429, 1, v15);
    return 0;
  }
  v5 = a1[1];
  v6 = a1[2];
...
LABEL_15:
    v12 = a1[4];
    if ( !v12 || (v13 = 1, !<str as core::fmt::Display>::fmt(&unk_29D409, 16, v12)) )
    {
      v13 = 0;
      *((_BYTE *)a1 + 4) = 0;
      *a1 = 0;
...
LABEL_29:
  ...
  if ( v21 >= 0x1A || ((0x3BCFBBFu >> v21) & 1) == 0 )
    core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2CEC74);
  return <str as core::fmt::Display>::fmt(*(&off_2CECCC + (char)(a2 - 97)), dword_29D540[(char)(a2 - 97)], v20) != 0;
}
