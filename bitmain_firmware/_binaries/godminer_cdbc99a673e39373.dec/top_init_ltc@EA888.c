int __fastcall top_init_ltc(_DWORD *a1)
{
  ...
  v3 = zlog(
         ...
         "ild/godminer-origin_godminer-new/backend/backend_ltc_1489/backend_ltc_1489.c",
         187,
         "top_init_ltc",
         12,
         505,
  ...
  v5 = a1[78];
  v6 = a1[116];
  v7 = sub_25BAE0(256, (unsigned __int8)v5);
  if ( (_BYTE)v5 )
  {
    v8 = v6 - 1;
    v9 = 0;
  ...
  v10 = (void (__fastcall *)(_DWORD *, int, int))a1[60];
  a1[101] = v7;
  v10(a1, v6, v5);
  sub_E70B0((int)a1, 0);
  v11 = sub_EA6A0((int)a1);
  V_LOCK(v11);
