_DWORD *__fastcall <std::fs::ReadDir as core::iter::traits::iterator::Iterator>::next(int a1)
{
  int v2; // r1
  _DWORD *result; // r0
  int v4; // lr
  ...
  <std::sys::unix::fs::ReadDir as core::iter::traits::iterator::Iterator>::next(&v11);
  if ( v11 )
  {
    v2 = v16;
    result = (_DWORD *)(a1 + 8);
