int __fastcall memchr::memmem::Searcher::new(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  if ( a4 - 256 < 0xFFFFFF02 )
    goto LABEL_18;
  v8 = *a3;
  if ( byte_2965AB[a3[1]] >= (unsigned int)byte_2965AB[v8] )
  {
    v9 = a3[1];
    v82 = 0;
    v80 = 1;
...
LABEL_21:
  ...
  do
  {
    v43 = v41;
    if ( v42 + v38 >= v5 )
      core::panicking::panic_bounds_check(v42 + v38, v5, (int)&off_2CD7A8);
    v44 = a3[v39];
    v45 = a3[v42 + v38];
    v46 = v44 > v45;
    if ( v44 < v45 )
  ...
  do
  {
    ...
    v55 = v48;
    if ( v53 + v49 >= v48 )
      core::panicking::panic_bounds_check(v53 + v49, v48, (int)&off_2CD7A8);
    v56 = a3[v50];
    v57 = a3[v53 + v49];
    v58 = v56 >= v57;
    if ( v56 > v57 )
  ...
  {
    if ( v49 > v55 )
      core::panicking::panic((int)aAssertionFaile_22, 35, (int)&off_2CD768);
    v64 = v55;
    if ( v62 < v60 )
...
LABEL_67:
  ...
  {
    if ( v83 >= v64 )
      core::panicking::panic_bounds_check(v83, v64, (int)&off_2CD748);
    if ( v81 >= v64 )
      core::panicking::panic_bounds_check(v81, v64, (int)&off_2CD758);
    v67 = sub_1FCD74;
    if ( byte_2965AB[a3[v83]] >= 0xFBu )
      v67 = 0;
  }
  *(_BYTE *)(v77 + 40) = v83;
  *(_DWORD *)(v77 + 16) = v66;
