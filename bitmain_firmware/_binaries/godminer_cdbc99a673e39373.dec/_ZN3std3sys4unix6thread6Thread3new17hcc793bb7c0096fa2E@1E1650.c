int __fastcall std::sys::unix::thread::Thread::new(_DWORD *a1, size_t a2, int a3, int a4)
{
  ...
  *v8 = a3;
  ...
  v10 = 0x4000;
  v11 = (int (__fastcall *)(pthread_attr_t *))off_2D3868;
  if ( off_2D3868 )
  {
    if ( off_2D3868 != (_UNKNOWN *)1 )
    {
      __dmb(0xBu);
      if ( !v11 )
        goto LABEL_7;
    ...
    v11 = (int (__fastcall *)(pthread_attr_t *))sub_7A148();
    if ( v11 )
LABEL_6:
      v10 = v11(&s);
  }
LABEL_7:
  ...
  if ( v12 )
  {
    ...
    {
      v22 = 0;
      sub_77E94(0, (int)&v19, (int)&unk_2912D4, v21, (int)&off_2CBAD8);
    }
    v13 = sysconf(30);
  ...
  v14 = pthread_create(&newthread, &s, (void *(*)(void *))sub_1E18E8, v9);
...
LABEL_25:
    v22 = 0;
LABEL_26:
    sub_77E94(0, (int)&v20, (int)"", v21, (int)v16);
  }
  if ( v14 )
  {
