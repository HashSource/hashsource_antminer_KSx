int get_miner_sale_hashrate()
{
  ...
  _BYTE v20[48]; // [sp+24h] [bp-34h] BYREF
  __int16 v21; // [sp+54h] [bp-4h]
  _BYTE v22[2]; // [sp+56h] [bp-2h] BYREF
  ...
  do
  {
    ...
    freq_scan_status = 2;
    strcpy((char *)search_failed_info, "R:1");
    v6 = snprintf((char *)search_failed_info, 0x100u, "J%d:1", v11);
  }
  while ( v22 != v10 );
LABEL_15:
  v13 = frontend_runtime_instance(v6);
  format_hashrate_double(*(_DWORD *)(*(_DWORD *)(v13 + 72) + 16), v18, v19);
  v14 = v17;
  result = sub_25BAE0((int)v18[0], v17) * v14;
  switch ( opt_algo )
  {
    case 6:
      result -= 50;
...
LABEL_26:
      ...
      if ( (unsigned int)(result - 3130) <= 0x63 )
        return 3180;
      return sub_25BAE0(result, v14) * v14;
    case 7:
      result = sub_25BAE0(result, v14) * v14 - 50;
      if ( result > 3729 )
        return 3780;
      goto LABEL_26;
    case 9:
    ...
    case 2:
      if ( result > 172999 )
        return (int)&stru_2A3BC.st_info;
      if ( (unsigned int)(result - 166000) <= 0x1B57 )
        return (int)&stru_2886C.st_value;
      return sub_25BAE0(result, v14) * v14;
    case 5:
      if ( result <= 1859 )
      {
