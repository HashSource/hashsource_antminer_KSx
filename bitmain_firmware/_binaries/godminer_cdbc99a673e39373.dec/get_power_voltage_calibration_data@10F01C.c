int __fastcall get_power_voltage_calibration_data(int a1)
{
  ...
  v1 = (unsigned int)dword_2EA058 > 0x62;
  if ( dword_2EA058 != 98 )
    v1 = (unsigned int)(dword_2EA058 - 100) > 2;
  v2 = !v1;
  if ( !v1 )
  {
    V_LOCK(a1);
  ...
  memset(&v30[1], 0, 14);
  v30[0] = v2;
  sub_10D560((int)v30, 12, _byteswap_uint64(v31) & 0x1FFFFFFFFFFFFFFLL);
  v6 = sub_10D560((int)&v30[2] + 3, 7, __SPAIR64__(v2, v5));
  v7 = v2;
  V_LOCK(v6);
  ...
  v12 = v34;
  unk_2EA068 = v30[0];
  qword_2EA06C = *(_QWORD *)&v30[1];
  unk_2EA074 = v30[3];
  word_2EA078 = v30[4];
  dword_2EA120 = 100 * ((unsigned __int16)(v11 >> 4) % 0xCu)
               + 100
