char *__fastcall rustc_demangle::demangle(int *a1, int a2, int a3)
{
  ...
  v3 = (char *)a2;
  core::str::pattern::StrSearcher::new((int)&v107, a2, a3, &unk_29D46F, 6);
  v106 = v3;
  if ( v107 )
  {
    v4 = v115;
          ...
          while ( 1 )
          {
            ...
            while ( v13 != v14 )
            {
              if ( v5 + v14 >= v117 )
              {
                ...
                if ( v117 > v12 + v5 )
                  v91 = v117;
                core::panicking::panic_bounds_check(v91, v117, (int)&off_2CE964);
              }
...
LABEL_35:
      ...
      if ( v111 )
      {
        v17 = v23;
LABEL_223:
        core::panicking::panic_bounds_check(v17, v119, (int)&off_2CE974);
      }
LABEL_185:
      v19 = a3;
      v20 = v5 + 6;
...
LABEL_119:
          ...
          core::result::unwrap_failed((int)aFmtErrorSShoul, 61, (int)&v120, (int)&off_2CE9A4, (int)&off_2CEB74);
        }
LABEL_219:
        core::str::slice_error_fail((int)v3);
      }
