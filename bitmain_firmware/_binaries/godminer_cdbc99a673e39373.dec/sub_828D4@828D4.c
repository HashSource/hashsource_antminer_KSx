int __fastcall sub_828D4(int a1, const char **a2)
{
  int v3; // r7
  ...
  else
  {
    ...
    v24 = sub_25B7B4(LODWORD(v12), HIDWORD(v12));
    ...
    if ( v26 )
    {
      v126 = sub_25B7B4(COERCE_UNSIGNED_INT64(v19 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v19 * v12 * 100.0)));
      v127 = sub_25B8F8(v126, HIDWORD(v126));
      v128 = json_real(LODWORD(v127));
      v33 = v23;
      json_object_set_new(v23, "rate_5s", v128);
      v129 = sub_25B7B4(COERCE_UNSIGNED_INT64(v22 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v22 * 100.0)));
      v130 = sub_25B8F8(v129, HIDWORD(v129));
      v32 = json_real(LODWORD(v130));
      LOWORD(v34) = -5124;
    }
    else
    {
      v27 = sub_25B7B4(COERCE_UNSIGNED_INT64(v20 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v20 * v12 * 100.0)));
      v28 = COERCE_UNSIGNED_INT64(sub_25B8F8(v27, HIDWORD(v27)));
      v29 = json_real(v28);
      ...
      v31 = sub_25B8F8(v30, HIDWORD(v30));
    ...
    v35 = sub_25B7B4(COERCE_UNSIGNED_INT64(v21 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v21 * 100.0)));
    v36 = sub_25B8F8(v35, HIDWORD(v35));
    v37 = json_real(LODWORD(v36));
    json_object_set_new(v33, "rate_30m", v37);
    v38 = sub_25B7B4(COERCE_UNSIGNED_INT64(v141 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v141 * 100.0)));
    v39 = sub_25B8F8(v38, HIDWORD(v38));
    ...
    if ( v140 > 0 )
    {
      ...
      while ( 1 )
      {
        ...
        v61 = json_integer(*((_DWORD *)v55 + 18), *((int *)v55 + 18) >> 31);
        json_object_set_new(v58, "freq_avg", v61);
        v62 = *((float *)v55 + 10);
        v141 = v12 * *((double *)v55 + 6);
        v63 = sub_25B7B4(COERCE_UNSIGNED_INT64(v141 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v141 * 100.0)));
        v64 = sub_25B8F8(v63, HIDWORD(v63));
        v65 = json_real(LODWORD(v64));
        json_object_set_new(v58, "rate_ideal", v65);
        v66 = sub_25B7B4(COERCE_UNSIGNED_INT64(v62 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v62 * v12 * 100.0)));
        v67 = sub_25B8F8(v66, HIDWORD(v66));
        v68 = json_real(LODWORD(v67));
        json_object_set_new(v58, "rate_real", v68);
        v69 = json_integer(*((_DWORD *)v55 + 16), *((int *)v55 + 16) >> 31);
...
LABEL_36:
        ...
        v97 = *((_QWORD *)v55 + 10);
        if ( opt_algo == 9 )
          v97 = sub_25B668(v97, HIDWORD(v97), 1000, 0);
