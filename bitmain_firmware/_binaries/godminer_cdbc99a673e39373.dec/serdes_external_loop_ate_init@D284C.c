int __fastcall serdes_external_loop_ate_init(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 240, 0x80000000);
  sub_CFBEC(a1, a3, 86, 67634184);
  sub_CFBEC(a1, a3, 64, 256);
  sub_CFBEC(a1, a3, 80, 33423870);
  sub_CFBEC(a1, a3, 81, 832516511);
  sub_CFBEC(a1, a3, 88, -1);
  v7 = sub_CFBEC(a1, a3, 86, 201853960);
  V_LOCK(v7);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 196611);
  sub_CFBEC(a1, a3, 78, -2144272046);
  sub_CFBEC(a1, a3, 77, 33554944);
  sub_CFBEC(a1, a3, 78, -2144247742);
  sub_CFBEC(a1, a3, 77, 100664832);
  sub_CFBEC(a1, a3, 78, -2144247742);
  sub_CFBEC(a1, a3, 77, 65537);
  v11 = sub_CFBEC(a1, a3, 78, -2144272003);
  V_LOCK(v11);
  ...
  zlog(
    ...
    60,
    v194);
  sub_D0160(a1, a3, 24642, a4 | 0x600);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247741);
  sub_D0160(a1, a3, 24644, a4 << 7);
  sub_D0160(a1, a3, 24642, a4 | 0x700);
  sub_CFBEC(a1, a3, 77, 16777472);
  sub_CFBEC(a1, a3, 78, -2144247741);
  v13 = sub_D0160(a1, a3, 24644, a4 << 7);
  V_LOCK(v13);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144251892);
  sub_CFBEC(a1, a3, 77, 268439552);
  sub_CFBEC(a1, a3, 78, -2144251892);
  sub_CFBEC(a1, a3, 77, 33489407);
  sub_CFBEC(a1, a3, 78, -2144272086);
  sub_CFBEC(a1, a3, 77, 268374015);
  v15 = sub_CFBEC(a1, a3, 78, -2144272085);
  V_LOCK(v15);
  ...
  zlog(
    ...
    60,
    v194);
  sub_D0160(a1, a3, 24644, (a4 << 7) | 0x8020);
  sub_D0160(a1, a3, 24644, (a4 << 7) | 0x8060);
  sub_CFBEC(a1, a3, 77, -1);
  sub_CFBEC(a1, a3, 78, -2144247719);
  sub_CFBEC(a1, a3, 77, -8388737);
  v17 = sub_CFBEC(a1, a3, 78, -2144247718);
  V_LOCK(v17);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247776);
  sub_CFBEC(a1, a3, 77, -2136964960);
  v19 = sub_CFBEC(a1, a3, 78, -2144247776);
  V_LOCK(v19);
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v21) = 4144;
  sub_CFBEC(a1, a3, 77, v21);
  sub_CFBEC(a1, a3, 78, -2144247722);
  sub_CFBEC(a1, a3, 77, -1);
  v22 = sub_CFBEC(a1, a3, 78, -2144247718);
  V_LOCK(v22);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247771);
  sub_CFBEC(a1, a3, 77, (int)&loc_140014);
  v24 = sub_CFBEC(a1, a3, 78, -2144247771);
  V_LOCK(v24);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 33554944);
  sub_CFBEC(a1, a3, 78, -2144247760);
  sub_CFBEC(a1, a3, 77, 122947412);
  v26 = sub_CFBEC(a1, a3, 78, -2144247760);
  V_LOCK(v26);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 1073758208);
  sub_CFBEC(a1, a3, 78, -2144247770);
  sub_CFBEC(a1, a3, 77, -1072381932);
  v28 = sub_CFBEC(a1, a3, 78, -2144247770);
  V_LOCK(v28);
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v30) = 3;
  sub_CFBEC(a1, a3, 77, v30);
  sub_CFBEC(a1, a3, 78, -2144247739);
  sub_CFBEC(a1, a3, 77, -1);
  v31 = sub_CFBEC(a1, a3, 78, -2144247732);
  V_LOCK(v31);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 268439552);
  sub_CFBEC(a1, a3, 78, -2144247769);
  sub_CFBEC(a1, a3, 77, 805318656);
  v33 = sub_CFBEC(a1, a3, 78, -2144247769);
  V_LOCK(v33);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247751);
  sub_CFBEC(a1, a3, 77, 5505108);
  v35 = sub_CFBEC(a1, a3, 78, -2144247751);
  V_LOCK(v35);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, (int)&dword_10000 + 1);
  sub_CFBEC(a1, a3, 78, -2144251903);
  sub_CFBEC(a1, a3, 77, (int)&loc_230020 + 3);
  v37 = sub_CFBEC(a1, a3, 78, -2144251903);
  V_LOCK(v37);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144251872);
  sub_CFBEC(a1, a3, 77, (int)&loc_80008);
  v39 = sub_CFBEC(a1, a3, 78, -2144251872);
  V_LOCK(v39);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144272111);
  sub_CFBEC(a1, a3, 77, 1073692671);
  v41 = sub_CFBEC(a1, a3, 78, -2144272088);
  V_LOCK(v41);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 234884608);
  sub_CFBEC(a1, a3, 78, -2144272382);
  sub_CFBEC(a1, a3, 77, 235408904);
  v43 = sub_CFBEC(a1, a3, 78, -2144272382);
  V_LOCK(v43);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 234884608);
  sub_CFBEC(a1, a3, 78, -2144272381);
  sub_CFBEC(a1, a3, 77, 235408904);
  v45 = sub_CFBEC(a1, a3, 78, -2144272381);
  V_LOCK(v45);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, (int)&loc_180018);
  v47 = sub_CFBEC(a1, a3, 78, -2144272353);
  V_LOCK(v47);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 22348117);
  sub_CFBEC(a1, a3, 78, -2144272044);
  sub_CFBEC(a1, a3, 77, 67044351);
  v49 = sub_CFBEC(a1, a3, 78, -2144272044);
  V_LOCK(v49);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 61277095);
  sub_CFBEC(a1, a3, 78, -2144272380);
  sub_CFBEC(a1, a3, 77, 65471463);
  v51 = sub_CFBEC(a1, a3, 78, -2144272380);
  V_LOCK(v51);
  ...
  sub_CFBEC(a1, a3, 77, 235408904);
  sub_CFBEC(a1, a3, 78, -2144272382);
  sub_CFBEC(a1, a3, 77, 252186376);
  sub_CFBEC(a1, a3, 78, -2144272382);
  sub_CFBEC(a1, a3, 77, 235408904);
  sub_CFBEC(a1, a3, 78, -2144272381);
  sub_CFBEC(a1, a3, 77, 252186376);
  v53 = sub_CFBEC(a1, a3, 78, -2144272381);
  V_LOCK(v53);
  ...
  sub_CFBEC(
    ...
    a3,
    77,
    (int)"$LT$core..num..nonzero..NonZeroU8$u20$as$u20$core..str..traits..FromStr$GT$8from_str17ha054cf60a9e357d1E");
  sub_CFBEC(a1, a3, 78, -2144272379);
  sub_CFBEC(a1, a3, 77, (int)&loc_C000C);
  v55 = sub_CFBEC(a1, a3, 78, -2144272379);
  V_LOCK(v55);
  ...
  sub_CFBEC(
    ...
    77,
    (int)"$LT$core..num..nonzero..NonZeroU8$u20$as$u20$core..str..traits..FromStr$GT$8from_str17ha054cf60a9e357d1E");
  sub_CFBEC(a1, a3, 78, -2144272378);
  sub_CFBEC(a1, a3, 77, (int)&loc_C000C);
  v57 = sub_CFBEC(a1, a3, 78, -2144272378);
  V_LOCK(v57);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144272372);
  sub_CFBEC(a1, a3, 77, (int)&loc_100010);
  v59 = sub_CFBEC(a1, a3, 78, -2144272372);
  V_LOCK(v59);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144272360);
  sub_CFBEC(a1, a3, 77, (int)&loc_100010);
  v61 = sub_CFBEC(a1, a3, 78, -2144272360);
  V_LOCK(v61);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144272114);
  sub_CFBEC(a1, a3, 77, 710158932);
  v63 = sub_CFBEC(a1, a3, 78, -2144272114);
  V_LOCK(v63);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144272124);
  sub_CFBEC(a1, a3, 77, (int)&stru_1FFFC.st_value + 2);
  v65 = sub_CFBEC(a1, a3, 78, -2144272124);
  V_LOCK(v65);
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v69) = 501;
  sub_CFBEC(a1, a3, 77, v69);
  v70 = sub_CFBEC(a1, a3, 78, -2144247559);
  V_LOCK(v70);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 20971840);
  sub_CFBEC(a1, a3, 78, -2144251901);
  sub_CFBEC(a1, a3, 77, 88606024);
  v72 = sub_CFBEC(a1, a3, 78, -2144251901);
  V_LOCK(v72);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, (int)&loc_100010);
  sub_CFBEC(a1, a3, 78, -2144251900);
  sub_CFBEC(a1, a3, 77, 542122064);
  v74 = sub_CFBEC(a1, a3, 78, -2144251900);
  V_LOCK(v74);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247761);
  sub_CFBEC(a1, a3, 77, (int)&stru_1FFFC.st_value + 2);
  v76 = sub_CFBEC(a1, a3, 78, -2144247761);
  V_LOCK(v76);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 537010178);
  v78 = sub_CFBEC(a1, a3, 78, -2144247750);
  V_LOCK(v78);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, 872428544);
  sub_CFBEC(a1, a3, 78, -2144247769);
  sub_CFBEC(a1, a3, 77, 1006648320);
  v80 = sub_CFBEC(a1, a3, 78, -2144247769);
  V_LOCK(v80);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, (int)&loc_80008);
  sub_CFBEC(a1, a3, 78, -2144247745);
  sub_CFBEC(a1, a3, 77, (int)&loc_180018);
  v82 = sub_CFBEC(a1, a3, 78, -2144247745);
  V_LOCK(v82);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247798);
  sub_CFBEC(a1, a3, 77, (int)&stru_1FFFC.st_value + 2);
  v84 = sub_CFBEC(a1, a3, 78, -2144247798);
  V_LOCK(v84);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, (int)&dword_10000 + 1);
  v86 = sub_CFBEC(a1, a3, 78, -2144247604);
  V_LOCK(v86);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144247796);
  sub_CFBEC(a1, a3, 77, 268439552);
  v88 = sub_CFBEC(a1, a3, 78, -2144247796);
  V_LOCK(v88);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 0);
  sub_CFBEC(a1, a3, 78, -2144243666);
  sub_CFBEC(a1, a3, 77, (int)&stru_1FFFC.st_value + 2);
  sub_CFBEC(a1, a3, 78, -2144243666);
  sub_CFBEC(a1, a3, 77, 4259905);
  sub_CFBEC(a1, a3, 78, -2144251869);
  sub_CFBEC(a1, a3, 77, 13304011);
  v90 = sub_CFBEC(a1, a3, 78, -2144251869);
  V_LOCK(v90);
  ...
  sub_CFBEC(
    ...
    77,
    (int)"$LT$core..num..nonzero..NonZeroU8$u20$as$u20$core..str..traits..FromStr$GT$8from_str17ha054cf60a9e357d1E");
  v92 = sub_CFBEC(a1, a3, 78, -2144243609);
  V_LOCK(v92);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, (int)&loc_A0008 + 2);
  v94 = sub_CFBEC(a1, a3, 78, -2144247768);
  V_LOCK(v94);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, (int)"peDebug$u20$as$u20$core..fmt..Display$GT$3fmt17h76cfe72b567ef45aE");
  v96 = sub_CFBEC(a1, a3, 78, -2144272078);
  V_LOCK(v96);
  ...
  sub_CFBEC(a1, a3, 77, -2136964960);
  sub_CFBEC(a1, a3, 78, -2144247776);
  sub_CFBEC(a1, a3, 77, -2136309590);
  v98 = sub_CFBEC(a1, a3, 78, -2144247776);
  V_LOCK(v98);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, (int)&dword_10000 + 1);
  v110 = sub_CFBEC(a1, a3, 78, -2144251791);
  V_LOCK(v110);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, (int)&loc_A0008 + 2);
  sub_CFBEC(a1, a3, 78, -2144247768);
  sub_CFBEC(a1, a3, 77, (int)&loc_A0008 + 2);
  v112 = sub_CFBEC(a1, a3, 78, -2144247768);
  V_LOCK(v112);
  ...
  zlog(
    ...
    60,
    v194);
  sub_CFBEC(a1, a3, 77, (int)"micI16$u20$as$u20$core..fmt..Debug$GT$3fmt17h0889c43153a0c703E");
  sub_CFBEC(a1, a3, 78, -2144243377);
  sub_CFBEC(a1, a3, 77, (int)"micI16$u20$as$u20$core..fmt..Debug$GT$3fmt17h0889c43153a0c703E");
  sub_CFBEC(a1, a3, 78, -2144243377);
  sub_CFBEC(a1, a3, 77, (int)"peDebug$u20$as$u20$core..fmt..Display$GT$3fmt17h76cfe72b567ef45aE");
  v114 = sub_CFBEC(a1, a3, 78, -2144243377);
  V_LOCK(v114);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, -2136309590);
  v124 = sub_CFBEC(a1, a3, 78, -2144247776);
  V_LOCK(v124);
  ...
  zlog(
    ...
    v194);
  sub_CFBEC(a1, a3, 77, 65537);
  sub_CFBEC(a1, a3, 78, -2144251757);
  sub_CFBEC(a1, a3, 77, 65537);
  sub_CFBEC(a1, a3, 78, -2144251757);
  sub_CFBEC(a1, a3, 77, 1114129);
  sub_CFBEC(a1, a3, 78, -2144251757);
  sub_CFBEC(a1, a3, 77, 65537);
  sub_CFBEC(a1, a3, 78, -2144251757);
  sub_CFBEC(a1, a3, 77, 1114129);
