int __fastcall <std::sys_common::wtf8::Wtf8 as core::fmt::Debug>::fmt(int a1, unsigned int a2, int a3)
{
  ...
  v6 = 1;
  if ( !<core::fmt::Formatter as core::fmt::Write>::write_str(a3, asc_29163F, 1) )
  {
    v7 = (char *)(a1 + a2);
    v8 = v23;
    v9 = &off_2CB20C;
...
LABEL_33:
        v6 = 1;
        if ( !sub_1D5710(a3, a1 + v10, a2 - v10) )
          return <core::fmt::Formatter as core::fmt::Write>::write_str(a3, asc_29163F, 1);
        return v6;
      }
      v11 = v10;
      v12 = (char *)(a1 + v10);
...
LABEL_9:
      ...
      v18 = v8;
      v19 = v9;
      if ( sub_1D5710(a3, a1 + v10, v11 - v10) )
        return 1;
      v22[3] = 2;
      v22[5] = 1;
      v22[0] = 0;
