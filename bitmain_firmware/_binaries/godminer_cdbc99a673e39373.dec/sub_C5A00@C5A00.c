int __fastcall sub_C5A00(int a1, int a2)
{
  int v4; // r0
  ...
  zlog(
    ...
    v42);
  v32[0] = a2;
  v5 = *(int (__fastcall **)(int, _DWORD *))(a1 + 252);
  v32[1] = 0;
  v33 = 0xFF00000001LL;
  v6 = v5(a1, v32);
  if ( v6 < 0 )
  ...
  else
  {
    ...
    v10 = (*(int (**)(int, _DWORD *, int, int *, int *, int, int, _DWORD, int, int, int, int, const char *, ...))(a1 + 276))(
            a1,
            v32,
            v9,
            ptr,
