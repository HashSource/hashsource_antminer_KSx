bool __fastcall sub_9B7FC(int a1, int *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
                                ...
                                if ( v4 )
                                {
                                  ...
                                  if ( v4 )
                                  {
                                    ...
                                    if ( v31 )
                                    {
                                      ...
                                      if ( memcmp(v30, &dword_2D45C4, 0x20u) )
                                      {
                                        v73 = *v30;
                                        v112 = 0u;
                                        dword_2D45C4 = v73;
                                        dest = 0;
                                        *(_QWORD *)byte_2D45E4 = 0;
                                        unk_2D45EC = 0;
                                        dbl_2D45F4 = 0.0;
                                        dbl_2D45FC = 0.0;
                                        v113 = 0;
                                        ...
                                        hs_blake2b_final(v114, byte_2D45E4, 32);
                                      }
                                      v34 = a2 + 116;
                                      v35 = a2[19];
