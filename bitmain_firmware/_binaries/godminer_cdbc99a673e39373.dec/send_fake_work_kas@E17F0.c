int __fastcall send_fake_work_kas(pthread_mutex_t *a1)
{
  ...
  {
    v4 = dev_ctrl(v3);
    v3 = (*(int (__fastcall **)(int))(v4 + 68))(a1[9].__kind);
  }
  while ( v3 <= 0x35 );
  v5 = dev_ctrl(v3);
  (*(void (__fastcall **)(int, _DWORD *, int))(v5 + 52))(a1[9].__kind, v7, 54);
  check_and_print_uart_debug_log((int)&a1[44], 54, (unsigned __int8 *)v7, a1[9].__nusers, 1);
