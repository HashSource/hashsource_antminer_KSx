int __fastcall sub_7DA64(int a1, int a2, const char *a3)
{
        ...
        *(_DWORD *)((char *)&v31 + 2) = v27;
        if ( v28 > 0 )
        {
          ...
          do
          {
            ...
            (*(void (__fastcall **)(int, __int64 *, int, unsigned int *, int *, int, int, _DWORD))(v11 + 268))(
              v11,
              &v30,
              v12,
              v14,
            ...
            ++v6;
            v22 = (*(int (__fastcall **)(_DWORD))(v21 + 48))(*(_DWORD *)(*v9 + 228));
