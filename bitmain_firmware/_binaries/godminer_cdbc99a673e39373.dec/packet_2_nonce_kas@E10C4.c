int __fastcall packet_2_nonce_kas(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  ...
  if ( (*(_BYTE *)(a2 + 13) & 0x80) == 0 )
    return 10;
  if ( v11 == (*(_BYTE *)(a2 + 13) & 0x1F) || !*(_BYTE *)(a1 + 238) )
  {
    ...
    else
    {
      ...
      *a7 = v16;
      if ( v16 != -1 )
      {
        ...
        *(_BYTE *)(a3 + 16) = v13;
        *(_BYTE *)(a3 + 17) = v21;
        v22 = sub_25BD18(*(unsigned __int8 *)(a2 + 6), *(_DWORD *)(a1 + 404));
        if ( v22 >= *(_DWORD *)(a1 + 312) )
        {
          v41 = rand();
          sub_25BA0C(v41, *(_DWORD *)(a1 + 312));
          v22 = v42;
        }
        *a6 = v22;
        *(_DWORD *)(a3 + 8) = v22;
        ...
        *a4 = 1;
        ...
        if ( v25[4] == 999 )
        {
          ...
          else
          {
            ...
            v36 = 2 * v24;
            v37 = *(_QWORD *)&dword_2E1950[2 * v24 + 20];
            if ( v37 >= v35 || v35 - v37 > 0x63 )
              goto LABEL_28;
            for ( i = 0; i < v29; ++i )
            {
              v39 = *v50;
              v40 = qword_2E1A20[256 * v24 + i];
              ++v50;
...
LABEL_28:
              v43 = (__int64 *)s;
              v44 = (char *)&qword_2E1A20[256 * v24 - 1];
              v45 = 0;
              do
              {
                ++v45;
          ...
          *(_QWORD *)&dword_2E1950[v36 + 20] = v33;
        }
        else
        {
          ++v25[4];
  ...
  v26 = &dword_2E1950[*(_DWORD *)(a1 + 232)];
  v27 = v26[1];
  v26[1] = v27 + 1;
  if ( v27 <= 9 )
  {
