void __fastcall sub_1EC704(int *a1, int *a2)
{
  int *v2; // r11
  void *v4; // r6
  size_t v5; // r7
...
LABEL_24:
    ...
    v88[6] = 0;
    v2 = v68;
    sub_1E7168(&v79, (int)&v73, dest, (int)v88);
    a1 = v67;
    v24 = v81;
    if ( v81 )
      goto LABEL_25;
...
LABEL_71:
  ...
  src[21] = v38;
  src[20] = v39;
  sub_1E7D98(v84, v38, v40);
  if ( v84[0] != 1 )
    goto LABEL_79;
  if ( v76 == 1 )
    core::panicking::panic((int)aAssertionFaile_21, 36, (int)&off_2CBE94);
  len = v84[2];
  addr = (void *)v84[1];
  v76 = 1;
  sub_1ED074(v85);
