int __fastcall sub_8E4F4(_DWORD *a1, int a2, int a3, int a4, int (__fastcall *a5)(__int16 *, int, int), int a6)
{
  int v7; // r5
  int v8; // r9
  unsigned int v9; // r8
    ...
    case 0:
      ...
      if ( (v11 & 0x80) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          v25 = strlen(v24);
          sub_8E164((int)v24, v25, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
          ...
          if ( sub_8E4F4(v28, v9, v50, v7, a5, a6) )
            return -1;
          if ( !v23 )
          {
            v14 = 0;
            if ( !sub_8E3EC(v9, v45, 0, a5, a6) )
              goto LABEL_65;
            return -1;
          }
          if ( a5(&word_25F1B8, 1, a6) || sub_8E3EC(v9, v50, 1, a5, a6) )
            return -1;
        }
      }
      ...
      while ( v34 );
      v7 = v51;
      qsort(base, nmemb, 4u, (__compar_fn_t)sub_8E158);
      if ( nmemb )
      {
        v48 = v8;
        v36 = v53;
        ...
        do
        {
          ...
          v40 = strlen(v38);
          sub_8E164((int)v38, v40, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
          if ( a5((__int16 *)v42, v44, a6) || (v41 = sub_8E4F4(v39, v9, v50, v51, a5, a6)) != 0 )
          {
LABEL_70:
            v14 = -1;
            jsonp_free(base);
          ...
          else if ( sub_8E3EC(v9, a3, v41, a5, a6) )
          {
            goto LABEL_70;
          }
        }
...
LABEL_47:
    ...
    case 2:
      ...
      return sub_8E164(v16, v17, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
    case 3:
  ...
  do
  {
    ...
    v14 = sub_8E4F4(v31, v9, v30, v7, a5, a6);
    if ( v14 )
      return -1;
    v32 = v43 - 1 > v29++;
    if ( v32 )
    {
      if ( a5(&word_25F1B8, 1, a6) || sub_8E3EC(v9, v30, 1, a5, a6) )
        return -1;
    }
    else if ( sub_8E3EC(v9, v46, v14, a5, a6) )
    {
      return -1;
    }
  }
