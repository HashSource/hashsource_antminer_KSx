...
LABEL_2:
    ...
    else
    {
      ...
      else
      {
        ...
        if ( dword_2D2598 > 0 )
          close(dword_2D2598);
        dword_2D2598 = open64("/sys/class/gpio/gpio459/value", 1);
        if ( dword_2D2598 < 0 )
        {
        ...
        else
        {
          if ( dword_2D2590 > 0 )
            close(dword_2D2590);
          dword_2D2590 = open64("/sys/class/gpio/gpio461/value", 1);
          if ( dword_2D2590 < 0 )
          {
          ...
          else
          {
            if ( dword_2D2594 > 0 )
              close(dword_2D2594);
            dword_2D2594 = open64("/sys/class/gpio/gpio461/direction", 1);
            if ( dword_2D2594 >= 0 )
            {
              v1 = 255;
