int __fastcall <object::pe::ImageAuxSymbolSection as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[7] = &off_2CC638;
  v3[1] = &off_2CC638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aImageauxsymbol, 21, &off_2CCE80, 8, v3, 8);
}
