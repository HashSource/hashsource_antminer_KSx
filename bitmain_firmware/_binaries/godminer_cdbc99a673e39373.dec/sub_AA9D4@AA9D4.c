int __fastcall sub_AA9D4(int a1, int *a2, int a3)
{
  size_t *v3; // r7
  const void *v6; // r8
  int v7; // r0
  ...
  {
    v6 = a2 + 116;
    if ( a3 && memcmp(&unk_2D4820, a2 + 116, 0x116u) )
    {
      dbl_2D4940 = 0.0;
      memcpy(&unk_2D4820, v6, 0x11Eu);
    }
    ...
    if ( v8 && v8 == *v3 )
    {
      ...
      zlog(
        ...
        20,
        v19);
      memcpy(v3 + 1, &dbl_2D4940, *v3);
      v18 = dbl_2D4940;
      if ( *(_QWORD *)&dbl_2D4940 > 0xFFu )
      {
        dbl_2D4940 = 0.0;
      }
      else
      {
        ++LODWORD(dbl_2D4940);
        HIDWORD(dbl_2D4940) = (unsigned __int64)(*(_QWORD *)&v18 + 1LL) >> 32;
      }
    }
