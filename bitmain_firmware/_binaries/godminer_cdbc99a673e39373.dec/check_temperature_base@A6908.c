int __fastcall check_temperature_base(int a1, int *a2, int *a3)
{
  ...
  v48 = 0;
  all_created_runtime = get_all_created_runtime(&v48);
  if ( v48 > 0 )
  {
    ...
    while ( (int *)(all_created_runtime + 4 * v48) != v5 );
    if ( v4 == 256 )
      v4 = 2;
  }
  else
    ...
    do
    {
      if ( v9 > 0 )
      {
        ...
        do
        {
          ...
          if ( *v15 != -64 )
          {
            v18 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(all_created_runtime + 4 * v16) + 364) + v14 + 12);
            if ( v18 )
            {
              if ( v18 == 1 )
              {
