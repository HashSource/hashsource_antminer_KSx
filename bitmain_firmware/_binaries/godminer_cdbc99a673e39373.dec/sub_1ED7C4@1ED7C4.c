int __fastcall sub_1ED7C4(int *a1, unsigned int *a2, char *a3, size_t a4)
{
  int v4; // r7
  int v5; // r6
  int v6; // r11
...
LABEL_14:
        ...
        if ( *a1 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !HIDWORD(v27) )
            {
              ...
              if ( bytes_at_until )
              {
                ...
                {
                  v31 = bytes_at_until;
                  v32 = bcmp(&unk_291768, bytes_at_until, 8u);
                  v33 = v32 == 0;
                  if ( !v32 )
                    v33 = v30 - 1 == a4;
            ...
            && (HIDWORD(bytes_at) & 0xFFFFFFFC) != 8 )
          {
            ...
            if ( HIDWORD(bytes_at) < 0xC )
              v41 = 0;
            v42 = sub_1E7068(a2, bswap32(bytes_at));
            v17 = sub_1EDF4C(v40, v41, v42, HIDWORD(v42));
            if ( v17 )
              return v42;
          }
        }
  ...
  {
    v38 = sub_1E7068(a2, *(_DWORD *)(v16 + 4));
    v37 = v38;
