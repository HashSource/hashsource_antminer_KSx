int __fastcall <core::ffi::VaList as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v10 = v3;
  v9 = a2;
  v4 = core::fmt::builders::DebugStruct::field(&v9, (int)&unk_2A0624, 5u, (int)&v7, (int)&off_2D0778);
  core::fmt::builders::DebugStruct::field(v4, (int)aMarker, 7u, (int)&v8, (int)&off_2D0788);
  if ( v11 )
  {
    if ( v10 )
    {
