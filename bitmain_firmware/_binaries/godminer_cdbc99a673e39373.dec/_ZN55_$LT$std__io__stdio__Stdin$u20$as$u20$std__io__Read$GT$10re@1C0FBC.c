int __fastcall <std::io::stdio::Stdin as std::io::Read>::read_exact(int a1, int *a2, void *a3, size_t a4)
{
  int v4; // r4
  _BOOL4 v9; // r5
  int result; // r0
...
LABEL_5:
  ...
  v13 = v9;
  v12 = v4;
  <std::io::stdio::StdinLock as std::io::Read>::read_exact(a1, (int)&v12, a3, a4);
  if ( !v9
