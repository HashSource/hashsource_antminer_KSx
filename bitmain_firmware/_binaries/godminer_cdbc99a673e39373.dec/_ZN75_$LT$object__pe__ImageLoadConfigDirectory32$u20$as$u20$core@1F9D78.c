int __fastcall <object::pe::ImageLoadConfigDirectory32 as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[7] = &off_2CC110;
  v3[5] = &off_2CC110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_295DC3, 26, &off_2CCFF0, 42, v3, 42);
}
