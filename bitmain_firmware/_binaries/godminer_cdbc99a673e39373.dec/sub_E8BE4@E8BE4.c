int __fastcall sub_E8BE4(int a1, char a2)
{
  int v2; // r5
  int v4; // r6
  _DWORD *v5; // r8
  ...
  v6 = calloc(12 * v2, 1u);
  v7 = (*(int (__fastcall **)(int, __int64 *, int, _DWORD *, int *))(a1 + 268))(a1, &v20, v2, v6, &v18);
  if ( v18 > 0 )
  {
    v8 = v6;
...
LABEL_7:
  ...
  zlog(
    *v5,
    ...
    40,
    v24);
  v15 = (*(int (__fastcall **)(int, __int64 *))(a1 + 248))(a1, &v20);
  usleep(0x2710u);
  return v15;
}
