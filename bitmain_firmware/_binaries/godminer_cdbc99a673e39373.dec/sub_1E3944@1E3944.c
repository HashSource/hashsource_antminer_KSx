void __fastcall sub_1E3944(int **a1, int a2, int a3, int a4)
{
  int v8; // r3
  int v9; // r5
  ...
  sub_1DFD60((int *)&attr.__flags, a2, a3, v8, a4);
...
LABEL_9:
    ...
    {
      v22 = __ldrex((unsigned int *)&dword_2EAB64);
      if ( v22 == dword_2EAB64 )
      {
...
LABEL_69:
        ...
        *(_DWORD *)&attr.__flags = v100;
        ...
        if ( write(v84, &buf, 8u) == -1 )
        {
          ...
          *(__int16 *)((char *)&attr.__flags + 1) = 0;
          ...
          sub_19D328((int)&attr);
          set.__val[3] = 2;
          set.__val[2] = (unsigned int)&off_2CA6F8;
          ...
          attr.__sd.__val[1] = 1;
          attr.__sd.__val[0] = (unsigned int)&off_2CBD4C;
          attr.__sd.__val[3] = 0;
          attr.__sd.__val[2] = (unsigned int)aRustc9eb3afe9e;
          *(_DWORD *)&attr.__flags = 0;
          sub_1C56B0(&v110, (int)v116, &set);
      ...
      do
      {
        v37 = __ldrex((unsigned int *)&dword_2EAB64);
        v38 = v37 - 1;
      }
      while ( __strex(v38, (unsigned int *)&dword_2EAB64) );
      if ( (v38 & 0xBFFFFFFF) == 0x80000000 )
        std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_2EAB64, v38);
      close(v84);
      ...
      for ( i = read(v88, &buf, 8u); i == -1; i = read(v88, &buf, 8u) )
      {
        ...
        if ( (unsigned __int8)std::sys::unix::decode_error_kind(v40) != 35 )
        {
          ...
          if ( LOBYTE(attr.__flags) == 4 )
          {
            ...
            attr.__sd.__val[1] = 1;
            v75 = &off_2CBCEC;
            attr.__sd.__val[0] = (unsigned int)&off_2CBCE4;
            *(_DWORD *)&attr.__flags = 0;
          ...
          else
          {
            ...
            attr.__sd.__val[1] = 1;
            attr.__sd.__val[0] = (unsigned int)&off_2CBCCC;
            v74 = 0;
            *(_DWORD *)&attr.__flags = 0;
          }
...
LABEL_84:
      ...
      if ( i == 8 )
      {
        ...
        if ( v109 != 1480937294 )
        {
          ...
          *(_DWORD *)&attr.__flags = 0;
          file_actions.__used = (int)sub_19ECA4;
          file_actions.__allocated = (int)&buf;
          attr.__sd.__val[0] = (unsigned int)&off_2CBD24;
          sub_77E28((int)&v110, &attr);
        }
        v41 = buf;
        sub_1E4B7C(&attr, &set);
        if ( LOBYTE(attr.__flags) == 4 )
...
LABEL_63:
    *a1 = (int *)2;
    ...
    do
    {
      v35 = __ldrex((unsigned int *)&dword_2EAB64);
      v36 = v35 - 1;
    }
    while ( __strex(v36, (unsigned int *)&dword_2EAB64) );
    if ( (v36 & 0xBFFFFFFF) == 0x80000000 )
      std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_2EAB64, v36);
    close(v84);
    v16 = 1;
LABEL_85:
    close(v88);
