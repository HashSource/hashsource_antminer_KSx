void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    do
    {
      ...
      while ( !*(_QWORD *)&dbl_2D49F0 );
    }
    while ( *(_QWORD *)&dbl_2D49F0 == *(_QWORD *)&dbl_2D49F8 );
    V_LOCK(LODWORD(dbl_2D49F0));
    ...
    zlog(
      ...
      v97);
    v2 = dbl_2D49F0;
    v3 = sub_25B668(LODWORD(dbl_2D49F0), HIDWORD(dbl_2D49F0), 3, 0);
    v4 = (char *)&v93 + 4;
    v5 = &v96;
    ...
    if ( v89 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          40,
          v97);
        v52 = sub_25B668(LODWORD(dbl_2D49F0), HIDWORD(dbl_2D49F0), 7500, 0);
        v53 = v48[1];
        ++v48;
        v63 = *(void (__fastcall **)(int, _DWORD, _DWORD, _DWORD))(v53 + 12);
        v54 = vshrd_n_u64(qword_2724C8[v52], 8u);
        printf("dag_load: %llx\n", v54);
