void *__fastcall std::env::_var_os(size_t *a1, const void *a2, size_t n)
{
  ...
  if ( (unsigned int)dword_2EAB64 > 0x3FFFFFFF || (dword_2EAB64 & 0x3FFFFFFE) == 0x3FFFFFFE )
    goto LABEL_28;
  v6 = __ldrex((unsigned int *)&dword_2EAB64);
  if ( v6 != dword_2EAB64 )
  {
    __clrex();
    goto LABEL_28;
...
LABEL_9:
  ...
  while ( __strex(v8, (unsigned int *)&dword_2EAB64) );
  if ( (v8 & 0xBFFFFFFF) == 0x80000000 )
    std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_2EAB64, v8);
LABEL_13:
