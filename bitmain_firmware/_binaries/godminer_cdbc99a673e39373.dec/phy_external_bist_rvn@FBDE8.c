...
LABEL_6:
    ...
    {
      v17 = *++v16;
      sub_F4028(a1, v17, 133, 0xFFFF);
      sub_F4028(a1, *v16, 134, 1342177279);
    }
    while ( v12 != v16 );
    sub_F3FE8(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
...
LABEL_31:
  ...
  free(ptr);
  v40 = *(_QWORD *)&dword_2E9A58;
  v41 = *(_QWORD *)&dword_2E9A60;
  v42 = &v65[8];
  for ( i = &v66[1]; ; ++i )
  {
    v40 += v39;
  ...
  *(_QWORD *)&dword_2E9A58 = v40;
  *(_QWORD *)&dword_2E9A60 = v41;
  V_LOCK(v40);
  V_INT((int)&v62, "chain");
