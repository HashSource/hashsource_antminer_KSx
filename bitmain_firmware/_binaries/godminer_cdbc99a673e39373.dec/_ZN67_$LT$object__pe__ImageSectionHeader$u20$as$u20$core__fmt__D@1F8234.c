int __fastcall <object::pe::ImageSectionHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[15] = &off_2CC110;
  v3[1] = &off_2CC5B0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_29539A, 18, &off_2CCDE0, 10, v3, 10);
}
