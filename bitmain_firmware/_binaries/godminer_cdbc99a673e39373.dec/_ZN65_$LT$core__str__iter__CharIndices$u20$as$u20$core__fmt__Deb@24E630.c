int __fastcall <core::str::iter::CharIndices as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v10 = v3;
  v9 = a2;
  v4 = core::fmt::builders::DebugStruct::field(&v9, (int)aFrontOffset, 0xCu, (int)&v7, (int)&off_2D0908);
  core::fmt::builders::DebugStruct::field(v4, (int)&unk_2A05C5, 4u, (int)&v8, (int)&off_2D0A40);
  if ( v11 )
  {
    if ( v10 )
    {
