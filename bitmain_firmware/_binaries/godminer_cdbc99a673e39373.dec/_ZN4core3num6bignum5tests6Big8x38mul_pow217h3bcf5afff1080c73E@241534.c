int __fastcall core::num::bignum::tests::Big8x3::mul_pow2(int result, unsigned int a2)
{
  ...
  if ( a2 > 0x17 )
    core::panicking::panic((int)aAssertionFaile_53, 28, (int)&off_2D0618);
  v2 = a2 >> 3;
  if ( *(_DWORD *)result )
  {
    v3 = *(_DWORD *)result - 1;
...
LABEL_24:
    core::panicking::panic_bounds_check(v4, 3, (int)&off_2D0618);
  }
LABEL_7:
  if ( a2 >= 8 )
  {
    ...
    if ( a2 >= 0x10 )
    {
      *(_BYTE *)(result + 5) = 0;
      if ( v8 != 2 )
      {
        *(_BYTE *)(result + 6) = 0;
        if ( v8 != 3 )
          core::panicking::panic_bounds_check(3, 3, (int)&off_2D0618);
      }
    }
  }
  v9 = a2 & 7;
  ...
  if ( (a2 & 7) != 0 )
  {
    ...
    if ( v4 - 1 > 2 )
LABEL_23:
      core::panicking::panic_bounds_check(v5, 3, (int)&off_2D0618);
    v10 = result + v5;
    v11 = -a2 & 7;
    ...
    {
      if ( v4 - 2 >= 3 )
        core::panicking::panic_bounds_check(-1, 3, (int)&off_2D0618);
      v14 = result + v4--;
