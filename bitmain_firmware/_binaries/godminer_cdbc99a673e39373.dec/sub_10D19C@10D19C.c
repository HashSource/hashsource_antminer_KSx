int __fastcall sub_10D19C(int a1, unsigned __int8 a2)
{
  int v3; // r0
  int v4; // r0
  ...
  if ( a1 == 255 )
  {
    if ( !sub_10CEAC((unsigned __int8 *)&v5, 8u, (unsigned __int8 *)&v9, 8u) )
      return WORD2(v9);
  ...
  {
    if ( !sub_10D014(a1, (unsigned __int8 *)&v5, 8u, (unsigned __int8 *)&v9, 8u) )
      return WORD2(v9);
    strcpy(v10, "set watchdog failed");
    V_LOCK(*(_DWORD *)"set watchdog failed");
