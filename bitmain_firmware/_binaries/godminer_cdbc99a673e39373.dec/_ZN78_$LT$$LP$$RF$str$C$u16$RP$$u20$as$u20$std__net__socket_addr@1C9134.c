int __fastcall <(&str,u16) as std::net::socket_addr::ToSocketAddrs>::to_socket_addrs(_DWORD *a1, int a2)
{
  ...
  if ( v2 <= 0xF )
  {
    ...
    *(_DWORD *)v16 = v4;
    sub_1C66A4((int)&v14, (unsigned __int8 **)v16);
    if ( !*(_DWORD *)&v16[4] )
    {
      if ( (_BYTE)v14 )
      {
...
LABEL_17:
  ...
  else
  {
    ...
    if ( v18 )
    {
      HIDWORD(v14) = dword_2CB158;
      LODWORD(v14) = 1;
      LODWORD(v15) = &off_2CB14C;
LABEL_14:
      v11 = v15;
      *a1 = HIDWORD(v14);
      a1[1] = v11;
    ...
    sub_1E5724((int)&v14, v5, name);
    if ( (_DWORD)v14 )
      goto LABEL_14;
  }
  v12 = HIDWORD(v14);
  v13 = v15;
  return sub_1C8DBC(a1, (int)&v12);
}
