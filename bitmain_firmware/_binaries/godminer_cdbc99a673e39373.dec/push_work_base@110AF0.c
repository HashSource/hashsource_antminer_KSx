int __fastcall push_work_base(int a1, int a2)
{
  ...
  if ( !*(_BYTE *)(a1 + 238) && !*(_BYTE *)(a1 + 237) )
    return 13;
  v4 = (unsigned __int8 *)calloc(1u, *(_DWORD *)(a1 + 816));
  v5 = a2;
  ...
  {
    v9 = dev_ctrl(v8);
    v8 = (*(int (__fastcall **)(_DWORD))(v9 + 68))(*(_DWORD *)(a1 + 228));
  }
  while ( v8 < v15 );
  v10 = dev_ctrl(v8);
  v11 = (*(int (__fastcall **)(_DWORD, unsigned __int8 *, unsigned int))(v10 + 52))(*(_DWORD *)(a1 + 228), v7, v15);
  pthread_mutex_unlock((pthread_mutex_t *)(a1 + 912));
  v12 = check_and_print_uart_debug_log(a1 + 1056, v15, v7, *(_DWORD *)(a1 + 232), 1);
  if ( v11 <= 0 )
  {
    V_LOCK(v12);
