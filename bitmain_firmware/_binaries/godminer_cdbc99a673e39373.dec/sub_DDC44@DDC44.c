int __fastcall sub_DDC44(int a1, int a2, char a3, __int16 a4)
{
  float v4; // s0
  int v5; // r7
  int v6; // r2
...
LABEL_9:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)(v13 - 16) <= 0xEA )
    {
      ...
      if ( (v5 != 1 || v14 <= 3125.0) && v14 <= 3200.0 )
      {
        ...
        if ( v14 >= 2000.0 )
        {
          v15 = sub_25BAE0(v12, v5);
          v16 = sub_25BAE0(v15, v7);
          v12 = sub_25BAE0(v16, v10);
          v17 = v14 > 2400.0;
  ...
  zlog(
    ...
    v31);
  if ( v18 > 0.0 )
    v10 = (*(int (__fastcall **)(int, __int64 *))(a1 + 248))(a1, &v28);
  else
    v10 = -1;
LABEL_24:
  usleep(0x2710u);
