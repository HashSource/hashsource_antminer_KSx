int __fastcall <object::pe::ImageEnclaveConfig32 as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[15] = &off_2CC4B8;
  v3[13] = &off_2CC4B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_29602B, 20, &off_2CD328, 13, v3, 13);
}
