int __fastcall sub_80A84(int a1, const char **a2)
{
  float v2; // s0
  void *v5; // r0
  bool v6; // zf
  ...
  {
    sub_7CFF8(a1, a2, (int)&v51);
    v9 = sub_7D100(a1, v7, v8);
    v48 = json_array(v9);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( v23 )
        {
          ...
          if ( v43 )
          {
            v13 = sub_25B7B4(*(_DWORD *)(v23 + 1968), *(_DWORD *)(v23 + 1972));
          }
          else
          {
          ...
          v15 = sub_25B7B4(*(_DWORD *)(v23 + 1816), *(_DWORD *)(v23 + 1820));
          v16 = json_integer(v15, HIDWORD(v15));
          json_object_set_new(v25, "diffs", v16);
          v17 = sub_25B7B4(*(_DWORD *)(v23 + 1624), *(_DWORD *)(v23 + 1628));
