int __fastcall <object::pe::ImageArchiveMemberHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2CC590;
  v3[1] = &off_2CC4B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2955B8, 24, &off_2CCEC0, 7, v3, 7);
}
