void *runtime_ctrl_dcr_1727()
{
  ...
  LODWORD(v2[11]) = sub_C71CC;
  HIDWORD(v2[11]) = sub_C70B4;
  LODWORD(v2[12]) = sub_C5674;
  LODWORD(v2[13]) = sub_C6DE4;
  HIDWORD(v2[13]) = sub_C6A08;
  LODWORD(v2[14]) = sub_C6638;
  HIDWORD(v2[14]) = sub_C6164;
  LODWORD(v2[15]) = sub_C5DB8;
  ...
  HIDWORD(v2[25]) = sub_C7FB8;
  LODWORD(v2[26]) = sub_C4BA8;
  HIDWORD(v2[26]) = sub_C568C;
  ...
  LODWORD(v2[37]) = 7496548;
  *(_QWORD *)&v2[38] = 0x100001727LL;
  *(_QWORD *)&v2[40] = 0x4000002F8LL;
  HIDWORD(v2[41]) = 2;
  ...
  LODWORD(v2[35]) = 3625540;
  *(_QWORD *)&v2[39] = 0xC00000005CLL;
  v2[36] = 0.0;
  HIDWORD(v2[62]) = 1;
  *(_QWORD *)&v2[120] = 4774;
  LODWORD(v2[51]) = 39;
  HIDWORD(v2[45]) = sensor_info_dcr_1727;
  *(_QWORD *)&v2[46] = qword_2D1A8C;
  *(_QWORD *)&v2[47] = qword_2D1A94;
  HIDWORD(v2[100]) = 280;
  *(_QWORD *)&v2[101] = 0x400000050LL;
  *(_QWORD *)&v2[48] = qword_2D1A9C;
  *(_QWORD *)&v2[102] = 0xB000000BALL;
  LODWORD(v2[118]) = 1520;
  LOBYTE(v2[119]) = 15;
  v2[117] = 1.18750933e20;
  v0 = calloc(1u, 0x468u);
