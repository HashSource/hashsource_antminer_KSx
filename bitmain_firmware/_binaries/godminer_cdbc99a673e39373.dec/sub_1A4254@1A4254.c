unsigned int __fastcall sub_1A4254(int *a1, int *a2, _BYTE *a3)
{
  unsigned int v3; // r5
  int (*v4)(); // r8
  int v5; // r9
...
LABEL_31:
      ...
      v58 = v38;
      v59 = 1;
      core::panicking::panic_fmt((int)&v54, (int)&off_2CA428);
    }
    v23 = *(_DWORD *)(v19 + 276);
