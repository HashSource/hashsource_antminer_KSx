bool __fastcall sub_1A081C(void *s1, size_t n, void *s2, unsigned int a4)
{
  unsigned int v5; // r11
  unsigned int v6; // r5
  unsigned int v7; // r3
...
LABEL_84:
            if ( v58 > v46 )
              v46 = v58;
            core::panicking::panic_bounds_check(v46, v58, (int)&off_2CA1B0);
          }
        ...
        while ( v19 != -1 )
        {
          if ( v53 - 1 >= v60 )
LABEL_81:
            core::panicking::panic_bounds_check(v19, v60, (int)&off_2CA1C0);
          v20 = v34 + v19;
          if ( v34 + v19 >= v58 )
LABEL_82:
            core::panicking::panic_bounds_check(v20, v58, (int)&off_2CA1D0);
