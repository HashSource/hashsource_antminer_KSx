unsigned int __fastcall sub_1C7108(unsigned __int8 **a1, int a2, unsigned int a3, unsigned int a4)
{
  unsigned int v4; // lr
  _WORD *v5; // r7
  int v7; // r4
...
LABEL_45:
  ...
  v9 = *a1;
  v10 = a1[1];
  if ( v8 && (!v10 || (v11 = *v9, *a1 = v9 + 1, a1[1] = v10 - 1, v11 != 58)) || (sub_1C66A4((int)&v44, a1), !v44) )
  {
    *a1 = v9;
    a1[1] = v10;
    v12 = v10;
  ...
  if ( v8 >= a3 )
    core::panicking::panic_bounds_check(v8, a3, (int)&off_2CAD48);
  v35 = v45;
  *(v5 - 1) = __rev16(v45);
  if ( v8 + 1 >= a3 )
    core::panicking::panic_bounds_check(v8 + 1, a3, (int)&off_2CAD58);
  *v5 = bswap32(v35);
  return v8 + 2;
}
