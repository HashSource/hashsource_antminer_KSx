int __fastcall sub_219D2C(int *a1)
{
  int v2; // r0
  int v3; // r8
  int v4; // r6
  ...
  while ( 1 )
  {
    ...
    if ( v7 )
      goto LABEL_11;
    if ( <str as core::fmt::Display>::fmt(asc_29D42B, 2, v5) )
      return 1;
    v2 = *a1;
    if ( *a1 )
    {
LABEL_11:
      ...
      if ( v9 < v8 && *(_BYTE *)(v2 + v9) == 115 )
      {
        ...
        if ( v9 + 1 >= v8 || *(_BYTE *)(v2 + v10) != 95 )
        {
          ...
          v24 = a1[4];
          if ( !v24 || (v4 = 1, !<str as core::fmt::Display>::fmt(&unk_29D409, 16, v24)) )
          {
            v4 = 0;
            *((_BYTE *)a1 + 4) = 0;
            *a1 = 0;
...
LABEL_36:
      sub_218A04((int)&v25, a1);
      if ( v25 )
      {
        v18 = a1[4];
        if ( v18
          && (<rustc_demangle::v0::Ident as core::fmt::Display>::fmt(&v25, v18)
           || <str as core::fmt::Display>::fmt(asc_29D46B, 2, v18)) )
        {
          return 1;
        }
        v4 = 1;
    ...
    else
    {
      ...
      if ( !v11 )
        return 0;
      v4 = 1;
      if ( <str as core::fmt::Display>::fmt(asc_29D429, 1, v11) )
        return v4;
LABEL_4:
      v2 = *a1;
      ++v3;
