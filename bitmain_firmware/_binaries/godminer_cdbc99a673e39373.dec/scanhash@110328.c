int __fastcall scanhash(int a1)
{
  ...
  v3 = snprintf(v2, 0x40u, "%.10s_%d", "scanhash", *(_DWORD *)(a1 + 228));
  V_LOCK(v3);
  syscall(224);
  v29 = 0;
  v30 = 1;
  ...
  ptr = (char *)calloc(1u, *(_DWORD *)(a1 + 812));
LABEL_2:
  memset(s, 0, sizeof(s));
  ...
  if ( !*(_BYTE *)(a1 + 860) )
  {
    while ( 1 )
    {
      ...
      {
        queue_dequeue(v5, s, 1);
        check_and_print_uart_debug_log(a1 + 984, 1, s, *(_DWORD *)(a1 + 232), 0);
        if ( *(_BYTE *)(a1 + 860) )
          goto LABEL_5;
      }
      ...
      if ( s[1] == 85 )
      {
        ...
        check_and_print_uart_debug_log(a1 + 984, v10, s, *(_DWORD *)(a1 + 232), v33);
        v11 = *(unsigned __int8 *)(a1 + 860);
        if ( *(_BYTE *)(a1 + 860) )
          break;
        ...
        if ( v12 == 10 )
        {
          if ( !queue_enqueue(*(_DWORD *)(a1 + 840), s, v10) && v32 <= ++v31 )
          {
            V_LOCK(0);
        ...
        else if ( !v12 && *(_BYTE *)(a1 + 238) )
        {
          if ( !*(_BYTE *)(a1 + v36 + 512) && v34 && platform_check_repeat_nonce(a1, v35, ptr) )
          {
            ++*(_QWORD *)(*(_DWORD *)(a1 + 432) + 48 * v35 + 32);
          }
          else
          {
            ...
            {
              v15 = v35;
              v16 = (_QWORD *)(*(_DWORD *)(a1 + 432) + 8 * v13 + 48 * v35);
              ++*v16;
              if ( v13 <= 1 )
              {
                ...
                *(_QWORD *)(a1 + 424) = v17;
                ...
                if ( !v14
                  && !*(_BYTE *)(a1 + v18 + 512)
                  && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 844) + 836), v6, 1)
                  && v30 <= ++v29 )
                {
                  V_LOCK(0);
      ...
      v27 = *(_BYTE *)(a1 + 860);
      s[0] = s[1];
      check_and_print_uart_debug_log(a1 + 984, 2, s, v8, v27);
    }
  }
LABEL_5:
  *(_BYTE *)(a1 + 860) = 0;
