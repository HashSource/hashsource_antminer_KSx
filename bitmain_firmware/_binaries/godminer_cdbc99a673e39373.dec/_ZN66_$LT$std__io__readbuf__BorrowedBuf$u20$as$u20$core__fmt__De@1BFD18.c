int __fastcall <std::io::readbuf::BorrowedBuf as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3 = core::fmt::builders::DebugStruct::field(v7, aInit, 4, a1 + 12, &off_2CA748);
  v4 = core::fmt::builders::DebugStruct::field(v3, aFilled, 6, a1 + 8, &off_2CA748);
  v8 = *(_DWORD *)(a1 + 4);
  v5 = core::fmt::builders::DebugStruct::field(v4, aCapacity_0, 8, &v8, &off_2CA748);
