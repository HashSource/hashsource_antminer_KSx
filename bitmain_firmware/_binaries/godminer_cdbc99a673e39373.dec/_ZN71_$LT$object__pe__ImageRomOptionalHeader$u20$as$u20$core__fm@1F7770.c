int __fastcall <object::pe::ImageRomOptionalHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2CC0D0;
  v3[1] = &off_2CC110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_295272, 22, &off_2CCB30, 13, v3, 13);
}
