...
LABEL_4:
      ...
      while ( 1 )
      {
        ...
        if ( v18 )
        {
          ...
          {
            if ( v45 + v10 + v16 > 0x27 )
              core::panicking::panic_bounds_check(v49 + v10 + v16 - 1, 40, (int)&off_2D0600);
            *(&v47[v10] + v49 + v16) = v21;
            v23 = v44;
          }
          v24 = v10 + v23;
    ...
    while ( 1 )
    {
      ...
      if ( v32 )
      {
        ...
        do
        {
          if ( !(4 * v33 - 160 + v35) )
LABEL_43:
            core::panicking::panic_bounds_check(v17, 40, (int)&off_2D0600);
          ++v17;
        ...
        if ( v36 )
        {
          if ( v6 - 1 + v48 + v31 > 0x27 )
            core::panicking::panic_bounds_check(v6 + v48 + v31 - 1, 40, (int)&off_2D0600);
          v38 = v6 + 1;
