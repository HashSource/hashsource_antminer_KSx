int __fastcall <std::sys_common::net::UdpSocket as core::fmt::Debug>::fmt(int *a1, int a2)
{
  int v3; // r8
  int v4; // r5
  int v5; // r0
  ...
  core::fmt::Formatter::debug_struct(v7, a2, aUdpsocket, 9);
  v3 = *a1;
  sub_1E60DC((int)&v8, *a1);
  ...
  else
  {
    ...
    v16[6] = v14;
    v16[7] = v15;
    core::fmt::builders::DebugStruct::field(v7, aAddr, 4, v16, &off_2CBE44);
  }
  v16[0] = v3;
  v5 = core::fmt::builders::DebugStruct::field(v7, aFd, 2, v16, &off_2CAA5C);
