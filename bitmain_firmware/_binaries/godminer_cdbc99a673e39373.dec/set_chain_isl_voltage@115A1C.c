int __fastcall set_chain_isl_voltage(unsigned __int8 a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    {
      v14 = -1;
      sub_1153F4(v4, v5, 0, &v14, 1);
      usleep((__useconds_t)&elf_hash_chain[4398]);
      v15 = v3;
      sub_1153F4(v4, v5, 33, (char *)&v15, 2);
      usleep((__useconds_t)"nixDatagram15set_nonblocking17h4ff315a764057036E");
      v7 = sub_1158F8(v4, v5, &v16);
      ...
      zlog(
        *v2,
        ...
        60,
        v17);
      v7 = usleep((__useconds_t)"nixDatagram15set_nonblocking17h4ff315a764057036E");
    ...
    a1 = zlog(
           *v2,
           ...
           "build/godminer-origin_godminer-new/backend/device/hal/drv_pic/isl68127.c",
           181,
