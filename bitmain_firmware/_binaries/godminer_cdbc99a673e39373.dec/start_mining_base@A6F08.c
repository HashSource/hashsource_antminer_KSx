...
LABEL_25:
  ...
  v10 = power_init((unsigned __int8)byte_2D47C8, v42);
  if ( v10 )
  {
    V_LOCK(v10);
...
LABEL_27:
          ...
          else
          {
            ...
            if ( !v20 )
            {
              v28 = (*(int (__fastcall **)(int))(a1 + 64))(a1);
              if ( *(_DWORD *)(a1 + 72) != 9 )
              {
                V_LOCK(v28);
              ...
              v29 = (*(int (__fastcall **)(_DWORD))(a1 + 24))(*(_DWORD *)(a1 + 92));
              fan_pwm_set(v29);
              if ( v42 > 0 )
              {
                v30 = v27 - 1;
              ...
              if ( *(_DWORD *)(a1 + 72) == 9 )
              {
                v33 = (*(int (__fastcall **)(int))(a1 + 64))(a1);
                V_LOCK(v33);
