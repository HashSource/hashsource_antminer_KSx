int __fastcall sub_832AC(int a1, const char **a2)
{
  int v3; // r4
  _DWORD *v5; // r8
  ...
  if ( a2 )
  {
    ...
    v23 = sub_25B7B4(LODWORD(v17), HIDWORD(v17));
    ...
    if ( v25 )
      ...
      v26 = v20;
    v27 = sub_25B7B4(COERCE_UNSIGNED_INT64(v26 * v17 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v26 * v17 * 100.0)));
    v28 = COERCE_UNSIGNED_INT64(sub_25B8F8(v27, HIDWORD(v27)));
    v29 = json_real(v28);
    json_object_set_new(v16, "rate_5s", v29);
    v30 = (unsigned int)opt_algo > 0xA;
    if ( opt_algo != 10 )
      v30 = (unsigned int)(opt_algo - 6) > 1;
    if ( !v30 )
    {
      v22 = *(float *)&v17 * v22;
      v21 = *(float *)&v17 * v21;
    }
    v31 = sub_25B7B4(COERCE_UNSIGNED_INT64(v22 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v22 * 100.0)));
    v32 = sub_25B8F8(v31, HIDWORD(v31));
    v33 = json_real(LODWORD(v32));
    json_object_set_new(v16, "rate_avg", v33);
    v34 = sub_25B7B4(COERCE_UNSIGNED_INT64(v21 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v21 * 100.0)));
    v35 = sub_25B8F8(v34, HIDWORD(v34));
    v36 = json_real(LODWORD(v35));
    json_object_set_new(v16, "rate_30m", v36);
    v37 = sub_25B7B4(COERCE_UNSIGNED_INT64(v61 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v61 * 100.0)));
    v38 = sub_25B8F8(v37, HIDWORD(v37));
    ...
    v41 = *(_QWORD *)&v18;
    if ( opt_algo == 9 )
      v41 = sub_25B668(LODWORD(v18), HIDWORD(v18), 1000, 0);
    v42 = json_integer(v41, HIDWORD(v41));
    json_object_set_new(v16, "hw_all", v42);
    v43 = json_integer(LODWORD(dbl_2D38A8), HIDWORD(dbl_2D38A8));
