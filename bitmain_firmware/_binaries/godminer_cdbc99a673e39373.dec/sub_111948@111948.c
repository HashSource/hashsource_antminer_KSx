int __fastcall sub_111948(pthread_mutex_t *a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  v12 = 0;
  v18[1] = 1000000 * v13;
  v18[0] = sub_25B668(a5, a6, 1000, 0);
  while ( a2 > v12 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, v19, 10, v18) == 110 )
      {
        v11 = 3;
        goto LABEL_11;
      }
      if ( v19[0] != 170 || v19[1] != 85 || (v20[0] & 0xEF) != 0 )
      {
        v11 = 1;
        goto LABEL_11;
      }
