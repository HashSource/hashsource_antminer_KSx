...
LABEL_10:
    memset(s, 0, 0x600u);
    v9 = sub_C98DC(a1, (unsigned __int16)v30, 162, s);
    v10 = v9;
    if ( v9 == 8
      || (V_LOCK(v9),
          V_INT((int)v35, "chain"),
...
LABEL_18:
  ...
  *(_QWORD *)v26 = 0;
  ...
  while ( v15 != 8 );
  v20 = dev_ctrl(v16);
  (*(void (__fastcall **)(_DWORD))(v20 + 80))(*(_DWORD *)(a1 + 228));
  qword_2E1920 = v44;
  qword_2E1928 = v45;
  qword_2E1930 = *(_QWORD *)&v46;
  qword_2E1938 = *(_QWORD *)&v47;
  return 0;
}
