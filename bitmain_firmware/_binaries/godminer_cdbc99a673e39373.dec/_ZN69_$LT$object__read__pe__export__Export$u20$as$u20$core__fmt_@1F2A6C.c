int __fastcall <object::read::pe::export::Export as core::fmt::Debug>::fmt(int *a1, int a2)
{
  ...
  v3 = core::fmt::builders::DebugStruct::field(v8, aOrdinal, 7, a1 + 2, &off_2CC278);
  v4 = *a1;
  v9[1] = a1[1];
  v9[0] = v4;
  v5 = core::fmt::builders::DebugStruct::field(v3, aName_1, 4, v9, &off_2CC288);
  v6 = core::fmt::builders::DebugStruct::field(v5, aTarget, 6, a1 + 3, &off_2CC298);
