...
int32_t function_128a0(int32_t *p_a1, int32_t *p_a2, int32_t *p_a3,
                       ...
                       uint32_t i_a7);
int32_t function_133e8(uint32_t i_a1, int32_t i_a2);
int32_t function_137cc(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t function_13808(void);
int32_t function_1380c(int32_t i_a1, int32_t *p_a2);
int32_t function_13810(void);
int32_t function_13818(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
...
int32_t function_e3033bc4(void);
int32_t function_e3033bd4(void);
...
int32_t entry_point(int32_t i_a1, int32_t i_a2) {
    ...
    int32_t i_v2 = function_10720(0x133e8, i_a2, &i_v1, 0x137cd, 0x133e8, i_a1,
                                  &i_v1); // 0x10854
    return function_10708(i_v2) - 9;
}
...
// Address range: 0x128a0 - 0x133e8
int32_t function_128a0(int32_t *p_a1, int32_t *p_a2, int32_t *p_a3,
                       int32_t *p_a4, uint32_t i_a5, uint32_t i_a6,
                       uint32_t i_a7) {
    int32_t i_v1 = (int32_t)p_a1;
    int32_t i_v2; // bp-200, 0x128a0
    function_1380c(i_v1, &i_v2);
    ...
    if (i_v56 == 0) {
        // 0x12e28
        function_107f0("Dump version Failed!\r", (int32_t) "w", i_v54, 0);
        i_v5 = 13;
        // 0x133dc
        return 13;
    }
    ...
    i_v5 = i_v27;
    if (i_v27 != 0) {
        int32_t i_v57 = function_10798((int32_t) "/tmp/tmpfw/miner.pem", "w", 8,
                                       (int32_t *)i_v27); // 0x12e4c
        i_v5 = i_v57;
        if (i_v57 == 0) {
            // 0x12ea8
            function_107f0("Dump Miner.pem Failed!\r", (int32_t) "w", 8, 0);
            i_v5 = 15;
            // 0x133dc
            return 15;
        }
        // 0x12e60
        function_107d4((int32_t *)i_v53, 1, i_v52, i_v57);
        function_10738(i_v57);
        int32_t i_v58 = function_10798((int32_t) "/tmp/tmpfw/miner.pem.sig",
                                       "w", i_v52, (int32_t *)i_v57); // 0x12e90
        i_v5 = i_v58;
        if (i_v58 == 0) {
            // 0x12ee4
        ...
        // 0x12ebc
        function_107d4((int32_t *)i_v54, 1, 256, i_v58);
        function_10738(i_v58);
    }
    // 0x12ef8
    int32_t i_v59; // bp-2288, 0x128a0
    function_10744(&i_v59, 0, 1056, &i_v59);
    int32_t i_v60; // bp-2400, 0x128a0
    function_10820(&i_v60);
    function_10808(&i_v60, i_v10, 2048, &i_v60);
    function_10774(&i_v59, &i_v60, &i_v60, &i_v59);
    int32_t i_v61 = &i_v59;
    if (i_v28 != 0) {
        int32_t i_v62 = i_v61 + 32; // 0x13028
        for (int32_t i_v63 = 0; i_v63 < i_v38; i_v63++) {
            int32_t i_v64 = 5 * i_v63 + i_v10;             // 0x12f88
            unsigned char i_v65 = *(char *)(i_v64 + 1310); // 0x12f94
            unsigned char i_v66 = *(char *)(i_v64 + 1311); // 0x12fbc
            unsigned char i_v67 = *(char *)(i_v64 + 1312); // 0x12fe4
            unsigned char i_v68 = *(char *)(i_v64 + 1313); // 0x13010
            unsigned char i_v69 = *(char *)(i_v64 + 1309); // 0x1305c
            function_10dc8(i_v7,
                           0x10000 * (int32_t)i_v66 |
                               0x1000000 * (int32_t)i_v65 |
                               256 * (int32_t)i_v67 | (int32_t)i_v68,
                           i_v62 + 32 * i_v63, (int32_t)i_v69, 0, i_v27);
        }
        int32_t i_v70 = 0;
        int32_t i_v71 = i_v70 + 1;
        unsigned char i_v72 = *(char *)(i_v10 + 1309 + 5 * i_v70); // 0x130f0
        function_10dc8(i_v7, 256, 32 * (i_v71 + i_v38) + i_v61, (int32_t)i_v72,
                       1, i_v27);
        while (i_v71 < i_v38) {
            // 0x130ac
            i_v70 = i_v71;
            i_v71 = i_v70 + 1;
            i_v72 = *(char *)(i_v10 + 1309 + 5 * i_v70);
            function_10dc8(i_v7, 256, 32 * (i_v71 + i_v38) + i_v61,
                           (int32_t)i_v72, 1, i_v27);
        }
    }
    int32_t i_v73 = 0; // bp-2656, 0x13138
    int32_t i_v74;     // bp-2652, 0x128a0
    function_10744(&i_v74, 0, 252, &i_v74);
    function_1075c(i_v7, -256, 2);
    function_1082c(&i_v73, 256, 1, i_v7);
    int32_t i_v75 = 0; // bp-2688, 0x13188
    __asm_vmov_i32(0);
    float64_t f_v76; // 0x128a0
    int32_t i_v77;   // 0x128a0
    __asm_vst1_8(f_v76, f_v76, i_v77);
    __asm_vst1_8(f_v76, f_v76, i_v77);
    int32_t i_v78; // bp-2800, 0x128a0
    function_10820(&i_v78);
    function_10808(&i_v78, i_v61, 64 * i_v38 | 32, &i_v78);
    function_10774(&i_v75, &i_v78, &i_v78, &i_v75);
    int32_t i_v79 = function_107a4(i_v53, 1024);    // 0x13230
    int32_t i_v80 = function_10768(i_v79, 0, 0, 0); // 0x13248
    if (i_v80 == 0) {
        int32_t i_v81 = function_107c8(function_10714(0), 0); // 0x1326c
        function_107bc("OpenSSL error: %s\n", i_v81, 0, i_v81);
        function_107f0("Load Pem Failed!", i_v81, 0, i_v81);
        i_v5 = 17;
        // 0x133dc
        return 17;
    }
    int32_t i_v82 =
        function_10750(672, &i_v75, 32, (int32_t)&i_v73, 256, i_v80); // 0x132c8
    function_107fc(i_v80);
    if (i_v79 != 0) {
        // 0x132f0
        function_10814(i_v79);
    }
    int32_t i_v83 = &i_v75; // 0x132ac
    i_v5 = i_v82;
    if (i_v82 != 1) {
        int32_t i_v84 = function_107f0("Check File Sig failed!\r", i_v83, 32,
                                       i_v82);                    // 0x1330c
        int32_t i_v85 = function_107c8(function_10714(i_v84), 0); // 0x13320
        function_107bc("OpenSSL error: %s\n", i_v85, 32, i_v85);
        i_v5 = 18;
        // 0x133dc
        return 18;
    ...
    // 0x13354
    function_10738(i_v7);
    function_107f0("All Done!\r", i_v83, 32, 0);
    i_v5 = i_v26;
    if (i_v26 != 0) {
        // 0x13374
        function_107f0("This Comment Of This Package:", i_v83, 32, i_v26);
        int32_t i_v86 = 0; // bp-3060, 0x13384
        int32_t i_v87;     // bp-3056, 0x128a0
        function_10744(&i_v87, 0, 253, &i_v87);
        int32_t i_v88 = i_v10 + 1360; // 0x133a8
        function_1078c(&i_v86, i_v88, 256, &i_v86);
        function_107f0((char *)&i_v86, i_v88, 256, (int32_t)&i_v86);
    }
    // 0x133d8
    i_v5 = 0;
    // 0x133dc
...
int32_t function_133e8(uint32_t i_a1, int32_t i_a2) {
    ...
    int32_t *p_v1 = (int32_t *)(i_a2 + 4); // 0x1342c
    if (*(char *)*p_v1 != 45) {
        // 0x137c0
        return 2;
    }
    int32_t i_v2 = 0; // bp-272, 0x13458
    int32_t i_v3;     // bp-268, 0x133e8
    function_10744(&i_v3, 0, 252, &i_v3);
    int32_t i_v4 = 0; // bp-400, 0x13474
    int32_t i_v5;     // bp-396, 0x133e8
    function_10744(&i_v5, 0, 124, &i_v5);
    int32_t i_v6 = 0; // bp-528, 0x13490
    int32_t i_v7;     // bp-524, 0x133e8
    function_10744(&i_v7, 0, 124, &i_v7);
    int32_t i_v8; // bp-2576, 0x133e8
    function_10744(&i_v8, 0, 2048, &i_v8);
    int32_t i_v9; // bp-2832, 0x133e8
    function_10744(&i_v9, 0, 253, &i_v9);
    int32_t i_v10 = 0;   // 0x133e8
    int32_t i_v11 = 253; // 0x133e8
    switch (i_a1) {
    case 5: {
        int32_t *p_v12 = (int32_t *)(i_a2 + 8);             // 0x13514
        uint32_t i_v13 = function_10780((int32_t *)*p_v12); // 0x1351c
        ...
        int32_t i_v14 = *p_v12; // 0x13548
        function_107b0(&i_v2, i_v14);
        int32_t *p_v15 = (int32_t *)(i_a2 + 12);            // 0x13564
        uint32_t i_v16 = function_10780((int32_t *)*p_v15); // 0x1356c
        ...
        int32_t i_v17 = *p_v15; // 0x13598
        function_107b0(&i_v4, i_v17);
        int32_t *p_v18 = (int32_t *)(i_a2 + 16);            // 0x135b4
        uint32_t i_v19 = function_10780((int32_t *)*p_v18); // 0x135bc
    ...
    case 2: {
    lab_0x13690:;
        unsigned char i_v21 = *(char *)(*p_v1 + 1); // 0x136a8
        int32_t i_v22 = (int32_t)i_v21 - 102;       // 0x136ac
        i_g6 = i_v22;
        char i_v23 = 0;    // 0x136b4
        char i_v24 = 1;    // 0x136b4
        int32_t i_v25 = 0; // 0x136b4
        int32_t i_v26 = 0; // 0x136b4
        char i_v27 = 0;    // 0x136b4
        char i_v28 = 0;    // 0x136b4
        int32_t i_v29;     // 0x133e8
        switch (i_v21) {
        case 120: {
            // 0x13724
            i_v23 = 1;
        ...
        case 102: {
            int32_t i_v30 =
                function_128a0(&i_v4, &i_v2, &i_v6, &i_v8, i_v26,
                               (int32_t)i_v27, (int32_t)i_v28); // 0x1376c
            i_v29 = i_v30;
            // break -> 0x137c0
            break;
        }
    ...
    case 3: {
        int32_t *p_v31 = (int32_t *)(i_a2 + 8);             // 0x13614
        uint32_t i_v32 = function_10780((int32_t *)*p_v31); // 0x1361c
        ...
        int32_t i_v33 = *p_v31; // 0x13648
        function_107b0(&i_v4, i_v33);
        i_v10 = i_v33;
        i_v11 = i_v33;
        // branch (via goto) -> 0x13690
        goto lab_0x13690;
    }
    default: {
        // 0x1366c
...
// Address range: 0x137cc - 0x13800
int32_t function_137cc(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    int32_t i_v1 = function_106e8(i_a1, i_a2, i_a3, i_a4); // 0x137dc
    return 0x24f0a - (int32_t)&i_g1 >> 2 == 0 ? i_v1 : i_a1;
}

// Address range: 0x13808 - 0x1380a
int32_t function_13808(void) {
    // 0x13808
    int32_t i_v1; // 0x13808
    return i_v1;
}

// Address range: 0x1380c - 0x13810
int32_t function_1380c(int32_t i_a1, int32_t *p_a2) {
    // 0x1380c
    return i_a1;
}

// Address range: 0x13810 - 0x13816
int32_t function_13810(void) {
    // 0x13810
    return function_107e0();
}

// Address range: 0x13818 - 0x13820
int32_t function_13818(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    // 0x13818
    return i_a1;
}
...
// Address range: 0xe3033bc4 - 0xe3033bc5
int32_t function_e3033bc4(void) {
    // 0xe3033bc4
    int32_t i_v1; // 0xe3033bc4
    return i_v1;
}

// Address range: 0xe3033bd4 - 0xe3033bd5
int32_t function_e3033bd4(void) {
    // 0xe3033bd4
    int32_t i_v1; // 0xe3033bd4
    return i_v1;
}
