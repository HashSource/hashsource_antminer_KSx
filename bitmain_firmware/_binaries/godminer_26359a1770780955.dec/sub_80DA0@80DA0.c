int __fastcall sub_80DA0(int a1, int a2)
{
  void *v4; // r0
  bool v5; // zf
  int v6; // r4
  ...
  else
  {
    ...
    if ( total_pools )
    {
      v7 = sub_7EB64(a1, 1, 7, *(_DWORD *)(a2 + 8));
      v8 = json_array(v7);
      v72 = v8;
      if ( total_pools > 0 )
      {
        ...
        do
        {
          ...
          v56 = sub_26CA50(v55, HIDWORD(v55));
          v57 = json_real(v56);
          json_object_set_new(v29, "Difficulty Accepted", v57);
          v58 = sub_26C90C(COERCE_UNSIGNED_INT64(*v51 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v51 * 100.0)));
          v59 = sub_26CA50(v58, HIDWORD(v58));
          v60 = json_real(v59);
          ...
          v62 = sub_26CA50(v61, HIDWORD(v61));
          v63 = json_real(v62);
          ...
          v65 = sub_26CA50(v64, HIDWORD(v64));
          v66 = json_real(v65);
          ...
          if ( v19 != 0.0 )
          {
            ...
            v18 = sub_26CA50(v20, HIDWORD(v20));
          }
          v21 = json_real(v18);
          ...
          if ( v24 != 0.0 )
          {
            ...
            v22 = sub_26CA50(v25, HIDWORD(v25));
          }
          ++v71;
          v26 = json_real(v22);
