    ...
    do
    {
      ...
      zlog(
        *v2,
        ...
        60,
        v17);
      v7 = usleep((__useconds_t)"t..LowerHex$u20$for$u20$u8$GT$3fmt17hbb583368dc481f64E");
