int __fastcall <object::pe::ImageEnclaveImport as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[7] = &off_2E04B8;
  v3[5] = &off_2E1318;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A9793, 18, &off_2E1390, 7, v3, 7);
}
