unsigned int *__fastcall sub_7C0E8(unsigned int *a1, int **a2)
{
      ...
      case 0u:
        ...
        **a2 = 0;
        ...
        if ( *(_BYTE *)(v5 + 20) )
          goto LABEL_33;
        *(_BYTE *)(v5 + 20) = 1;
        while ( !__ldrex(&dword_307C28) )
        {
          if ( !__strex(1u, &dword_307C28) )
          {
            __dmb(0xBu);
            goto LABEL_23;
          }
        ...
        __clrex();
        std::sys::unix::locks::futex_mutex::Mutex::lock_contended(&dword_307C28);
LABEL_23:
        v7 = 0;
...
LABEL_27:
        ...
        __dmb(0xBu);
        do
          v11 = __ldrex(&dword_307C28);
        while ( __strex(0, &dword_307C28) );
        if ( v11 == 2 )
          syscall(240, &dword_307C28, 129, 1);
LABEL_33:
        result = v16;
        v15 = 4;
        __dmb(0xBu);
