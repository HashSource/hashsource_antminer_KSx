size_t __fastcall std::sys::unix::path::absolute(_DWORD *a1, _BYTE *a2, unsigned int a3)
{
  char v6; // r4
  _BYTE *v7; // r0
  unsigned int v8; // r1
  ...
  v6 = 1;
  v7 = std::path::Path::_strip_prefix(a2, a3, asc_2A565E, 1);
  if ( !v7 )
  {
    v7 = a2;
    v8 = a3;
  ...
  if ( a3 && *a2 == 47 )
  {
    v25 = a3;
    v24 = a2;
    if ( a3 >= 2 && *(_WORD *)a2 == 12079 && (a3 < 3 || bcmp(&unk_2A681C, a2, 3u)) )
    {
