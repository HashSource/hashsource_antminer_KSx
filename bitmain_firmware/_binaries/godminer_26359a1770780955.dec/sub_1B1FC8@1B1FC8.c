size_t __fastcall sub_1B1FC8(size_t *a1, _DWORD *a2, size_t *a3, size_t *a4)
{
  int v4; // r7
  _DWORD *v5; // r8
  int v6; // r1
...
LABEL_21:
  ...
  if ( v21 )
  {
    ...
    *v37 = v39;
    ...
    v46 = v34 + 1;
    if ( v38 - (v34 + 1) != v39 )
      core::panicking::panic((int)aAssertionFaile_6, 40, (int)&off_2DE448);
    v47 = v155;
    v48 = 3 * v46;
    v49 = 12 * v39;
...
LABEL_64:
      ...
      v177 = v153;
      if ( !v162[1] )
        core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2DE3E8);
      v116 = *v162;
      v117 = v162[1];
