int sub_1F634C()
{
  ...
  if ( dword_2E7F4C )
    return dword_2E7F4C;
  key[0] = 0;
  v4[0] = pthread_key_create(key, (void (*)(void *))off_2E7F50);
  if ( v4[0] )
    goto LABEL_13;
  v1 = key[0];
  if ( key[0] )
...
LABEL_13:
    v7 = 0;
    sub_797AC(0, (int)v4, (int)"", v6, (int)&off_2DFBD0);
  }
  v1 = key[0];
  ...
  if ( !v1 )
  {
    ...
    v10 = 0;
    v6[0] = 0;
    sub_1D6804(v3, (int)v11, v4);
    sub_1AF1E0((int)v3);
    std::sys::unix::abort_internal();
  }
LABEL_7:
  v2 = __ldrex((unsigned int *)&dword_2E7F4C);
  if ( v2 )
  {
LABEL_11:
    __clrex();
  ...
  {
    __dmb(0xBu);
    while ( __strex(v1, (unsigned int *)&dword_2E7F4C) )
    {
      v2 = __ldrex((unsigned int *)&dword_2E7F4C);
      if ( v2 )
        goto LABEL_11;
