int __fastcall sub_CA5C8(int a1, char a2, int a3, char a4, int a5)
{
  int v5; // r6
  double v8; // r0
  __int64 v9; // r0
  ...
  if ( v5 )
  {
    v8 = sub_26C9C0(*(_DWORD *)(a1 + 984), *(_DWORD *)(a1 + 988)) / (double)a3 * *(float *)(a1 + 964);
    v9 = sub_26CB80(LODWORD(v8), HIDWORD(v8));
