int __fastcall alloc::str::<impl str>::to_uppercase(_DWORD *a1, int a2, size_t size)
{
  int v6; // r6
  int result; // r0
  unsigned int v8; // r1
  ...
  int v28; // r3
  int v29; // r3
  _DWORD v30[3]; // [sp+0h] [bp-Ch] BYREF
    ...
    *a1 = size;
    ...
    if ( v6 != size )
    {
      ...
      do
      {
        ...
        core::unicode::unicode_data::conversions::to_upper(v30, v26);
        if ( v30[1] )
        {
          if ( v30[2] )
            sub_23C208(a1);
