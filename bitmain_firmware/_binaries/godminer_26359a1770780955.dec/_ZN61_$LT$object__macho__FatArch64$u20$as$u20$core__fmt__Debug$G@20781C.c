int __fastcall <object::macho::FatArch64 as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[7] = &off_2E0C90;
  v3[5] = &off_2E0C90;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aFatarch64, 9, &off_2E0648, 6, v3, 6);
}
