int __fastcall sub_25926C(unsigned int a1, unsigned int a2, _DWORD *a3)
{
  int v4; // r0
  _DWORD *v5; // r7
  unsigned int v6; // r6
  ...
  else
  {
    if ( (v4 & 0x20) == 0 )
    {
      ...
      else
      {
        ...
        do
        {
          v8 = sub_26C7C0(a1, v6, 10000, 0);
          v9 = a1 - 10000 * v8;
          v10 = &v22[v7];
          v7 -= 4;
          v11 = (unsigned int)(5243 * (v9 >> 2)) >> 17;
          *(_WORD *)(v10 + 35) = word_2B3EB7[v11];
          *(_WORD *)(v10 + 37) = word_2B3EB7[(unsigned __int16)(v9 - 100 * v11)];
...
LABEL_9:
            v13 = HIDWORD(v8) - 2;
            *(_WORD *)&v22[v13] = word_2B3EB7[(_DWORD)v8];
...
LABEL_27:
      ...
      *(_WORD *)&v22[HIDWORD(v8)] = word_2B3EB7[(unsigned __int16)(a1 - 100 * v8)];
