int __fastcall <std::io::stdio::Stdin as std::io::Read>::read_vectored(int a1, int *a2, struct iovec *a3)
{
  int v3; // r4
  _BOOL4 v7; // r5
  int result; // r0
...
LABEL_5:
  ...
  v11 = v7;
  v10 = v3;
  <std::io::stdio::StdinLock as std::io::Read>::read_vectored(a1, (int)&v10, a3);
  if ( !v7
