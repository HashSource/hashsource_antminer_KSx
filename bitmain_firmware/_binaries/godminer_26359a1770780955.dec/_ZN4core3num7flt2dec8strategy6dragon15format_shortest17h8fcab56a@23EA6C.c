int __fastcall core::num::flt2dec::strategy::dragon::format_shortest(int a1, int a2, _BYTE *a3, unsigned int a4)
{
  ...
  v6 = *(_DWORD *)(a2 + 12);
  if ( !*(_QWORD *)(a2 + 8) )
    core::panicking::panic((int)aAssertionFaile_33, 29, (int)&off_2E3B64);
  v7 = *(_DWORD *)(a2 + 16);
  v8 = *(_DWORD *)(a2 + 20);
  if ( !*(_QWORD *)(a2 + 16) )
  {
...
LABEL_239:
  ...
  if ( __CFADD__(__CFADD__((_DWORD)v4, v7), HIDWORD(v4)) | __CFADD__(v8, __CFADD__((_DWORD)v4, v7) + HIDWORD(v4)) )
    core::panicking::panic((int)aAssertionFaile_35, 54, (int)&off_2E3B84);
  if ( v4 < __PAIR64__(v6, v5) )
    core::panicking::panic((int)aAssertionFaile_36, 55, (int)&off_2E3B94);
  if ( a4 < 0x11 )
    core::panicking::panic((int)aAssertionFaile_37, 45, (int)&off_2E3BA4);
  v154 = *(char *)(a2 + 26);
...
LABEL_45:
  ...
  if ( v26 )
  {
    ...
    if ( v41 )
    {
      ...
      v27 = v26;
LABEL_230:
      core::panicking::panic_bounds_check(v27, 40, (int)&off_2E4600);
    }
  }
  else
  {
...
LABEL_126:
    ...
    if ( n == a4 )
      core::panicking::panic_bounds_check(a4, a4, (int)&off_2E3BB4);
    v99 = v162;
    v116 = v54 > v162;
    v158 = v162;
    a3[n] = v60 + 48;
...
LABEL_211:
  ...
  *a3 = 49;
  ...
  if ( v157 >= a4 )
    core::panicking::panic_bounds_check(v157, a4, (int)&off_2E3BD4);
  v131 = v19 + 1;
  a3[v157] = 48;
  v132 = v141 + 2;
LABEL_221:
