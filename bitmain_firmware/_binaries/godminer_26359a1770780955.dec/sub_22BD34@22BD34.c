int __fastcall sub_22BD34(_DWORD *a1, int a2)
{
  int v3; // r0
  unsigned int v4; // r8
  unsigned int v5; // r3
  ...
  if ( v5 + 1 < v4 && *(_BYTE *)(v3 + v6) == 95 )
  {
    ...
    a1[2] = v5 + 2;
    LODWORD(v8) = 0;
    return sub_22A6D0((int)a1, a2, v7, v8);
  }
  else
  {
    if ( v6 > v4 )
    ...
    v19 = a1[4];
    if ( !v19 || (v20 = <str as core::fmt::Display>::fmt(&unk_2B0B09, 16, v19), result = 1, !v20) )
    {
      result = 0;
      *((_BYTE *)a1 + 4) = 0;
      *a1 = 0;
