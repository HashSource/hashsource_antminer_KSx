int __fastcall <std::os::unix::net::datagram::UnixDatagram as core::fmt::Debug>::fmt(int *a1, int a2)
{
  ...
  v3 = 2;
  core::fmt::builders::DebugStruct::field(v8, aFd, 2, a1, &off_2DEE6C);
  v4 = *a1;
  memset(s, 0, 0x6Eu);
  len = 110;
  ...
  else if ( !len || (v3 = len, *(unsigned __int16 *)s == 1) )
  {
    ...
    *(_DWORD *)s = v3;
    ...
    core::fmt::builders::DebugStruct::field(v8, aLocal, 5, s, &off_2DEE7C);
  }
  v5 = *a1;
  memset(s, 0, 0x6Eu);
  len = 110;
  ...
  else
  {
    ...
    *(_DWORD *)s = v6;
    memcpy(&s[8], dest, 0x6Cu);
    core::fmt::builders::DebugStruct::field(v8, aPeer, 4, s, &off_2DEE7C);
    return core::fmt::builders::DebugStruct::finish(v8);
  }
}
