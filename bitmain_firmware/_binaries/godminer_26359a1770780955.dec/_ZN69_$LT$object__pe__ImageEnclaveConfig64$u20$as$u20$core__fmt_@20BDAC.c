int __fastcall <object::pe::ImageEnclaveConfig64 as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[15] = &off_2E04B8;
  v3[13] = &off_2E04B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A973F, 20, &off_2E1328, 13, v3, 13);
}
