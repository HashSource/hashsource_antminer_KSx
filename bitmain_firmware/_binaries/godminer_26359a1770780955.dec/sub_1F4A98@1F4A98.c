void __fastcall sub_1F4A98(int **a1, int a2, int a3, int a4)
{
  int v8; // r3
  int v9; // r5
  ...
  sub_1F0EB4((int *)&attr.__flags, a2, a3, v8, a4);
...
LABEL_84:
      ...
      if ( i == 8 )
      {
        ...
        if ( v109 != 1480937294 )
        {
          ...
          *(_DWORD *)&attr.__flags = 0;
          file_actions.__used = (int)sub_1AFDF8;
