int __fastcall get_chain_mps_voltage(int a1, _WORD *a2)
{
  ...
  *a2 = -1;
  result = sub_10FFAC(a1, 0);
  if ( !result )
    goto LABEL_3;
  src = 8562;
  v13 = 2;
  result = sub_10FBC8(a1, 60, &src, 3u, &v10, 2u);
  if ( result
    || (v6 = v10, v7 = v11, (result = sub_10FFAC(a1, 2)) == 0)
    || (v13 = 2, src = 3442, (result = sub_10FBC8(a1, 60, &src, 3u, &v10, 2u)) != 0) )
  {
LABEL_3:
    V_LOCK(result);
