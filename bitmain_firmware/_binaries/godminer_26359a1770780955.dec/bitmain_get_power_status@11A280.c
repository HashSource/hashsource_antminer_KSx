int bitmain_get_power_status()
{
  ...
  if ( (unsigned int)(dword_306CA8 - 193) > 1 )
  {
    ...
    if ( dword_306CA0 == 255 )
    {
      if ( sub_119144((unsigned __int8 *)&v9, 6u, (unsigned __int8 *)v11, 8u) )
      {
    ...
    else if ( sub_1192E4(dword_306CA0, (unsigned __int8 *)&v9, 6u, (unsigned __int8 *)v11, 8u) )
    {
      strcpy(s, "get power status failed");
      V_LOCK(*(_DWORD *)" failed");
  ...
  if ( dword_306CA0 == 255 )
  {
    if ( !sub_119144((unsigned __int8 *)&v9, 6u, (unsigned __int8 *)v11, 0xEu) )
    {
LABEL_5:
      v0 = HIDWORD(v11[0]);
  ...
  {
    if ( !sub_1192E4(dword_306CA0, (unsigned __int8 *)&v9, 6u, (unsigned __int8 *)v11, 0xEu) )
      goto LABEL_5;
    strcpy(s, "get power status failed\n");
    V_LOCK(*(_DWORD *)" failed\n");
