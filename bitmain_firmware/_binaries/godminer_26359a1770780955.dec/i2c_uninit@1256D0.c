int __fastcall i2c_uninit(int a1)
{
  ...
  v11 = a1;
  ptr = 0;
  if ( pthread_mutex_lock(&stru_307744) )
  {
    ...
    return zlog(
             ...
             "e/build/godminer-origin_godminer-kas_2382/backend/device/hal/platform/cv183x/cv183x_i2c.c",
             196,
             "i2c_uninit",
             10,
             102,
  ...
  {
    if ( find_c_map((_DWORD *)dword_307760, (int)&v11, (int)&ptr) == 1 )
    {
      v5 = (char *)ptr;
      remove_c_map((_DWORD *)dword_307760);
      v6 = new_iterator_c_map(dword_307760);
      if ( ((int (*)(void))*v6)() )
      {
        v7 = v5 + 12;
        while ( 1 )
...
LABEL_13:
    ...
    if ( ptr )
      free(ptr);
    return pthread_mutex_unlock(&stru_307744);
  }
}
