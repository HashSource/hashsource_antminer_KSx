_QWORD *__fastcall update_hashrate(int a1, int a2, _QWORD *a3)
{
  ...
  *(_QWORD *)(a2 + 64) = v8;
  if ( v7 <= 16 )
  {
    ...
    v12 = sub_26C7E8(v10, HIDWORD(v10)) / 1000.0;
    if ( v12 >= 5.0 )
    {
      v32 = *(_QWORD *)(a1 + 448);
      ...
      else
      {
        ...
        v44 = vshld_u64(1u, v3);
        v45 = COERCE_FLOAT(((int (__fastcall *)(_DWORD, _DWORD))sub_26C664)(v44, HIDWORD(v44)));
        v34 = sub_26C664(v35, HIDWORD(v35));
      ...
      *((_DWORD *)v38 + 720) = (v40 + 1) % 720;
      v42 = v36 + (float)(sub_26C664(v41, HIDWORD(v41)) * *(float *)(a2 + 48));
      *(float *)(a2 + 48) = v42 / sub_26C664(v47, HIDWORD(v47));
      *((_QWORD *)v39 + 1) = v47;
    }
    sub_BB3F8((int)v11);
    *(float *)(a2 + 36) = 5.0;
    ...
    *(_QWORD *)(a2 + 88) = v14;
    ...
    if ( (float)(sub_26C7E8(v19, HIDWORD(v19)) / 1000.0) >= 900.0 )
    {
      sub_BB3F8((int)v11);
      v21 = *(_DWORD *)(a2 + 208);
      if ( v21 > 23 )
