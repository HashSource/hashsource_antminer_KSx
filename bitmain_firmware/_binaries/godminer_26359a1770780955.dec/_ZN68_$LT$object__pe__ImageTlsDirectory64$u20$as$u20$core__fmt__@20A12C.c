int __fastcall <object::pe::ImageTlsDirectory64 as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[11] = &off_2E0638;
  v3[9] = &off_2E0638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aImagetlsdirect, 19, &off_2E0F50, 6, v3, 6);
}
