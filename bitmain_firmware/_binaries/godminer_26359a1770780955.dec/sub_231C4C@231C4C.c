int __fastcall sub_231C4C(_DWORD *a1, _DWORD *a2, char a3)
{
  _DWORD *v4; // r10
  int *v5; // r12
  int v7; // r11
  ...
  if ( v4[5] )
    core::panicking::panic((int)aAssertionFaile_2, 47, (int)&off_2E3074);
  v15 = a1 + 0x4000;
  v4[4] = 0;
  v16 = a1[16387];
  v4[5] = 0;
...
LABEL_130:
    core::panicking::panic_bounds_check(v17, 0x10000, (int)&off_2E2FF4);
  }
  v17 = a1[16385];
  if ( v17 >= 0x10000 )
    goto LABEL_130;
...
LABEL_129:
    core::panicking::panic_bounds_check((int)v24, (int)v5, (int)&off_2E2DC4);
  }
LABEL_32:
  v87 = (int)a1;
...
LABEL_37:
  ...
  if ( !v11 )
  {
    v33 = sub_230570(v4[14], &v89, v87, (v15[2] < 0x30u) | ((*v4 & 0x40000u) >> 18));
    if ( v33 == 2 )
      return 1;
    v31 = n;
    v15 = v88;
...
LABEL_69:
    ...
    v92 = v25;
    n = v18;
    if ( (unsigned __int8)sub_230570(v52, &v89, v87, 1) != 2 )
      goto LABEL_72;
    return 1;
  }
LABEL_44:
...
LABEL_50:
    if ( v18 >= (unsigned int)v90 )
      core::panicking::panic_bounds_check(v18, (int)v90, (int)&off_2E2DC4);
    *(_BYTE *)(v89 + v18++) = v25;
    v25 >>= 8;
    n = v18;
    v92 = v25;
...
LABEL_97:
      ...
      *(_BYTE *)(v70 + v68 + 1) = v71;
      ...
      {
LABEL_126:
        core::panicking::panic_bounds_check((int)v29, (int)v27, (int)&off_2E2DC4);
      }
      *(_BYTE *)(v72 + v68 + 3) = -1;
      v56 = 0;
      v92 = 0;
