void *__fastcall runtime_ctrl_ltc_1489(int a1)
{
  ...
  LODWORD(s[11]) = sub_F5DA0;
  HIDWORD(s[11]) = sub_F5C88;
  LODWORD(s[12]) = sub_F3F98;
  HIDWORD(s[12]) = sub_F3A28;
  LODWORD(s[13]) = sub_F3A30;
  HIDWORD(s[13]) = sub_F59BC;
  LODWORD(s[14]) = sub_F4D78;
  HIDWORD(s[14]) = sub_F55DC;
  LODWORD(s[15]) = sub_F55B4;
