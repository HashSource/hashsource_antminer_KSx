int __fastcall sub_230570(int a1, int *a2, int a3, int a4)
{
  int v4; // r4
  int v6; // r11
  int v7; // r1
  ...
  if ( a4 )
  {
    ...
    *(_DWORD *)(v6 + 3772) = 84215045;
    sub_22F870(v6, 0, 0x120u, 0xFu, 1u);
    sub_22F870(v6, 1, 0x20u, 0xFu, 1u);
    v7 = a2[4];
    v8 = v7 + 2;
    v9 = a2[3] | (1 << (v7 & 0x1F));
    a2[3] = v9;
...
LABEL_7:
  ...
  v83 = 0;
  *(_WORD *)(a1 + 512) = 1;
  sub_22F870(a1, 0, 0x120u, 0xFu, 0);
  sub_22F870(v6, 1, 0x20u, 0xFu, 0);
  v84 = 0;
  if ( !*(_BYTE *)(v6 + 3741) )
  {
    v84 = 1;
...
LABEL_260:
  v138 = *a2;
  v139 = (char *)&unk_2B0D32;
  a2[4] = v8;
  v140 = (char *)&unk_2B0D32 + v135;
  do
  {
...
LABEL_307:
        ...
        v50 = word_2B0D70[v49];
        if ( v50 >= 0x120 )
          core::panicking::panic_bounds_check(word_2B0D70[v49], 288, (int)&off_2E3024);
        v51 = byte_2B0FB4[v49];
        if ( v51 >= 0x11 )
        {
          v153 = byte_2B0FB4[v49];
          v154 = &off_2E3034;
          goto LABEL_311;
        }
        v158 = *(unsigned __int8 *)(a3 + v16 + 2);
        v161 = *(unsigned __int8 *)(a3 + v21) | (v158 << 8);
        v52 = dword_2B0F70[v51] & v49;
        v53 = v8 & 0x3F;
        ...
        if ( v161 >= 0x200 )
        {
          ...
          v61 = (unsigned __int8 *)&unk_2B1534 + v158;
          v63 = (char *)&unk_2B14B4 + v158;
        }
        else
        {
          v61 = (unsigned __int8 *)&unk_2B12B4 + v161;
          v62 = v173;
          v63 = (char *)&unk_2B10B4 + v161;
        }
        v64 = *v61;
        if ( v64 >= 0x11 )
        {
