...
LABEL_142:
  ...
  {
    core::panicking::panic((int)aAssertionFaile_35, 54, (int)&off_2E3CD4);
  }
  v8 = v4 - v5;
  v9 = v4 >= __PAIR64__(v6, v5);
  v10 = (v4 - __PAIR64__(v6, v5)) >> 32;
  if ( !v9 )
    core::panicking::panic((int)aAssertionFaile_36, 55, (int)&off_2E3CE4);
  if ( a4 < 0x11 )
  {
...
LABEL_138:
    v134[2] = 0;
    sub_7DAE8((int)&v132, (int)&v129, v134);
  }
  v30 = (int)&elf_hash_chain[20 * (__int16)(-96 - v120) + 1138] / 2126;
  if ( v30 >= 0x51 )
    core::panicking::panic_bounds_check(v30, 81, (int)&off_2E3C94);
  v31 = v22 << v24;
  ...
  while ( 1 )
  {
    v70 = sub_26CE70(v43, v59);
    if ( a4 == v69 )
      core::panicking::panic_bounds_check(a4, a4, (int)&off_2E3D24);
    v43 -= v70 * v59;
    v71 = v70 + 48;
    *(_BYTE *)(a3 + v69) = v70 + 48;
    v72 = v43 >> v121;
...
LABEL_120:
    ...
    v59 /= 0xAu;
    if ( !v9 )
      core::panicking::panic((int)aAttemptToDivid, 25, (int)&off_2E3D14);
  }
  result = v69 + 1;
  ...
  {
    if ( v118 == result )
      core::panicking::panic_bounds_check(v118, a4, (int)&off_2E3D44);
    v85 = v83;
    v86 = v64;
    LODWORD(v64) = 10 * v64;
    HIDWORD(v64) *= 5;
