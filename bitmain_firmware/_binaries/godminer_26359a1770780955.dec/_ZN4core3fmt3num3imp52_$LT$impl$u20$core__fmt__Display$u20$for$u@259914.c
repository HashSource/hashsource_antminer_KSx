...
LABEL_10:
    ...
    *(_WORD *)&v15[v4] = word_2B3EB7[(unsigned __int16)(v9 - 100 * v12)];
    if ( v12 >= 0xA )
      goto LABEL_8;
LABEL_11:
    v13 = v4 - 1;
  ...
  do
  {
    ...
    *(_WORD *)(v7 + 35) = word_2B3EB7[v11];
    *(_WORD *)(v7 + 37) = word_2B3EB7[(unsigned __int16)(v10 - 100 * v11)];
  }
  while ( v8 );
  v3 = a2;
  v4 = v6 + 39;
...
LABEL_8:
  v13 = v4 - 2;
  *(_WORD *)&v15[v4 - 2] = word_2B3EB7[v12];
  return core::fmt::Formatter::pad_integral(v3, v2 >= 0, aLibraryCoreSrc, 0, (int)&v15[v13], 39 - v13);
}
