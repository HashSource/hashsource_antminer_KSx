...
LABEL_50:
    ...
    while ( 1 )
    {
      v16 = getopt_long(argc, argv, "a:c:hp:Po:u:v:F", &off_270638, 0);
      if ( v16 < 0 )
        break;
    ...
    if ( !v11 )
    {
      ...
      *(_DWORD *)s = 0;
      ...
      if ( v11 )
        return v11;
      signal(2, (__sighandler_t)sub_87D64);
      signal(3, (__sighandler_t)sub_87D64);
      signal(15, (__sighandler_t)sub_87D64);
      signal(11, (__sighandler_t)sub_87D64);
      signal(10, (__sighandler_t)sub_87D64);
