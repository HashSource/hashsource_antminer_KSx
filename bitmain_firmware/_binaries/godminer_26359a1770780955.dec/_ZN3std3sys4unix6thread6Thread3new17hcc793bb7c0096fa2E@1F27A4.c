int __fastcall std::sys::unix::thread::Thread::new(_DWORD *a1, size_t a2, int a3, int a4)
{
  ...
  *v8 = a3;
  ...
  if ( off_2E7F60 )
  {
    ...
    v11 = (int (__fastcall *)(pthread_attr_t *))sub_7BA60();
    if ( v11 )
LABEL_6:
      v10 = v11(&s);
  }
LABEL_7:
  ...
  if ( v12 )
  {
    ...
    {
      v22 = 0;
      sub_797AC(0, (int)&v19, (int)&unk_2A49D4, v21, (int)&off_2DFAD8);
    }
    v13 = sysconf(30);
  ...
  v14 = pthread_create(&newthread, &s, (void *(*)(void *))sub_1F2A3C, v9);
...
LABEL_25:
    v22 = 0;
LABEL_26:
    sub_797AC(0, (int)&v20, (int)"", v21, (int)v16);
  }
  if ( v14 )
  {
