int __fastcall sub_906A8(int a1, int a2, char *a3, const char **a4, int *a5, char a6)
{
  char v6; // r7
  int v9; // r0
  int v10; // r3
  ...
  while ( 1 )
  {
    ...
    *v12 = 0;
    if ( v14 >= a1 )
    {
      ...
      {
        sub_903CC(dword_2E5B30, dword_2E5B2C, v14, a2);
        optind -= v33 - v34;
      }
      goto LABEL_57;
    }
...
LABEL_69:
    ...
    if ( dword_2E5B2C != -1 )
    {
      sub_903CC(v31, dword_2E5B2C, v40, a2);
      optind -= v39 - v31;
    }
LABEL_57:
    dword_2E5B2C = -1;
