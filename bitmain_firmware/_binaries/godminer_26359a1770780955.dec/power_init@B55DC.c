...
LABEL_12:
  ...
  if ( opt_custom_voltage_swith || (v17 = is_eeprom_loaded(v17)) != 0 )
    dword_2E95DC = opt_custom_voltage;
  byte_2E95D4 = platform_is_adjustable_power(v17);
  byte_2E95E0 = platform_is_check_asic_voltage_enable();
  dword_2E95E4 = platfrom_get_check_asic_voltage();
  V_LOCK(dword_2E95E4);
...
LABEL_28:
  ...
  {
    v33 = usleep((__useconds_t)"archer15prefilter_state17ha8a356c4ac1bebf2E");
    if ( v101 > 0 )
    {
      for ( j = 0; j < v101; ++j )
      {
        ...
        v92 = usleep((__useconds_t)".Display$GT$3fmt17h78ae595610e5e5acE");
        v93 = dev_ctrl(v92);
        (*(void (__fastcall **)(int))(v93 + 36))(j);
        v94 = sleep(1u);
        v95 = dev_ctrl(v94);
        (*(void (__fastcall **)(int))(v95 + 40))(j);
        v96 = usleep((__useconds_t)".Display$GT$3fmt17h78ae595610e5e5acE");
        v97 = dev_ctrl(v96);
  ...
  while ( 2 )
  {
    ...
    if ( v37 )
    {
      ...
      if ( device_num > 0 )
      {
        ...
        do
        {
          ...
          device_num = zlog(
                         ...
                         "t/tmp/release/build/godminer-origin_godminer-kas_2382/miner_util/power_api.c",
                         171,
      ...
      v48 = zlog(
              ...
              "se/build/godminer-origin_godminer-kas_2382/miner_util/power_api.c",
              171,
              "get_minimal_feedback_voltage",
              28,
              74,
