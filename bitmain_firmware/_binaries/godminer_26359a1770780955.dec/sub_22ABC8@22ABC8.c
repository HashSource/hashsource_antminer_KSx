int __fastcall sub_22ABC8(_DWORD *a1)
{
  int v2; // r0
  unsigned int v3; // r8
  unsigned int v4; // r3
    ...
    if ( v19 )
    {
      if ( v5 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v24 || !<str as core::fmt::Display>::fmt(asc_2B0B2B, 2, v21) )
          {
            ++a1[5];
            if ( !sub_22A6D0((int)a1, v23, 1u, 0) )
              continue;
          }
          return 1;
        }
        ...
        if ( v26 )
        {
          if ( <str as core::fmt::Display>::fmt(asc_2B0B2D, 2, v26) )
            return 1;
        }
      }
      result = sub_22C4E4(a1);
      a1[5] -= v5;
    }
    else
    {
      return sub_22C4E4(a1);
    }
  }
  else
  {
