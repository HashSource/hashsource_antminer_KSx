int __fastcall uart_send(void *a1, int a2, unsigned int a3)
{
  int v6; // r0
  int v7; // r9
  unsigned int v8; // r4
  ...
  mutex = (pthread_mutex_t *)((char *)&unk_3077CC + 24 * (_DWORD)a1);
      ...
      do
      {
        ...
        if ( v12 < 0 )
        {
          ...
          zlog(
            ...
            "/build/godminer-origin_godminer-kas_2382/backend/device/hal/platform/cv183x/cv183x_uart.c",
            197,
            "uart_send",
            9,
            191,
