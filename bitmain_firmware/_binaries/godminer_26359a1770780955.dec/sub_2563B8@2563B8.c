...
void __fastcall sub_2563B8(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  _DWORD *v8; // r4
  _DWORD *v9; // r5
  ...
  if ( v11 )
  {
    if ( !v13 )
    {
      ...
      if ( v11 != 1
        || !v14
        || (v12[6] & 4) != 0
        || !(*(int (__fastcall **)(_DWORD, const char *, int))(v12[1] + 12))(*v12, asc_2B3DEF, 1) )
      {
        (*(void (__fastcall **)(_DWORD, const char *, int))(v9[1] + 12))(*v9, asc_2B38F9, 1);
      }
    }
  }
