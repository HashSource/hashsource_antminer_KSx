int __fastcall sub_22C4E4(int *a1)
{
  int v1; // r6
  int v2; // r1
  unsigned int v4; // r2
...
LABEL_34:
      ...
      {
        v13 = a1[4];
        if ( !v13 || (v9 = 1, !<str as core::fmt::Display>::fmt(&unk_2B0B09, 16, v13)) )
        {
          v9 = 0;
          *((_BYTE *)a1 + 4) = 0;
          *a1 = 0;
...
LABEL_41:
        ...
        {
LABEL_42:
          if ( v10 && <str as core::fmt::Display>::fmt(asc_2B0B58, 2, v10) )
            return 1;
          goto LABEL_45;
        }
        v29 = v10;
...
LABEL_71:
          ...
          if ( <str as core::fmt::Display>::fmt(asc_2B0A2B, 1, v29) )
            return 1;
          v29 = 0;
          if ( v10 )
          {
...
LABEL_72:
    ...
    else
    {
      ...
      if ( v19 )
LABEL_85:
        core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2E2C64);
      v11 = v1;
      v12 = v35;
      if ( !v10 )
        goto LABEL_41;
...
LABEL_45:
  ...
  if ( *a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v25 && <str as core::fmt::Display>::fmt(asc_2B0B2B, 2, v23) || sub_22BED4(a1) )
        return 1;
      v21 = *a1;
      --v22;
      if ( !*a1 )
...
LABEL_57:
  ...
  v9 = 1;
  if ( <str as core::fmt::Display>::fmt(asc_2B0963, 1, v26) )
    return v9;
  v21 = *a1;
  if ( *a1 )
  {
...
LABEL_66:
  ...
  {
    v9 = 1;
    if ( <str as core::fmt::Display>::fmt(asc_2B0942, 4, v28) )
      return v9;
  }
  return sub_22BED4(a1);
}
