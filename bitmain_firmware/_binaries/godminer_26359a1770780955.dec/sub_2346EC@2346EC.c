int __fastcall sub_2346EC(int a1, int a2)
{
  int *v2; // r0
  int v3; // r4
  unsigned int v4; // t1
  ...
  if ( v4 > 2 )
LABEL_43:
    core::panicking::panic_bounds_check(v3, 3, (int)&off_2E3234);
  v44 = v2;
  while ( 2 )
  {
    ...
    if ( v5 )
    {
      ...
      do
      {
        v9 = *v7;
        if ( v9 > 0xF )
          core::panicking::panic_bounds_check(v9, 16, (int)&off_2E3254);
        --v8;
        ++v7;
        ++s[v9];
      }
    ...
    do
    {
      ...
      {
        if ( v18 == v20 )
          core::panicking::panic_bounds_check(v20, 288, (int)&off_2E3264);
        v21 = v18;
        v22 = &v6[v18++];
        v23 = v22[3200];
        if ( !v23 )
          goto LABEL_17;
        if ( v23 >= 0x11 )
          core::panicking::panic_bounds_check(v23, 17, (int)&off_2E3274);
        v24 = v54[v23];
        v25 = 0;
        v54[v23] = v24 + 1;
        v26 = 0;
...
LABEL_30:
      for ( i = 11; i < v23; ++i )
      {
        v36 = ((v34 >> 1) & 1) + ~v31;
        if ( v36 >> 6 > 8u )
          core::panicking::panic_bounds_check((__int16)v36, 576, (int)&off_2E3284);
...
LABEL_38:
      v40 = ((v34 >> 1) & 1) + ~v31;
      if ( v40 >= 0x240u )
        core::panicking::panic_bounds_check((__int16)v40, 576, (int)&off_2E3294);
