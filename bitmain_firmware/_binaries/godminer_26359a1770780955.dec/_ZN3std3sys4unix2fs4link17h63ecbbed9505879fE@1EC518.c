void __fastcall std::sys::unix::fs::link(int a1, const void *a2, unsigned int a3, const void *a4, size_t n)
{
  int v8; // r7
  int v9; // r0
  ...
  else
  {
    ...
    {
LABEL_5:
      *(_DWORD *)a1 = dword_2DF158;
      *(_DWORD *)(a1 + 4) = &off_2DF14C;
      return;
    }
    v8 = v12;
    if ( n >> 7 > 2 )
    {
      sub_7B550(a1, (int)a4, n, v12);
    }
    else
    {
      memcpy(v13, a4, n);
