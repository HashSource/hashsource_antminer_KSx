...
LABEL_25:
      if ( signal(13, (__sighandler_t)v9) == (__sighandler_t)-1 )
      {
        ...
        fds.sa_mask.__val[1] = (unsigned int)&off_2DFC30;
        fds.sa_mask.__val[4] = 0;
        fds.sa_mask.__val[3] = (unsigned int)aRustc9eb3afe9e;
        fds.sa_handler = 0;
        sub_1D6804(stacksize, stackaddr, v35);
        sub_1AF1E0((int)stacksize);
        goto LABEL_46;
      }
LABEL_26:
      v10 = &fds;
      ...
      if ( !fds.sa_handler )
      {
        ...
        fds.sa_handler = (__sighandler_t)sub_1F2044;
        sigaction(11, &fds, 0);
        byte_307C7C = 1;
      }
      sigaction(7, 0, &fds);
...
LABEL_49:
        v36 = 0;
        sub_797AC(0, (int)&p_fds, (int)"", v35, (int)v25);
      }
      sub_26CC14(v10, v12);
      if ( v16 )
...
LABEL_37:
      ...
      if ( v29 )
      {
        ...
        stackaddr[0] = &fds;
        fds.sa_mask.__val[1] = (unsigned int)&off_2DE708;
        fds.sa_handler = 0;
        stacksize[1] = (size_t)sub_1BD02C;
        stacksize[0] = (size_t)&p_p_fds;
        sub_1D6804(v31, stackaddr, v35);
        v24 = v31[0];
        if ( v31[0] != 4 )
          sub_1AE47C((int)v31);
LABEL_46:
