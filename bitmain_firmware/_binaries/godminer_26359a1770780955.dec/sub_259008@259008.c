int __fastcall sub_259008(unsigned int *a1, _DWORD *a2)
{
  int v2; // r2
  unsigned int v3; // r3
  int v4; // r12
    ...
    if ( (v2 & 0x20) == 0 )
    {
      ...
      else
      {
        ...
        do
        {
          ...
          *(_WORD *)(v6 + 35) = word_2B3EB7[v10];
          *(_WORD *)(v6 + 37) = word_2B3EB7[(unsigned __int16)(v9 - 100 * v10)];
        }
        while ( v7 );
        v4 = v5 + 39;
        if ( v8 <= 0x63 )
...
LABEL_8:
            v12 = v4 - 2;
            *(_WORD *)&v19[v4 - 2] = word_2B3EB7[v11];
...
LABEL_22:
      ...
      *(_WORD *)&v19[v4] = word_2B3EB7[(unsigned __int16)(v8 - 100 * v11)];
      if ( v11 >= 0xA )
        goto LABEL_8;
      goto LABEL_22;
    }
