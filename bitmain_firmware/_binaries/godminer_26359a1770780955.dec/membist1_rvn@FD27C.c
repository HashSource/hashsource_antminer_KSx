int __fastcall membist1_rvn(int a1)
{
  ...
  do
  {
    sub_F96F0(a1, v23, 28, 1);
    usleep(0xC350u);
    sub_F96F0(a1, v23, 160, -2147483647);
    usleep((__useconds_t)&elf_hash_chain[4398]);
    memset(s, 0, 0x300u);
    v3 = sub_F9A68(a1, (unsigned __int16)v23, 161, s);
    v4 = v3;
    if ( v3 == 1
      || (V_LOCK(v3),
          V_INT((int)v26, "chain"),
...
LABEL_10:
    memset(s, 0, 0x300u);
    v9 = sub_F9A68(a1, (unsigned __int16)v23, 162, s);
    v10 = v9;
    if ( v9 == 1
      || (V_LOCK(v9),
          V_INT((int)v29, "chain"),
...
LABEL_18:
  ...
  v18 = dev_ctrl(v17);
  (*(void (__fastcall **)(_DWORD))(v18 + 80))(*(_DWORD *)(a1 + 244));
  dword_306B0C = v24;
  return 0;
}
