int __fastcall <object::pe::ImageSeparateDebugHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2E0110;
  v3[1] = &off_2E0110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A991B, 24, &off_2E1458, 13, v3, 13);
}
