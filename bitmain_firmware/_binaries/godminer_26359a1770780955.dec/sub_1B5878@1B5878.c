unsigned int __fastcall sub_1B5878(int *a1, int *a2, _BYTE *a3)
{
  unsigned int v3; // r5
  int (*v4)(); // r8
  int v5; // r9
...
LABEL_31:
      ...
      v58 = v38;
      v59 = 1;
      core::panicking::panic_fmt((int)&v54, (int)&off_2DE428);
    }
    v23 = *(_DWORD *)(v19 + 276);
