int __fastcall backend_init_base(int a1)
{
  ...
  v2 = dev_ctrl(a1);
  v3 = (*(int (__fastcall **)(_DWORD))(v2 + 48))(*(_DWORD *)(a1 + 244));
  *(_DWORD *)(a1 + 248) = v3;
  v4 = dev_ctrl(v3);
  v5 = (*(int (__fastcall **)(_DWORD))(v4 + 44))(*(_DWORD *)(a1 + 244));
  v6 = dev_ctrl(v5);
  (*(void (__fastcall **)(_DWORD))(v6 + 4))(*(_DWORD *)(a1 + 244));
  *(_DWORD *)(a1 + 856) = queue_new(1, 0);
  *(_DWORD *)(a1 + 860) = queue_new(*(_DWORD *)(a1 + 832), 0);
  *(_DWORD *)(a1 + 864) = queue_new(1, 0);
  *(_DWORD *)(a1 + 852) = queue_new(*(_DWORD *)(a1 + 828), 0);
  ...
  pthread_mutex_init((pthread_mutex_t *)(a1 + 936), 0);
  v7 = *(_DWORD *)(a1 + 332);
  ...
  *(_BYTE *)(a1 + 886) = 0;
  if ( v16 )
    v16(a1);
  pthread_create((pthread_t *)(a1 + 876), 0, (void *(*)(void *))get_response, (void *)a1);
  pthread_create((pthread_t *)(a1 + 872), 0, (void *(*)(void *))scanhash, (void *)a1);
  pthread_create((pthread_t *)(a1 + 880), 0, (void *(*)(void *))send_work, (void *)a1);
  *(_BYTE *)(a1 + 252) = 1;
  return 0;
}
