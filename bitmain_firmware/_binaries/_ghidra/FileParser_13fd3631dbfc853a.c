// Decompiled: FileParser_13fd3631dbfc853a
...

{
    ...
    __libc_start_main(FUN_000133e8, in_stack_00000000, &stack0x00000004,
                      0x137cd, &DAT_00013809, param_1);
...

{
    ...
    FUN_0001380c(param_1, auStack_c8);
    local_24 = local_98;
    if (local_98 < 0x800) {
                                ...
                                if (local_44 == 0) {
                                    ...
                                    if (local_48 == (FILE *)0x0) {
                                        ...
                                        if (param_5 != '\0') {
                                            ...
                                            fclose(local_4c);
                                            local_4c = fopen64(
                                                "/tmp/tmpfw/miner.pem.sig",
                                                "w");
                                            if (local_4c == (FILE *)0x0) {
                                                puts("Dump Miner.pem.sig "
                                                     "Failed!\r");
                                                return 0x10;
                                            }
                                        ...
                                        SHA256_Update(&SStack_960, param_4,
                                                      0x800);
                                        ...
                                        if (local_54 == (RSA *)0x0) {
                                            ...
                                            local_58 = RSA_verify(
                                                0x2a0, local_a80, 0x20,
                                                (uchar *)&local_a60, 0x100,
                                                local_54);
                                            if (local_54 != (RSA *)0x0) {
                                                RSA_free(local_54);
                                            }
...
undefined4 FUN_000133e8(int param_1, undefined4 *param_2)
...
void FUN_000137cc(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
...
void FUN_0001380c(char *param_1, stat64 *param_2)
