// Decompiled: configfs.ko_6bbe46966f033538_debug
...

{
  ...
  if ((DAT_00106daa >> 2 & 1) != 0) {
    __dynamic_pr_debug(&PTR_s_configfs_00106d88,"configfs: %s: count = %zd, ppos = %lld, buf = %s\n",
...

{
  ...
  if (param_2[1] == 0) {
    iVar2 = (*(code *)*param_2)(param_2,&DAT_00106418,1,0,*(undefined8 *)(*(long *)(lVar5 + 0x30) + 0x38),4);
    if (iVar2 != 0) {
      return 0;
    }
    param_2[1] = 1;
  ...
  iVar2 = (*pcVar7)(param_2,&DAT_00106420,2,1,uVar4,4);
  if (iVar2 != 0) {
    return 0;
  }
  param_2[1] = 2;
...

{
  ...
  lockref_get(param_1 + 0x58);
  if ((DAT_00106dd2 >> 2 & 1) != 0) {
    __dynamic_pr_debug(&PTR_s_configfs_00106db0,"configfs: configfs %s: dropping attrs for  dir\n",
...

{
  ...
  if (param_1 != 0) {
    ...
    *(int **)(piVar6 + 4) = piVar1;
    ...
    if ((DAT_00106dfa >> 2 & 1) != 0) {
      __dynamic_pr_debug(&PTR_s_configfs_00106dd8,"configfs:  o %pd removing done (%d)\n",param_1,
        ...
        if (lVar12 == 0) {
          ...
          if (*(long *)(param_1 + 0x10) == 0) {
            ...
            if (puVar6 != (undefined8 *)0x0) {
              ...
              iVar1 = iVar3 * 3 + iVar1;
              if (iVar1 + -1 < 0x1001) {
                if ((DAT_00106e22 >> 2 & 1) != 0) {
                  __dynamic_pr_debug(&PTR_s_configfs_00106e00,"configfs: %s: depth = %d, size = %d\n",
                ...
                if ((DAT_00106e4a >> 2 & 1) != 0) {
                  __dynamic_pr_debug(&PTR_s_configfs_00106e28,"configfs: %s: path = \'%s\'\n","configfs_get_target_path"
                                     ,puVar5);
                }
...

{
  ...
  *(undefined1 **)(param_1 + 0x30) = &DAT_00105200;
  lVar1 = configfs_new_inode(0x41ed,&DAT_00106c70,param_1);
  if (lVar1 == 0) {
    if ((DAT_00106e72 >> 2 & 1) != 0) {
      __dynamic_pr_debug(&PTR_s_configfs_00106e50,"configfs: could not get root inode\n");
    }
    return 0xfffffff4;
  }
  ...
  *(undefined1 **)(lVar1 + 0x178) = configfs_dir_operations;
  ...
  if (lVar1 == 0) {
    if ((DAT_00106e9a >> 2 & 1) == 0) {
      return 0xfffffff4;
    }
    __dynamic_pr_debug(&PTR_s_configfs_00106e78,"configfs: %s: could not get root dentry!\n","configfs_fill_super");
    uVar2 = 0xfffffff4;
  }
  else {
    config_group_init(&PTR_DAT_00106cc8);
    *(undefined1 **)(lVar1 + 0x90) = &DAT_00106c70;
...
{
  _mcount();
  return param_1 == &PTR_DAT_00106cc8;
}
...

{
  ...
  _mcount();
  iVar1 = simple_pin_fs(&PTR_s_configfs_00106d50,&DAT_00107208,&DAT_00107200);
  if (iVar1 == 0) {
    return *DAT_00107208;
  }
  return (long)iVar1;
...
{
  _mcount();
  config_item_set_name(param_1,&DAT_00106870,param_2);
...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    if (iVar4 + -1 == 0) {
      ...
      lVar3 = param_1[7];
      lVar9 = param_1[8];
      if ((DAT_00106ec2 >> 2 & 1) != 0) {
        __dynamic_pr_debug(&PTR_s_configfs_00106ea0,"config_item %s: cleaning up\n",*param_1);
      }
...

{
  ...
  if (configfs_dir_cachep == 0) {
    ...
    if (iVar1 == 0) {
      iVar1 = register_filesystem(&PTR_s_configfs_00106d50);
      if (iVar1 == 0) {
        return 0;
      }
      printk(&DAT_00106768);
...
{
  unregister_filesystem(&PTR_s_configfs_00106d50);
  sysfs_remove_mount_point(_kernel_kobj,"config");
  kmem_cache_destroy(configfs_dir_cachep);
  configfs_dir_cachep = 0;
  return;
