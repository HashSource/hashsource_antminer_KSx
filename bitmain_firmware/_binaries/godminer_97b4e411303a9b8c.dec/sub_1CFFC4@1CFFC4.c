ssize_t __fastcall sub_1CFFC4(int a1, int a2, struct iovec *iovec, unsigned int a4)
{
  struct iovec *v4; // r6
  unsigned int v5; // r10
  struct iovec *v6; // r11
...
LABEL_35:
  ...
  v14 = v5 - v10;
  if ( v5 - v10 > v5 )
    core::panicking::panic((int)aAssertionFaile, 35, (int)&off_2DFA00);
  v15 = a1;
  v16 = 0;
  if ( v5 != v10 )
  {
