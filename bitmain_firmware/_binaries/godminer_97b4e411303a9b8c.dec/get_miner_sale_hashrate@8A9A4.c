int get_miner_sale_hashrate()
{
  ...
  if ( v9[16] )
  {
    miner_6060info_status = *(_DWORD *)"J:6";
    strcpy((char *)search_failed_info, "J:6");
    freq_scan_status = 2;
  }
  v12 = v9;
  v13 = 0;
...
LABEL_24:
  ...
  v20 = v23;
  result = sub_26D748((int)v24[0], v23) * v20;
  if ( opt_algo == 6 )
  {
    result -= 50;
    if ( result > 3729 )
  ...
  if ( opt_algo == 7 )
  {
    result = sub_26D748(result, v20) * v20 - 50;
    if ( result > 3729 )
      return 3780;
LABEL_38:
    ...
    if ( (unsigned int)(result - 3130) <= 0x63 )
      return 3180;
    return sub_26D748(result, v20) * v20;
  }
  if ( opt_algo != 9 )
  {
    switch ( opt_algo )
    {
      ...
      case 2:
        if ( result > 172999 )
          return (int)&stru_2A3C4.st_value;
        if ( (unsigned int)(result - 166000) <= 0x1B57 )
          return (int)&stru_28864.st_info;
        break;
      case 5:
        if ( result > 1859 )
          return 1860;
