int __fastcall std::sys::unix::fs::readdir(int a1, void *src, signed int n)
{
  int v6; // r1
  int v7; // r0
  DIR *v8; // r6
  ...
  signed int v24; // [sp+1Ch] [bp-180h]
  int v25; // [sp+20h] [bp-17Ch]
  signed int v26; // [sp+24h] [bp-178h]
  _DWORD v27[3]; // [sp+190h] [bp-Ch] BYREF

  if ( (unsigned int)n >> 7 > 2 )
  {
    sub_7B6FC(&v19);
  ...
  else
  {
    ...
    *((_BYTE *)&dest + n) = 0;
    ...
    if ( v27[0] )
    {
      v6 = dword_2E0158;
      v20 = (DIR *)&off_2E014C;
      v7 = (unsigned __int8)dword_2E0158;
      v19 = dword_2E0158;
