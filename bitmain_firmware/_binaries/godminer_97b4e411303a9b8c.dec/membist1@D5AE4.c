int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_D1300(a1, v30, 12, 1);
    usleep((__useconds_t)"3c2aE");
    sub_D1300(a1, v30, 160, -2147483647);
    usleep(0xC3500u);
    memset(s, 0, 0x600u);
    v3 = sub_D1598(a1, (unsigned __int16)v30, 161, s);
    v4 = v3;
    if ( v3 == 8
      || (V_LOCK(v3),
          V_INT((int)&v32, "chain"),
...
LABEL_10:
    memset(s, 0, 0x600u);
    v9 = sub_D1598(a1, (unsigned __int16)v30, 162, s);
    v10 = v9;
    if ( v9 == 8
      || (V_LOCK(v9),
          V_INT((int)v35, "chain"),
...
LABEL_18:
  ...
  *(_QWORD *)v26 = 0;
  ...
  qword_2FB970 = v44;
  qword_2FB978 = v45;
  qword_2FB980 = *(_QWORD *)&v46;
  qword_2FB988 = *(_QWORD *)&v47;
  return 0;
}
