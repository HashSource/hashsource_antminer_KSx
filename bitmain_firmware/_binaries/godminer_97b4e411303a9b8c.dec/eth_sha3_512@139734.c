int __fastcall eth_sha3_512(int a1, unsigned int a2, int a3, unsigned int a4)
{
  ...
  {
    v8 = &v119;
    v4 = (const char *)&unk_29BCB7;
  }
  v113 = (const char *)&unk_29BC98;
  if ( a4 > 0x47 )
  {
    v114 = (const char *)&unk_29BCB7;
    v111 = &v119;
    while ( 1 )
    {
      v9 = s;
      ...
      *((_QWORD *)v12 + 4) = 0;
      while ( 1 )
      {
        ...
        v29 = 10;
        v30 = 1;
        v31 = (unsigned __int8 *)&unk_29BCB8;
        v32 = s[1];
        v33 = v114;
        while ( 1 )
        {
