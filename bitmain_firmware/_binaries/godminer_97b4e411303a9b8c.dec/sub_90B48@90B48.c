int __fastcall sub_90B48(int a1, int a2, char *a3, const char **a4, int *a5, char a6)
{
  char v6; // r7
  int v9; // r0
  int v10; // r3
  ...
  while ( 1 )
  {
    ...
    *v12 = 0;
    if ( v14 >= a1 )
    {
      ...
      {
        sub_9086C(dword_2E6B30, dword_2E6B2C, v14, a2);
        optind -= v33 - v34;
      }
      goto LABEL_57;
    }
...
LABEL_18:
      v21 = (char *)off_2E6B1C;
      v22 = *(unsigned __int8 *)off_2E6B1C;
      if ( *(_BYTE *)off_2E6B1C )
        goto LABEL_19;
    }
    else
...
LABEL_78:
      ...
      if ( v27 && v26 == 59 )
      {
        if ( !v42[1] )
        {
          ...
          off_2E6B1C = *(_UNKNOWN **)(a2 + 4 * v28);
        }
        v24 = sub_90934(a2, s, a4, a5, 0);
        goto LABEL_53;
      }
LABEL_69:
      if ( v26 != 58 )
    ...
    if ( dword_2E6B2C != -1 )
    {
      sub_9086C(v31, dword_2E6B2C, v40, a2);
      optind -= v39 - v31;
    }
LABEL_57:
    dword_2E6B2C = -1;
