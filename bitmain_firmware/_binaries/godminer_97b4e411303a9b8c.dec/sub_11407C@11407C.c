int __fastcall sub_11407C(unsigned int a1, int a2)
{
  int v4; // r7
  int v5; // r0
  int v6; // r0
  ...
  if ( v4 )
  {
    ...
    zlog(
      ...
      20,
      v18);
    if ( pthread_mutex_lock(&stru_30BBF0) )
    {
      v8 = -1;
    ...
    else
    {
      ...
      else if ( a2 == 2 )
      {
        ...
        {
          v8 = -1;
          if ( exists_c_map(dword_30BC08, &v16) )
          {
      ...
      pthread_mutex_unlock(&stru_30BBF0);
    }
  }
  else
  {
