int __fastcall <object::pe::AnonObjectHeaderBigobj as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[11] = &off_2E1D18;
  v3[9] = &off_2E1638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A970F, 22, &off_2E1D78, 13, v3, 13);
}
