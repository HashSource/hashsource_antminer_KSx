bool __fastcall sub_1F3718(size_t *a1, int a2, _BYTE *src, size_t n)
{
  int v5; // r1
  _BOOL4 v9; // r0
  int v10; // r4
...
LABEL_11:
  ...
  *(_DWORD *)(a2 + 8) = 0;
  ...
  if ( v12 >> 7 > 2 )
  {
    sub_7B538(&v32, (int)v11, v12, (int)fd);
...
LABEL_21:
    ...
    {
      sub_1EC04C((int)&v32, v39[1], v39[2], (int)fd);
      if ( (unsigned __int8)v32 != 4 )
        goto LABEL_21;
    }
  }
...
LABEL_23:
  ...
  if ( *(_DWORD *)a2 - v28 < v27 )
    sub_798B0((size_t *)a2, v28, v27);
  sub_1D6C44((int *)&dest, fd[0], (size_t *)a2);
  if ( (unsigned __int8)dest == 4 )
  {
    close(fd[0]);
    v29 = sub_1B021C(*(char **)(a2 + 4), *(_DWORD *)(a2 + 8));
