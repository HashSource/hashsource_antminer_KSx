int __fastcall sub_BD808(_DWORD *a1)
{
  signed int *v1; // r0
  signed int v2; // r4
  int v3; // r0
  ...
  else
  {
    ...
    if ( v4 && *v4 == 2 )
    {
      ...
      if ( v7 && *v7 == 1 )
      {
        ...
        dword_30D624 = (int)v9;
        dword_30D63C = (int)calloc((size_t)v9, 2u);
        if ( (int)v9 > 0 )
        {
          do
          {
          ...
          if ( v17 && (unsigned int)(*v17 - 5) <= 1 )
          {
            ...
            if ( v20 && *v20 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v41);
              dword_30D62C = json_integer_value(v21);
              ...
              if ( v23 && *v23 == 3 )
              {
                ...
                zlog(
                  ...
                  20,
                  v41);
                dword_30D630 = json_integer_value(v24);
                ...
                if ( v26 && *v26 == 3 )
                {
                  ...
                  zlog(
                    ...
                    20,
                    v41);
                  dword_30D634 = json_integer_value(v27);
                  return 0;
                }
                V_LOCK(v26);
