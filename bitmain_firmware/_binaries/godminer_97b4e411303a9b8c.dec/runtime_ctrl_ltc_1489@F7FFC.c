void *__fastcall runtime_ctrl_ltc_1489(int a1)
{
  ...
  LODWORD(s[11]) = sub_F6598;
  HIDWORD(s[11]) = sub_F6480;
  LODWORD(s[12]) = sub_F4790;
  HIDWORD(s[12]) = sub_F4220;
  LODWORD(s[13]) = sub_F4228;
  HIDWORD(s[13]) = sub_F61B4;
  LODWORD(s[14]) = sub_F5570;
  HIDWORD(s[14]) = sub_F5DD4;
  LODWORD(s[15]) = sub_F5DAC;
