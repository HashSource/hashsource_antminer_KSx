...
void __fastcall sub_1D0C3C(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10)
{
  int v10; // r0
  ...
  v10 = core::fmt::builders::DebugTuple::field(v11, &v12, &off_2DFA3C);
