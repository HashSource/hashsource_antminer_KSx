unsigned int __fastcall core::num::bignum::tests::Big8x3::div_rem(unsigned int *a1, int a2, int a3, int a4)
{
  ...
  if ( !*(_BYTE *)(a2 + 4) )
  {
    ...
    if ( !*(_BYTE *)(a2 + 5) )
    {
      ...
      if ( v10 )
LABEL_50:
        core::panicking::panic((int)aAssertionFaile_52, 30, (int)&off_2E5618);
    }
  }
  *(_DWORD *)a4 = v5;
  result = *a1;
  ...
  if ( result )
  {
    ...
    if ( result != -1 )
    {
      ...
      do
      {
        ...
        result = --v18 >> 3;
        if ( v42 >= 0x18 )
          core::panicking::panic_bounds_check(result, 3, (int)&off_2E5618);
        v21 = *(_DWORD *)a2;
        v22 = v18 & 7;
        ...
        *(_BYTE *)(a4 + 4) |= (*((unsigned __int8 *)a1 + result + 4) >> v22) & 1;
        ...
        if ( v21 )
        {
          ...
          v8 = v28;
          if ( !v29 )
            core::panicking::panic((int)aAssertionFaile_49, 26, (int)&off_2E5618);
        }
        *(_DWORD *)a4 = v21;
        v19 = v41;
        if ( (v41 & 1) != 0 )
