    ...
    else
    {
      ...
      *a7 = v16;
      if ( v16 != -1 )
      {
        ...
        *(_BYTE *)(a3 + 16) = v13;
        *(_BYTE *)(a3 + 17) = v21;
        v22 = sub_26D980(*(unsigned __int8 *)(a2 + 6), *(_DWORD *)(a1 + 428));
        if ( v22 >= *(_DWORD *)(a1 + 332) )
        {
          v41 = rand();
          sub_26D674(v41, *(_DWORD *)(a1 + 332));
          v22 = v42;
        }
        *a6 = v22;
        *(_DWORD *)(a3 + 8) = v22;
        ...
        if ( *((_DWORD *)v25 + 5) == 999 )
        {
          ...
          *((_DWORD *)v25 + 5) = 0;
          ...
          else
          {
            ...
            v36 = 8 * v24;
            v37 = *(_QWORD *)&byte_303A78[8 * v24 + 88];
            if ( v37 >= v35 || v35 - v37 > 0x63 )
              goto LABEL_28;
            for ( i = 0; i < v29; ++i )
            {
              v39 = *v50;
              v40 = qword_303B50[256 * v24 + i];
              ++v50;
...
LABEL_28:
              v43 = (__int64 *)s;
              v44 = (char *)&qword_303B50[256 * v24 - 1];
              v45 = 0;
              do
              {
                ++v45;
  ...
  v26 = &byte_303A78[4 * *(_DWORD *)(a1 + 248)];
  v27 = *((_DWORD *)v26 + 2);
  *((_DWORD *)v26 + 2) = v27 + 1;
  if ( v27 <= 9 )
  {
