int __fastcall sub_843DC(int a1, const char **a2)
{
  int v3; // r7
  ...
  else
  {
    ...
    v24 = sub_26D41C(LODWORD(v12), HIDWORD(v12));
    ...
    if ( v26 )
    {
      v126 = sub_26D41C(COERCE_UNSIGNED_INT64(v19 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v19 * v12 * 100.0)));
      v127 = sub_26D560(v126, HIDWORD(v126));
      v128 = json_real(LODWORD(v127));
      v33 = v23;
      json_object_set_new(v23, "rate_5s", v128);
      v129 = sub_26D41C(COERCE_UNSIGNED_INT64(v22 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v22 * 100.0)));
      v130 = sub_26D560(v129, HIDWORD(v129));
      v32 = json_real(LODWORD(v130));
      LOWORD(v34) = 2184;
    }
    else
    {
      v27 = sub_26D41C(COERCE_UNSIGNED_INT64(v20 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v20 * v12 * 100.0)));
      v28 = COERCE_UNSIGNED_INT64(sub_26D560(v27, HIDWORD(v27)));
      v29 = json_real(v28);
      ...
      v31 = sub_26D560(v30, HIDWORD(v30));
    ...
    v35 = sub_26D41C(COERCE_UNSIGNED_INT64(v21 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v21 * 100.0)));
    v36 = sub_26D560(v35, HIDWORD(v35));
    v37 = json_real(LODWORD(v36));
    json_object_set_new(v33, "rate_30m", v37);
    v38 = sub_26D41C(COERCE_UNSIGNED_INT64(v141 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v141 * 100.0)));
    v39 = sub_26D560(v38, HIDWORD(v38));
    ...
    if ( v140 > 0 )
    {
      ...
      while ( 1 )
      {
        ...
        v63 = sub_26D41C(COERCE_UNSIGNED_INT64(v141 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v141 * 100.0)));
        v64 = sub_26D560(v63, HIDWORD(v63));
        v65 = json_real(LODWORD(v64));
        json_object_set_new(v58, "rate_ideal", v65);
        v66 = sub_26D41C(COERCE_UNSIGNED_INT64(v62 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v62 * v12 * 100.0)));
        v67 = sub_26D560(v66, HIDWORD(v66));
...
LABEL_36:
        ...
        v97 = *((_QWORD *)v55 + 11);
        if ( opt_algo == 9 )
          v97 = sub_26D2D0(v97, HIDWORD(v97), 1000, 0);
