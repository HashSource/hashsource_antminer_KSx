unsigned int __fastcall sub_1B4708(_DWORD *a1, int *a2)
{
  int v3; // r1
  int v5; // r0
  int v6; // r6
  ...
  if ( v3 )
  {
    ...
    {
      if ( v5 == 2 )
        core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2DF518);
      v6 = a2[1];
...
LABEL_5:
          ...
          {
            _rust_dealloc(i);
            core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2DF4F8);
          }
          v8 = i[134];
          _rust_dealloc(i);
          ++v6;
