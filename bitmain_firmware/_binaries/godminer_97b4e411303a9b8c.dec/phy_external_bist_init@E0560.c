int __fastcall phy_external_bist_init(int a1, unsigned int a2, unsigned __int8 a3, int a4, int a5)
{
  ...
  zlog(
    ...
    60,
    v33);
  sub_D7B3C(a1, v26, 86, 3670024);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 85, 109905420);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 101, -268374016);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 64, 256);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 80, 33423870);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 81, 832516511);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 88, -1);
  usleep(0x12Cu);
  ...
  sub_D7B3C(a1, v26, 86, 137889800);
  usleep(0x12Cu);
  sub_D7B3C(a1, v26, 80, 0);
  usleep(0x12Cu);
