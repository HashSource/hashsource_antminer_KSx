...
LABEL_27:
        ...
        __dmb(0xBu);
        do
          v11 = __ldrex(&dword_30CC78);
        while ( __strex(0, &dword_30CC78) );
        if ( v11 == 2 )
          syscall(240, &dword_30CC78, 129, 1);
LABEL_33:
        result = v16;
        v15 = 4;
        __dmb(0xBu);
      ...
      case 1u:
        ...
        v15 = 0;
        v19 = aRustc9eb3afe9e;
        core::panicking::panic_fmt(&v15, &off_2DF854);
      case 2u:
        result = (unsigned int *)__ldrex(a1);
...
LABEL_11:
      ...
      default:
        ...
        v19 = aRustc9eb3afe9e;
        v15 = 0;
        core::panicking::panic_fmt(v13, &off_2DF854);
    }
  }
}
