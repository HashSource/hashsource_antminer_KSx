int __fastcall sub_1F2B54(int a1, int a2)
{
  int (*v2)(); // r6
  unsigned int v3; // r8
  int v6; // r0
  ...
  v6 = *(unsigned __int8 *)_tls_get_addr(&dword_2E6450);
  if ( v6 != 1 )
  {
    if ( v6 )
    {
  ...
  if ( *(_DWORD *)_tls_get_addr(&dword_2E6458) )
    core::result::unwrap_failed((int)aAlreadyBorrowe, 16, (int)&v28, (int)&off_2DF2E8, (int)&off_2E01D4);
  v8 = (_DWORD *)_tls_get_addr(&dword_2E6458);
  v9 = v8[2];
  *v8 = -1;
  if ( v9 )
  {
    if ( v9 == 2 )
    {
      ...
      v11 = (int *)_tls_get_addr(&dword_2E6458);
      v12 = *v11;
      v11[1] = (int)v2;
      v11[2] = 0;
      v9 = v12 + 1;
    ...
    {
      v13 = _tls_get_addr(&dword_2E6458);
      v2 = *(int (**)())(v13 + 12);
      v10 = 1;
      v3 = *(_DWORD *)(v13 + 16);
      v9 = 0;
  ...
  *(_DWORD *)_tls_get_addr(&dword_2E6458) = v9;
LABEL_12:
  ...
  if ( v17 )
  {
    ...
    v28.sa_handler = 0;
    v27 = (int (*)())sub_1AD520;
    v28.sa_mask.__val[1] = (unsigned int)&off_2E0A80;
    sub_1D7314(v24, (int)&v28, &v28);
    if ( LOBYTE(v24[0]) != 4 )
      sub_1AEF8C((int)v24);
    __dmb(0xBu);
    do
    ...
    v28.sa_mask.__val[1] = (unsigned int)&off_2E0A90;
    v28.sa_mask.__val[4] = 0;
    v28.sa_mask.__val[3] = (unsigned int)aRustc9eb3afe9e;
    v28.sa_handler = 0;
    sub_1D7314(v24, (int)&v28, v25);
    v23 = LOBYTE(v24[0]);
    if ( LOBYTE(v24[0]) != 4 )
      sub_1AEF8C((int)v24);
