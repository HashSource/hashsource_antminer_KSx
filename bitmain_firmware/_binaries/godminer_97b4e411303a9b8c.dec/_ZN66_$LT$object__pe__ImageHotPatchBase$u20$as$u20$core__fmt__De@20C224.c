int __fastcall <object::pe::ImageHotPatchBase as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2E1638;
  v3[1] = &off_2E1638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aImagehotpatchb, 17, &off_2E22D8, 8, v3, 8);
}
