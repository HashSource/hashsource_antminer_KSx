void __fastcall std::panicking::default_hook(int a1)
{
  ...
  v2 = *(_DWORD *)_tls_get_addr(&dword_2E6460);
  backtrace_style = 1;
  if ( v2 <= 1 )
  ...
  if ( !v4 )
    core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2E034C);
  v38 = v4;
...
LABEL_43:
  ...
  if ( !v21 )
  {
    v20 = sub_1C7F3C(0);
    if ( !v20 )
      core::result::unwrap_failed((int)aCannotAccessAT, 70, (int)&v45, (int)&off_2DF2F8, (int)&off_2DF778);
  }
  v22 = (int)*v20;
  *v20 = 0;
...
LABEL_26:
  ...
  sub_1E866C(v42, v22 + 16, &off_2E0324);
  if ( !v25
  ...
  v27 = v44;
  byte_30CC40 = 1;
  v28 = (_DWORD *)_tls_get_addr(&dword_2E6440);
  v45 = v27;
