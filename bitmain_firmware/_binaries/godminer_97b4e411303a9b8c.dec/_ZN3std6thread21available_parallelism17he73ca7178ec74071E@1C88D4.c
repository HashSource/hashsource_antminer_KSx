char **__fastcall std::thread::available_parallelism(_DWORD *a1)
{
  ...
  *(_WORD *)v235 = 0;
  ...
  if ( !v217 )
  {
    sub_1EC04C(&v224, v218, v219, &v232);
    v201 = a1;
...
LABEL_47:
      ...
      if ( !v217 )
      {
        ...
        s[1] = v219;
        s[0] = 0;
        for ( i = (const void *)sub_1B04EC(s); i; i = (const void *)sub_1B04EC(s) )
        {
...
LABEL_14:
  ...
  if ( (v8 & 1) == 0 )
  {
    ...
    while ( 2 )
    {
      ((void (__fastcall *)(size_t *, _BYTE *, int))off_2E0B4C[v31])(s, ptr, v1);
      if ( s[0] == 2 )
        goto LABEL_72;
      v33 = 0;
      v34 = s[3];
...
LABEL_92:
          ...
          if ( !v44 && v43 != 0 )
          {
            ...
            {
              v126 = sub_1F3718((int)&v221, (int)&v224, &unk_2A5F6C, 0x10u);
              v128 = v127;
              v129 = sub_1F3718((int)&v221, (int)&v224, aCpuCfsPeriodUs, 0x11u);
              v131 = v126 == 1;
              if ( v126 == 1 )
                v131 = v129 == 1;
              if ( v131 && v130 )
              {
                v132 = sub_26D980(v128, v130);
                v133 = nb;
                if ( nb >= v132 )
                  v133 = v132;
                nb = v133;
    ...
    *(_WORD *)v235 = 0;
    ...
    if ( (v150 + 7) >> 7 <= 2 )
    {
      ...
      *((_BYTE *)s + v122) = 0;
      ...
      {
        v229 = dword_2E0158;
        v230 = (void **)&off_2E014C;
        if ( (unsigned __int8)dword_2E0158 == 4 )
          goto LABEL_207;
        goto LABEL_198;
      }
      sub_1EC04C(&v229, v218, v219, &v232);
    }
    else
    {
      sub_7B538(&v229, (int)v222, v150 + 7, (int)&v232);
    }
...
LABEL_208:
    ...
    v155 = sub_1CE0D0(s);
    if ( v224 - v226 < v155 )
      sub_798B0((size_t *)&v224, v226, v155);
    sub_1D6C44(&v227, s[0], &v224);
    close(s[0]);
    v152 = v227 & 7;
    if ( v152 == 4 )
    {
