int __fastcall sub_22E6B4(int *a1)
{
  int v2; // r0
  unsigned int v3; // r1
  unsigned int v4; // r2
  ...
  if ( !v2 )
  {
    v10 = a1[4];
    if ( v10 )
      return <str as core::fmt::Display>::fmt(asc_2B1829, 1, v10);
    return 0;
  }
  v3 = a1[1];
  v4 = a1[2];
...
LABEL_14:
  ...
  v29 = v16;
  do
    v17 = sub_227F68((unsigned int)&v27);
  while ( v17 < 0x110000 );
  if ( v17 != 1114113 )
  {
LABEL_28:
    v21 = a1[4];
    if ( !v21 || (v12 = 1, !<str as core::fmt::Display>::fmt(&unk_2B1809, 16, v21)) )
    {
      *((_BYTE *)a1 + 4) = 0;
      *a1 = 0;
      return 0;
  ...
  v28 = v15;
  v27 = v14;
  v19 = sub_227F68((unsigned int)&v27);
  if ( v19 != 1114113 )
  {
    for ( i = v19; i != 1114113; i = sub_227F68((unsigned int)&v27) )
    {
      if ( i == 1114112 )
        core::result::unwrap_failed((int)aCalledResultUn_0, 43, (int)v32, (int)&off_2E39B4, (int)&off_2E3954);
      v23 = v20;
      v24 = 48;
      v25 = 1114114;
      switch ( i )
