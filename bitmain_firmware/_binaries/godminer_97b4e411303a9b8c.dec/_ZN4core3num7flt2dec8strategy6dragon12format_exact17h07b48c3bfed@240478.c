        ...
        __int16 a5)
{
  ...
  v9 = a2[3];
  if ( !*((_QWORD *)a2 + 1) )
    core::panicking::panic((int)aAssertionFaile_33, 29, (int)&off_2E4C04);
  if ( !*((_QWORD *)a2 + 2) )
  {
...
LABEL_205:
  ...
  if ( __CFADD__(__CFADD__(v5, a2[4]), v7) | __CFADD__(a2[5], __CFADD__(v5, a2[4]) + v7) )
    core::panicking::panic((int)aAssertionFaile_35, 54, (int)&off_2E4C24);
  v137 = a4;
  if ( __PAIR64__(v7, v5) < __PAIR64__(v9, v8) )
    core::panicking::panic((int)aAssertionFaile_36, 55, (int)&off_2E4C34);
  v10 = v7;
  if ( v7 )
    v10 = v7;
  v11 = v138;
...
LABEL_17:
    ...
    while ( 1 )
    {
      if ( v23 )
      {
        ...
        do
        {
          ...
          v27 = sub_26D2D0(v26, v24, 1000000000, 0);
  ...
  v28 = dword_2B3B58[v22];
  if ( !v28 )
    core::panicking::panic((int)aAssertionFaile_51, 27, (int)&off_2E5600);
  if ( v149 >= 0x29 )
    goto LABEL_25;
  if ( v149 )
  {
...
LABEL_130:
      ...
      if ( v57 )
      {
        ...
        if ( v110 )
        {
          ...
          v34 = v57;
LABEL_198:
          core::panicking::panic_bounds_check(v34, 40, (int)&off_2E5600);
        }
LABEL_144:
        v139 = v57;
        if ( v128 == v52 )
