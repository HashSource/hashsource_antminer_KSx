int __fastcall <core::str::pattern::CharSearcher as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2E5184;
  v3[1] = &off_2E58F8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aCharsearcher, 12, (int)&off_2E5AF0, 6, (int)v3, 6);
}
