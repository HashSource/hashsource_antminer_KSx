int __fastcall sub_E1848(int a1, int *a2)
{
  int v2; // r2
  _DWORD *v3; // r7
  int v5; // r10
...
LABEL_6:
      ...
      v19 = v17 <= 3;
      v20 = dword_2E70A0[v16];
      v21 = *(_DWORD *)((char *)&dword_2E70A0[6] + v18);
      if ( v19 )
        goto LABEL_18;
      v22 = v20 == -64;
      if ( v20 == -64 )
...
LABEL_18:
      if ( v20 != v15 )
        dword_2E70A0[v16] = v15;
      if ( v21 != v14 )
        v18 += (int)dword_2E70A0;
      ++v5;
      v3 += 6;
      a2 += 3;
      if ( v21 != v14 )
