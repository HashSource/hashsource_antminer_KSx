int __fastcall sub_82B88(int a1, int a2)
{
  ...
  else
  {
    ...
    v31 = *(float *)&v33;
    v34 = sub_26D41C(LODWORD(v33), HIDWORD(v33));
    ...
    if ( v37 )
    {
      v147 = sub_26D41C(COERCE_UNSIGNED_INT64(v29 * v33 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v29 * v33 * 100.0)));
      v148 = sub_26D560(v147, HIDWORD(v147));
      v149 = json_real(v148);
      json_object_set_new(v26, "GHS 5s", v149);
      v150 = sub_26D41C(COERCE_UNSIGNED_INT64(v38 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v38 * 100.0)));
      v151 = sub_26D560(v150, HIDWORD(v150));
      v152 = json_real(v151);
      json_object_set_new(v26, "GHS av", v152);
      v153 = sub_26D41C(COERCE_UNSIGNED_INT64(v36 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v36 * 100.0)));
      v48 = sub_26D560(v153, HIDWORD(v153));
    }
    else
    {
      v39 = sub_26D41C(COERCE_UNSIGNED_INT64(v32 * v33 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v32 * v33 * 100.0)));
      v40 = COERCE_DOUBLE(sub_26D560(v39, HIDWORD(v39)));
      ...
      v44 = sub_26D41C(COERCE_UNSIGNED_INT64(v38 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v38 * 100.0)));
      v45 = sub_26D560(v44, HIDWORD(v44));
      v46 = json_real(v45);
      json_object_set_new(v26, "GHS av", v46);
      v47 = sub_26D41C(COERCE_UNSIGNED_INT64(v43 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v43 * 100.0)));
      v48 = sub_26D560(v47, HIDWORD(v47));
    }
    v49 = json_real(v48);
    json_object_set_new(v26, "rate_30m", v49);
    v50 = sub_26D41C(COERCE_UNSIGNED_INT64(v166 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v166 * 100.0)));
    v51 = sub_26D560(v50, HIDWORD(v50));
    v52 = json_real(v51);
...
LABEL_83:
    ...
    if ( opt_algo == 9 )
      v121 = sub_26D2D0(v115, HIDWORD(v115), 1000, 0);
    else
      v121 = v115;
