...
LABEL_51:
    ...
    while ( 1 )
    {
      v16 = getopt_long(argc, argv, "a:c:hp:Po:u:v:F", &off_271148, 0);
      if ( v16 < 0 )
        break;
      ...
      if ( !v11 )
      {
        ...
        *(_DWORD *)s = 0;
        ...
        if ( create_pool_connect(v37) == 35 )
          return 1;
        thr_info = 0;
        pthread_attr_init(&stru_30CD80);
        v58 = pthread_create(dword_30CD7C, &stru_30CD80, (void *(*)(void *))work_generator_thread, &thr_info);
        v38 = pthread_attr_destroy(&stru_30CD80);
        if ( v58 )
        {
          V_LOCK(v38);
        ...
        {
          dword_30CDA8 = 1;
          pthread_attr_init((pthread_attr_t *)&dword_30CDAC[1]);
          v11 = pthread_create(
                  dword_30CDAC,
                  (const pthread_attr_t *)&dword_30CDAC[1],
                  (void *(*)(void *))nonce_submit_thread,
                  &dword_30CDA8);
          v39 = pthread_attr_destroy((pthread_attr_t *)&dword_30CDAC[1]);
          if ( v11 )
          {
            V_LOCK(v39);
          ...
          else
          {
            ...
            v46 = pthread_join(dword_30CD7C[0], 0);
            V_LOCK(v46);
