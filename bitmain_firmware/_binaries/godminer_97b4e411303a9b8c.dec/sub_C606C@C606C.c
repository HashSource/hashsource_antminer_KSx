int __fastcall sub_C606C(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r9
  int v9; // r11
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v9;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = sub_26D980(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 428));
  if ( v19 >= *(_DWORD *)(a1 + 332) )
  {
    v26 = rand();
    sub_26D674(v26, *(_DWORD *)(a1 + 332));
    v19 = v27;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
