int __fastcall platform_check_repeat_nonce(int a1, int a2, char *s2)
{
  ...
  if ( memcmp((const void *)(v4 + v7), s2, v3) )
  {
    ...
    {
      memcpy(v9, v8, v3);
      memcpy((void *)(*(_DWORD *)(a1 + 484) + v7), s2, v3);
      return 0;
    }
  }
...
LABEL_18:
  ...
  if ( v3 )
  {
    ...
    do
    {
      ...
      v20 = v11;
      v11 += 2;
      sprintf(v20, "%02x", *(unsigned __int8 *)(*(_DWORD *)(a1 + 484) + v7 + v15 - s2));
      v21 = v17;
      v17 += 2;
      v12 = (void *)sprintf(v21, "%02x", *(unsigned __int8 *)(*(_DWORD *)(a1 + 484) + v23 + v15 - s2));
    }
    while ( v15 != v27 );
  }
  V_LOCK(v12);
