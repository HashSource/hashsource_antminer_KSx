int __fastcall sub_7CAEC(int **a1)
{
  ...
  while ( 2 )
  {
    switch ( result )
    {
      case 0:
      case 1:
        v3 = __ldrex((unsigned int *)&dword_30CD10);
        if ( v3 != result )
        {
          __clrex();
LABEL_11:
        ...
        if ( __strex(2u, (unsigned int *)&dword_30CD10) )
          goto LABEL_11;
        __dmb(0xBu);
        v4 = **a1;
        **a1 = 0;
        ...
        *(_DWORD *)(v4 + 24) = 0;
        ...
        __dmb(0xBu);
        do
          v6 = __ldrex((unsigned int *)&dword_30CD10);
        while ( __strex(4u, (unsigned int *)&dword_30CD10) );
        if ( v6 == 3 )
          return syscall(240, v10, 129, 0x7FFFFFFF);
        return result;
      case 2:
        result = __ldrex((unsigned int *)&dword_30CD10);
        if ( result != 2 )
        {
          __clrex();
LABEL_13:
        ...
        if ( __strex(3u, (unsigned int *)&dword_30CD10) )
          goto LABEL_13;
LABEL_14:
        v9 = 0;
        while ( dword_30CD10 == 3 && syscall(240, &dword_30CD10, 137, 3, v9, 0, -1) <= -1 && *_errno_location() == 4 )
          ;
        result = dword_30CD10;
        __dmb(0xBu);
        continue;
