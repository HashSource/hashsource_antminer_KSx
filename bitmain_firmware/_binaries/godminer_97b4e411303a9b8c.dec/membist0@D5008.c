int __fastcall membist0(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_D1300(v3, v43, 12, 1);
      sub_D1300(v3, v43, 160, 3);
      usleep((__useconds_t)"3c2aE");
      v7 = sub_D1598(v3, (unsigned __int16)v43, 161, ptr);
      v8 = v7;
      if ( v7 == 8
        || (V_LOCK(v7),
            V_INT((int)&v48, "chain"),
...
LABEL_11:
      memset(ptr, 0, 0x600u);
      v13 = sub_D1598(v3, (unsigned __int16)v43, 162, ptr);
      v14 = v13;
      if ( v13 == 8
        || (V_LOCK(v13),
            V_INT((int)v51, "chain"),
...
LABEL_19:
      memset(ptr, 0, 0x600u);
      v4 = (void *)sub_D1598(v3, (unsigned __int16)v43, 163, ptr);
      v19 = (int)v4;
      if ( v4 == (void *)8
        || (V_LOCK(v4),
            V_INT((int)&v54, "chain"),
