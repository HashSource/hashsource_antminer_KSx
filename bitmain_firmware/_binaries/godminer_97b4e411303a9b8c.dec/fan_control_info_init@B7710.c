        ...
        unsigned int a13)
{
  ...
  *(_QWORD *)&flt_2EA630 = 0;
  ...
  dword_2E6E2C = a8;
  dword_2E6E30 = a9;
  qword_2E6E34 = __PAIR64__(a11, a10);
  qword_2E6E3C = __PAIR64__(a13, a12);
  dbl_2EA648 = 0.0;
  dbl_2EA640 = 0.0;
  *(double *)((char *)&dbl_2EA648 + 4) = 0.0;
  if ( a1 == 2 )
  {
    *(_QWORD *)&dbl_2EA638 = qword_2E6E34;
    *(_QWORD *)&dbl_2EA640 = qword_2E6E3C;
    flt_2EA630 = (float)SLODWORD(flt_2E6E28);
    flt_2EA62C = (float)dword_2E6E14;
    flt_2EA628 = (float)dword_2E6E18;
  }
  V_LOCK(a9);
