int task_check_miner_status()
{
  ...
  pthread_mutex_lock(&stru_2EA668);
  v1 = 0;
  v2 = (unsigned __int8)byte_2EA660 ^ 1;
  v125[0] = 0;
...
LABEL_70:
  ...
  v42 = pthread_mutex_unlock(&stru_2EA668);
