...
LABEL_2:
    ...
    else
    {
      ...
      else
      {
        ...
        if ( dword_2E7C90 > 0 )
          close(dword_2E7C90);
        dword_2E7C90 = open64("/sys/class/gpio/gpio459/value", 1);
        if ( dword_2E7C90 < 0 )
        {
        ...
        else
        {
          if ( dword_2E7C88 > 0 )
            close(dword_2E7C88);
          dword_2E7C88 = open64("/sys/class/gpio/gpio461/value", 1);
          if ( dword_2E7C88 < 0 )
          {
          ...
          else
          {
            if ( dword_2E7C8C > 0 )
              close(dword_2E7C8C);
            dword_2E7C8C = open64("/sys/class/gpio/gpio461/direction", 1);
            if ( dword_2E7C8C >= 0 )
            {
              v1 = 255;
