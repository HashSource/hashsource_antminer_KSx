void cal_log_init()
{
  ...
  v0 = (const pthread_attr_t *)(unsigned __int8)byte_30CBDE;
  if ( !byte_30CBDE )
  {
    time(&timer);
    v1 = localtime(&timer);
    strftime(&byte_30CBDE, 0xFu, "%Y-%m/%d", v1);
    strftime(byte_30CBFC, 0xAu, "%H-%M-%S", v1);
    dword_30CBB8 = (int)"/var/log";
    dword_30CBBC = (int)"nvdata";
    dword_30CC10 = (int)"cglog_init";
    dword_30CBB4 = 1;
    sub_161E28((int)&dword_30CBB4);
    if ( pthread_create(&newthread, v0, (void *(*)(void *))sub_162050, &dword_30CBB4) )
    {
