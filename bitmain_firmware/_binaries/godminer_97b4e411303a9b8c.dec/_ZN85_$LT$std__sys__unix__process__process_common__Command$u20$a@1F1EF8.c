int __fastcall <std::sys::unix::process::process_common::Command as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  if ( core::fmt::Formatter::alternate(a2) )
  {
    ...
    v4 = core::fmt::builders::DebugStruct::field(v29, aProgram, 7, a1 + 32, &off_2E0948);
    core::fmt::builders::DebugStruct::field(v4, "args && ", 4, a1 + 88, &off_2E0958);
    v5 = *(_BYTE *)(a1 + 12) == 0;
    if ( !*(_BYTE *)(a1 + 12) )
      v5 = *(_DWORD *)(a1 + 8) == 0;
    if ( !v5 )
      core::fmt::builders::DebugStruct::field(v29, aEnv, 3, a1, &off_2E0968);
    if ( *(_DWORD *)(a1 + 16) )
      core::fmt::builders::DebugStruct::field(v29, aCwd, 3, a1 + 16, &off_2E0978);
    if ( *(_DWORD *)(a1 + 64) == 1 )
    {
      core::fmt::builders::DebugStruct::field(v29, aUid, 3, a1 + 64, &off_2E0988);
      v6 = a1 + 72;
      if ( *(_DWORD *)(a1 + 72) != 1 )
      {
LABEL_10:
    ...
    core::fmt::builders::DebugStruct::field(v29, aGid, 3, v6, &off_2E0988);
    v7 = a1 + 24;
    if ( !*(_DWORD *)(a1 + 24) )
    {
LABEL_12:
      ...
      {
        core::fmt::builders::DebugStruct::field(v29, aStdin_2, 5, a1 + 40, &off_2E09A8);
        v8 = a1 + 48;
        if ( *(_DWORD *)(a1 + 48) == 4 )
        {
LABEL_14:
      ...
      core::fmt::builders::DebugStruct::field(v29, aStdout_0, 6, v8, &off_2E09A8);
      v9 = a1 + 56;
      if ( *(_DWORD *)(a1 + 56) == 4 )
      {
LABEL_15:
        ...
        {
LABEL_17:
          core::fmt::builders::DebugStruct::field(v29, aCreatePidfd, 12, a1 + 126, &off_2DF758);
          return core::fmt::builders::DebugStruct::finish(v29);
        }
LABEL_16:
        core::fmt::builders::DebugStruct::field(v29, aPgroup, 6, v10, &off_2E09B8);
        goto LABEL_17;
      }
LABEL_50:
      core::fmt::builders::DebugStruct::field(v29, aStderr_1, 6, v9, &off_2E09A8);
      v10 = a1 + 80;
      if ( *(_DWORD *)(a1 + 80) != 1 )
        goto LABEL_17;
      goto LABEL_16;
...
LABEL_11:
    core::fmt::builders::DebugStruct::field(v29, aGroups, 6, v7, &off_2E0998);
    goto LABEL_12;
  }
  if ( *(_DWORD *)(a1 + 16) )
  {
