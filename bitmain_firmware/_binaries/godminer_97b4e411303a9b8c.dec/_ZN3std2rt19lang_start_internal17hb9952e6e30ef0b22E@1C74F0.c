...
LABEL_25:
      if ( signal(13, (__sighandler_t)v9) == (__sighandler_t)-1 )
      {
        ...
        fds.sa_mask.__val[1] = (unsigned int)&off_2E0C30;
        fds.sa_mask.__val[4] = 0;
        fds.sa_mask.__val[3] = (unsigned int)aRustc9eb3afe9e;
        fds.sa_handler = 0;
        sub_1D7314(stacksize, stackaddr, v35);
        sub_1AFCF0((int)stacksize);
        goto LABEL_46;
      }
LABEL_26:
      v10 = &fds;
      ...
      if ( !fds.sa_handler )
      {
        ...
        fds.sa_handler = (__sighandler_t)sub_1F2B54;
        sigaction(11, &fds, 0);
        byte_30CCCC = 1;
      }
      sigaction(7, 0, &fds);
...
LABEL_37:
      ...
      if ( v29 )
      {
        ...
        stackaddr[0] = &fds;
        fds.sa_mask.__val[1] = (unsigned int)&off_2DF708;
        fds.sa_handler = 0;
        stacksize[1] = (size_t)sub_1BDB3C;
        stacksize[0] = (size_t)&p_p_fds;
        sub_1D7314(v31, stackaddr, v35);
        v24 = v31[0];
        if ( v31[0] != 4 )
          sub_1AEF8C((int)v31);
LABEL_46:
