int __fastcall std::sys::unix::thread::Thread::new(_DWORD *a1, size_t a2, int a3, int a4)
{
  ...
  *v8 = a3;
  ...
  v10 = 0x4000;
  v11 = (int (__fastcall *)(pthread_attr_t *))off_2E8F64;
  if ( off_2E8F64 )
  {
    if ( off_2E8F64 != (_UNKNOWN *)1 )
    {
      __dmb(0xBu);
      if ( !v11 )
        goto LABEL_7;
...
LABEL_7:
  ...
  if ( v12 )
  {
    ...
    {
      v22 = 0;
      sub_79864(0, (int)&v19, (int)&unk_2A56D4, v21, (int)&off_2E0AD8);
    }
    v13 = sysconf(30);
  ...
  v14 = pthread_create(&newthread, &s, (void *(*)(void *))sub_1F354C, v9);
