char **__fastcall std::net::udp::UdpSocket::peer_addr(int a1, int *a2)
{
  int v3; // r5
  int v4; // r6
  int v5; // r5
  ...
  {
    if ( len < 0x10 )
      core::panicking::panic((int)aAssertionFaile_20, 66, (int)&off_2E0E1C);
  ...
  {
    if ( len < 0x1C )
      core::panicking::panic((int)aAssertionFaile_19, 67, (int)&off_2E0E0C);
    *(_WORD *)a1 = 1;
