...
LABEL_12:
  ...
  if ( opt_custom_voltage_swith || (v17 = is_eeprom_loaded(v17)) != 0 )
    dword_2EA5EC = opt_custom_voltage;
  byte_2EA5E4 = platform_is_adjustable_power(v17);
  byte_2EA5F0 = platform_is_check_asic_voltage_enable();
  dword_2EA5F4 = platfrom_get_check_asic_voltage();
  V_LOCK(dword_2EA5F4);
