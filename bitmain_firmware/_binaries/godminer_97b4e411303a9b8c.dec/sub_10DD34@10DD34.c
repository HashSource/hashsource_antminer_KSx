int __fastcall sub_10DD34(int a1, int *a2)
{
  int v2; // r12
  _DWORD *v4; // r8
  int v5; // r7
  ...
  if ( v2 > 0 )
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v9 = usleep((__useconds_t)"ore..iter..traits..iterator..Iterator$GT$4last17hc978315af0f81255E");
        --v5;
      }
      while ( v5 );
      v34 = -64;
...
LABEL_9:
    ...
    do
    {
      ...
      do
      {
        ...
        v16 = usleep((__useconds_t)"ore..iter..traits..iterator..Iterator$GT$4last17hc978315af0f81255E");
        --v12;
      }
      while ( v12 );
      v34 = -64;
