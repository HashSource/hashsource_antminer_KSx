_DWORD *__fastcall std::sys_common::thread_info::set(int *a1, unsigned int *a2)
{
  ...
  v4 = *(unsigned __int8 *)_tls_get_addr(&dword_2E6450);
  if ( v4 != 1 )
  {
    if ( v4 )
    {
      ...
      core::result::unwrap_failed((int)aCannotAccessAT, 70, (int)v18, (int)&off_2DF2F8, (int)&off_2DF778);
    }
  ...
  if ( *(_DWORD *)_tls_get_addr(&dword_2E6458) )
    core::result::unwrap_failed((int)aAlreadyBorrowe, 16, (int)v18, (int)&off_2DF2E8, (int)&off_2E01E4);
  v6 = (_DWORD *)_tls_get_addr(&dword_2E6458);
  v7 = v6[2];
  *v6 = -1;
  if ( v7 != 2 )
  {
