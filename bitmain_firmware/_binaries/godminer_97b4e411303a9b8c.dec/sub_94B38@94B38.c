int __fastcall sub_94B38(int a1, _DWORD *a2, _QWORD ***a3)
{
  __int64 v3; // d0
  int v7; // r6
  int v8; // r8
...
LABEL_158:
        v7 = -1;
        sub_94664((int *)a1, "<validation>", 10, v63, v64);
      }
      else
      {
        sub_946C4(a1);
...
LABEL_109:
          if ( a2 && json_array_size(a2) != v27 )
          {
            ...
            sub_94664((int *)a1, "<validation>", 7, "%li array item(s) left unpacked", v50 - v27);
            return v7;
          }
          return 0;
        }
        ...
        {
LABEL_132:
          sub_94664((int *)a1, "<format>", 9, "Unexpected end of format string");
          return -1;
        }
        v28 = v26 == 33;
        if ( v26 != 33 )
...
LABEL_68:
          ...
          sub_94664((int *)a1, "<format>", 9, "Expected ']' after '%c', got '%c'", v26, v30);
          return -1;
        }
        while ( strchr("{[siIbfFOon", v26) )
        {
          ...
          {
            v7 = -1;
            sub_94664((int *)a1, "<validation>", 17, "Array index %lu out of range", v27);
            return v7;
          }
          ++v27;
          if ( sub_94B38(a1) )
...
LABEL_102:
        v7 = -1;
        sub_94664((int *)a1, "<format>", 9, "Unexpected format character '%c'", v65);
      }
      return v7;
    case 'b':
      if ( !a2 )
    ...
    case 's':
      ...
      if ( *v39 )
      {
        ...
        if ( *(_BYTE *)(a1 + 36) == 37 )
        {
          ...
          {
            sub_94664((int *)a1, "<args>", 12, "NULL string length argument");
            return -1;
          }
        }
        else
      ...
      {
        v7 = -1;
        sub_94664((int *)a1, "<args>", 12, "NULL string argument");
      }
      return v7;
    case '{':
      ...
      if ( v7 )
      {
        sub_94664((int *)a1, "<internal>", 1, "Out of memory");
        return -1;
      }
      if ( a2 && *a2 )
      {
        v7 = -1;
        sub_94664((int *)a1, "<validation>", 10, "Expected object, got %s", (&off_273F18)[*a2]);
        goto LABEL_30;
      }
      sub_946C4(a1);
...
LABEL_25:
            ...
            sub_94664((int *)a1, "<format>", 9, "Expected '}' after '%c', got '%c'", v8, v15);
            v7 = -1;
          }
          else
          {
            while ( 1 )
            {
              ...
              {
                v7 = -1;
                sub_94664((int *)a1, "<format>", 9, "Expected format 's', got '%c'", v8);
                goto LABEL_30;
              }
              v11 = (char **)(*a3)++;
              v12 = *v11;
              ...
              {
                v7 = -1;
                sub_94664((int *)a1, "<args>", 12, "NULL object key");
                goto LABEL_30;
              }
              sub_946C4(a1);
              if ( *(_BYTE *)(a1 + 36) == 63 )
              ...
              {
                v7 = -1;
                sub_94664((int *)a1, "<validation>", 16, "Object item not found: %s", v12);
                goto LABEL_30;
              }
              if ( sub_94B38(a1) )
              {
...
LABEL_148:
      if ( v54 )
      {
        ...
        sub_94664((int *)a1, "<validation>", 7, "%li object item(s) left unpacked: %s", v54, v61);
        strbuffer_close(v66);
        v7 = -1;
      }
      goto LABEL_30;
