void __fastcall __noreturn sub_1E8BC0(_DWORD *a1)
{
  _DWORD *v2; // r0
  int v3; // r2
  int v4; // r1
...
LABEL_5:
      ...
      std::panicking::rust_panic_with_hook(&v18, &off_2E03C4, v9, v8, can_unwind);
    }
    v13 = 0;
    v12 = aRustc9eb3afe9e;
  }
  ...
  std::panicking::rust_panic_with_hook(&v18, &off_2E03D8, v15, v16, v17);
}
