...
LABEL_6:
    ...
    {
      v17 = *++v16;
      sub_103F84(a1, v17, 133, 0xFFFF);
      sub_103F84(a1, *v16, 134, 1342177279);
    }
    while ( v16 != v12 );
    sub_103F44(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
...
LABEL_27:
  ...
  free(ptr);
  *(_QWORD *)&dword_30BB68 += v34;
  *(_QWORD *)&dbl_30BB70 += v35;
  V_LOCK(v36);
  V_INT((int)&v55, "chain");
