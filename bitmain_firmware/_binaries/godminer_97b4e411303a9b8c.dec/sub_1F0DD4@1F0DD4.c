int __fastcall sub_1F0DD4(int result, int a2)
{
  int v2; // r2
  int v3; // r10
  bool v4; // zf
  ...
  if ( !v2 )
  {
    ...
    if ( v134 != v135 )
    {
      ...
      while ( 1 )
      {
        ...
        v125 = v12;
        v124 = v11;
        sub_1B2AD8(&v145, &v142, (size_t *)&v118, (size_t *)&v124);
        v13 = ptr == 0;
        if ( ptr )
          v13 = v145 == 0;
        if ( !v13 )
...
LABEL_26:
  while ( 1 )
  {
    ...
    if ( v21 )
    {
      ...
      v134 = (char *)v23;
      v133 = v29;
      sub_1B2AD8((size_t *)&v118, &v142, (size_t *)&v124, (size_t *)&v133);
      v30 = v119 == 0;
      if ( v119 )
        v30 = v118 == 0;
      if ( !v30 )
...
LABEL_64:
        ...
        {
          if ( !v106 )
            core::panicking::panic((int)aAssertionFaile_5, 33, (int)&off_2DF438);
          v61 = (_DWORD *)v108[68];
          *v61 = 0;
          v142 = (char *)(v106 - 1);
          v143 = v61;
  ...
  *v69 = 0;
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      v126 = v82;
      sub_1B6BD0(&v118, v81, v81 >= 0, (int)&v124);
      v73 = (_DWORD *)v118;
      if ( v118 )
      {
        v75 = v120;
...
LABEL_109:
      ...
      v119 = v89;
      if ( !v115 )
        core::panicking::panic_bounds_check(v92, 0, (int)&off_2E0938);
      v93 = v114;
      v4 = v115 == (_DWORD)v113;
      *(_DWORD *)(v114 + 4 * v92) = v91;
      if ( v4 )
      {
        sub_1B6EB8((unsigned int *)&v113, v90);
        v93 = v114;
        v90 = v115;
      }
      v94 = v110;
      ...
      *(_DWORD *)(v93 + 4 * v90) = 0;
      ...
      if ( v95 == v94 )
      {
        sub_1B6C98((unsigned int *)&v110, v95);
        v95 = v112;
      }
      v71 = v111;
