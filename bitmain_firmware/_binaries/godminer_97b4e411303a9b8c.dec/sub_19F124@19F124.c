int __fastcall sub_19F124(int a1, int a2)
{
  _DWORD *v4; // r5
  int *v5; // r3
  _DWORD *v6; // lr
  ...
  sub_19E70C((unsigned __int8 *)a1, &v1010);
  v4 = &unk_2A3FA8;
  sub_19E70C((unsigned __int8 *)(a1 + 2), &v1074);
  v5 = &v1010;
  v6 = &unk_2A3FA8;
  v7 = 226;
  v8 = v1010 - v1074;
  ...
  v22 = 226;
  sub_19E70C((unsigned __int8 *)(a1 + 1), &v1138);
  v23 = 46;
  sub_19E70C((unsigned __int8 *)(a1 + 3), &v1202);
  v24 = &v1010;
  v25 = 139;
  v26 = v1138 - v1202;
  v1138 += v1202;
  ...
  if ( a2 )
  {
    v409 = (unsigned __int16 *)&unk_2A4788;
    v410 = &v1009;
    for ( i = 2; ; i = v412 )
    {
      v413 = v410[1];
  ...
  {
    v56 = &v1009;
    v57 = (unsigned __int16 *)&unk_2A4588;
    for ( j = 1; ; j = v59 )
    {
      v60 = v56[1];
      ++v56;
