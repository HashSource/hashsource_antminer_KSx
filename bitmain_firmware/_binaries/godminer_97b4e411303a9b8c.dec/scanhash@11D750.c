  ...
  if ( !*(_BYTE *)(a1 + 884) )
  {
    while ( 1 )
    {
      ...
      if ( s[1] == 85 )
      {
        ...
        check_and_print_uart_debug_log(a1 + 1008, v10, s, *(_DWORD *)(a1 + 248), v33);
        ...
        if ( v12 == 10 )
        {
          if ( !queue_enqueue(*(_DWORD *)(a1 + 864), s, v10) && v32 <= ++v31 )
          {
            V_LOCK(0);
        ...
        {
          if ( !*(_BYTE *)(a1 + v36 + 536) && v34 && platform_check_repeat_nonce(a1, v35, ptr) )
          {
            ...
            if ( v13 <= 5 )
            {
              ...
              if ( v13 <= 1 )
              {
                ...
                *(_QWORD *)(a1 + 448) = v17;
                ...
                if ( !v14
                  && !*(_BYTE *)(a1 + v18 + 536)
                  && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 868) + 860), v6, 1)
                  && v30 <= ++v29 )
                {
                  V_LOCK(0);
      ...
      v27 = *(_BYTE *)(a1 + 884);
      s[0] = s[1];
      check_and_print_uart_debug_log(a1 + 1008, 2, s, v8, v27);
    }
  }
LABEL_5:
  *(_BYTE *)(a1 + 884) = 0;
