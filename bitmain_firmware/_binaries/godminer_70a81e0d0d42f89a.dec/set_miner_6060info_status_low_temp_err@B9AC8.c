int __fastcall set_miner_6060info_status_low_temp_err(char a1)
{
  ...
  if ( !byte_2EB9B8 )
    goto LABEL_9;
  difftime(tv.tv_sec, dword_2EB9BC);
  v4 = sub_26EB6C(v1, v2);
  if ( (int)(((unsigned __int64)(v4 - *(_QWORD *)&dword_2EB9C0) >> 32) - ((_DWORD)v4 == dword_2EB9C0)) < 0 == __OFSUB__((unsigned __int64)(v4 - *(_QWORD *)&dword_2EB9C0) >> 32, 0, (_DWORD)v4 != dword_2EB9C0) )
  {
    v8 = 3291728;
    V_LOCK(v4);
