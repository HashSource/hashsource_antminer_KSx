int __fastcall <core::task::wake::RawWaker as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v10 = v3;
  v9 = a2;
  v4 = core::fmt::builders::DebugStruct::field(&v9, (int)aData_0, 4u, (int)&v7, (int)&off_2E6C40);
  core::fmt::builders::DebugStruct::field(v4, (int)aVtable, 6u, (int)&v8, (int)&off_2E6C50);
  if ( v11 )
  {
    if ( v10 )
    {
