int __fastcall eeprom_dump_fixture(unsigned __int8 *a1)
{
  ...
  _BYTE v54[4100]; // [sp+820h] [bp-1004h] BYREF

  v2 = snprintf(s, 0x800u, "%-30s : 0x%04x", "key_version", *a1 & 0xF);
  V_LOCK(v2);
  v3 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v3);
  zlog(
    g_zc,
  ...
  V_LOCK(v14);
  v15 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v15);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v16);
  v17 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v17);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v18);
  v19 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v19);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v20);
  v21 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v21);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v22);
  v23 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v23);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v24);
  v25 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v25);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v26);
  v27 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v27);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v30);
  v31 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v31);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v40);
  v41 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v41);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v42);
  v43 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v43);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  V_LOCK(v46);
  v47 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v47);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build/g"
  ...
  zlog(
    ...
    100,
    v54);
  v50 = snprintf(s, 0x800u, "%-30s : 0x%08x", "strategy", **((_DWORD **)a1 + 14));
  V_LOCK(v50);
  v51 = logfmt_raw((int)v54, 0x1000u);
  V_UNLOCK(v51);
  return zlog(
           g_zc,
           "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/"
           "build/godminer-origin_godminer-kas_2382/backend/device/hal/eeprom/bitmain_eeprom.c",
           191,
           "eeprom_dump_fixture",
           19,
           496,
