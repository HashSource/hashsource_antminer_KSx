int __fastcall set_miner_6060info_uneffective_temp_err(char a1)
{
  ...
  if ( !byte_2EB9C8 )
    goto LABEL_9;
  difftime(tv.tv_sec, dword_2EB9CC);
  v4 = sub_26EB6C(v1, v2);
  if ( (int)(((unsigned __int64)(v4 - *(_QWORD *)&dword_2EB9D0) >> 32) - ((_DWORD)v4 == dword_2EB9D0)) < 0 == __OFSUB__((unsigned __int64)(v4 - *(_QWORD *)&dword_2EB9D0) >> 32, 0, (_DWORD)v4 != dword_2EB9D0) )
  {
    v8 = 3553866;
    V_LOCK(v4);
