int __fastcall sync_get_core_reg_by_id(int a1, int a2, int a3, int a4, int a5, double a6)
{
  ...
  if ( v18 > 0 )
  {
    ...
    if ( a1 == *(_DWORD *)(*all_created_runtime + 244) )
      goto LABEL_7;
    v13 = 0;
    while ( ++v13 != v18 )
    {
      ...
      if ( a1 == *(_DWORD *)(v14 + 244) )
        goto LABEL_7;
    }
  }
  fake_regio_runtime = get_fake_regio_runtime(a1);
LABEL_7:
  if ( *(_DWORD *)(fake_regio_runtime + 856) == *(_DWORD *)(fake_regio_runtime + 864) )
    pthread_create(
      (pthread_t *)(fake_regio_runtime + 876),
      0,
  ...
  if ( *(_DWORD *)(fake_regio_runtime + 856) == *(_DWORD *)(fake_regio_runtime + 864) )
  {
    v17 = *(_DWORD *)(fake_regio_runtime + 876);
    *(_BYTE *)(fake_regio_runtime + 885) = 1;
    pthread_join(v17, 0);
    return v16;
  }
  return result;
