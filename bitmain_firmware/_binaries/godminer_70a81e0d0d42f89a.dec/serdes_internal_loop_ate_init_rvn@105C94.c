int __fastcall serdes_internal_loop_ate_init_rvn(int a1, unsigned int a2, int a3, int a4)
{
  ...
  v9 = sub_1053C4(a1, (unsigned __int16)a3, 240, v8);
  V_LOCK(v9);
  V_INT((int)v26, "chain");
  ...
  v11 = sub_1053C4(a1, (unsigned __int16)a3, 86, v8);
  V_LOCK(v11);
  V_INT((int)v27, "chain");
  ...
  v13 = sub_105374(a1, a3, 86, 201853960);
  V_LOCK(v13);
  V_INT((int)v28, "chain");
  ...
  sub_105374(a1, a3, 78, -2144272085);
  ...
  sub_105374(a1, a3, 78, -2144247718);
  sub_105374(a1, a3, 77, 0);
  ...
  sub_105374(a1, a3, 77, (int)v15);
  sub_105374(a1, a3, 78, -2144247739);
  sub_105374(a1, a3, 77, -1);
  sub_105374(a1, a3, 78, -2144247732);
  sub_105374(a1, a3, 77, 268439552);
  ...
  sub_105374(a1, a3, 78, -2144272088);
  ...
  sub_105374(a1, a3, 78, -2144272353);
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v16) = 501;
  sub_105374(a1, a3, 77, v16);
  sub_105374(a1, a3, 78, -2144247559);
  sub_105374(a1, a3, 77, 25166208);
  sub_105374(a1, a3, 78, -2144251901);
  sub_105374(a1, a3, 77, 92800392);
  sub_105374(a1, a3, 78, -2144251901);
  sub_105374(a1, a3, 77, 0);
  sub_105374(a1, a3, 78, -2144251900);
  sub_105374(a1, a3, 77, 541073472);
  sub_105374(a1, a3, 78, -2144251900);
  sub_105374(a1, a3, 77, 0);
  ...
  sub_105374(a1, a3, 78, -2144247750);
  ...
  sub_105374(a1, a3, 78, -2144247798);
  sub_105374(a1, a3, 77, (int)&dword_10000 + 1);
  sub_105374(a1, a3, 78, -2144247604);
  sub_105374(a1, a3, 77, 0);
  ...
  sub_105374(a1, a3, 78, -2144251869);
  sub_105374(a1, a3, 77, (int)"");
  sub_105374(a1, a3, 78, -2144243609);
  ...
  sub_105374(a1, a3, 78, -2144272078);
  ...
  sub_105374(a1, a3, 77, (int)&dword_10000 + 1);
  sub_105374(a1, a3, 78, -2144251791);
  sub_105374(a1, a3, 77, (int)&loc_E000C + 2);
  sub_105374(a1, a3, 78, -2144247768);
  sub_105374(a1, a3, 77, (int)&loc_E000C + 2);
  sub_105374(a1, a3, 78, -2144247768);
