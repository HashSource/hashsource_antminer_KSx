int __fastcall set_miner_6060info_malloc_failed_err(char a1)
{
  ...
  if ( !byte_2EBD68 )
    goto LABEL_9;
  difftime(tv.tv_sec, dword_2EBD6C);
  v4 = sub_26EB6C(v1, v2);
  if ( (int)(((unsigned __int64)(v4 - *(_QWORD *)&dword_2EBD70) >> 32) - ((_DWORD)v4 == dword_2EBD70)) < 0 == __OFSUB__((unsigned __int64)(v4 - *(_QWORD *)&dword_2EBD70) >> 32, 0, (_DWORD)v4 != dword_2EBD70) )
  {
    v8 = 3226189;
    V_LOCK(v4);
