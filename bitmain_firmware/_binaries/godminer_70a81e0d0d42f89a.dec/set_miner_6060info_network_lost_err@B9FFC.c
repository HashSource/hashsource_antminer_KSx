int __fastcall set_miner_6060info_network_lost_err(char a1)
{
  ...
  if ( !byte_2EBD58 )
    goto LABEL_9;
  difftime(tv.tv_sec, dword_2EBD5C);
  v4 = sub_26EB6C(v1, v2);
  if ( (int)(((unsigned __int64)(v4 - *(_QWORD *)&dword_2EBD60) >> 32) - ((_DWORD)v4 == dword_2EBD60)) < 0 == __OFSUB__((unsigned __int64)(v4 - *(_QWORD *)&dword_2EBD60) >> 32, 0, (_DWORD)v4 != dword_2EBD60) )
  {
    v8 = 3422798;
    V_LOCK(v4);
