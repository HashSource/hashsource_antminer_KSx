void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    do
    {
      ...
      while ( !*(_QWORD *)&dbl_2EB8A8 );
    }
    while ( *(_QWORD *)&dbl_2EB8A8 == *(_QWORD *)&dbl_2EB8B0 );
    V_LOCK(LODWORD(dbl_2EB8A8));
    ...
    zlog(
      ...
      v97);
    v2 = dbl_2EB8A8;
    v3 = sub_26EA20(LODWORD(dbl_2EB8A8), HIDWORD(dbl_2EB8A8), 3, 0);
    v4 = (char *)&v93 + 4;
    v5 = &v96;
    ...
    if ( v89 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          40,
          v97);
        v52 = sub_26EA20(LODWORD(dbl_2EB8A8), HIDWORD(dbl_2EB8A8), 7500, 0);
        v53 = v48[1];
        ++v48;
        v63 = *(void (__fastcall **)(int, _DWORD, _DWORD, _DWORD))(v53 + 12);
        v54 = vshrd_n_u64(qword_286370[v52], 8u);
        printf("dag_load: %lx\n", v63);
