...
LABEL_191:
        ...
        v110 = v106 + i - 1;
        if ( v110 > 0x8101 )
          core::panicking::panic_bounds_check(v106 + i - 1, 33026, (int)&off_2E4D54);
        if ( v109 >= 0x8102 )
          core::panicking::panic_bounds_check(v106 + i, 33026, (int)&off_2E4D64);
        v111 = v168[i > 0x1F] - 1;
        if ( v168[i > 0x1F] == 1 )
        {
          v5 = v194;
        ...
        else
        {
          ...
          do
          {
            ...
            while ( 1 )
            {
              ...
              if ( v123 > 0x8101 )
LABEL_268:
                core::panicking::panic_bounds_check(33026, 33026, (int)&off_2E4D64);
...
LABEL_267:
              core::panicking::panic_bounds_check(v119, 33026, (int)&off_2E4D54);
            }
LABEL_189:
            v111 = -v115;
          }
...
LABEL_211:
        v143 = v104;
        sub_2348D8(v140, v141, v134, v107);
        v104 = v143;
        v74 = 0;
        v144 = i;
LABEL_223:
...
LABEL_224:
      if ( v75 < v144 )
        core::panicking::panic((int)aAssertionFaile_30, 47, (int)&off_2E5104);
      v149 = *v16;
...
LABEL_74:
    ...
    *((_BYTE *)v179 + v63) |= 0x80u;
    ...
    {
      if ( (__int16)v61 <= -1 )
        core::panicking::panic_bounds_check(HIBYTE(v61), 128, (int)&off_2E5154);
      v65 = (unsigned __int8 *)&unk_2B3A74 + HIBYTE(v61);
    }
    else
    {
      v65 = (unsigned __int8 *)&unk_2B3674 + v61;
    }
    v15 = v185;
    v66 = v185[16] + 2 * *v65;
    ++*(_WORD *)(v66 + 576);
    if ( v60 >= 0x100 )
      core::panicking::panic_bounds_check(v60, 256, (int)&off_2E5164);
    v50 = word_2B3330[v60];
    if ( v50 >= 0x120 )
      core::panicking::panic_bounds_check(v50, 288, (int)&off_2E5174);
LABEL_65:
    ++*(_WORD *)(v15[16] + 2 * v50);
    v51 = v15[1] - 1;
    v15[1] = v51;
...
LABEL_251:
  ...
  {
    if ( sub_233EAC(v6, a3, *(_BYTE *)(v5 + 53)) )
    {
      v158 = -1;
      result = *(_DWORD *)(v5 + 28);
      v159 = *(_DWORD *)(v5 + 32);
