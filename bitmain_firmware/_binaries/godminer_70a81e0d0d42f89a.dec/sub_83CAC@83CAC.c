int __fastcall sub_83CAC(int a1, int a2)
{
  ...
  {
    v7 = v5;
    v8 = sub_7EE7C(a1, 1, 11, *(_DWORD *)(a2 + 8));
    v9 = json_array(v8);
    v104 = v9;
    ...
    v19 = v17 * v15;
    v20 = COERCE_DOUBLE(((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(LODWORD(total_accepted), HIDWORD(total_accepted)));
    v105 = v16 * v15;
    v21 = v20;
    if ( v15 != 0.0 )
      v21 = v20 / v15;
    ...
    v23 = sub_26EB6C(LODWORD(v15), HIDWORD(v15));
    ...
    if ( v25 )
    {
      v94 = sub_26EB6C(COERCE_UNSIGNED_INT64(v14 * v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * v15 * 100.0)));
      v95 = sub_26ECB0(v94, HIDWORD(v94));
      v96 = json_real(LODWORD(v95));
      json_object_set_new(v12, "GHS 5s", v96);
      v97 = sub_26EB6C(COERCE_UNSIGNED_INT64(v19 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v19 * 100.0)));
      v98 = sub_26ECB0(v97, HIDWORD(v97));
      v99 = json_real(LODWORD(v98));
      json_object_set_new(v12, "GHS av", v99);
      v100 = sub_26EB6C(COERCE_UNSIGNED_INT64(v105 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v105 * 100.0)));
      v34 = sub_26ECB0(v100, HIDWORD(v100));
    }
    else
    {
      v26 = sub_26EB6C(COERCE_UNSIGNED_INT64(v18 * v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v18 * v15 * 100.0)));
      v27 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v26, HIDWORD(v26));
      v28 = json_real(v27);
      json_object_set_new(v12, "GHS 5s", v28);
      v29 = *(float *)&v15;
      v30 = sub_26EB6C(COERCE_UNSIGNED_INT64(v29 * v19 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v29 * v19 * 100.0)));
      v31 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v30, HIDWORD(v30));
      v32 = json_real(v31);
      json_object_set_new(v12, "GHS av", v32);
      v33 = sub_26EB6C(COERCE_UNSIGNED_INT64(v29 * v105 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v29 * v105 * 100.0)));
      LODWORD(v34) = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v33, HIDWORD(v33));
    }
    v35 = json_real(LODWORD(v34));
    json_object_set_new(v12, "GHS 30m", v35);
    v36 = json_integer(dword_2EA2A8, 0);
    ...
    v41 = sub_26EB6C(COERCE_UNSIGNED_INT64(v22 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v22 * 100.0)));
    v42 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v41, HIDWORD(v41));
    v43 = json_real(v42);
    ...
    v50 = sub_26EB6C(COERCE_UNSIGNED_INT64(dbl_2EA2B0 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(dbl_2EA2B0 * 100.0)));
    v51 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v50, HIDWORD(v50));
    v52 = json_real(v51);
    ...
    v56 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v55, HIDWORD(v55));
    v57 = json_real(v56);
    ...
    v59 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v58, HIDWORD(v58));
    v60 = json_real(v59);
    ...
    v62 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v61, HIDWORD(v61));
    v63 = json_real(v62);
    json_object_set_new(v12, "Difficulty Stale", v63);
    v64 = json_integer(LODWORD(dbl_2EA2B8), HIDWORD(dbl_2EA2B8));
    json_object_set_new(v12, "Best Share", v64);
    v65 = v102;
    v106 = v102 + *(_QWORD *)&total_diff1;
    if ( v102 + *(_QWORD *)&total_diff1 )
    {
      v66 = COERCE_DOUBLE(((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26EC20)(v102, HIDWORD(v102)));
      v67 = sub_26EC20(v106, HIDWORD(v106));
      v68 = sub_26EB6C(COERCE_UNSIGNED_INT64(v66 / v67 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v66 / v67 * 100.0)));
      LODWORD(v65) = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v68, HIDWORD(v68));
    }
    v69 = json_real(v65);
    ...
    v76 = sub_26EB6C(COERCE_UNSIGNED_INT64(v73 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v73 * 100.0)));
    v77 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v76, HIDWORD(v76));
    v78 = json_real(v77);
    ...
    if ( v80 != 0.0 )
    {
      ...
      v79 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_26ECB0)(v91, HIDWORD(v91));
    }
    v81 = json_real(v79);
