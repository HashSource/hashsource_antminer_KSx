int __fastcall dram_pre_bist1_rvn(int a1, char a2)
{
  ...
  sub_FB328(a1, a2, 254, 6698008);
  sub_FB328(a1, a2, 255, 6698009);
  sub_FB328(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_FB328(a1, a2, 240, 769);
  usleep(0x249u);
  sub_FB328(a1, a2, 245, (int)"fE");
  sub_FB328(a1, a2, 246, 270336);
  sub_FB328(
    a1,
    a2,
    247,
    (int)"_$LT$core..core_arch..arm_shared..neon..uint16x8x2_t$u20$as$u20$core..fmt..Debug$GT$3fmt17h41a4fb7e80fd2266E");
