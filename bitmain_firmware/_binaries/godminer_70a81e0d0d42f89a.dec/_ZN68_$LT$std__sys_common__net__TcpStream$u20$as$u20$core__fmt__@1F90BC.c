int __fastcall <std::sys_common::net::TcpStream as core::fmt::Debug>::fmt(int *a1, int a2)
{
  ...
  else
  {
    ...
    v23 = v15;
    v24 = v16;
    core::fmt::builders::DebugStruct::field(v8, aAddr, 4, &v17, &off_2E1E44);
  }
  sub_1F8F48((int)&v9, v3);
  if ( (unsigned __int16)v9 == 2 )
  {
    if ( (unsigned __int8)v10 == 3 )
    {
  ...
  else
  {
    ...
    v23 = v15;
    v24 = v16;
    core::fmt::builders::DebugStruct::field(v8, aPeer, 4, &v17, &off_2E1E44);
  }
  v17 = v3;
  v6 = core::fmt::builders::DebugStruct::field(v8, aFd, 2, &v17, &off_2E0A5C);
