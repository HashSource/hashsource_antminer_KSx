int __fastcall <core::ffi::VaList as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v10 = v3;
  v9 = a2;
  v4 = core::fmt::builders::DebugStruct::field(&v9, (int)&unk_2B62E4, 5u, (int)&v7, (int)&off_2E6778);
  core::fmt::builders::DebugStruct::field(v4, (int)aMarker, 7u, (int)&v8, (int)&off_2E6788);
  if ( v11 )
  {
    if ( v10 )
    {
