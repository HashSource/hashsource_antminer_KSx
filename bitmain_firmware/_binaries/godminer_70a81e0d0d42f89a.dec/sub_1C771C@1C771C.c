unsigned int __fastcall sub_1C771C(unsigned int result, int a2, unsigned int a3, int a4)
{
  int v4; // r7
  unsigned int v6; // r10
  _DWORD *v7; // r9
...
LABEL_28:
  ...
  while ( 2 )
  {
    ...
    v71 = v31;
    v72 = v32;
    sub_1BA2C0((int)&v61, (unsigned int *)&v56, v33, (int)&v70);
    if ( v61 == 46 )
    {
      result = v62;
      v46 = v63;
    ...
    if ( (unsigned __int16)v64 <= 0x46u )
    {
      if ( (unsigned __int16)v64 == 3 )
      {
        ...
        LODWORD(v37) = &v70;
        sub_1BC300(v37);
        sub_1BCDBC((int)&v66, (_DWORD *)(v38 + 8), *(unsigned __int8 *)(a2 + 41), *(_DWORD *)(a2 + 264), &v70);
        v39 = v52;
...
LABEL_32:
    ...
    if ( v34 )
    {
      ...
      LODWORD(v35) = &v70;
      sub_1BC300(v35);
      sub_1BCDBC((int)&v66, (_DWORD *)(v36 + 8), *(unsigned __int8 *)(a2 + 41), *(_DWORD *)(a2 + 264), &v70);
      if ( (unsigned __int8)v66 == 75 )
      {
        v49 = v68;
        *(_DWORD *)(v55 + 4) = v67;
