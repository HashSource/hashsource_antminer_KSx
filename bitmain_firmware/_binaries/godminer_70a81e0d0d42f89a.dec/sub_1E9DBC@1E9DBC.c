void __fastcall sub_1E9DBC(int *a1, int a2, int a3)
{
  ...
  if ( v10 != 3 )
  {
    if ( v10 == 2 )
    {
      __dmb(0xBu);
      do
        v11 = __ldrex((unsigned __int8 *)&unk_2EA260);
      while ( __strex(0, (unsigned __int8 *)&unk_2EA260) );
      __dmb(0xBu);
      if ( !v11 )
        return;
      v24 = 1;
    ...
    else
    {
      if ( v10 == 1 )
      {
        sub_1E7024((int)&v21, a2, a3, 1);
        if ( (unsigned __int8)v21 != 3 )
          return;
      }
      else
      {
        sub_1E7024((int)&v21, a2, a3, 0);
        if ( (unsigned __int8)v21 != 3 )
          return;
      }
      v12 = v22;
