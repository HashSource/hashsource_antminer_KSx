int __fastcall set_miner_6060info_runtime_bad_asic_err(int a1, char a2)
{
  ...
  v8 = sub_26EB6C(v2, v3);
  v9 = (unsigned __int64)(v8 - *(_QWORD *)&byte_2EB9A8[16 * v5 + 440]) >> 32;
  if ( v9 - ((_DWORD)v8 == *(_DWORD *)&byte_2EB9A8[16 * v5 + 440]) < 0 == __OFSUB__(
                                                                            v9,
                                                                            0,
                                                                            (_DWORD)v8 != *(_DWORD *)&byte_2EB9A8[16 * v5 + 440]) )
  {
    v10 = snprintf(s, 0x80u, "J%d:1", v5);
    V_LOCK(v10);
