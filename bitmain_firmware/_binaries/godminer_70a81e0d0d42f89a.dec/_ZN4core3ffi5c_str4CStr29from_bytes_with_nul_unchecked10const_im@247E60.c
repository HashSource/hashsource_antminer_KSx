int __fastcall core::ffi::c_str::CStr::from_bytes_with_nul_unchecked::const_impl(int result, unsigned int a2)
{
  ...
  if ( !a2 )
    goto LABEL_12;
  if ( v2 >= a2 )
    core::panicking::panic_bounds_check(v2, a2, (int)&off_2E5FB4);
  if ( *(_BYTE *)(result + v2) )
  {
LABEL_12:
    v7 = 1;
    ...
    v6 = &off_2E5FC4;
    v8 = aLibraryCoreSrc;
    core::panicking::panic_fmt((int)v5, (int)&off_2E5FCC);
  }
  for ( i = 2 - a2; i != 1; ++i )
  {
    if ( a2 < 2 )
      core::panicking::panic_bounds_check(-i, a2, (int)&off_2E5FDC);
    if ( !*(unsigned __int8 *)(result - i) )
    {
      ...
      v6 = (char **)&off_2E5FEC;
      v8 = aLibraryCoreSrc;
      core::panicking::panic_fmt((int)v5, (int)&off_2E5FF4);
    }
  }
  return result;
}
