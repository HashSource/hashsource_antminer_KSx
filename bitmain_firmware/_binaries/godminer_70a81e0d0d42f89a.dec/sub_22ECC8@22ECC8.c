int __fastcall sub_22ECC8(_DWORD *a1)
{
  int v1; // r2
  unsigned int v3; // r9
  unsigned int v4; // lr
...
LABEL_50:
    ...
    else
    {
      ...
      if ( v21 <= 0x1F4 )
      {
        ...
        v33 = v22;
        v34 = v23;
        result = (unsigned __int8)sub_22ECC8(a1);
        *a1 = v33;
        a1[1] = v34;
        a1[2] = v24;
        a1[3] = v25;
...
LABEL_51:
  ...
  {
    a1[2] = v4 + 1;
    if ( sub_22D6CC((int)a1, 0) )
      return 2;
    v19 = a1[4];
    if ( v19 )
    {
      if ( <str as core::fmt::Display>::fmt(asc_2B2F1A, 1, v19) )
        return 2;
    }
    v26 = *a1;
    if ( *a1 )
    {
      for ( i = 0; ; --i )
      {
        ...
        if ( !v30 && <str as core::fmt::Display>::fmt(asc_2B30EB, 2, v28) || sub_22DF94(a1, v29) )
          return 2;
        v26 = *a1;
        if ( !*a1 )
          return 1;
