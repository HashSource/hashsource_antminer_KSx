int __fastcall sub_8500C(int a1, const char **a2)
{
  int v3; // r4
  _DWORD *v5; // r8
  ...
  if ( a2 )
  {
    ...
    v23 = sub_26EB6C(LODWORD(v17), HIDWORD(v17));
    ...
    if ( v25 )
      v26 = sub_26EB6C(COERCE_UNSIGNED_INT64(v20 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v20 * 100.0)));
    else
      v26 = sub_26EB6C(COERCE_UNSIGNED_INT64(v19 * v17 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v19 * v17 * 100.0)));
    v27 = COERCE_UNSIGNED_INT64(sub_26ECB0(v26, HIDWORD(v26)));
    v28 = json_real(v27);
    ...
    v30 = sub_26EB6C(COERCE_UNSIGNED_INT64(v22 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v22 * 100.0)));
    v31 = sub_26ECB0(v30, HIDWORD(v30));
    v32 = json_real(LODWORD(v31));
    json_object_set_new(v16, "rate_avg", v32);
    v33 = sub_26EB6C(COERCE_UNSIGNED_INT64(v21 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v21 * 100.0)));
    v34 = sub_26ECB0(v33, HIDWORD(v33));
    v35 = json_real(LODWORD(v34));
    json_object_set_new(v16, "rate_30m", v35);
    v36 = sub_26EB6C(COERCE_UNSIGNED_INT64(v60 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v60 * 100.0)));
    v37 = sub_26ECB0(v36, HIDWORD(v36));
    ...
    v40 = *(_QWORD *)&v18;
    if ( opt_algo == 9 )
      v40 = sub_26EA20(LODWORD(v18), HIDWORD(v18), 1000, 0);
    v41 = json_integer(v40, HIDWORD(v40));
    json_object_set_new(v16, "hw_all", v41);
    v42 = json_integer(LODWORD(dbl_2EA2B8), HIDWORD(dbl_2EA2B8));
