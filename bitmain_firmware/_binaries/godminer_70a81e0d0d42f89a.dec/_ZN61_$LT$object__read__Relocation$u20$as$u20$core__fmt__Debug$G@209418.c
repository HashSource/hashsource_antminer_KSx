int __fastcall <object::read::Relocation as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2E2518;
  v3[1] = &off_2E2508;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aRelocation, 10, &off_2E24D8, 6, v3, 6);
}
