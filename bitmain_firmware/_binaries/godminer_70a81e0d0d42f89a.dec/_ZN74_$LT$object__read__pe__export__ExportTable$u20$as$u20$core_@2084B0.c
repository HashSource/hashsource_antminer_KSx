int __fastcall <object::read::pe::export::ExportTable as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2E2308;
  v3[1] = &off_2E23B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2AA5A8, 11, &off_2E2388, 6, v3, 6);
}
