...
LABEL_22:
          ...
          *a1 = v36[0];
          ...
          while ( __strex(v12, (unsigned int *)&dword_30DFFC) );
          if ( (v12 & 0xBFFFFFFF) == 0x80000000 )
            std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_30DFFC, v12);
          goto LABEL_28;
        }
      }
      else
