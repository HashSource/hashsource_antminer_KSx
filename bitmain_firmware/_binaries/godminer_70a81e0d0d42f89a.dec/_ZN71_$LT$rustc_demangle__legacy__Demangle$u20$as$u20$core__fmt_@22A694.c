...
LABEL_178:
        core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2E4B24);
      }
      v5 = (char)v3[v8 + 1];
      if ( v5 <= -65 )
        goto LABEL_179;
...
LABEL_17:
    ...
    if ( (_BYTE)v76 )
    {
      ...
      core::result::unwrap_failed((int)aCalledResultUn_0, 43, (int)&v74, (int)&off_2E49C4, (int)&off_2E4A54);
    }
    v13 = v77;
    v14 = &v3[v8];
    v3 += v8;
...
LABEL_34:
    if ( v4 && <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B2F0A, 2) )
      return 1;
...
LABEL_108:
            ...
            if ( v13 < 2 )
            {
              v38 = 1;
              v13 = 0;
              if ( <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B2F0E, 1) )
                return v38;
              continue;
            }
            if ( (char)*v14 <= -65 )
            ...
            {
LABEL_48:
              if ( <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B2F0A, 2) )
                return 1;
              if ( v13 >= 3 && v20[2] <= -65 )
LABEL_187:
...
LABEL_188:
        ...
        v76 = (char *)(v14 + 1);
        v81 = 36;
        sub_22A374(&v74, (int *)&v76);
        if ( v74 != 1 )
          goto LABEL_153;
        v35 = v75;
        v36 = v75 + 1;
        if ( v75 == -1 )
          core::str::traits::str_index_overflow_fail((int)&off_2E4AD4);
...
LABEL_125:
        ...
        if ( v75 != 1 )
        {
          if ( v75 == 2 )
          {
            v40 = (const char *)&unk_2B2F11;
            if ( *v34 == 20563
              || (v40 = asc_2B2F14, *v34 == 20546)
              || (v40 = asc_2B2F17, *v34 == 18002)
              || (v40 = asc_2B2F1A, *v34 == 21580)
              || (v40 = asc_2B2F1D, *v34 == 21575)
              || (v40 = asc_2B2F20, *v34 == 20556)
              || (v40 = asc_2B2F23, *v34 == 20562) )
            {
LABEL_105:
              v38 = 1;
