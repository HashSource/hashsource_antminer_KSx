int __fastcall phy_eq_main_set(int a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    sub_D8AEC(a1, 111, bswap32(*v6) | v3);
  }
LABEL_7:
  v8 = sub_D8B7C(a1, 0, 111, v4);
  if ( v8 )
  {
    v9 = v4;
    v10 = 0;
...
LABEL_13:
  ...
  if ( v12 )
  {
    ...
    sub_D8AEC(a1, 112, bswap32(*v13) | v3);
  }
LABEL_19:
  v15 = sub_D8B7C(a1, 0, 112, v4);
  if ( v15 )
  {
    v16 = v4;
    v17 = 0;
