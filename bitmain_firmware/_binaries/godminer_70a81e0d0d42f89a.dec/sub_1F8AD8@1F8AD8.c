int __fastcall sub_1F8AD8(int a1, __int16 a2, char *name)
{
  int v5; // r0
  int v6; // r6
  _BOOL4 v7; // r2
  ...
  if ( v6 != -11 )
  {
    ...
    if ( v32 )
    {
      v28 = src;
      v29 = n;
      core::result::unwrap_failed((int)&unk_2A68EA, 43, (int)&v28, (int)&off_2E0328, (int)&off_2E1868);
    }
    v12 = n;
    v13 = src;
    v14 = 1;
    ...
    v26 = v29;
    v27 = size;
    sub_1D1F94(&v32, (const void *)v29, size);
    v16 = v32;
