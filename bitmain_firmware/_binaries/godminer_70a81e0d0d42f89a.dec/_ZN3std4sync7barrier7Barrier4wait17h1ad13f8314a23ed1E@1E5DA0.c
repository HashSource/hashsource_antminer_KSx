...
LABEL_34:
    v19 = v3;
    v18 = a1;
    core::result::unwrap_failed((int)&unk_2A68EA, 43, (int)&v18, (int)&off_2E0338, (int)&off_2E10A4);
  }
...
LABEL_21:
        v19 = v17;
        v18 = a1;
        core::result::unwrap_failed((int)&unk_2A68EA, 43, (int)&v18, (int)&off_2E0338, (int)&off_2E10B4);
      }
    }
  }
  if ( !v17
