...
LABEL_6:
    ...
    {
      v17 = *++v16;
      sub_105374(a1, v17, 133, 0xFFFF);
      sub_105374(a1, *v16, 134, 1342177279);
    }
    while ( v16 != v12 );
    sub_105334(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
...
LABEL_27:
  ...
  free(ptr);
  *(_QWORD *)&dword_30CE78 += v34;
  *(_QWORD *)&dbl_30CE80 += v35;
  V_LOCK(v36);
  V_INT((int)&v55, "chain");
