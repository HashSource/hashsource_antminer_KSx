        ...
        int a7)
{
  ...
  do
  {
    v13 = core::fmt::builders::DebugStruct::field(v13, *(v11 - 1), *v11, a6, (int)&off_2E6268);
    a6 += 8;
    v11 += 2;
    --v8;
  }
  ...
  if ( v20 )
  {
    ...
    if ( v19 )
      return v10 != 0;
    if ( (v18[6] & 4) != 0 )
      v15 = (*(int (__fastcall **)(_DWORD, const char *, int))(v18[1] + 12))(*v18, asc_2B639C, 1);
    else
      v15 = (*(int (__fastcall **)(_DWORD, const char *, int))(v18[1] + 12))(*v18, asc_2B63AA, 2);
    return v15 != 0;
  }
  else
  {
