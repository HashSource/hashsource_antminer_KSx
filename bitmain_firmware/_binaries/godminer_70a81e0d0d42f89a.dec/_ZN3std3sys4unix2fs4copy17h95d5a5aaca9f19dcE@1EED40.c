int __fastcall std::sys::unix::fs::copy(int a1, const void *a2, size_t n, const void *a4, size_t a5)
{
  ...
  if ( n >> 7 > 2 )
  {
    sub_7B738(&v43, (int)a2, n, (int)&v40);
    v8 = (int *)(a1 + 4);
...
LABEL_6:
    ...
    sub_1ED79C((int)&v43, SHIDWORD(v45), v46, (int)&v40);
    v8 = (int *)(a1 + 4);
    if ( (unsigned __int8)v43 == 4 )
      goto LABEL_6;
  }
...
LABEL_18:
  ...
  {
    sub_7B738(&v43, (int)a4, a5, (int)&v40);
  }
  if ( (unsigned __int8)v43 == 4 )
  {
LABEL_16:
...
LABEL_44:
        ...
        do
        {
          while ( 1 )
          {
            ...
            {
              v30 = 2;
              v31 = (unsigned int)&off_2E0C28 >> 8;
              v32 = (_DWORD)&off_2E0C28 << 24;
              goto LABEL_57;
            }
            if ( v23 < v29 )
