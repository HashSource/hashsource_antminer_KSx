unsigned int __fastcall std::fs::write::inner(int a1, const void *a2, size_t n, char *a4, unsigned int a5)
{
  int v8; // r6
  unsigned int v9; // r0
  unsigned int v10; // r7
  ...
  if ( n >> 7 > 2 )
  {
    sub_7B738(&v19, (int)a2, n, (int)v17);
...
LABEL_6:
  ...
  if ( !v22[0] )
  {
    sub_1ED79C(&v19, v22[1], v22[2], v17);
    if ( (unsigned __int8)v19 != 4 )
      goto LABEL_8;
    goto LABEL_6;
  }
