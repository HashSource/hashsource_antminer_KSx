int __fastcall <(&str,u16) as std::net::socket_addr::ToSocketAddrs>::to_socket_addrs(_DWORD *a1, int a2)
{
  ...
  if ( v2 <= 0xF )
  {
    ...
    *(_DWORD *)v16 = v4;
    sub_1D9A58((int)&v14, (unsigned __int8 **)v16);
    if ( !*(_DWORD *)&v16[4] )
    {
      if ( (_BYTE)v14 )
      {
...
LABEL_17:
  ...
  else
  {
    ...
    if ( v18 )
    {
      HIDWORD(v14) = dword_2E1158;
      LODWORD(v14) = 1;
      LODWORD(v15) = &off_2E114C;
LABEL_14:
      v11 = v15;
      *a1 = HIDWORD(v14);
      a1[1] = v11;
    ...
    sub_1F8AD8((int)&v14, v5, name);
    if ( (_DWORD)v14 )
      goto LABEL_14;
  }
  v12 = HIDWORD(v14);
  v13 = v15;
  return sub_1DC170(a1, (int)&v12);
}
