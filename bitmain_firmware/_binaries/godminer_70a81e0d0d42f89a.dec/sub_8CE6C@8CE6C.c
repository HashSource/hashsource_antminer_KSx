int __fastcall sub_8CE6C(int a1)
{
  int v1; // r0
  pthread_t v2; // r0
  int v3; // r0
  ...
  if ( dword_2EAA14 > 0 )
  {
    ...
    do
    {
      v8 = sub_8C138();
      ++v7;
      sub_8BA60((void **)(v8 + 12), (_BYTE *)(v8 + 28), v6);
      set_user(v6 + 256);
      v3 = set_pass(v6 + 512);
      v6 += 768;
    }
    while ( dword_2EAA14 > v7 );
  }
  if ( total_pools == v56 )
  {
    V_LOCK(v3);
...
LABEL_57:
    ...
    v49 = pthread_create((pthread_t *)&dword_30E0F4, &attr, (void *(*)(void *))watchpool_thread, &dword_30E0F0);
