int __fastcall set_miner_6060info_board_num_less_than_design_err(char a1)
{
  ...
  if ( !byte_2EBD78 )
    goto LABEL_9;
  difftime(tv.tv_sec, dword_2EBD7C);
  v4 = sub_26EB6C(v1, v2);
  if ( (int)(((unsigned __int64)(v4 - *(_QWORD *)&dword_2EBD80) >> 32) - ((_DWORD)v4 == dword_2EBD80)) < 0 == __OFSUB__((unsigned __int64)(v4 - *(_QWORD *)&dword_2EBD80) >> 32, 0, (_DWORD)v4 != dword_2EBD80) )
  {
    v8 = 3684938;
    V_LOCK(v4);
