int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_D22F0(a1, v30, 12, 1);
    usleep((__useconds_t)"s$u20$core..fmt..Debug$GT$3fmt17h5868a220a5159e3dE");
    sub_D22F0(a1, v30, 160, -2147483647);
    usleep(0xC3500u);
    memset(s, 0, 0x600u);
    v3 = sub_D2588(a1, (unsigned __int16)v30, 161, s);
    v4 = v3;
    if ( v3 == 8
      || (V_LOCK(v3),
          V_INT((int)&v32, "chain"),
          ...
          v3 = zlog(
                 ...
                 "lease/build/godminer-origin_godminer-kas_2382/backend/backend_eth_2280/backend_eth_2280.c",
                 192,
                 "membist1",
                 8,
                 685,
...
LABEL_10:
    memset(s, 0, 0x600u);
    v9 = sub_D2588(a1, (unsigned __int16)v30, 162, s);
    v10 = v9;
    if ( v9 == 8
      || (V_LOCK(v9),
          V_INT((int)v35, "chain"),
...
LABEL_18:
  ...
  *(_QWORD *)v26 = 0;
  ...
  while ( v15 != 8 );
  v20 = dev_ctrl(v16);
  (*(void (__fastcall **)(_DWORD))(v20 + 80))(*(_DWORD *)(a1 + 244));
  qword_2FCC80 = v44;
  qword_2FCC88 = v45;
  qword_2FCC90 = *(_QWORD *)&v46;
  qword_2FCC98 = *(_QWORD *)&v47;
  return 0;
}
