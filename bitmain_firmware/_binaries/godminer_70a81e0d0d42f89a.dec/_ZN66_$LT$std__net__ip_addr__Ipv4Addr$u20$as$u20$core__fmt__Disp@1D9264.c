int __fastcall <std::net::ip_addr::Ipv4Addr as core::fmt::Display>::fmt(int *a1, int a2)
{
  ...
  int (__fastcall *v8)(_DWORD, _DWORD); // [sp+20h] [bp-38h]
  char *v9; // [sp+24h] [bp-34h]
  int (__fastcall *v10)(_DWORD, _DWORD); // [sp+28h] [bp-30h]
  char *v11; // [sp+2Ch] [bp-2Ch]
  int (__fastcall *v12)(_DWORD, _DWORD); // [sp+30h] [bp-28h]
  char *v13; // [sp+34h] [bp-24h]
  int (__fastcall *v14)(_DWORD, _DWORD); // [sp+38h] [bp-20h]
  unsigned int *v15; // [sp+3Ch] [bp-1Ch] BYREF
  _DWORD v16[2]; // [sp+40h] [bp-18h] BYREF
  ...
  if ( core::fmt::Formatter::precision(a2) == 1 || core::fmt::Formatter::width(a2) == 1 )
  {
    ...
    v19 = &v7;
    v17 = &off_2E0CD8;
    if ( core::fmt::write(&v15, &off_2E00C8, v16) )
      core::result::unwrap_failed((int)&unk_2A68EA, 43, (int)v16, (int)&off_2E0318, (int)&off_2E0CF8);
    if ( v5 >= 0x10 )
