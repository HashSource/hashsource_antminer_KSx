int __fastcall set_miner_6060info_low_hashrate_err(int a1, char a2)
{
  ...
  v8 = sub_26EB6C(v2, v3);
  v9 = (unsigned __int64)(v8 - *(_QWORD *)&byte_2EB9A8[16 * v5 + 184]) >> 32;
  if ( v9 - ((_DWORD)v8 == *(_DWORD *)&byte_2EB9A8[16 * v5 + 184]) < 0 == __OFSUB__(
                                                                            v9,
                                                                            0,
                                                                            (_DWORD)v8 != *(_DWORD *)&byte_2EB9A8[16 * v5 + 184]) )
  {
    v10 = snprintf(s, 0x80u, "R%d:1", v5);
    V_LOCK(v10);
