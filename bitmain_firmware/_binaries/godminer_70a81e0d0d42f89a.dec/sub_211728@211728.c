unsigned int __fastcall sub_211728(
        int a1,
        unsigned int *a2,
        _DWORD *a3,
        int a4,
...
LABEL_76:
          ...
          do
          {
            if ( v69 == -1 )
              return 1;
            if ( v51 - 1 >= v10 )
              core::panicking::panic_bounds_check(v69, v10, (int)&off_2E38C8);
            v27 = v52 + v69;
            if ( v52 + v69 >= a5 )
            {
LABEL_128:
...
LABEL_110:
          ...
          if ( v74 > result )
          {
            ...
            while ( 1 )
            {
              if ( v47 >= v10 )
LABEL_126:
                core::panicking::panic_bounds_check(v47, v10, (int)&off_2E3918);
              v48 = v72 + v47;
              if ( v72 + v47 >= a5 )
              {
LABEL_127:
...
LABEL_116:
          if ( result >= v10 )
LABEL_134:
            core::panicking::panic_bounds_check(result, v10, (int)&off_2E3938);
          v49 = v72 + result;
          if ( v72 + result >= a5 )
          {
LABEL_135:
...
LABEL_16:
      ...
      do
      {
        if ( v26 == -1 )
          return 1;
        if ( v12 - 1 >= a7 )
          core::panicking::panic_bounds_check(v26, a7, (int)&off_2E38C8);
        v27 = v13 + v26;
        if ( v13 + v26 >= a5 )
          goto LABEL_128;
