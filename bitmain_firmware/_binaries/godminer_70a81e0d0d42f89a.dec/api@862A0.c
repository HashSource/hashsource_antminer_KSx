void *api()
{
  ...
  v1 = (unsigned __int8)byte_2EA2C0;
  v130 = 0;
  v131 = 0;
  v135 = 0;
  v136 = 0;
...
LABEL_10:
    ...
    if ( v12 >= 0 )
    {
      ...
      while ( 1 )
      {
        v13 = (unsigned __int8)byte_2EA29C;
        if ( byte_2EA29C )
        {
LABEL_107:
        ...
        *(_QWORD *)::s1 = 0;
              ...
              while ( json_array_size(v26) > v66 )
              {
                ...
                if ( *v68 == 2 )
                {
                  ...
                  if ( v72 | v115 )
                  {
                    ...
                    sub_81A54(v118, (const char *)&s1, v70, v115);
        ...
        if ( !v30 || *v30 )
        {
          ...
          sub_81A54(v28, (const char *)&v130, (int)&v135, 2u);
          goto LABEL_38;
        }
        ...
        if ( v55 && *v55 == 2 )
        {
          ...
          if ( v102 && *v102 == 5 )
          {
            ...
            {
              v112 = protocol;
              sub_81A54(v28, (const char *)&v130, (int)&v135, protocol);
              goto LABEL_38;
            }
            v104 = protocol;
          }
          else
          {
            ...
            {
              v112 = 1;
              sub_81A54(v28, (const char *)&v130, (int)&v135, 1u);
              goto LABEL_38;
            }
            v104 = 1;
          }
          ...
          if ( v107 )
          {
            sub_81A54(v28, (const char *)&v130, (int)&v135, v104);
          }
          else
          {
            json_delete(v31);
            sub_81A54(v28, (const char *)&v130, (int)&v135, v112);
          }
        }
        else
        {
          ...
          zlog(
            ...
            100,
            v152);
          sub_7EE7C(v28, 0, 24, (int)"Missing JSON 'command'");
        }
LABEL_38:
        if ( v112 == 2 )
        {
                ...
                if ( v38 )
                {
                  if ( !*v38 )
                  {
                    ...
                    *((_BYTE *)&v144[69] + strlen(s) + 3) = 124;
                    ...
                    if ( (v48 & 0xFFFFFFFB) == 0 )
                    {
                      snprintf(src, 0x100u, (const char *)&off_272598, v49);
                      strcat(s, src);
                    }
