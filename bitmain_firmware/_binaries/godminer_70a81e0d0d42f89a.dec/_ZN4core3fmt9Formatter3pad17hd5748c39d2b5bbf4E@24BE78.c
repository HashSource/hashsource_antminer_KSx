int __fastcall core::fmt::Formatter::pad(int *a1, char *a2, unsigned int a3)
{
  ...
  if ( !v7 )
  {
    v11 = *a1;
    v12 = a1[1];
    return (*(int (__fastcall **)(int, char *))(v12 + 12))(v11, v6);
  }
  if ( v5 == 1 )
  {
    v8 = &a2[a3];
    ...
    while ( 1 )
    {
      ...
      v9 = (unsigned int)&a2[v9 - (_DWORD)v14];
      if ( v13 == 1114112 )
        goto LABEL_34;
    }
    if ( a2 != v8 )
...
LABEL_35:
  ...
  if ( v9 >= 0x10 )
  {
    v23 = core::str::count::do_count_chars(v6, v9);
    if ( v22 > v23 )
      goto LABEL_42;
LABEL_48:
    v12 = a1[1];
...
LABEL_53:
  ...
  if ( v35 == 1114112 || (*(int (__fastcall **)(int, char *, unsigned int))(v34 + 12))(v32, v6, v9) )
    return 1;
  v36 = 0;
  while ( v30 != v36 )
  {
