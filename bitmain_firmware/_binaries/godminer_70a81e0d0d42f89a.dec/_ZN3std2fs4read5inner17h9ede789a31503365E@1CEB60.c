unsigned int __fastcall std::fs::read::inner(int a1, const void *a2, size_t n)
{
  int v5; // r5
  unsigned int v6; // r0
  int v7; // r6
  ...
  if ( n >> 7 > 2 )
  {
    sub_7B738(&v22, (int)a2, n, (int)&v18);
...
LABEL_6:
  ...
  *((_BYTE *)&dest + n) = 0;
  ...
  if ( !v28[0] )
  {
    sub_1ED79C(&v22, v28[1], v28[2], &v18);
    if ( (unsigned __int8)v22 != 4 )
      goto LABEL_8;
    goto LABEL_6;
  }
