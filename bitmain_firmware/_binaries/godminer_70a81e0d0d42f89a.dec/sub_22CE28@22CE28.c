int __fastcall sub_22CE28(_DWORD *a1)
{
  int v2; // r0
  unsigned int v3; // r8
  unsigned int v4; // r3
    ...
    if ( v19 )
    {
      if ( v5 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v24 || !<str as core::fmt::Display>::fmt(asc_2B30EB, 2, v21) )
          {
            ++a1[5];
            if ( !sub_22C930((int)a1, v23, 1u, 0) )
              continue;
          }
          return 1;
        }
        ...
        if ( v26 )
        {
          if ( <str as core::fmt::Display>::fmt(asc_2B30ED, 2, v26) )
            return 1;
        }
      }
      result = sub_22E744(a1);
      a1[5] -= v5;
    }
    else
    {
      return sub_22E744(a1);
    }
  }
  else
  {
