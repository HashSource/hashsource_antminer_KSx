unsigned int __fastcall sub_1B7098(_DWORD *a1, int *a2, int a3, unsigned int a4)
{
  int v4; // r4
  unsigned int v5; // r6
  unsigned int v6; // r9
  ...
  if ( v7 < a4 )
    core::panicking::panic((int)aAssertionFaile_10, 145, (int)&off_2E04D8);
  v8 = v6 + 1;
  v9 = v6 + 1 + v5;
  v28 = a2[3];
  if ( v9 >= 0xC )
    core::panicking::panic((int)aAssertionFaile_11, 42, (int)&off_2E04E8);
  v10 = a2[5];
  v11 = a2[6];
  v26 = *a2;
  v25 = a2[4];
