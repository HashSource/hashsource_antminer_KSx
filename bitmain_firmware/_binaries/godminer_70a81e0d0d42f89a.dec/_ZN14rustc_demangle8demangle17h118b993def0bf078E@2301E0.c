char *__fastcall rustc_demangle::demangle(int *a1, int a2, int a3)
{
  ...
  v3 = (char *)a2;
  core::str::pattern::StrSearcher::new((int)&v107, a2, a3, &unk_2B312F, 6);
  v106 = v3;
  if ( v107 )
  {
    v4 = v115;
          ...
          while ( 1 )
          {
            ...
            while ( v13 != v14 )
            {
              if ( v5 + v14 >= v117 )
              {
                ...
                if ( v117 > v12 + v5 )
                  v91 = v117;
                core::panicking::panic_bounds_check(v91, v117, (int)&off_2E4964);
              }
...
LABEL_35:
      ...
      if ( v111 )
      {
        v17 = v23;
LABEL_223:
        core::panicking::panic_bounds_check(v17, v119, (int)&off_2E4974);
      }
LABEL_185:
      v19 = a3;
      v20 = v5 + 6;
...
LABEL_119:
          ...
          core::result::unwrap_failed((int)aFmtErrorSShoul, 61, (int)&v120, (int)&off_2E49A4, (int)&off_2E4B74);
        }
LABEL_219:
        core::str::slice_error_fail((int)v3);
      }
