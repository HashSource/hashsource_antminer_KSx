void __fastcall std::panicking::default_hook(int a1)
{
  ...
  v2 = *(_DWORD *)_tls_get_addr(&dword_2E7464);
  backtrace_style = 1;
  if ( v2 <= 1 )
  ...
  if ( !v4 )
    core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2E134C);
  v38 = v4;
...
LABEL_43:
  ...
  if ( !v21 )
  {
    v20 = sub_1C968C(0);
    if ( !v20 )
      core::result::unwrap_failed((int)aCannotAccessAT, 70, (int)&v45, (int)&off_2E02F8, (int)&off_2E0778);
  }
  v22 = (int)*v20;
  *v20 = 0;
...
LABEL_26:
  ...
  sub_1E9DBC(v42, v22 + 16, &off_2E1324);
  if ( !v25
  ...
  v27 = v44;
  byte_30DF58 = 1;
  v28 = (_DWORD *)_tls_get_addr(&dword_2E7444);
  v45 = v27;
