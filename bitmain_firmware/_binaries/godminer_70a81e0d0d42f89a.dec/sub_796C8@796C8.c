int *__fastcall sub_796C8(int *a1, unsigned int a2)
{
  int *result; // r0
  unsigned int v3; // r9
  unsigned int v4; // r1
  ...
  if ( a2 >> 1 )
  {
    ...
    do
    {
      ...
      if ( v4 < v3 )
      {
        ...
        do
        {
          ...
          v8 = v4;
          if ( v5 >= v3 )
            core::panicking::panic_bounds_check(v5, v3, &off_2E0288);
          if ( v4 >= v3 )
            core::panicking::panic_bounds_check(v4, v3, &off_2E0298);
          v9 = &a1[6 * v4];
          v10 = &a1[6 * v5];
    ...
    if ( v3 >= 2 )
    {
      ...
      {
        if ( --v17 >= v3 )
          core::panicking::panic_bounds_check(v17, v3, &off_2E0278);
        v18 = a1[1];
        v19 = a1[2];
        v20 = a1[3];
        v21 = a1[4];
        ...
        *v23 = v49;
        ...
        do
        {
          ...
          v33 = v30;
          if ( v31 >= v17 )
            core::panicking::panic_bounds_check(v31, v17, &off_2E0288);
          if ( v30 >= v17 )
            core::panicking::panic_bounds_check(v30, v17, &off_2E0298);
          v34 = &a1[6 * v30];
          v35 = &a1[6 * v31];
