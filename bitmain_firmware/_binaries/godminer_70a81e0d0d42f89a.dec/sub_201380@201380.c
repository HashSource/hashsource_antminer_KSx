int __fastcall sub_201380(int *a1, _BYTE *a2, unsigned int a3)
{
  int v6; // r1
  int v7; // r4
  int v8; // r0
  ...
  if ( a3 < 2 )
    goto LABEL_12;
  v6 = (unsigned __int8)byte_30DFE0;
  if ( byte_30DFE0 )
  {
    if ( byte_30DFE0 == 1 )
      goto LABEL_4;
...
LABEL_15:
  ...
  if ( v14 == v32 )
  {
    sub_1B8B24((unsigned int *)&v32, v14);
    v10 = v33;
    v14 = v34;
  }
  *(_BYTE *)(v10 + v14) = v15 + (v13 >> 4);
  ...
  if ( v17 == v32 )
  {
    sub_1B8B24((unsigned int *)&v32, v17);
    v17 = v34;
  }
  v19 = v32;
  *(_BYTE *)(v33 + v17) = v16 + v18;
  ...
  if ( v20 == v19 )
  {
    sub_1B8B24((unsigned int *)&v32, v20);
    v20 = v34;
  }
  v21 = a2 + 1;
  v22 = a3 - 1;
  *(_BYTE *)(v33 + v20) = 47;
  ...
  do
  {
    ...
    if ( v23 == v32 )
    {
      sub_1B8B24((unsigned int *)&v32, v23);
      v23 = v34;
    }
    v26 = v25 + (v24 >> 4);
    v27 = v32;
    ...
    *(_BYTE *)(v33 + v23) = v26;
    ...
    if ( v30 == v27 )
    {
      sub_1B8B24((unsigned int *)&v32, v30);
      v30 = v34;
    }
    --v22;
    ++v21;
