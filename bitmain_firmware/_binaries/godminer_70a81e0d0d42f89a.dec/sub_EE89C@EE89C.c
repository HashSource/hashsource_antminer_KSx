int __fastcall sub_EE89C(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r8
  int v9; // r11
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 89) = v9;
  *(_BYTE *)(a3 + 88) = v17;
  v18 = sub_26F0D0(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 428));
  if ( v18 >= *(_DWORD *)(a1 + 332) )
  {
    v23 = rand();
    sub_26EDC4(v23, *(_DWORD *)(a1 + 332));
    v18 = v24;
  }
  *a6 = v18;
  *(_DWORD *)(a3 + 8) = v18;
