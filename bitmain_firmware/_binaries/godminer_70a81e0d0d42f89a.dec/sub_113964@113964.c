int sub_113964()
{
    ...
    do
    {
      ...
      *((_DWORD *)v21 + v0) = v5;
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-kas_2382/backend/device/hal/platform/cv183x/cv183x_fan.c",
        196,
        "fan_thread_function",
        19,
        62,
  ...
  for ( ; dword_30CEA4[0]; v3 = usleep(0x64u) )
  {
    v8 = 0;
  ...
  return zlog(
           ...
           "build/godminer-origin_godminer-kas_2382/backend/device/hal/platform/cv183x/cv183x_fan.c",
           196,
           "fan_thread_function",
           19,
           94,
