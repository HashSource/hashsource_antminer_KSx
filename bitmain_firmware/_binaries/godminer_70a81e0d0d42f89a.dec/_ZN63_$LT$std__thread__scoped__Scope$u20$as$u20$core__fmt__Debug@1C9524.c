int __fastcall <std::thread::scoped::Scope as core::fmt::Debug>::fmt(int *a1, int a2)
{
  ...
  v3 = *a1;
  v10 = *(_DWORD *)(v3 + 8);
  v4 = core::fmt::builders::DebugStruct::field(v9, aNumRunningThre, 19, &v10, &off_2E0748);
  v5 = *(_BYTE *)(v3 + 16);
  v11 = v5 != 0;
  v6 = core::fmt::builders::DebugStruct::field(v4, &unk_2A711C, 17, &v11, &off_2E0758);
  v7 = core::fmt::builders::DebugStruct::field(v6, aMainThread, 11, v3 + 12, &off_2E0768);
