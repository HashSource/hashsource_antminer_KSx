unsigned int __fastcall sub_934D4(_DWORD *a1, int a2)
{
  _DWORD *v2; // r8
  unsigned int v5; // r4
  int v6; // r4
    ...
    if ( !v7 )
    {
      if ( v5 != 34 )
      {
        ...
        if ( !v9 )
        {
          ...
          if ( v5 == 45 )
          {
            v38 = sub_9347C((int)a1, a2);
            if ( v38 == 48 )
            {
LABEL_59:
              v19 = sub_9347C((int)a1, a2);
              if ( v19 - 48 <= 9 )
              {
LABEL_60:
                sub_934BC(a1, v19);
...
LABEL_62:
                ...
                if ( !v20 )
                {
                  ...
                  *v40 = 0;
                  ...
                  if ( *v40 == 34 )
                  {
                    if ( v41 < 0 )
                    {
                      sub_93124(a2, a1, 15, "too big negative integer");
                    }
                    else
                    {
                      *v40 = 0;
                      ...
                      if ( *v40 == 34 )
                      {
                        sub_93124(a2, a1, 15, "too big integer");
                        return a1[15];
                      }
                    }
                  }
              ...
              sub_93124(a2, a1, 15, "real number overflow");
              return a1[15];
            }
            if ( v38 - 48 > 9 )
            {
      ...
      if ( v13 != 34 )
      {
        ...
        {
LABEL_117:
          sub_93124(a2, a1, 6, "premature end of input");
          goto LABEL_55;
        }
        if ( v13 <= 0x1F )
        {
LABEL_115:
          sub_934BC(a1, v14);
          if ( v14 == 10 )
            sub_93124(a2, a1, 8, "unexpected newline");
          else
            sub_93124(a2, a1, 8, "control character 0x%x", v14);
LABEL_55:
          jsonp_free(a1[16]);
          v6 = a1[15];
          a1[16] = 0;
        ...
        while ( 1 )
        {
          if ( v14 == 92 )
          {
            v15 = sub_9347C((int)a1, a2);
            if ( v15 == 117 )
            {
              v27 = 4;
              v14 = sub_9347C((int)a1, a2);
              while ( 1 )
              {
                v28 = v14 & 0xFFFFFFDF;
                v29 = v14 - 48;
...
LABEL_54:
              sub_93124(a2, a1, 8, "invalid escape");
              goto LABEL_55;
            }
            v16 = v15 - 92;
...
LABEL_42:
      ...
      for ( i = (const char *)(strbuffer_value(v2) + 1); ; i += 2 )
      {
        while ( 1 )
        {
          ...
          if ( v34 != 117 )
            break;
          v35 = sub_93018((int)(i + 1));
          v36 = v35;
          if ( v35 < 0 )
          {
            sub_93124(a2, a1, 8, "invalid Unicode escape '%.6s'", i);
            goto LABEL_55;
          }
          v45 = v35 - 55296;
          ...
          else
          {
            ...
            {
LABEL_148:
              sub_93124(a2, a1, 8, "invalid Unicode '\\u%04X'", v35);
              goto LABEL_55;
            }
            v37 = sub_93018((int)(i + 7));
            if ( v37 < 0 )
            {
              sub_93124(a2, a1, 8, "invalid Unicode escape '%.6s'", i + 6);
              goto LABEL_55;
            }
            i += 12;
            if ( (unsigned int)(v37 - 56320) >= 0x400 )
            {
              sub_93124(a2, a1, 8, "invalid Unicode '\\u%04X\\u%04X'", v36, v37);
              goto LABEL_55;
            }
