        ...
        unsigned int a2)
{
  ...
  v2 = *(_QWORD *)a1;
  v3 = a1[2];
  v6 = sub_26EA20(*a1, a1[1], a2, 0);
  v7 = v6;
  v8 = HIDWORD(v6);
  LODWORD(v2) = sub_26EA20(1000000000 * (v2 - v6 * a2), (1000000000 * (v2 - v6 * (unsigned __int64)a2)) >> 32, a2, 0);
  v9 = sub_26F0D0(v3, a2) + v2;
  ...
  if ( HIDWORD(v10) == 1 )
  {
    ...
    core::panicking::panic_fmt((int)v12, (int)&off_2E6508);
  }
  *a1 = v7 + v9 / 0x3B9ACA00;
  a1[1] = v10;
