void *__fastcall runtime_ctrl_ltc_1489(int a1)
{
  ...
  LODWORD(s[11]) = sub_F7988;
  HIDWORD(s[11]) = sub_F7870;
  LODWORD(s[12]) = sub_F5B80;
  HIDWORD(s[12]) = sub_F5610;
  LODWORD(s[13]) = sub_F5618;
  HIDWORD(s[13]) = sub_F75A4;
  LODWORD(s[14]) = sub_F6960;
  HIDWORD(s[14]) = sub_F71C4;
  LODWORD(s[15]) = sub_F719C;
