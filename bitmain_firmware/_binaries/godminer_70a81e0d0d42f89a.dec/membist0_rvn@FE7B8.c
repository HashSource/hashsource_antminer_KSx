int __fastcall membist0_rvn(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_FB2D8(a1, v28, 28, 1);
      sub_FB2D8(a1, v28, 160, 3);
      usleep((__useconds_t)"s$u20$core..fmt..Debug$GT$3fmt17h5868a220a5159e3dE");
      v6 = ptr;
      v7 = sub_FB650(a1, (unsigned __int16)v28, 161, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_10:
      v10 = ptr;
      v11 = sub_FB650(a1, (unsigned __int16)v28, 162, ptr);
      if ( v11 > 0 )
      {
        v12 = &ptr[12 * v11];
        do
...
LABEL_16:
      v14 = ptr;
      v3 = sub_FB650(a1, (unsigned __int16)v28, 163, ptr);
      if ( v3 > 0 )
      {
        v15 = &ptr[12 * v3];
        do
...
LABEL_22:
  ...
  v23 = dev_ctrl(v22);
  (*(void (__fastcall **)(_DWORD))(v23 + 80))(*(_DWORD *)(a1 + 244));
  return 0;
}
