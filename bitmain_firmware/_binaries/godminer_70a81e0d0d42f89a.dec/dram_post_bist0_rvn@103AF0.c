int __fastcall dram_post_bist0_rvn(int a1, char a2)
{
  ...
  sub_FB328(a1, a2, 252, 0);
  sub_FB328(a1, a2, 253, 0);
  sub_FB328(a1, a2, 254, 14948360);
  sub_FB328(a1, a2, 255, 14948361);
  sub_FB328(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_FB328(a1, a2, 240, 769);
  usleep(0x249u);
  sub_FB328(a1, a2, 245, 0x40000);
  sub_FB328(a1, a2, 246, (int)"_pic_mcu_en");
  sub_FB328(a1, a2, 247, (int)"tform_is_pic_mcu_en");
