...
LABEL_2:
    ...
    else
    {
      ...
      else
      {
        ...
        if ( dword_2E8F98 > 0 )
          close(dword_2E8F98);
        dword_2E8F98 = open64("/sys/class/gpio/gpio459/value", 1);
        if ( dword_2E8F98 < 0 )
        {
        ...
        else
        {
          if ( dword_2E8F90 > 0 )
            close(dword_2E8F90);
          dword_2E8F90 = open64("/sys/class/gpio/gpio461/value", 1);
          if ( dword_2E8F90 < 0 )
          {
          ...
          else
          {
            if ( dword_2E8F94 > 0 )
              close(dword_2E8F94);
            dword_2E8F94 = open64("/sys/class/gpio/gpio461/direction", 1);
            if ( dword_2E8F94 >= 0 )
            {
              v1 = 255;
