int __fastcall sub_2296B8(unsigned int a1)
{
  unsigned int v1; // r1
  unsigned int v2; // r2
  unsigned int v3; // r2
  ...
  *(_DWORD *)(a1 + 4) = v6;
  if ( v2 != 2 )
    core::panicking::panic((int)aInternalErrorE_1, 40, (int)&off_2E4BB4);
  v8 = *v5;
  v9 = v5[1];
  LOBYTE(v10) = v8 - 48;
...
LABEL_76:
          ...
          v48[2] = &off_2E4BE4;
          v48[4] = &v49;
          core::panicking::panic_fmt((int)v48, (int)&off_2E4C04);
        }
        if ( v6 - 2 < 2 )
          return 1114112;
        v27 = *v23;
...
LABEL_60:
                ...
                v42 = 3;
LABEL_78:
                core::panicking::panic_bounds_check(v42, v26, (int)&off_2E4BD4);
              }
            }
          }
        }
...
LABEL_82:
    core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2E4BC4);
  }
  return 1114112;
}
