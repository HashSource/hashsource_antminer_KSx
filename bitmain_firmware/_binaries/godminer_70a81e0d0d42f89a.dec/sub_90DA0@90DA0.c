int __fastcall sub_90DA0(int a1, int a2, char *a3, const char **a4, int *a5, char a6)
{
  char v6; // r7
  int v9; // r0
  int v10; // r3
  ...
  while ( 1 )
  {
    ...
    *v12 = 0;
    if ( v14 >= a1 )
    {
      ...
      {
        sub_90AC4(dword_2E7B34, dword_2E7B30, v14, a2);
        optind -= v33 - v34;
      }
      goto LABEL_57;
    }
...
LABEL_18:
      v21 = (char *)off_2E7B20;
      v22 = *(unsigned __int8 *)off_2E7B20;
      if ( *(_BYTE *)off_2E7B20 )
        goto LABEL_19;
    }
    else
...
LABEL_78:
      ...
      if ( v27 && v26 == 59 )
      {
        if ( !v42[1] )
        {
          ...
          off_2E7B20 = *(_UNKNOWN **)(a2 + 4 * v28);
        }
        v24 = sub_90B8C(a2, s, a4, a5, 0);
        goto LABEL_53;
      }
LABEL_69:
      if ( v26 != 58 )
    ...
    if ( dword_2E7B30 != -1 )
    {
      sub_90AC4(v31, dword_2E7B30, v40, a2);
      optind -= v39 - v31;
    }
LABEL_57:
    dword_2E7B30 = -1;
