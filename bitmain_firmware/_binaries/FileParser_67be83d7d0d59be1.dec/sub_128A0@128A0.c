int __fastcall sub_128A0(const char *a1, char *a2, const char *a3, _BYTE *a4, char a5, char a6, char a7)
{
  ...
  unsigned int v33; // [sp+BB4h] [bp-58h]
  int v34; // [sp+BB8h] [bp-54h]
  int v35; // [sp+BBCh] [bp-50h]
  int bio_RSA_PUBKEY; // [sp+BC0h] [bp-4Ch]
  int v37; // [sp+BC4h] [bp-48h]
  FILE *v38; // [sp+BC8h] [bp-44h]
  int v39; // [sp+BCCh] [bp-40h]
  size_t n; // [sp+BD0h] [bp-3Ch]
  FILE *v41; // [sp+BD4h] [bp-38h]
  unsigned int v42; // [sp+BD8h] [bp-34h]
  unsigned __int16 v43; // [sp+BDEh] [bp-2Eh]
  unsigned __int64 v44; // [sp+BE0h] [bp-2Ch]
  FILE *stream; // [sp+BE8h] [bp-24h]
  int v46; // [sp+BECh] [bp-20h]
  int m; // [sp+BF0h] [bp-1Ch]
  int k; // [sp+BF4h] [bp-18h]
  int j; // [sp+BF8h] [bp-14h]
  int v50; // [sp+BFCh] [bp-10h]
  int i; // [sp+C00h] [bp-Ch]
  unsigned __int8 v52; // [sp+C07h] [bp-5h]
      ...
      if ( *a4 == 38 )
      {
        ...
        if ( v44 == dest )
        {
          ...
          if ( !a7 || (printf("content:%x\n", v43), (v43 & 0xFE00) == 0xFE00) )
          {
            ...
            if ( v52 == (unsigned __int8)a4[1304] )
            {
              v50 = ((unsigned __int8)a4[1304] + 9) << 8;
              v42 = _byteswap_ulong(*(_DWORD *)(a4 + 1305));
              for ( j = 0; j < v52; ++j )
              {
              ...
              if ( v50 == v46 )
              {
                v41 = (FILE *)fopen64(a3, "r");
                if ( v41 )
                {
                  memset(v29, 0, sizeof(v29));
                  fread(v29, 0x400u, 1u, v41);
                  fclose(v41);
                  v41 = 0;
                  n = ((unsigned __int8)a4[22] << 8) | (unsigned __int8)a4[23];
                  v39 = sub_10C50((int)(a4 + 24), n, (int)(a4 + 1048), (int)v29);
                  if ( v39 )
                  {
                  ...
                  else
                  {
                    ...
                    for ( m = 0; m < v52; ++m )
                      sub_10DC8(stream, 256, (int)&v28[2 * v52 + 2 + 2 * m], a4[5 * m + 1309], 1, a5);
                    ...
                    v25 = 0;
                    SHA256_Init(v20);
                    SHA256_Update(v20, v28, (v52 << 6) + 32);
