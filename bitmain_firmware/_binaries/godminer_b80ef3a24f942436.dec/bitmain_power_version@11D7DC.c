int bitmain_power_version()
{
  ...
  if ( dword_3114C8 == 255 )
  {
    if ( sub_11D014((unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u) )
    {
      v0 = -2147482880;
  ...
  else if ( sub_11D17C(dword_3114C8, (unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u) )
  {
    v0 = -2147482880;
    strcpy(s, "get power version failed");
    V_LOCK(*(_DWORD *)"n failed");
