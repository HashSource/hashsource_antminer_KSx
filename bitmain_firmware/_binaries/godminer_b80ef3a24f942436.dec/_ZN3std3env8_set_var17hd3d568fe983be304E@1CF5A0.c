int __fastcall std::env::_set_var(_BYTE *a1, size_t a2, _BYTE *a3, size_t n)
{
  char *v7; // r6
  int result; // r0
...
LABEL_6:
  ...
  if ( (unsigned __int8)v11 != 4 )
  {
    ...
    v16[4] = &v17;
    v16[2] = v10;
    v16[3] = <std::path::Display as core::fmt::Debug>::fmt;
    v16[1] = <std::path::Display as core::fmt::Debug>::fmt;
    v16[0] = v9;
    core::panicking::panic_fmt((int)dest, (int)&off_2E98AC);
  }
  return result;
}
