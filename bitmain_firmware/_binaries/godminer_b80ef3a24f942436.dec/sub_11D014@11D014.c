int __fastcall sub_11D014(unsigned __int8 *a1, unsigned int a2, unsigned __int8 *a3, unsigned int a4)
{
  int v8; // r10
  unsigned int v9; // r4
  unsigned int v10; // r3
  ...
  do
  {
    ...
    v12 = sub_11CDE8(a1, a3, a4);
    if ( !v12 )
      break;
    v16 = v8++;
    v13 = snprintf(s, 0x800u, "Send power cmd(0x%02x) failed, retry %d", a1[3], v16);
    V_LOCK(v13);
