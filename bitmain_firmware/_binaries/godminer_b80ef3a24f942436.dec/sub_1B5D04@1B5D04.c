int __fastcall sub_1B5D04(_DWORD *a1, _DWORD *a2, size_t *a3, int *a4)
{
  unsigned int v4; // r7
  _DWORD *v5; // r8
  int v6; // r1
...
LABEL_64:
    ...
    while ( 1 )
    {
      ...
      *(_DWORD *)v77 = 0;
      ...
      v86 = v85[1];
      v87 = v85[2];
      v186 = (unsigned __int16 *)v84;
      v199 = v87;
      v198 = (unsigned __int16 *)v86;
      if ( v81 > 0xB )
        core::slice::index::slice_end_index_len_fail();
      v88 = v75 + 1;
      if ( v80 - (v75 + 1) != v81 )
