int __fastcall <core::str::lossy::Utf8Chunks as core::fmt::Debug>::fmt(_DWORD *a1, _DWORD *a2)
{
  ...
  v10[0] = *a1;
  v10[1] = v4;
  core::fmt::builders::DebugStruct::field(&v7, (int)aSource, 6u, (int)v10, (int)&off_2EF478);
  if ( v9 )
  {
    if ( v8 )
    {
    ...
    {
      if ( (v7[6] & 4) != 0 )
        v6 = (*(int (__fastcall **)(_DWORD, const char *, int))(v7[1] + 12))(*v7, asc_2BF6DC, 1);
      else
        v6 = (*(int (__fastcall **)(_DWORD, const char *, int))(v7[1] + 12))(*v7, asc_2BF6EA, 2);
      return v6 != 0;
    }
  }
  else
