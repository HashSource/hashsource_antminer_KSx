int __fastcall sub_1F2A58(_DWORD *a1, char *name, char *value)
{
  _BOOL4 v7; // r5
  int v8; // r6
  unsigned int v9; // r0
...
LABEL_4:
  ...
  v8 = (unsigned __int8)byte_312454;
...
LABEL_8:
      ...
      do
      {
        v9 = __ldrex((unsigned int *)&dword_31244C);
        v10 = v9 - 0x3FFFFFFF;
        result = __strex(v9 - 0x3FFFFFFF, (unsigned int *)&dword_31244C);
      }
      while ( result );
      goto LABEL_18;
    }
  ...
  do
  {
    v13 = __ldrex((unsigned int *)&dword_31244C);
    v10 = v13 - 0x3FFFFFFF;
    result = __strex(v13 - 0x3FFFFFFF, (unsigned int *)&dword_31244C);
  }
  while ( result );
LABEL_18:
  if ( v10 >= 0x40000000 )
    return std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_31244C, v10);
  return result;
}
