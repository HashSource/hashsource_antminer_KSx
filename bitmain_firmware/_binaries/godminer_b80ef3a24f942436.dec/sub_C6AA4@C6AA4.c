int __fastcall sub_C6AA4(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r9
  int v9; // r11
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v9;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = sub_270BA8(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 428));
  if ( v19 >= *(_DWORD *)(a1 + 336) )
  {
    v26 = rand();
    sub_27089C(v26, *(_DWORD *)(a1 + 336));
    v19 = v27;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 8) & 3)
  ...
  if ( BM_CRC5((_BYTE *)(a2 + 2), 75) != (*(_BYTE *)(a2 + 11) & 0x1F) && *(_BYTE *)(a1 + 254) )
  {
    v24 = dword_3010F4++;
    if ( !(v24 % 0x3E8) )
    {
