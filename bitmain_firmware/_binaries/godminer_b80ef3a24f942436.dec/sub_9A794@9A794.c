int __fastcall sub_9A794(_DWORD *a1, int a2)
{
  int v2; // r4
  int v4; // r0
  _DWORD *v7; // r0
  ...
  _BYTE v45[4100]; // [sp+20h] [bp-1004h] BYREF
  ...
  {
    V_LOCK(v19);
    v22 = logfmt_raw((int)v45, 0x1000u);
    V_UNLOCK(v22);
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build"
...
LABEL_15:
  ...
  *(_DWORD *)(a2 + 1748) = v30;
  ...
  {
    V_LOCK(0);
    v40 = logfmt_raw((int)v45, 0x1000u);
    V_UNLOCK(v40);
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build"
...
LABEL_18:
  ...
  if ( v33 || (v33 = calloc(1u, 0x6Bu), (*(_DWORD *)(a2 + 1588) = v33) != 0) )
  {
    ...
    *(_DWORD *)(a2 + 1580) = v36;
    if ( v36 )
      strcpy(v36, "HAPPY");
    LODWORD(v37) = get_epoch_number_eth(v33);
    *(_DWORD *)(a2 + 1536) = v37;
    if ( nptr )
    {
      v37 = strtoull(nptr, 0, 16);
      *((_QWORD *)v33 + 12) = v37;
    }
    else
    {
