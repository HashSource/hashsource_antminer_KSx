int __fastcall set_miner_6060info_asic_num_less_than_design_err(int a1, int a2)
{
  ...
  struct timeval v11[512]; // [sp+90h] [bp-1000h] BYREF
  ...
  if ( a1 > 15 )
  {
    ...
    zlog(
      ...
      "/godminer-origin_godminer-new/miner_util/miner_monitor/miner_6060info.c",
      185,
  ...
  if ( a2 )
  {
    ...
    *((_DWORD *)v4 + 7) = v11[0].tv_sec;
    if ( !v6 )
    {
      if ( a2 )
      {
        v7 = snprintf(s, 0x80u, "J%d:2", v3);
        V_LOCK(v7);
