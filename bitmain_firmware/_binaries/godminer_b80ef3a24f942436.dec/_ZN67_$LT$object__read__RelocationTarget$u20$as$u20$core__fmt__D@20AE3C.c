int __fastcall <object::read::RelocationTarget as core::fmt::Debug>::fmt(_DWORD *a1, _DWORD *a2)
{
  ...
  if ( *a1 )
  {
    ...
    {
      v4 = a1 + 1;
      return core::fmt::Formatter::debug_tuple_field1_finish(a2, (int)aSection, 7, (int)&v4, (int)&off_2EB478);
    }
    else
    {
  ...
  {
    v3 = a1 + 1;
    return core::fmt::Formatter::debug_tuple_field1_finish(a2, (int)aSymbol_0, 6, (int)&v3, (int)&off_2EB4C8);
  }
}
