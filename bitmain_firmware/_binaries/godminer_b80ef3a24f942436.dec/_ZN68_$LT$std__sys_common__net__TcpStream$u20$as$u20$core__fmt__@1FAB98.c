int __fastcall <std::sys_common::net::TcpStream as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  ...
  else
  {
    ...
    v23 = v15;
    v24 = v16;
    core::fmt::builders::DebugStruct::field(v8, (int)aAddr, 4u, (int)&v17, (int)&off_2EAE44);
  }
  sub_1FAA24((int)&v9, v3);
  if ( (unsigned __int16)v9 == 2 )
  {
    if ( (unsigned __int8)v10 == 3 )
    {
  ...
  else
  {
    ...
    v23 = v15;
    v24 = v16;
    core::fmt::builders::DebugStruct::field(v8, (int)aPeer, 4u, (int)&v17, (int)&off_2EAE44);
  }
  v17 = v3;
  v6 = core::fmt::builders::DebugStruct::field(v8, (int)aFd, 2u, (int)&v17, (int)&off_2E9A5C);
