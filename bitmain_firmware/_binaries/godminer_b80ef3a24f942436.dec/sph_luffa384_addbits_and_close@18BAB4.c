void *__fastcall sph_luffa384_addbits_and_close(unsigned int *a1, char a2, char a3, _BYTE *a4)
{
  ...
  unsigned int v277; // [sp+54h] [bp-80h]
  ...
  unsigned int v315; // [sp+88h] [bp-4Ch]
  int v316; // [sp+88h] [bp-4Ch]
  unsigned int v317; // [sp+8Ch] [bp-48h]
  ...
  unsigned int v326; // [sp+A4h] [bp-30h]
  ...
  *((_BYTE *)a1 + v4) = (128 >> a3) | a2 & -(128 >> a3);
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v47 == 8 )
        break;
      v217 = dword_2AD8E0[v47];
      v49 = dword_2AD900[v47];
    }
    v315 = v45;
    v85 = 23617341;
    v251 = v50;
    ...
    while ( 1 )
    {
      ...
      if ( v86 == 8 )
        break;
      v218 = dword_2AD920[v86];
      v85 = dword_2AD940[v86];
    }
    v296 = v94;
    v261 = v87;
    v299 = v88;
    ...
    v132 = v280;
    v133 = v229;
    for ( i = -497126719; ; i = dword_2AD980[v125] )
    {
      v134 = v127 ^ v129;
      v135 = v130 ^ v132;
      v136 = v134 ^ v131 & v129;
    ...
    v171 = v292;
    v172 = v241;
    for ( j = -534197825; ; j = dword_2ADA60[v164] )
    {
      v173 = v166 ^ v168;
      v174 = v169 ^ v171;
      v175 = v173 ^ v170 & v168;
...
LABEL_18:
  ...
  a4[43] = v205;
  a4[47] = v206;
  a4[32] = (v235 ^ v326 ^ v224 ^ v248) >> 24;
  a4[33] = (v235 ^ v326 ^ v224 ^ v248) >> 16;
  a4[36] = HIBYTE(v204);
  a4[37] = BYTE2(v204);
  a4[38] = BYTE1(v204);
  a4[40] = (v230 ^ v317 ^ v299 ^ v242) >> 24;
  a4[42] = BYTE1(v205);
  a4[44] = HIBYTE(v206);
  a4[41] = BYTE2(v205);
  a4[45] = BYTE2(v206);
  a4[46] = BYTE1(v206);
  result = memcpy(a1 + 9, &unk_2AD9A0, 0x80u);
  a1[8] = 0;
  return result;
}
