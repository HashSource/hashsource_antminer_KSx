int __fastcall <std::sys_common::net::TcpListener as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  ...
  else
  {
    ...
    v16[6] = v14;
    v16[7] = v15;
    core::fmt::builders::DebugStruct::field(v7, (int)aAddr, 4u, (int)v16, (int)&off_2EAE44);
  }
  v16[0] = v3;
  v5 = core::fmt::builders::DebugStruct::field(v7, (int)aFd, 2u, (int)v16, (int)&off_2E9A5C);
