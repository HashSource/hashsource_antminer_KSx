int __fastcall sync_get_core_reg_rvn(int a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  int v9; // r5
  char v11; // r12
  char v14; // r1
  ...
  *(_WORD *)((char *)&v30 + 3) = v16;
  ...
  v28[1] = 1000000 * v20;
  v28[0] = sub_2704F8(a7, a8, 1000, 0);
  while ( v19 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), v31, 0xCu, v28) == 110 )
      {
        v9 = 3;
        goto LABEL_15;
      }
      if ( (unsigned __int8)v31[0] != 170 || v31[1] != 85 || v32[0] != 10 || (v34 & 0x40000000) != 0 )
      {
        v9 = 1;
        *a5 = v19;
