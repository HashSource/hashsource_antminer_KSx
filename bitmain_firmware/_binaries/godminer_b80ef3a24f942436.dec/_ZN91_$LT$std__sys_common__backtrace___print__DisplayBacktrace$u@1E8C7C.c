int __fastcall <std::sys_common::backtrace::_print::DisplayBacktrace as core::fmt::Display>::fmt(char *a1, int *a2)
{
  ...
  bool v8; // zf
  bool v10; // zf
  unsigned __int8 v11; // [sp+3h] [bp-4Dh] BYREF
  ...
  unsigned __int8 *v21; // [sp+30h] [bp-20h] BYREF
  ...
  v25 = aRustc9eb3afe9e;
  v21 = 0;
  if ( !core::fmt::Formatter::write_fmt(a2, (int *)&v21) )
  {
    v16[1] = &off_2EA168;
    v25 = (const char *)v16;
    v24 = (int)&v19;
    ...
    v27[1] = &off_2EA464;
    v27[0] = &v21;
    Unwind_Backtrace(sub_1FBCB4, v27);
    if ( !v19 )
    {
      if ( v11
        || (v24 = 1,
            ...
            v23 = &off_2EA17C,
            v25 = aRustc9eb3afe9e,
            !core::fmt::Formatter::write_fmt(a2, (int *)&v21)) )
      {
        v10 = ptr == 0;
        if ( ptr )
          v10 = v12 == 0;
