int __fastcall stratum_authorize_ks5(int a1, int *a2, double *a3)
{
  int v3; // r6
  double *v6; // r11
  int v8; // r8
  ...
  while ( 1 )
  {
    ...
    if ( !v8 )
    {
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c",
        180,
...
LABEL_10:
  ...
  if ( !v6 )
  {
    ...
    zlog(
      ...
      "/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c",
      180,
      "stratum_authorize_ks5",
      21,
      153,
  ...
  zlog(
    ...
    "odminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c",
    180,
    "stratum_authorize_ks5",
    21,
    163,
  ...
  if ( !v3
    || (v16 = json_dumps(v31, 3),
        ...
        zlog(
          ...
          "uild/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c",
          180,
          "stratum_authorize_ks5",
          21,
          170,
