int *__fastcall keccak::f1600(int *a1)
{
  ...
  do
  {
    ...
    v94 = v146 ^ v163;
    v146 ^= *(_DWORD *)&byte_2AF940[-v137 + 4] ^ v163 ^ v98 & ~v93;
    v13 = (v8 << 12) | (v121 >> 20);
    ...
    v91 = v149 ^ v15;
    v122 = v15;
    v149 ^= *(_DWORD *)&byte_2AF940[-v137] ^ v15 ^ v96 & ~v13;
    LODWORD(v16) = v170 ^ v164;
    HIDWORD(v16) = v11 ^ v166;
    v17 = (4 * (v167 ^ v115)) | ((v168 ^ (unsigned int)v156) >> 30);
    ...
    LODWORD(v16) = ((v163 ^ v151) << 9) | ((v15 ^ (unsigned int)v148) >> 23);
    v106 = v113 & ~v17 ^ v22;
    v107 = v20 & ~v19 ^ v16;
    ...
    v105 = v27 & ~v26 ^ v25;
    v29 = (((unsigned int)v165 ^ v128) << 24) | ((HIDWORD(v165) ^ (unsigned int)v130) >> 8);
