int __fastcall hashtable_set(unsigned int *a1, char *a2, unsigned int a3)
{
  ...
  if ( *a1 >> v4 )
  {
    ...
    if ( 1 << v7 )
    {
      ...
      while ( (unsigned int **)((8 << v7) + v8) != v10 );
    }
    ...
    if ( v11 != v9 )
    {
      do
      {
        while ( 1 )
        {
          ...
          v15 = v11[4] & v12;
          v16 = *(unsigned int **)(v8 + 8 * v15);
          v17 = (unsigned int **)(v8 + 8 * v15);
          if ( v16 == v9 && v9 == v17[1] )
            break;
          v13 = *v16;
...
LABEL_12:
  ...
  v19 = strlen(a2);
  v20 = sub_90788((unsigned __int16 *)a2, v19, hashtable_seed);
  v21 = (int *)(v8 + 8 * (v12 & v20));
  v22 = sub_90CCC((int)a1, v21, a2, v20);
  v23 = v22;
  if ( v22 )
  {
    v24 = *(_DWORD **)(v22 + 20);
