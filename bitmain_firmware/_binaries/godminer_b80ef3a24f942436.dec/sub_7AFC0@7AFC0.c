void __fastcall sub_7AFC0(_DWORD *a1, _BYTE *a2, size_t a3)
{
  void *v4; // r3
  char *v5; // r5
  unsigned int v6; // r2
...
LABEL_17:
  ...
  if ( (unsigned int)dword_31244C > 0x3FFFFFFF || (dword_31244C & 0x3FFFFFFE) == 0x3FFFFFFE )
    goto LABEL_9;
  v6 = __ldrex((unsigned int *)&dword_31244C);
  if ( v6 != dword_31244C )
  {
    __clrex();
    goto LABEL_9;
...
LABEL_10:
  ...
  *(_BYTE *)a1 = 4;
  ...
  while ( __strex(v8, (unsigned int *)&dword_31244C) );
  if ( (v8 & 0xBFFFFFFF) == 0x80000000 )
    std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_31244C, v8);
  v9 = ptr;
  v10 = v15 == 0;
  *(_BYTE *)ptr = 0;
  if ( !v10 )
