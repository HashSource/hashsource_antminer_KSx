void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    do
    {
      ...
      while ( !*(_QWORD *)&dbl_2F3DC0 );
    }
    while ( *(_QWORD *)&dbl_2F3DC0 == *(_QWORD *)&dbl_2F3DC8 );
    V_LOCK(LODWORD(dbl_2F3DC0));
    ...
    zlog(
      ...
      v97);
    v2 = dbl_2F3DC0;
    v3 = sub_2704F8(LODWORD(dbl_2F3DC0), HIDWORD(dbl_2F3DC0), 3, 0);
    v4 = (char *)&v93 + 4;
    v5 = &v96;
    ...
    if ( v89 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          40,
          v97);
        v52 = sub_2704F8(LODWORD(dbl_2F3DC0), HIDWORD(dbl_2F3DC0), 7500, 0);
        v53 = *((_DWORD *)v48 + 1);
        v48 += 4;
        v63 = *(void (__fastcall **)(int, _DWORD, _DWORD, _DWORD))(v53 + 12);
        v54 = vshrd_n_u64(qword_28FB40[v52], 8u);
        printf("dag_load: %lx\n", v63);
        v63(v53, v63, v54, HIDWORD(v54));
        while ( 1 )
        {
          ++v51;
          v55 = (*(int (**)(void))(*(_DWORD *)v48 + 8))();
          if ( v51 == 27 )
            break;
          ++v49;
        }
        ...
        v46 = zlog(
                ...
                "ease/build/godminer-origin_godminer-new/dhash_content/rvn/rvn_dhash_common.c",
                180,
                "dag_gen_rvn_thread_func",
                23,
                368,
