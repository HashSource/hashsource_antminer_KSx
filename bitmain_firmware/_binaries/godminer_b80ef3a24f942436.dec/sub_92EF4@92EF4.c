int __fastcall sub_92EF4(int a1, char ***a2, const char *a3, size_t *a4, _DWORD *a5, int a6)
{
  _DWORD *v6; // r5
  _DWORD *v9; // r7
  int v10; // r1
  ...
  *a5 = 0;
  if ( v15 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !*v28 )
      {
        sub_92D54((int *)a1, "<args>", 12, "NULL %s", a3);
        *(_DWORD *)(a1 + 76) = 1;
      }
      sub_92DB4(a1);
      ...
      if ( *(_BYTE *)(a1 + 36) != 43 )
      {
        ...
        *v6 = *v13;
        ...
        else
        {
          ...
          {
            sub_92D54((int *)a1, "<args>", 5, "Invalid UTF-8 %s", a3);
            strbuffer_close((int)&v50);
            *(_DWORD *)(a1 + 76) = 1;
          }
        }
...
LABEL_36:
    v40 = (const char *)v19;
    sub_92D54((int *)a1, v44, v45, v46, v47);
    *(_DWORD *)(a1 + 76) = 1;
    return (int)v40;
  }
  if ( !a6 )
