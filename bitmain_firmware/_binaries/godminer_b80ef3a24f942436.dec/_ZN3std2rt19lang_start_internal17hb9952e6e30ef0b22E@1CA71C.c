int __fastcall std::rt::lang_start_internal(int a1, int a2, int a3, int a4, char a5)
{
  ...
  do
  {
    ...
    {
      if ( (fds.sa_mask.__val[0] & 0x200000) != 0 && open64(aD_3, 2) == -1
        || (fds.sa_mask.__val[2] & 0x200000) != 0 && open64(aD_3, 2) == -1 )
      {
        goto LABEL_41;
      }
...
LABEL_41:
  ...
  if ( v8 > 0x16
    || ((1 << v8) & 0x401800) == 0
    || fcntl(0, 1) == -1 && *_errno_location() == 9 && open64(aD_3, 2) == -1
    || fcntl(1, 1) == -1 && *_errno_location() == 9 && open64(aD_3, 2) == -1 )
  {
    goto LABEL_41;
  }
...
LABEL_25:
      if ( signal(13, (__sighandler_t)v9) == (__sighandler_t)-1 )
      {
        ...
        fds.sa_mask.__val[1] = (unsigned int)&off_2EAC30;
        fds.sa_mask.__val[4] = 0;
        fds.sa_mask.__val[3] = (unsigned int)aRustc9eb3afe9e;
        fds.sa_handler = 0;
        sub_1DA540(stacksize, stackaddr, v35);
        sub_1B2F1C((int)stacksize);
        goto LABEL_46;
      }
LABEL_26:
      v10 = &fds;
      ...
      if ( !fds.sa_handler )
      {
        ...
        fds.sa_handler = (__sighandler_t)sub_1F5D80;
        sigaction(11, &fds, 0);
        byte_312434 = 1;
      }
      sigaction(7, 0, &fds);
...
LABEL_49:
        v36 = 0;
        sub_79544(0, (int)&p_fds, (int)"", v35, (int)v25);
      }
      sub_27094C(v10, v12);
      if ( v16 )
...
LABEL_37:
      ...
      if ( v29 )
      {
        ...
        stackaddr[0] = &fds;
        fds.sa_mask.__val[1] = (unsigned int)&off_2E9708;
        fds.sa_handler = 0;
        stacksize[1] = (size_t)sub_1C0D68;
        stacksize[0] = (size_t)&p_p_fds;
        sub_1DA540(v31, stackaddr, v35);
        v24 = v31[0];
        if ( v31[0] != 4 )
          sub_1B21B8((int)v31);
LABEL_46:
      ...
      v17 = std::thread::Thread::new((int)p_fds, (int)v28);
