bool __fastcall sub_99A30(int a1, int *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  _BOOL4 v7; // r4
            ...
            if ( valid )
            {
              ...
              if ( v24 && !strcmp(v24, v10) )
              {
                ...
                zlog(
                  ...
                  "elease/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                  180,
                  "stratum_notify_dcr",
                  18,
                  112,
                  ...
                  *(_DWORD *)(v79 + 4 * v53) = v57;
                  if ( !v57 )
                  {
                    ...
                    v57 = (void *)zlog(
                                    ...
                                    "fs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                                    180,
                                    "stratum_notify_dcr",
                                    18,
                                    146,
                  ...
                  if ( opt_protocol )
                  {
                    ...
                    zlog(
                      ...
                      "mp/release/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                      180,
                      "stratum_notify_dcr",
                      18,
                      148,
              ...
              if ( v7 )
              {
                    ...
                    if ( v7 )
                    {
                      ...
                      if ( !v48 )
                      {
                        ...
                        zlog(
                          ...
                          "ot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                          180,
                          "stratum_notify_dcr",
                          18,
                          197,
                ...
                else
                {
                  ...
                  zlog(
                    ...
                    "/release/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                    180,
                    "stratum_notify_dcr",
                    18,
                    174,
