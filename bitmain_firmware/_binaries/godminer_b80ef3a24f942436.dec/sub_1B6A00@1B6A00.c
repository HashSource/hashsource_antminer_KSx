int __fastcall sub_1B6A00(_DWORD *a1, int *a2, int *a3, int *a4)
{
  unsigned int v4; // r6
  int v6; // r0
  void *v7; // r4
  ...
  int v157; // [sp+38h] [bp-CCh]
  int v158; // [sp+3Ch] [bp-C8h]
  size_t v159; // [sp+40h] [bp-C4h]
  int *v160; // [sp+44h] [bp-C0h]
  int v161; // [sp+48h] [bp-BCh]
  size_t v162; // [sp+4Ch] [bp-B8h]
  int v163; // [sp+50h] [bp-B4h]
  int v164; // [sp+58h] [bp-ACh]
  size_t v165; // [sp+5Ch] [bp-A8h]
  int v166; // [sp+60h] [bp-A4h]
  int v167; // [sp+70h] [bp-94h] BYREF
  size_t v168; // [sp+74h] [bp-90h]
  int v169; // [sp+78h] [bp-8Ch]
  int v170; // [sp+7Ch] [bp-88h]
  size_t v171; // [sp+80h] [bp-84h]
  int v172; // [sp+84h] [bp-80h]
  size_t v173; // [sp+88h] [bp-7Ch]
  int v174; // [sp+8Ch] [bp-78h]
  size_t v175; // [sp+90h] [bp-74h]
  unsigned __int16 *v176; // [sp+94h] [bp-70h]
  int v177; // [sp+98h] [bp-6Ch]
  void *v178; // [sp+9Ch] [bp-68h]
  int v179; // [sp+A0h] [bp-64h]
  int v180; // [sp+A4h] [bp-60h]
  size_t v181; // [sp+A8h] [bp-5Ch]
  int v182; // [sp+ACh] [bp-58h]
  int v183; // [sp+B0h] [bp-54h]
  size_t v184; // [sp+B4h] [bp-50h]
  int v185; // [sp+B8h] [bp-4Ch]
  int v186; // [sp+BCh] [bp-48h]
  size_t v187; // [sp+C0h] [bp-44h]
  int v188; // [sp+C4h] [bp-40h]
  int v189; // [sp+C8h] [bp-3Ch]
  void *v190; // [sp+CCh] [bp-38h]
  size_t v191; // [sp+D0h] [bp-34h]
  int v192; // [sp+D8h] [bp-2Ch]
  size_t v193; // [sp+DCh] [bp-28h]
  int v194; // [sp+E0h] [bp-24h]
  int v195; // [sp+E8h] [bp-1Ch]
  size_t v196; // [sp+ECh] [bp-18h]
  int v197; // [sp+F0h] [bp-14h]
  int v198; // [sp+F4h] [bp-10h]
  size_t v199; // [sp+F8h] [bp-Ch]
  int v200; // [sp+FCh] [bp-8h]
...
LABEL_21:
  ...
  if ( v19 )
  {
    ...
    *v35 = v37;
    ...
    v44 = v32 + 1;
    if ( v36 - (v32 + 1) != v37 )
      core::panicking::panic((int)aAssertionFaile_6, 40, (int)&off_2E9448);
    v45 = 3 * v44;
    v46 = 12 * v37;
...
LABEL_65:
      ...
      v175 = v150;
      if ( !v160[1] )
        core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2E93E8);
      v114 = *v160;
      v115 = v160[1];
