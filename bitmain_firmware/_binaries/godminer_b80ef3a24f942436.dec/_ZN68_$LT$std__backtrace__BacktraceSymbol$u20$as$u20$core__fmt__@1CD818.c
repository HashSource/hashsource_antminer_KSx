bool __fastcall <std::backtrace::BacktraceSymbol as core::fmt::Debug>::fmt(_DWORD *a1, int *a2)
{
  int v4; // r8
  int v5; // r0
  unsigned int v7; // [sp+4h] [bp-70h]
  ...
  unsigned int v18; // [sp+4Ch] [bp-28h]
  ...
  v7 = a1[10];
  core::str::converts::from_utf8((int)&v9, a1[9], v7);
  v5 = 2;
  if ( !v9 )
  {
    v5 = 2;
    if ( v10 )
    {
      rustc_demangle::try_demangle(&v9, (int)v10, (int)v11);
      v5 = v9;
      if ( v9 == 2 )
      {
        v5 = 2;
  ...
  v19[0] = &v9;
  if ( core::fmt::Formatter::write_fmt(a2, (int *)&v20) )
    return 1;
LABEL_11:
  if ( *a1 != 2 )
  {
