int __fastcall <std::fs::Metadata as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  int v3; // r6
  _BYTE *v4; // r0
  _BYTE *v5; // r0
  ...
  core::fmt::Formatter::debug_struct((int)v27, a2, (int)aMetadata, 8);
  v28 = *(_DWORD *)(a1 + 96);
  v3 = v28;
  v4 = core::fmt::builders::DebugStruct::field(v27, (int)aFileType, 9u, (int)&v28, (int)&off_2E990C);
  v29 = (v3 & 0xF000) == 0x4000;
  v5 = core::fmt::builders::DebugStruct::field(v4, (int)aIsDir, 6u, (int)&v29, (int)&off_2E9758);
  v30 = (v3 & 0xF000) == 0x8000;
  v6 = core::fmt::builders::DebugStruct::field(v5, (int)aIsFile, 7u, (int)&v30, (int)&off_2E9758);
  v31 = v3;
  v7 = core::fmt::builders::DebugStruct::field(v6, (int)aPermissions, 0xBu, (int)&v31, (int)&off_2E991C);
...
LABEL_7:
  ...
  v34 = v9;
  v33 = (void *)v11;
  v12 = core::fmt::builders::DebugStruct::field(v7, (int)aModified, 8u, (int)&v32, (int)&off_2E992C);
...
LABEL_13:
  ...
  v37 = v13;
  v36 = (void *)v15;
  v16 = core::fmt::builders::DebugStruct::field(v12, (int)aAccessed, 8u, (int)&v35, (int)&off_2E992C);
  if ( v8 )
  {
    v17 = &off_2EA7D0;
    goto LABEL_17;
...
LABEL_17:
  ...
  v38 = *(_QWORD *)(a1 + 8);
LABEL_20:
  v18 = core::fmt::builders::DebugStruct::field(v16, (int)aCreated, 7u, (int)&v38, (int)&off_2E992C);
  v19 = core::fmt::builders::DebugStruct::finish_non_exhaustive((int)v18);
  v20 = v39 == 1000000000;
  if ( v39 == 1000000000 )
