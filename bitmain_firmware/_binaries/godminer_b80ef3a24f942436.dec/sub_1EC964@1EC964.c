int __fastcall sub_1EC964(int *a1, int a2, _DWORD *a3, int *a4, int a5, int a6, int a7, char **a8)
{
  int *v9; // r6
  bool v10; // zf
  int v11; // r11
  ...
  int (__fastcall *v74)(_DWORD *, int *); // [sp+54h] [bp-8h]
  ...
  if ( v11 )
  {
    ...
    if ( core::fmt::Formatter::write_fmt(v16, (int *)&v58) )
      return 1;
    if ( *((_BYTE *)v9 + 16) == 1 )
    {
      v17 = (int *)v9[3];
      v18 = core::fmt::ArgumentV1::from_usize(&unk_2B027C);
      v63 = 2;
      v70 = v18;
      v62 = &v68;
      v61 = 1;
      ...
      v60 = &off_2E9980;
      v58 = &byte_2AFD60;
      if ( core::fmt::Formatter::write_fmt(v17, (int *)&v58) )
        return 1;
    }
  }
  else
  {
    ...
    if ( *((_BYTE *)v9 + 16) == 1 )
    {
      ...
      v62 = &v68;
      v58 = &byte_2AFD60;
      if ( core::fmt::Formatter::write_fmt(v55, (int *)&v58) )
        return 1;
    }
  }
  if ( v13 != (char *)3 )
  {
    if ( *((_BYTE *)v9 + 16) == 1 )
    {
      ...
      v73 = &v58;
LABEL_19:
      if ( !core::fmt::Formatter::write_fmt(v30, (int *)&v68) )
        goto LABEL_20;
      return 1;
    }
    if ( !*((_BYTE *)v9 + 16) )
  ...
  v63 = 0;
  v58 = 0;
  if ( core::fmt::Formatter::write_fmt(v31, (int *)&v58) )
    return 1;
LABEL_20:
  if ( <core::fmt::Formatter as core::fmt::Write>::write_str(v9[3], asc_2B03A1, 1) )
    return 1;
  if ( a5 == 1 && v14 != 2 )
  {
    ...
    if ( v44 == 1 )
    {
      ...
      v60 = &off_2E9980;
      v58 = &byte_2AFD60;
      if ( core::fmt::Formatter::write_fmt(v45, (int *)&v58) )
        return 1;
    }
    v47 = (int *)v9[3];
    v61 = 1;
    ...
    v63 = 0;
    v58 = 0;
    if ( core::fmt::Formatter::write_fmt(v47, (int *)&v58) )
      return 1;
    v48 = *v9;
    v49 = v9[1];
    v50 = (char *)v9[3];
    ...
    v68 = (char ***)&v75;
    v69 = (int)core::fmt::num::imp::<impl core::fmt::Display for usize>::fmt;
    if ( core::fmt::Formatter::write_fmt(v52, (int *)&v58) )
      return 1;
    if ( a7 == 1 )
    {
      v73 = a8;
      ...
      v62 = &v68;
      v69 = (int)core::fmt::num::imp::<impl core::fmt::Display for usize>::fmt;
      if ( core::fmt::Formatter::write_fmt(v53, (int *)&v58) )
        return 1;
    }
    v54 = (int *)v9[3];
    v61 = 1;
    ...
    v63 = 0;
    v58 = 0;
    if ( core::fmt::Formatter::write_fmt(v54, (int *)&v58) )
      return 1;
  }
LABEL_32:
  *a1 = v11 + 1;
