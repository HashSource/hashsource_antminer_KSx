...
LABEL_25:
    ...
    while ( 1 )
    {
      ...
      all_created_runtime = (_DWORD *)(*(int (__fastcall **)(int))(v6 + 32))(v2++);
      if ( v28 <= v2 )
        break;
      v5 = v4[1];
      ++v4;
  ...
  while ( 1 )
  {
    ...
    if ( v28 > 0 )
    {
      ...
      {
        v14 = dev_ctrl(v11);
        v11 = (*(int (__fastcall **)(int))(v14 + 52))(i);
        v12 = v28;
      }
    }
    v15 = power_init((unsigned __int8)byte_2F3B58, v12);
    v16 = v15;
    if ( v15 )
      break;
    v11 = (*(int (__fastcall **)(int, _DWORD))(a1 + 40))(a1, *(_DWORD *)(a1 + 80));
    if ( v28 > 0 )
    {
      v17 = v27 - 1;
      do
      {
        ...
        if ( !v11 )
        {
          ...
          {
            v20 = dev_ctrl(v11);
            (*(void (__fastcall **)(_DWORD, _DWORD, _DWORD))(v20 + 28))(
              *(_DWORD *)(*v17 + 240),
              *(_DWORD *)(*v17 + 980),
              *(_DWORD *)(*v17 + 1000));
            (*(void (**)(void))(*v17 + 216))();
            v11 = (*(int (**)(void))(*v17 + 204))();
            if ( !v11 )
              break;
            if ( !--v19 )
            {
