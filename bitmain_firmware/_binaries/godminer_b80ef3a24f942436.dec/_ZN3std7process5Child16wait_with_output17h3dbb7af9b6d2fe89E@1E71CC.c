...
LABEL_47:
            v45 = v10;
            buf = 0;
            core::result::unwrap_failed((int)&unk_2AFC2A, 43, (int)&buf, (int)&off_2E9308, (int)&off_2EA094);
          }
        }
        v15 = v14;
        if ( v11 > v14 )
...
LABEL_49:
  ...
  else if ( v6 == -1 )
  {
    ...
    if ( (unsigned __int8)v42 != 4 )
    {
      buf = v42;
      v45 = v43;
      core::result::unwrap_failed((int)&unk_2AFC2A, 43, (int)&buf, (int)&off_2E9308, (int)&off_2EA084);
    }
    close(fd);
  }
  else
  {
    sub_1F3728((int)&v42, v5, (int)&v35, v6, (int)&v38);
    if ( (unsigned __int8)v42 != 4 )
    {
      buf = v42;
      v45 = v43;
      core::result::unwrap_failed((int)&unk_2AFC2A, 43, (int)&buf, (int)&off_2E9308, (int)&off_2EA074);
    }
  }
