...
LABEL_7:
  ...
  v17[2] = (int *)&off_2E97E8;
  v17[3] = (int *)1;
  v17[5] = 0;
  v17[0] = 0;
  if ( !core::fmt::Formatter::write_fmt(a2, (int *)v17) )
  {
    core::fmt::Formatter::debug_list((int)v17, a2);
    if ( v7 != v8 )
    {
      v11 = (_DWORD *)(v9 + 28 * v8);
      v12 = (_DWORD *)(v9 + 28 * v7);
      do
      {
        ...
        if ( !v13 )
        {
          ...
          do
          {
            ...
            core::fmt::builders::DebugSet::entry(v17, &v18, &off_2E9180);
            v15 -= 44;
            v16 += 11;
          }
          while ( v15 );
