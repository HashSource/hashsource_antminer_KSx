int __fastcall i2c_write(int a1, int a2, int a3)
{
  ...
  _DWORD *v20; // [sp+1Ch] [bp-1808h] BYREF
  char s[2048]; // [sp+20h] [bp-1804h] BYREF
  _BYTE v22[4100]; // [sp+820h] [bp-1004h] BYREF

  v19 = a1;
  v5 = pthread_mutex_lock(&stru_311F6C);
  if ( v5 )
  {
  ...
  else if ( find_c_map((int *)dword_311F88, (int)&v19, &v20) == 1 )
  {
    v6 = v20;
    ...
    else
    {
      if ( a3 )
      {
        do
        {
          v9 = write(v6[1], (const void *)(a2 + v5), 1u);
          v10 = v5++;
          if ( v9 != 1 )
          {
