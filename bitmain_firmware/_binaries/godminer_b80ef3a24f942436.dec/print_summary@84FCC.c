char *print_summary()
{
  ...
  v0 = sub_270788(LODWORD(total_accepted), HIDWORD(total_accepted));
  V_LOCK(LODWORD(v0));
  ...
  if ( *(_QWORD *)&total_accepted || *(_QWORD *)&total_rejected )
  {
    ...
    sub_270788(LODWORD(total_accepted) + LODWORD(v54), (*(_QWORD *)&total_accepted + *(_QWORD *)&v54) >> 32);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *(v60 - 1) || *v60 )
        {
          ...
          sub_270788(v75, HIDWORD(v75));
          sub_270788(*((_DWORD *)v60 - 2) + v74, (unsigned __int64)(*(v60 - 1) + v74) >> 32);
  ...
  zlog(
    ...
    v85);
  v82 = 0;
  result = (char *)get_all_created_runtime(&v82);
  if ( v82 > 0 )
  {
    v78 = result - 4;
    v81 = 0;
