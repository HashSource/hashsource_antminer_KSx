int __fastcall sub_11D17C(int a1, unsigned __int8 *a2, unsigned int a3, unsigned __int8 *a4, unsigned int a5)
{
  int v7; // r11
  unsigned int v10; // r4
  unsigned int v11; // r3
  ...
  do
  {
    ...
    do
    {
      ...
      iic_read_reg(a1, &v18, 1u, (char *)&a4[v13], 1);
      v13 = v12;
    }
    while ( v12 < a5 );
    usleep((__useconds_t)&elf_hash_chain[4398]);
    v14 = sub_11CDE8(a2, a4, a5);
    if ( !v14 )
      break;
