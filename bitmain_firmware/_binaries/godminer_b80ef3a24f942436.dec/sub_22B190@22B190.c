int __fastcall sub_22B190(unsigned int a1)
{
  unsigned int v1; // r1
  unsigned int v2; // r2
  unsigned int v3; // r2
  ...
  int (*v52)(); // [sp+30h] [bp-18h]
  char *v53; // [sp+34h] [bp-14h]
  int (*v54)(); // [sp+38h] [bp-10h]
  ...
  *(_DWORD *)(a1 + 4) = v6;
  if ( v2 != 2 )
    core::panicking::panic((int)aInternalErrorE_1, 40, (int)&off_2EDBB4);
  v8 = *v5;
  v9 = v5[1];
  LOBYTE(v10) = v8 - 48;
          ...
          if ( v53 )
          {
            ...
            if ( v18 <= -1 )
            {
              ...
              else
              {
                ...
                {
                  v17 = (int (*)())((char *)v52 + 4);
                  v3 = *((_BYTE *)v52 + 3) & 0x3F | (v21 << 6) | ((v19 & 7) << 18);
                }
              }
            }
          }
...
LABEL_76:
          ...
          v50[2] = &off_2EDBE4;
          v50[4] = &v51;
          core::panicking::panic_fmt((int)v50, (int)&off_2EDC04);
        }
        if ( v6 - 2 < 2 )
          return 1114112;
        v28 = *v24;
...
LABEL_60:
                ...
                v43 = 3;
LABEL_78:
                core::panicking::panic_bounds_check(v43, v27, (int)&off_2EDBD4);
              }
            }
          }
        }
...
LABEL_82:
    core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2EDBC4);
  }
  return 1114112;
}
