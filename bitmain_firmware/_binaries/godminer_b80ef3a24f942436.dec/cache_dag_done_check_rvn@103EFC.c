...
LABEL_2:
          ...
          src = v9;
          v10 = v9;
          v11 = (*(int (__fastcall **)(int, __int64 *, int, void *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int, unsigned int))(a1 + 300))(
                  a1,
                  &v54,
                  v7,
                  v9,
            ...
            if ( v12 > 0 )
            {
              ...
              do
              {
                ...
                v18 = zlog(
                        ...
                        "/tmp/release/build/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
                        187,
                        "cache_dag_done_check_rvn",
                        24,
                        v34,
        ...
        if ( a3 == 2 && v12 > 0 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (*v21 & 0x1000000) != 0 )
            {
              ...
              v18 = zlog(
                      g_zc,
                      "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/buildroot/t"
                      "mp/release/build/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
                      187,
                      "cache_dag_done_check_rvn",
                      24,
                      2698,
          ...
          zlog(
            g_zc,
            "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release"
            "/build/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
            187,
            "cache_dag_done_check_rvn",
            24,
            2701,
...
LABEL_23:
  ...
  v29 = zlog(
          ...
          "uild/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
          187,
          "cache_dag_done_check_rvn",
          24,
          2688,
