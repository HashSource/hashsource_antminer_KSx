int __fastcall push_work_base(int a1, int a2)
{
  ...
  v15 = 0;
  v6(a1, v5, v4, &v15);
  v8 = pthread_mutex_lock((pthread_mutex_t *)(a1 + 948));
  do
  {
    v9 = dev_ctrl(v8);
    v8 = (*(int (__fastcall **)(_DWORD))(v9 + 84))(*(_DWORD *)(a1 + 240));
  }
  while ( v8 < v15 );
  v10 = dev_ctrl(v8);
  v11 = (*(int (__fastcall **)(_DWORD, unsigned __int8 *, unsigned int))(v10 + 64))(*(_DWORD *)(a1 + 240), v7, v15);
  pthread_mutex_unlock((pthread_mutex_t *)(a1 + 948));
  v12 = check_and_print_uart_debug_log(a1 + 1088, v15, v7, *(_DWORD *)(a1 + 248), 1);
  if ( v11 <= 0 )
  {
    V_LOCK(v12);
