int __fastcall sync_get_core_reg_ltc(int a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  ...
  int v29[2]; // [sp+28h] [bp-1024h] BYREF
  char v30[2]; // [sp+30h] [bp-101Ch] BYREF
  ...
  *(_DWORD *)&v35[4] = v14;
  ...
  v25 = 0;
  v29[1] = 1000000 * v17;
  v29[0] = sub_2704F8(a7, a8, 1000, 0);
  while ( a3 > v25 )
  {
    while ( 1 )
    {
      v19 = queue_dequeue_for(*(_DWORD *)(a1 + 868), v30, 9u, v29);
      if ( v19 == 110 )
      {
        v9 = 3;
        goto LABEL_16;
      }
      if ( (unsigned __int8)v30[0] != 170 || v30[1] != 85 || (v33 & 0xE0) != 0xC0 )
      {
        v9 = 1;
        goto LABEL_16;
      }
