int __fastcall sub_1125D8(int a1, int a2)
{
  int v2; // r5
  void *v5; // r0
  int v6; // r0
  ...
  __int64 v35[4]; // [sp+E8h] [bp-1524h] BYREF
    ...
    do
    {
      while ( 1 )
      {
        ...
        v9 = zlog(
               ...
               20,
               v38);
        if ( *(_DWORD *)(a1 + 328) == (unsigned __int16)__rev16(v11) )
          break;
        v10 += 6;
        if ( v30 <= v2 )
          goto LABEL_7;
      ...
      v10 += 6;
      ++v26;
      v28 = sub_270BA8(*((unsigned __int8 *)v10 - 8), *(_DWORD *)(a1 + 428));
      ++s[v28];
      V_LOCK(v28);
...
LABEL_13:
  ...
  if ( *(_DWORD *)(a1 + 336) > v26 )
  {
    V_LOCK(v14);
    V_INT((int)v34, "chain", *(int *)(a1 + 248));
    V_STR(v35, "error", "asic num error");
