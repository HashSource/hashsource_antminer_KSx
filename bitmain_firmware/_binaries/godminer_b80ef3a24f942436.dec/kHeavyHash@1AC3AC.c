int __fastcall kHeavyHash(int *a1, __int64 a2, int a3, int a4, _DWORD *a5, int a6)
{
  ...
  int src[62]; // [sp+138h] [bp-138h] BYREF
  _DWORD v39[8]; // [sp+230h] [bp-40h] BYREF
  _DWORD *v40; // [sp+250h] [bp-20h] BYREF
  int (*v41)(); // [sp+254h] [bp-1Ch]
  int v42; // [sp+258h] [bp-18h]
  int v43; // [sp+25Ch] [bp-14h]
  int v44; // [sp+260h] [bp-10h]
  int v45; // [sp+264h] [bp-Ch]
  int v46; // [sp+268h] [bp-8h]
  int v47; // [sp+26Ch] [bp-4h]
  ...
  {
    dest[3] = 4;
    src[5] = (int)sub_1AC294;
    src[3] = (int)sub_1AC294;
    dest[5] = 3;
    src[2] = (int)&v26;
    dest[4] = (int)src;
    dest[0] = 0;
    src[4] = (int)&v27;
    src[1] = (int)<std::fs::ReadDir as core::fmt::Debug>::fmt;
    src[0] = (int)&v29;
    dest[2] = (int)&off_2E8EF0;
  ...
  dest[6] = v35;
  dest[7] = v36;
  sub_1AC6DC(src, 1, dest, HIDWORD(a2), a2, HIDWORD(a2));
  if ( !src[61] )
  {
    dest[1] = src[1];
    dest[0] = src[0];
    core::result::unwrap_failed((int)aCalledResultUn, 43, (int)dest, (int)&off_2E8EE0, (int)&off_2E8F10);
  }
  ...
  if ( !a6 )
  {
    ...
    src[5] = 0;
    src[0] = 0;
    src[2] = (int)&off_2E8F20;
    src[4] = (int)aCalledResultUn;
  ...
  if ( !a6 )
  {
    ...
    v41 = sub_1ACAAC;
    v40 = v39;
    src[2] = (int)&off_2E8F28;
    std::io::stdio::_print(src);
    src[3] = 1;
    src[2] = (int)&off_2E8F38;
    src[5] = 0;
    src[4] = (int)aCalledResultUn;
    src[0] = 0;
    std::io::stdio::_print(src);
