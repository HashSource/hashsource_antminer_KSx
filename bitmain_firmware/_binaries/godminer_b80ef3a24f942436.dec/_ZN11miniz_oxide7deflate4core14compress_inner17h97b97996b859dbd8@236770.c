unsigned int __fastcall miniz_oxide::deflate::core::compress_inner(unsigned int *a1, int a2, int *a3, unsigned int a4)
{
  ...
  char **v163; // r2
  unsigned int v164; // [sp+4h] [bp-70h]
  unsigned int v165; // [sp+8h] [bp-6Ch]
  int v166; // [sp+Ch] [bp-68h]
  unsigned int v167; // [sp+10h] [bp-64h]
  unsigned int v168; // [sp+18h] [bp-5Ch]
  _DWORD *v169; // [sp+1Ch] [bp-58h]
  unsigned int v170; // [sp+20h] [bp-54h]
  unsigned int *v171; // [sp+24h] [bp-50h]
  unsigned __int8 v172; // [sp+28h] [bp-4Ch]
  unsigned int v173; // [sp+2Ch] [bp-48h]
  int v174; // [sp+34h] [bp-40h]
  int v175; // [sp+3Ch] [bp-38h]
  unsigned int v176; // [sp+3Ch] [bp-38h]
  unsigned int v177; // [sp+40h] [bp-34h]
  unsigned int v178; // [sp+40h] [bp-34h]
  unsigned int v179; // [sp+40h] [bp-34h]
  _DWORD *v180; // [sp+44h] [bp-30h]
  unsigned int v181; // [sp+48h] [bp-2Ch]
  unsigned int v182; // [sp+48h] [bp-2Ch]
  unsigned int v183; // [sp+48h] [bp-2Ch]
  unsigned int v184; // [sp+48h] [bp-2Ch]
  _DWORD *v186; // [sp+50h] [bp-24h]
  unsigned int v187; // [sp+54h] [bp-20h]
  int v188; // [sp+54h] [bp-20h]
  int v189; // [sp+54h] [bp-20h]
  int v190; // [sp+58h] [bp-1Ch]
  unsigned int v191; // [sp+5Ch] [bp-18h]
  unsigned int v192; // [sp+5Ch] [bp-18h]
  int v193; // [sp+5Ch] [bp-18h]
  unsigned int v194; // [sp+60h] [bp-14h]
  int v195; // [sp+64h] [bp-10h]
  unsigned int v196; // [sp+68h] [bp-Ch] BYREF
  unsigned int v197; // [sp+6Ch] [bp-8h]
  unsigned int v198; // [sp+70h] [bp-4h]
...
LABEL_191:
        ...
        v110 = v106 + i - 1;
        if ( v110 > 0x8101 )
          core::panicking::panic_bounds_check(v106 + i - 1, 33026, (int)&off_2EDD54);
        if ( v109 >= 0x8102 )
          core::panicking::panic_bounds_check(v106 + i, 33026, (int)&off_2EDD64);
        v111 = v169[i > 0x1F] - 1;
        if ( v169[i > 0x1F] == 1 )
        {
          v5 = v195;
        ...
        else
        {
          ...
          v184 = v75;
          v114 = v106;
          v166 = *(unsigned __int16 *)(v112 + 0x20000 + v106);
          v193 = *(unsigned __int8 *)(v112 + 0x20000 + v110) | (*(unsigned __int8 *)(v112 + 0x20000 + v109) << 8);
          v165 = v112 + 131074;
          v174 = v112 + 131074 + v106;
          v170 = 0;
          do
          {
            v115 = 1 - v111;
            while ( 1 )
            {
              ...
              if ( v118 >= 0x8102 )
                goto LABEL_268;
              if ( (*(unsigned __int8 *)(v113 + v119) | (*(unsigned __int8 *)(v113 + v118) << 8)) == v193 )
                break;
              ...
              if ( v121 > 0x8101 )
                goto LABEL_268;
              if ( (*(unsigned __int8 *)(v113 + v119) | (*(unsigned __int8 *)(v113 + v121) << 8)) == v193 )
                break;
              ...
              if ( v123 > 0x8101 )
LABEL_268:
                core::panicking::panic_bounds_check(33026, 33026, (int)&off_2EDD64);
              if ( (*(unsigned __int8 *)(v113 + v119) | (*(unsigned __int8 *)(v113 + v123) << 8)) == v193 )
                break;
              if ( ++v115 == 1 )
                goto LABEL_234;
            }
            if ( !v117 )
              break;
            if ( *(unsigned __int16 *)(v113 + v114) != v166 )
              goto LABEL_189;
            v124 = 0;
            v164 = v112;
            v173 = v165 + v114;
...
LABEL_233:
              ...
              if ( ((33024 - v114) & 0xFFFFFFF8) + 8 == v124 + 8 )
                goto LABEL_298;
              v126 = v173 + v124;
              v127 = *(_DWORD *)(v174 + v124 + 4);
              v128 = *(_DWORD *)(v173 + v124) ^ *(_DWORD *)(v174 + v124);
              v124 += 8;
            ...
            if ( v132 > i )
            {
              ...
              if ( v119 < 0x8102 )
              {
                i = v132;
                v170 = v117;
                v193 = *(unsigned __int8 *)(v113 + v119) | (*(unsigned __int8 *)(v113 + v132 + v106) << 8);
                goto LABEL_189;
              }
LABEL_267:
              core::panicking::panic_bounds_check(v119, 33026, (int)&off_2EDD54);
            }
LABEL_189:
            v111 = -v115;
          }
...
LABEL_211:
        v143 = v104;
        sub_2363B0(v140, v141, v134, v107);
        v104 = v143;
        v74 = 0;
        v144 = i;
LABEL_223:
...
LABEL_221:
        v74 = i;
        v176 = v107;
        v172 = *(_BYTE *)(v16[25] + v106 + 0x20000);
LABEL_222:
        v144 = 1;
        goto LABEL_223;
      }
...
LABEL_224:
      if ( v75 < v144 )
        core::panicking::panic((int)aAssertionFaile_30, 47, (int)&off_2EE104);
      v149 = *v16;
...
LABEL_15:
    ...
    if ( v21 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v25 + v22 > v194 )
          goto LABEL_294;
        memcpy((void *)(v16[25] + v24 + 0x20000), (const void *)(v190 + v22), v25);
        if ( v24 <= 0x100 )
        {
          v26 = 257 - v24;
          v27 = v24 | 0x8000;
...
LABEL_288:
          ...
          if ( v26 + v22 > v194 )
            goto LABEL_294;
          memcpy((void *)(v16[25] + v27 + 0x20000), (const void *)(v190 + v22), v26);
        }
        v21 -= v25;
        v23 = v25 + v24;
        v17 = v25 + v22;
...
LABEL_36:
    ...
    v28 = v177 + v181;
    v29 = v16[24];
    v30 = *(unsigned __int8 *)(v195 + 53);
    if ( 0x8000 - (v177 + v181) < v29 )
      v29 = 0x8000 - (v177 + v181);
    v16[24] = v29;
    if ( !v30 && v28 < 0x1000 )
    {
      v18 = v177 + v181;
...
LABEL_264:
  ...
  while ( 1 )
  {
    ...
    *(_WORD *)(v34 + 0x10000) = v31;
    ...
    v40 = v19;
    v41 = (char *)&stru_1FFF8.st_size + v38 + v19 + 3;
    v42 = (char *)&stru_1FFF8.st_size + v38 + v39 + 3;
    v43 = 0;
    while ( 1 )
    {
...
LABEL_269:
          v163 = &off_2EDFF4;
LABEL_279:
          core::panicking::panic_bounds_check(v46, 0x10000, (int)v163);
        }
LABEL_270:
        v163 = &off_2EDFE4;
        goto LABEL_279;
...
LABEL_74:
    ...
    v6 = v180;
    v60 = v45 - 3;
    *((_BYTE *)v180 + v59) = v45 - 3;
    v59 = *v16 + 1;
    *v16 = v59;
    if ( v59 >= 0x10000 )
      goto LABEL_271;
    v61 = v36 - 1;
    *((_BYTE *)v180 + v59) = v36 - 1;
    v62 = *v16 + 1;
    *v16 = v62;
    if ( v62 >= 0x10000 )
    {
    ...
    *((_BYTE *)v180 + v63) |= 0x80u;
    if ( v61 >= 0x200u )
    {
      if ( (__int16)v61 <= -1 )
        core::panicking::panic_bounds_check(HIBYTE(v61), 128, (int)&off_2EE154);
      v65 = (unsigned __int8 *)&unk_2BCDB4 + HIBYTE(v61);
    }
    else
    {
      v65 = (unsigned __int8 *)&unk_2BC9B4 + v61;
    }
    v15 = v186;
    v66 = v186[16] + 2 * *v65;
    ++*(_WORD *)(v66 + 576);
    if ( v60 >= 0x100 )
      core::panicking::panic_bounds_check(v60, 256, (int)&off_2EE164);
    v50 = word_2BC670[v60];
    if ( v50 >= 0x120 )
      core::panicking::panic_bounds_check(v50, 288, (int)&off_2EE174);
LABEL_65:
    ++*(_WORD *)(v15[16] + 2 * v50);
    v51 = v15[1] - 1;
    v15[1] = v51;
...
LABEL_247:
  if ( (*(_BYTE *)(v5 + 1) & 0x30) != 0 )
  {
    ...
    if ( v155 > v194 )
      core::slice::index::slice_end_index_len_fail();
    v196 = v15[8];
    adler::Adler32::write_slice((unsigned __int16 *)&v196, v190, v155);
    v15[8] = v196;
  }
  LODWORD(v153) = a3[1];
LABEL_251:
  ...
  {
    if ( sub_235984(v6, a3, *(_BYTE *)(v5 + 53)) )
    {
      v159 = -1;
      result = *(_DWORD *)(v5 + 28);
      v160 = *(_DWORD *)(v5 + 32);
