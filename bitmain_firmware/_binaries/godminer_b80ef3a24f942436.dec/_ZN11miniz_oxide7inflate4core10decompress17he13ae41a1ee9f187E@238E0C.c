...
LABEL_480:
        ...
        v242 = v11 - a7;
        v280 = v234[6];
        adler::Adler32::write_slice((unsigned __int16 *)&v280, a5 + a7, v11 - a7);
        v243 = v280;
        v234[6] = v280;
        if ( (a8 & 1) == 0 )
          goto LABEL_480;
...
LABEL_60:
        ...
        v48 = v45 >> (v43 & 0x1F);
        v275 = v48;
        *(_DWORD *)(v8 + 4 * n + 10504) = v47 + word_2BD586[n];
        v49 = v44 - v43;
        v50 = v42 + 1;
        v276 = v49;
        n = v42 + 1;
      ...
      case 9:
        while ( 2 )
        {
          while ( n >= *(_DWORD *)(v268 + 8) )
          {
            *(_DWORD *)(v268 + 8) = 19;
            v54 = v11;
            LOWORD(v55) = sub_238424(v8, (int)&v275);
...
LABEL_71:
            ...
            v275 = v57 >> 3;
            if ( n >= 0x13 )
              core::panicking::panic_bounds_check(n, 19, (int)&off_2EE4F4);
            v59 = byte_2BC632[n++];
            ...
            if ( v64 <= -1 )
            {
              if ( v276 >= 0xB )
              {
                ...
                do
                {
                  ...
                  if ( v72 >> 6 > 8 )
LABEL_494:
                    core::panicking::panic_bounds_check(v72, 576, (int)&off_2EE224);
...
LABEL_116:
        ...
        if ( (v18 & 0x80000000) != 0 )
        {
          ...
          do
          {
            ...
            if ( v78 >> 6 > 8 )
              core::panicking::panic_bounds_check(v78, 576, (int)&off_2EE204);
            ++v77;
        ...
        if ( v18 >= 0x10 )
        {
          ...
          if ( !v158 )
          {
            ...
            v159 = v18 - 16;
            if ( v18 - 16 > 2 )
              core::panicking::panic_bounds_check(v159, 3, (int)&off_2EE514);
        ...
        if ( n > 0x1C8 )
          core::panicking::panic_bounds_check(n, 457, (int)&off_2EE504);
        v79 = v8 + n++;
        LOBYTE(v55) = 0;
        *(_BYTE *)(v79 + 10524) = v18;
        goto LABEL_76;
...
LABEL_131:
            ...
            v280 = 3;
            if ( (v277 & 3) == 3 )
              core::panicking::panic_bounds_check(3, 3, (int)&off_2EE524);
            v18 = 0;
            if ( v277 == 16 )
            {
              if ( n - 1 > 0x1C8 )
                core::panicking::panic_bounds_check(n - 1, 457, (int)&off_2EE534);
...
LABEL_360:
                ...
                v199 = (unsigned __int8)byte_2BD14B[v198];
                v200 = word_2BD18C[v198];
                v249 = v199;
                if ( v199 )
                {
                  v189 -= v199;
...
LABEL_370:
                    ...
                    {
                      v206 = byte_2BD16B[v205];
                      v250 = word_2BD1CC[v205];
                      if ( byte_2BD16B[v205] )
                      {
                        if ( v189 < 0xF )
                        {
                      ...
                      if ( !v209 )
                      {
                        v19 = v200;
                        v210 = v11;
                        sub_238CEC(a5, a6, v11, v250, v200, v260);
                        v190 = v19;
                        v11 = v19 + v210;
                        v18 = 259;
                        v211 = a6 - (v19 + v210);
...
LABEL_484:
                core::panicking::panic_bounds_check(v98, 576, (int)&off_2EE204);
              }
              v18 = a6;
              if ( v105 >= a6 )
                goto LABEL_500;
...
LABEL_163:
          ...
          if ( v11 >= v18 )
LABEL_498:
            core::panicking::panic_bounds_check(v11, v18, (int)&off_2EE444);
          *(_BYTE *)(a5 + v11) = v96;
          v105 = v11 + 1;
          if ( (v103 & 0x100) != 0 )
          {
          ...
          if ( v105 >= v18 )
LABEL_500:
            core::panicking::panic_bounds_check(v105, v18, (int)&off_2EE444);
          v11 += 2;
          *(_BYTE *)(a5 + v105) = v103;
          v87 = v13 - v9;
          if ( (unsigned int)(v13 - v9) < 4 )
...
LABEL_503:
          core::panicking::panic_bounds_check(v11, a6, (int)&off_2EE444);
        }
        LOBYTE(v19) = 2;
        v247 = 13;
        goto LABEL_493;
        ...
        if ( v111 <= -1 )
        {
          if ( v276 >= 0xB )
          {
            ...
            do
            {
              ...
              if ( v161 >> 6 > 8 )
LABEL_497:
                core::panicking::panic_bounds_check(v161, 576, (int)&off_2EE224);
...
LABEL_410:
        ...
        if ( v225 )
        {
          ...
          {
            LOBYTE(v17) = 16;
            v18 = byte_2BD16B[v224];
            v277 = word_2BD1CC[v224];
            v279 = v18;
            if ( !v18 )
              LOBYTE(v17) = 22;
          }
...
LABEL_493:
      ...
      case 19:
        ...
        while ( v11 != a6 )
        {
          ...
          v125 = v9;
          v126 = v11;
          sub_238988(a5, a6, (v11 - v274) & v260, v11, v124, v260);
          v11 = v124 + v126;
          v9 = v125;
          v8 = v17;
          v92 = v122 > v123;
      ...
      case 21:
        ...
        if ( v18 != 256 )
        {
          ...
          {
            v133 = (v132 - 1) & 0x1F;
            v18 = (unsigned int)word_2BD18C;
            LOBYTE(v17) = 14;
            v134 = (unsigned __int8)byte_2BD14B[v133];
            v135 = word_2BD18C[v133];
            v279 = v134;
            n = v135;
            if ( !v134 )
              LOBYTE(v17) = 15;
      ...
      case 22:
        if ( (a8 & 4) == 0 || (LOBYTE(v17) = 29, v11 >= v277) )
        {
          ...
          {
            sub_238CEC(a5, a6, v11, v277, n, v260);
            LOBYTE(v17) = 12;
            v11 = v136;
          }
        }
