void __fastcall std::sys_common::process::CommandEnv::remove(int a1, const void *a2, size_t size)
{
  int v6; // r5
  bool v7; // zf
  _DWORD *v8; // r0
  ...
  size_t v48; // [sp+20h] [bp-5Ch] BYREF
...
LABEL_24:
    ...
    if ( v9 )
    {
      ...
      v64 = (void *)(v23 - 1);
      v62 = 0;
      sub_1B95B4((int *)&v54, (int *)&v62, &v47);
      v48 = v54;
      v49 = (int)v55;
      v50 = ptr;
      v51 = v57;
...
LABEL_56:
  ...
  v50 = (void *)size;
  v63 = 0;
  sub_1B6A00(&v54, (int *)a1, (int *)&v48, (int *)&v62);
  if ( v54 )
  {
    v27 = ptr == 0;
    if ( ptr )
