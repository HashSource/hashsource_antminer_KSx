void __fastcall __noreturn dram_bist_check_and_repair_rvn(int a1, int a2, char a3)
{
  ...
  while ( 1 )
  {
    ...
    BYTE1(v27) = a3;
    v6 = calloc(0x60u, 1u);
    v7 = (*(int (__fastcall **)(int, __int64 *, int, _WORD *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int))(a1 + 284))(
           a1,
           &v26,
           8,
           v6,
...
LABEL_7:
    ...
    if ( !v8 )
    {
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
        187,
        "dram_bist_check_and_repair_rvn",
        30,
        2646,
