int __fastcall dram_post_bist1_rvn(int a1, char a2)
{
  ...
  sub_FD268(a1, a2, 252, 0);
  sub_FD268(a1, a2, 253, 0);
  sub_FD268(a1, a2, 254, 14948376);
  sub_FD268(a1, a2, 255, 14948377);
  sub_FD268(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_FD268(a1, a2, 240, 769);
  usleep(0x249u);
  sub_FD268(a1, a2, 245, (int)"_addbits_and_close");
  sub_FD268(a1, a2, 246, 0x40000);
  sub_FD268(a1, a2, 247, (int)"_and_close");
