int __fastcall <object::pe::ImageEnclaveImport as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2EB4B8;
  v3[5] = &off_2EC318;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2B5093, 18, (int)&off_2EC390, 7, (int)v3, 7);
}
