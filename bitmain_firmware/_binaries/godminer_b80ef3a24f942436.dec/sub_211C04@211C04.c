int __fastcall sub_211C04(int *a1, int a2, int a3, unsigned int a4, int a5, unsigned int a6)
{
  unsigned int v7; // r5
  int v9; // r9
  ...
  if ( v7 >= a6 )
    core::panicking::panic_bounds_check(*(unsigned __int8 *)(a2 + 8), a6, (int)&off_2EC748);
  v20 = *(unsigned __int8 *)(a2 + 9);
  if ( v20 >= a6 )
    core::panicking::panic_bounds_check(v20, a6, (int)&off_2EC758);
  v9 = *a1;
  if ( !*a1 )
    return 1;
  v11 = a1[1];
