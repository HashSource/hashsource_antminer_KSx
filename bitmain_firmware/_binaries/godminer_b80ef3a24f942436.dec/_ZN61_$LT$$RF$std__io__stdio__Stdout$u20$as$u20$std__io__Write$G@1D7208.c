int __fastcall <&std::io::stdio::Stdout as std::io::Write>::write_fmt(_DWORD *a1, unsigned int ***a2, int *a3)
{
  unsigned int *v5; // r6
  unsigned int v6; // r7
  unsigned int v7; // r0
...
LABEL_8:
    v5[1] = _tls_get_addr(&dword_2F0428);
    v9 = 1;
  }
  v5[2] = v9;
  LOBYTE(v23) = 4;
  ...
  v26[4] = v14;
  v26[5] = v15;
  if ( core::fmt::write((int)&v23, (int)&off_2E9C58, v26) )
  {
