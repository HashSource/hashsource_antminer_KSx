  ...
  if ( v4 == 8
    || (V_LOCK(v4),
        ...
        v4 = zlog(
               ...
               "ase/build/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
               187,
               "get_chip_dag_packet_num_rvn",
               27,
               2098,
        ...
        v12 > 0) )
  {
    ...
    do
    {
      ...
      v4 = zlog(
             ...
             "e/build/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_2044.c",
             187,
             "get_chip_dag_packet_num_rvn",
             27,
             2107,
