bool __fastcall sub_9F6A4(int a1, int *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
  ...
  _DWORD v114[1025]; // [sp+A0h] [bp-1004h] BYREF
                      ...
                      if ( v4 )
                      {
                        ...
                        if ( v4 )
                        {
                          ...
                          if ( v4 )
                          {
                            ...
                            if ( v4 )
                            {
                              ...
                              if ( v4 )
                              {
                                ...
                                if ( v4 )
                                {
                                  ...
                                  if ( v4 )
                                  {
                                    v30 = (unsigned __int64 *)calloc(v100, 1u);
                                    ...
                                    if ( v31 )
                                    {
                                      ...
                                      if ( v32 )
                                      {
                                        ...
                                        zlog(
                                          g_zc,
                                          "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/buil"
                                          "d/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/fro"
                                          "ntend_hns/frontend_hns.c",
                                          180,
                                          "hns_padding",
                                          11,
                                          82,
                                      ...
                                      if ( memcmp(v30, &dword_2F3900, 0x20u) )
                                      {
                                        v73 = *(_DWORD *)v30;
                                        v112 = 0u;
                                        dword_2F3900 = v73;
                                        dest = 0;
                                        *(_QWORD *)&byte_2F3920 = 0;
                                        *(_QWORD *)&algn_2F3921[7] = 0;
                                        dbl_2F3930 = 0.0;
                                        dbl_2F3938 = 0.0;
                                        v113 = 0;
                                        memset(v114, 0, 0xF0u);
                                        hs_blake2b_init(v114, 32);
                                        hs_blake2b_update((int)v114, v30, 0x20u);
                                        hs_blake2b_update((int)v114, &dest, 0x20u);
                                        hs_blake2b_final((int)v114, &byte_2F3920, 0x20u);
                                      }
                                      v34 = a2 + 116;
                                      v35 = a2[19];
                                      ...
                                      *(_QWORD *)((char *)&v112 + 6) = 0;
                                      ...
                                      v49 = v45 + v103;
                                      v50 = (unsigned __int64 *)((char *)&v112 + 14);
                                      v51 = (char *)v34 + v49;
                                      do
                                      {
                                        v52 = *((_BYTE *)v50 - 1);
                                        v50 = (unsigned __int64 *)((char *)v50 - 1);
                                        *v51++ = v52;
                                      }
                                      while ( &dest != v50 );
                                      v53 = (char *)&dword_2F3940;
                                      v54 = (char *)v34 + v49 + 21;
                                      do
                                      {
                                        v55 = *--v53;
                                  ...
                                  else
                                  {
                                    ...
                                    zlog(
                                      g_zc,
                                      "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/ro"
                                      "otfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_hn"
                                      "s/frontend_hns.c",
                                      180,
                                      "stratum_notify_hns",
                                      18,
                                ...
                                else
                                {
                                  ...
                                  zlog(
                                    g_zc,
                                    "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/root"
                                    "fs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_hns/frontend_hns.c",
                                    180,
                                    "stratum_notify_hns",
                                    18,
                                    217,
                              ...
                              else
                              {
                                ...
                                zlog(
                                  ...
                                  "/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_hns/frontend_hns.c",
                                  180,
                                  "stratum_notify_hns",
                                  18,
                                  209,
                            ...
                            else
                            {
                              ...
                              zlog(
                                ...
                                "uildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_hns/frontend_hns.c",
                                180,
                                "stratum_notify_hns",
                                18,
                                197,
                          ...
                          else
                          {
                            ...
                            zlog(
                              g_zc,
                              "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/bui"
                              "ldroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_hns/frontend_hns.c",
                              180,
                              "stratum_notify_hns",
                              18,
                              189,
                        ...
                        else
                        {
                          ...
                          zlog(
                            ...
                            "root/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_hns/frontend_hns.c",
                            180,
                            "stratum_notify_hns",
                            18,
                            181,
