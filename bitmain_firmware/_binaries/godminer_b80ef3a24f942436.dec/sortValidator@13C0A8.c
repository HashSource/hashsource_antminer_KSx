...
LABEL_7:
  ...
  do
  {
    v21 = v15[1];
    ++v15;
    v22 = sub_27089C(bswap32(v21), v109);
    v23 = v4 * HIDWORD(v22);
    sub_13BEDC(v105, v22, v137, v110);
  ...
  {
    v119 = v17 + v30 + v30;
    qsort(ptr, nmemb, v17 + v30, sub_13BECC);
    v31 = &ptr[v17];
    v32 = &ptr[v17 + v30 + v17];
    nmemb = ((nmemb - 1) >> 1) + 1;
    v124 = 2 * v30;
  ...
  do
  {
    v60 = v57[1];
    ++v57;
    v61 = sub_27089C(v60, v109);
    v62 = v125 * HIDWORD(v61);
    sub_13BEDC(v105, v61, src, v110);
