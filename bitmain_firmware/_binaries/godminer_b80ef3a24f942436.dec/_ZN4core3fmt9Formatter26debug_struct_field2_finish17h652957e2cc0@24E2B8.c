int __fastcall core::fmt::Formatter::debug_struct_field2_finish(
        _DWORD *a1,
        int a2,
        int a3,
        int a4,
        ...
        int a11)
{
  ...
  if ( v18 )
  {
    ...
    {
      if ( (v16[6] & 4) != 0 )
        v15 = (*(int (__fastcall **)(_DWORD, const char *, int))(v16[1] + 12))(*v16, asc_2BF6DC, 1);
      else
        v15 = (*(int (__fastcall **)(_DWORD, const char *, int))(v16[1] + 12))(*v16, asc_2BF6EA, 2);
      return v15 != 0;
    }
  }
  else
