_DWORD *__fastcall _pipe_push(_DWORD *result, char *a2, size_t a3, _BYTE *a4)
{
  ...
  _DWORD v46[6]; // [sp+2Ch] [bp-18h] BYREF
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v8 < (unsigned int)v9 )
        ...
        v16 = (char *)(v10 - v8);
      if ( v8 >= (unsigned int)v9 )
        v16 = &v9[(_DWORD)v16 - v37];
      v17 = v10 - v37 - v11;
      if ( v17 < (unsigned int)&v16[v4 - v11] )
      {
      ...
      {
        v22 = a2;
        v34 = v12 - (_DWORD)&v9[v10 - v8 - v37 - v13];
        if ( v34 >= v4 )
          v21 = v4;
        else
          v21 = v34;
