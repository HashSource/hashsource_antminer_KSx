unsigned int __fastcall <memchr::memmem::FindIter as core::iter::traits::iterator::Iterator>::next(int a1)
{
  unsigned int v1; // r2
  __int64 v3; // r0
  unsigned int v4; // r6
  ...
  if ( v8 )
  {
    ...
    if ( v5 >= 0x10 )
    {
      v3 = sub_213204(a1, v10, a1 + 48, v9, v5, v11, v4);
      v8 = HIDWORD(v3);
      if ( (_DWORD)v3 )
      {
LABEL_22:
    ...
    else
    {
      ...
      while ( v5 > v4 )
      {
        ...
        {
LABEL_19:
          v21 = sub_7D054((unsigned __int8 *)(v9 + v8), v5, v11, v4);
          v11 = v24;
          v9 = v25;
          if ( v21 )
          {
