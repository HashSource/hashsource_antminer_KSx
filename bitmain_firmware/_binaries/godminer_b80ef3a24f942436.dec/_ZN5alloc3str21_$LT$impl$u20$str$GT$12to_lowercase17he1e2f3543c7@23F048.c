int __fastcall alloc::str::<impl str>::to_lowercase(unsigned int *a1, int a2, size_t size)
{
  ...
  __int16 v51; // r4
  unsigned int v52; // r0
  char **v53; // [sp+4h] [bp-18h]
  unsigned int v54; // [sp+8h] [bp-14h]
  int v55; // [sp+Ch] [bp-10h]
  unsigned int v56[3]; // [sp+10h] [bp-Ch] BYREF
...
LABEL_93:
                ...
                v53 = &off_2EE884;
LABEL_92:
                core::str::slice_error_fail(v23, v54, v41, v24, (int)v53);
              }
            }
            else if ( v23[v41] < -64 )
            {
...
LABEL_39:
      if ( v29 != 1114112 )
      {
        core::unicode::unicode_data::conversions::to_lower(v56, v29);
        if ( v56[1] )
        {
          if ( v56[2] )
            sub_23FF40(a1);
