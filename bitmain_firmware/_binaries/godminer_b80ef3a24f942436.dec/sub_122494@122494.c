int __fastcall sub_122494(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  v12 = 0;
  v19[1] = 1000000 * v13;
  v19[0] = sub_2704F8(a5, a6, 1000, 0);
  while ( a2 > v12 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), v20, 0xAu, v19) == 110 )
      {
        v11 = 3;
        goto LABEL_11;
      }
      if ( (unsigned __int8)v20[0] != 170 || v20[1] != 85 || v21 != 8 )
      {
        v11 = 1;
        goto LABEL_11;
      }
