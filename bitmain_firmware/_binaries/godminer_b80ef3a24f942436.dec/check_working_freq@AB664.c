void __fastcall __noreturn check_working_freq(int a1)
{
  ...
  v19 = 0;
  v18 = (char *)get_all_created_runtime(&v19) - 4;
  while ( 1 )
  {
    temp = get_temp(1);
    if ( temp != -64 )
              ...
              if ( v12 != v11 )
              {
                if ( !v9 )
                {
                  ...
                  v15 = zlog(
                          ...
                          "ot/tmp/release/build/godminer-origin_godminer-new/machine_runtime/machine_runtime_base.c",
                          182,
                          "check_working_freq",
                          18,
                          400,
                  ...
                  {
                    V_LOCK(v15);
                    V_INT((int)v20, "chain", *(int *)(*v4 + 248));
