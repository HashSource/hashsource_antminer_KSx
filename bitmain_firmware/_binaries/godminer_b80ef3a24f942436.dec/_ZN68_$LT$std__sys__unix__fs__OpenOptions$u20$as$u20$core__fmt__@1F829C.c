int __fastcall <std::sys::unix::fs::OpenOptions as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[15] = &off_2E91A0;
  v3[13] = &off_2E93B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aOpenoptions, 11, (int)&off_2EAC48, 8, (int)v3, 8);
}
