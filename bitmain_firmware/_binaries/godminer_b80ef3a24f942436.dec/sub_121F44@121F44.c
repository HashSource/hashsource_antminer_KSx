int __fastcall sub_121F44(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  int v25[2]; // [sp+24h] [bp-1058h] BYREF
  char v26[2]; // [sp+2Ch] [bp-1050h] BYREF
  unsigned __int8 v27[2]; // [sp+2Eh] [bp-104Eh] BYREF
  ...
  while ( a2 > v10 )
  {
    while ( 1 )
    {
      v14 = queue_dequeue_for(*(_DWORD *)(a1 + 868), v26, 0x4Au, v25);
      if ( v14 == 110 )
      {
        v9 = 3;
        goto LABEL_10;
