int __fastcall sub_B2A50(int a1)
{
  ...
  if ( v5 != 4 )
  {
    ...
    zlog(
      ...
      "/godminer-origin_godminer-new/dhash_content/rvn/rvn_2044/rvn_2044_content.c",
      189,
  ...
  *(_QWORD *)&dbl_2F3D20 += v4;
  ...
  zlog(
    ...
    "odminer-origin_godminer-new/dhash_content/rvn/rvn_2044/rvn_2044_content.c",
    189,
    "pre_push_work_rvn_2044",
    22,
    33,
