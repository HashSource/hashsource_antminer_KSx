int __fastcall chip_setting_check_bist_ltc(int a1, int a2, int a3, char a4, int *a5)
{
  ...
  HIBYTE(v35) = a4;
  BYTE4(v35) = a4;
  v15 = (*(int (__fastcall **)(int, __int64 *, int, char *, int *, int, int, _DWORD))(a1 + 300))(
          a1,
          &v34,
          v29,
          ptr,
  ...
  if ( v33 > 0 )
  {
    ...
    do
    {
      ...
      if ( a2 )
      {
        v15 = sub_270BA8((unsigned __int8)v16[4], *(_DWORD *)(a1 + 428));
        v10[v15] = v18;
      }
      else
      {
    ...
    || (V_LOCK(v15),
        ...
        v22 = zlog(
                *v11,
                ...
                "ease/build/godminer-origin_godminer-new/backend/backend_ltc_1489/chip_setting_ltc_1489.c",
                192,
                "chip_setting_check_bist_ltc",
                27,
                223,
