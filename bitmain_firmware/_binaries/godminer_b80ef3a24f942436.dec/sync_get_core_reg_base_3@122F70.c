int __fastcall sync_get_core_reg_base_3(int a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  ...
  int v34[2]; // [sp+3Ch] [bp-1018h] BYREF
  char v35[2]; // [sp+44h] [bp-1010h] BYREF
  ...
  v29 = 0;
  v34[1] = 1000000 * v18;
  v34[0] = sub_2704F8(a7, a8, 1000, 0);
  while ( v29 < a3 )
  {
    while ( 1 )
    {
      v21 = queue_dequeue_for(*(_DWORD *)(a1 + 868), v35, 9u, v34);
      if ( v21 == 110 )
      {
        v9 = 3;
        goto LABEL_14;
      ...
      zlog(
        ...
        20,
        v38);
      if ( (unsigned __int8)v35[0] != 170 || v35[1] != 85 || (v37 & 0x40) == 0 )
      {
        v9 = 1;
        goto LABEL_14;
      }
