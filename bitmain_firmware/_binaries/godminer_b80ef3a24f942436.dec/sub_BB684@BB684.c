int __fastcall sub_BB684(int a1)
{
  ...
  char v34[20]; // [sp+80h] [bp-38h] BYREF
  ...
  if ( v31 > 0 )
  {
    ...
    do
    {
      ...
      v13 = snprintf(
              ...
              *(_DWORD *)v5,
              *(_DWORD *)(*(_DWORD *)v5 + 440),
              *(_DWORD *)(*(_DWORD *)v5 + 444),
              *(_DWORD *)(*(_DWORD *)v5 + 448),
              *(_DWORD *)(*(_DWORD *)v5 + 452),
              HIDWORD(v8));
      v14 = *(_DWORD *)v5;
      v28 = *(_DWORD *)(*(_DWORD *)v5 + 336);
      v15 = v8 + v13;
      if ( v28 > 0 )
      {
        v16 = 0;
