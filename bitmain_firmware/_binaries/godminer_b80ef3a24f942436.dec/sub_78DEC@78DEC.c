int __fastcall sub_78DEC(unsigned __int64 *a1, unsigned int a2)
{
...
LABEL_20:
      if ( v12 == a2 )
        return 1;
      if ( v12 - 1 >= a2 )
        core::panicking::panic_bounds_check(v12 - 1, a2, (int)&off_2E9248);
      if ( !v18 )
        core::panicking::panic_bounds_check(v12, a2, (int)&off_2E9248);
      v66 = v11;
      v23 = (int *)&v2[3 * v12 - 3];
      v68 = *v23;
      v71 = v23[1];
