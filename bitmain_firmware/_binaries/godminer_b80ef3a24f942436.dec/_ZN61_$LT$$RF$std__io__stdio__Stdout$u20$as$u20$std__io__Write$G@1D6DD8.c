int __fastcall <&std::io::stdio::Stdout as std::io::Write>::flush(_DWORD *a1, unsigned int ***a2)
{
  ...
  v3 = **a2;
  v4 = v3[1];
  if ( v4 == _tls_get_addr(&dword_2F0428) )
  {
    v5 = v3[2];
    v6 = __CFADD__(v5, 1);
    v7 = v5 + 1;
...
LABEL_8:
    v3[1] = _tls_get_addr(&dword_2F0428);
    v7 = 1;
  }
  v3[2] = v7;
  if ( v3[3] )
    core::result::unwrap_failed((int)aAlreadyBorrowe, 16, (int)v14, (int)&off_2E92E8, (int)&off_2E9B14);
  v3[3] = -1;
  sub_1D2E1C((int)v13, (int)(v3 + 4));
  if ( LOBYTE(v13[0]) == 4 )
  {
    *a1 = 4;
  }
