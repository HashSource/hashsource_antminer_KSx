unsigned int __fastcall EaglesongSponge(int a1, unsigned int a2, int a3, unsigned int a4, unsigned __int8 a5)
{
  ...
  int v29; // r4
  int v30; // r3
  unsigned int v31; // [sp+4h] [bp-48h] BYREF
  ...
  if ( sub_270BA8(rate - 1 + v10, rate) )
  {
    ...
    while ( sub_270BA8(rate - 1 + v10, rate) > v11 );
  }
  result = sub_270BA8(v31, v9 / 8);
  if ( result )
  {
    v18 = 0;
    do
