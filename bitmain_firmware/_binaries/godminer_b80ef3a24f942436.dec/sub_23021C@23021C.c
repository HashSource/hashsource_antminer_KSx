int __fastcall sub_23021C(int a1)
{
  int v1; // r6
  char *v2; // r1
  unsigned int v4; // r2
...
LABEL_34:
      ...
      {
        v13 = *(_DWORD *)(a1 + 16);
        if ( !v13 || (v9 = 1, !<str as core::fmt::Display>::fmt(&unk_2BC409, 16, v13)) )
        {
          v9 = 0;
          *(_BYTE *)(a1 + 4) = 0;
          *(_DWORD *)a1 = 0;
...
LABEL_15:
    ...
    {
      v9 = 1;
      if ( <str as core::fmt::Display>::fmt(aExtern, 8, *(_DWORD *)(a1 + 16)) )
        return v9;
    }
    LOWORD(v42) = 1;
    v39 = 1;
...
LABEL_41:
        ...
        {
LABEL_42:
          if ( v10 && <str as core::fmt::Display>::fmt(asc_2BC458, 2, v10) )
            return 1;
          goto LABEL_45;
        }
        v29 = v10;
...
LABEL_71:
          ...
          if ( <str as core::fmt::Display>::fmt(asc_2BC32B, 1, v29) )
            return 1;
          v29 = 0;
          if ( v10 )
          {
...
LABEL_72:
    ...
    else
    {
      ...
      if ( v19 )
LABEL_85:
        core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2EDC64);
      v11 = v1;
      v12 = v35;
      if ( !v10 )
        goto LABEL_41;
...
LABEL_45:
  ...
  if ( *(_DWORD *)a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v25 && <str as core::fmt::Display>::fmt(asc_2BC42B, 2, v23) || sub_22FC0C((_DWORD *)a1) )
        return 1;
      v21 = *(char **)a1;
      --v22;
      if ( !*(_DWORD *)a1 )
...
LABEL_57:
  ...
  v9 = 1;
  if ( <str as core::fmt::Display>::fmt(asc_2BC263, 1, v26) )
    return v9;
  v21 = *(char **)a1;
  if ( *(_DWORD *)a1 )
  {
...
LABEL_66:
  ...
  {
    v9 = 1;
    if ( <str as core::fmt::Display>::fmt(asc_2BC242, 4, v28) )
      return v9;
  }
  return sub_22FC0C((_DWORD *)a1);
}
