int __fastcall <object::macho::FatArch64 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[7] = &off_2EBC90;
  v3[5] = &off_2EBC90;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aFatarch64, 9, (int)&off_2EB648, 6, (int)v3, 6);
}
