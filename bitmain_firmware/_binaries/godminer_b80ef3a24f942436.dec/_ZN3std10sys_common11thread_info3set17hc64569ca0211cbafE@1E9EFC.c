_DWORD *__fastcall std::sys_common::thread_info::set(int *a1, unsigned int *a2)
{
  ...
  int v16[6]; // [sp+30h] [bp-38h] BYREF
  _DWORD v17[2]; // [sp+48h] [bp-20h] BYREF
  _DWORD v18[6]; // [sp+50h] [bp-18h] BYREF

  v4 = *(unsigned __int8 *)_tls_get_addr(&dword_2F0430);
  if ( v4 != 1 )
  {
    if ( v4 )
    {
      ...
      core::result::unwrap_failed((int)aCannotAccessAT, 70, (int)v18, (int)&off_2E92F8, (int)&off_2E9778);
    }
  ...
  if ( *(_DWORD *)_tls_get_addr(&dword_2F0438) )
    core::result::unwrap_failed((int)aAlreadyBorrowe, 16, (int)v18, (int)&off_2E92E8, (int)&off_2EA1E4);
  v6 = (_DWORD *)_tls_get_addr(&dword_2F0438);
  v7 = v6[2];
  *v6 = -1;
  if ( v7 != 2 )
  {
    v16[3] = 2;
    v16[2] = (int)&off_2E96F8;
    v16[4] = (int)v17;
    v16[5] = 1;
    v16[0] = 0;
