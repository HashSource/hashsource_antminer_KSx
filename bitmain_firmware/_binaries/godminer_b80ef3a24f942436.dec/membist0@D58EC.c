int __fastcall membist0(int a1)
{
  ...
  {
    V_LOCK(v4);
    V_INT((int)v47, "chain", *(int *)(v3 + 248));
    v5 = *(_DWORD *)v44;
    v44 += 4;
    v43 = 0;
    ...
    do
    {
      sub_D1D3C(v3, v43, 12, 1);
      sub_D1D3C(v3, v43, 160, 3);
      usleep((__useconds_t)"r17hb863d821ff89472fE");
      v7 = sub_D1FD4(v3, (unsigned __int16)v43, 161, ptr);
      v8 = v7;
      if ( v7 == 8
        || (V_LOCK(v7),
            V_INT((int)&v48, "chain", *(int *)(v3 + 248)),
            ...
            v7 = zlog(
                   ...
                   "release/build/godminer-origin_godminer-new/backend/backend_eth_2280/backend_eth_2280.c",
                   187,
                   "membist0",
                   8,
                   600,
            ...
            v8 > 0) )
      {
        ...
        do
        {
          while ( (*v10 & 0x80) == 0 )
          {
            ...
            ++v11;
            v10 += 3;
            V_INT((int)&v50, "chain", *(int *)(v3 + 248));
          ...
          {
            V_LOCK(v7);
            V_INT((int)v49, "chain", *(int *)(v3 + 248));
...
LABEL_11:
      memset(ptr, 0, 0x600u);
      v13 = sub_D1FD4(v3, (unsigned __int16)v43, 162, ptr);
      v14 = v13;
      if ( v13 == 8
        || (V_LOCK(v13),
            V_INT((int)v51, "chain", *(int *)(v3 + 248)),
            ...
            v14 > 0) )
      {
        ...
        do
        {
          while ( (*v16 & 0x80) == 0 )
          {
            ...
            ++v17;
            v16 += 3;
            V_INT((int)v53, "chain", *(int *)(v3 + 248));
          ...
          {
            V_LOCK(v13);
            V_INT((int)&v52, "chain", *(int *)(v3 + 248));
...
LABEL_19:
      memset(ptr, 0, 0x600u);
      v4 = (void *)sub_D1FD4(v3, (unsigned __int16)v43, 163, ptr);
      v19 = (int)v4;
      if ( v4 == (void *)8
        || (V_LOCK(v4),
            V_INT((int)&v54, "chain", *(int *)(v3 + 248)),
            v20 = logfmt_raw((int)v60, 0x1000u),
            V_UNLOCK(v20),
            v4 = (void *)zlog(
                           g_zc,
                           "/workspace/jenkins/jenkins/workspace/Antminer_KS3_CVCtrl_godminer_release/build/rootfs/buildr"
                           "oot/tmp/release/build/godminer-origin_godminer-new/backend/backend_eth_2280/backend_eth_2280.c",
                           187,
                           "membist0",
                           8,
                           647,
            ...
            v19 > 0) )
      {
        ...
        do
        {
          ...
          V_LOCK(v4);
          v22 += 3;
          V_INT((int)v55, "chain", *(int *)(v3 + 248));
          ...
          v4 = (void *)zlog(
                         ...
                         "t/tmp/release/build/godminer-origin_godminer-new/backend/backend_eth_2280/backend_eth_2280.c",
                         187,
                         "membist0",
                         8,
                         655,
...
LABEL_26:
  ...
  for ( i = 0; i != 20; i += 4 )
  {
    ...
    *(_QWORD *)v40 = 0;
    ...
    do
    {
      ...
      *(_QWORD *)ptra += v27;
      *(_QWORD *)v40 += v28;
      V_INT((int)&v56, "chain", *(int *)(v3 + 248));
      v42 += v29;
      v37 += 64;
      ++v26;
  ...
  v31 = dev_ctrl(v25);
  (*(void (__fastcall **)(_DWORD))(v31 + 96))(*(_DWORD *)(v3 + 240));
  return 0;
}
