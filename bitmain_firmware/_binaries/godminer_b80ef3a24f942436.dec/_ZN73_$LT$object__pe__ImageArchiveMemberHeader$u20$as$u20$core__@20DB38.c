int __fastcall <object::pe::ImageArchiveMemberHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2EB590;
  v3[1] = &off_2EB4B8;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2B45B8, 24, (int)&off_2EBEC0, 7, (int)v3, 7);
}
