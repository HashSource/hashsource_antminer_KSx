int __fastcall set_frequency_with_voltage_kas(int a1)
{
  ...
  float v61; // [sp+24h] [bp-1210h] BYREF
  int v62; // [sp+28h] [bp-120Ch] BYREF
  int v63; // [sp+2Ch] [bp-1208h] BYREF
  _BYTE dest[512]; // [sp+30h] [bp-1204h] BYREF
  _BYTE v65[4100]; // [sp+230h] [bp-1004h] BYREF
  ...
  v1 = &g_zc;
  V_LOCK(v14);
  v31 = logfmt_raw((int)v65, 0x1000u);
  V_UNLOCK(v31);
  zlog(
    g_zc,
...
LABEL_44:
  v14 = check_temperature_base(a1, &v62, &v63);
  for ( i = 180; v62 <= 19; i -= 10 )
  {
    v43 = v63 <= 19;
    if ( !i )
      v43 = 0;
    ...
    if ( v60 > 0 )
    {
      for ( j = 0; j < v60; ++j )
      {
        check_temperature_base(a1, &v62, &v63);
...
LABEL_7:
  V_LOCK(v14);
  v17 = logfmt_raw((int)v65, 0x1000u);
  V_UNLOCK(v17);
  v18 = zlog(
          *v1,
...
LABEL_31:
      if ( working_voltage + 20 < v58 && v22 > v15 && v16 - v59 <= v23 )
      {
        ...
        if ( v28 )
          return v28;
        v18 = usleep((__useconds_t)"ersion12VersionIndex5index17hb28023ac069c5199E");
      }
      if ( ++v23 == v16 )
        goto LABEL_37;
    }
  ...
  if ( v60 > 0 )
  {
    ...
    for ( m = 0; m < v60; ++m )
    {
      ...
      if ( api_get_eeprom_fmt_version(*(_DWORD *)(v48 + 240)) == 4
        && !api_get_eeprom_asic_freqs(*(_DWORD *)(*v46 + 240), dest, &v61) )
      {
        v49 = *v46;
        v50 = 0.0;
        v51 = *(_DWORD *)(*v46 + 336);
        if ( v51 )
        {
          ...
          do
          {
            ...
            v50 = v50 + v54;
            printf("%-6.1f ", v54);
            if ( (v52 & 0xF) == 0xF || (v49 = *v46, v51 = *(_DWORD *)(*v46 + 336), v51 - 1 == v52) )
            {
              putchar(10);
              v49 = *v46;
              v51 = *(_DWORD *)(*v46 + 336);
