int __fastcall <std::sys::unix::fs::File as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  ...
  core::fmt::builders::DebugStruct::field(v17, (int)aFd, 2u, (int)&fd, (int)&off_2E9A5C);
  v18 = fd;
  ...
  src = (void *)1;
  v22 = 0;
  core::fmt::Formatter::new((int)&v26, (int)&v22, (int)&off_2E8FF8);
  if ( core::fmt::num::imp::<impl core::fmt::Display for i32>::fmt((unsigned int *)&v18, (int)&v26) )
    core::result::unwrap_failed((int)aADisplayImplem, 55, (int)v29, (int)&off_2E9318, (int)&off_2E9010);
  v4 = n;
  v5 = src;
  if ( n && *(_BYTE *)src == 47 )
  {
...
LABEL_9:
  ...
  if ( v8 >> 7 <= 2 )
  {
    ...
    *((_BYTE *)&v26 + v8) = 0;
    ...
    if ( v29[0] )
    {
      src = (void *)dword_2EA158;
      v22 = 1;
      n = (size_t)&off_2EA14C;
      goto LABEL_16;
    }
    sub_1EFF94(&v22, v29[1]);
  }
  else
  {
    sub_7A554(&v22, v20, v8);
  }
  if ( !v22 )
  {
    v5 = src;
...
LABEL_22:
  if ( v10 )
  {
    ...
    ptr = v10;
    v26 = v5;
    core::fmt::builders::DebugStruct::field(v17, (int)"pathreadHOMEargs && ", 4u, (int)&v26, (int)&off_2E993C);
    if ( v26 )
      _rust_dealloc(ptr);
  }
  v11 = fcntl(fd, 3);
  ...
  if ( !v12 )
  {
    ...
    v14 = core::fmt::builders::DebugStruct::field(v17, (int)"readHOMEargs && ", 4u, (int)&v22, (int)&off_2E9758);
    core::fmt::builders::DebugStruct::field(v14, (int)aWrite, 5u, (int)&v26, (int)&off_2E9758);
  }
