bool __fastcall core::fmt::Formatter::debug_tuple_fields_finish(_DWORD *a1, int a2, int a3, int a4, int a5)
{
  ...
  if ( a5 )
  {
    ...
    do
    {
      v10 = core::fmt::builders::DebugTuple::field(v10, a4, (int)&off_2EF268);
      v9 -= 8;
      a4 += 8;
    }
    while ( v9 );
    if ( v13 )
    {
      ...
      if ( !v15 )
      {
        ...
        if ( v13 != 1
          || !v16
          || (v14[6] & 4) != 0
          || (v8 = 1, !(*(int (__fastcall **)(_DWORD, const char *, int))(v14[1] + 12))(*v14, asc_2BF6EF, 1)) )
        {
          v8 = (*(int (__fastcall **)(_DWORD, const char *, int))(v11[1] + 12))(*v11, asc_2BF1F9, 1);
        }
      }
    }
    else
