int __fastcall std::env::_remove_var(_BYTE *src, size_t n)
{
  int result; // r0
  ...
  if ( (unsigned __int8)v5 != 4 )
  {
    ...
    v11 = v8;
    name = (char *)<std::path::Display as core::fmt::Debug>::fmt;
    v9 = v4;
    core::panicking::panic_fmt((int)dest, (int)&off_2E98CC);
  }
  return result;
}
