int __fastcall <object::pe::ImageSymbol as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2EB638;
  v3[1] = &off_2EB5B0;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aImagesymbol, 11, (int)&off_2EBE30, 6, (int)v3, 6);
}
