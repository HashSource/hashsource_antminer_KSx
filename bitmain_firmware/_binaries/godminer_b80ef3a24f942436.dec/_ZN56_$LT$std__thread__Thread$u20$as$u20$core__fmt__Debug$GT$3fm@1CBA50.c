int __fastcall <std::thread::Thread as core::fmt::Debug>::fmt(_DWORD *a1, _DWORD *a2)
{
  ...
  v10[1] = v3[5];
  v10[0] = v4;
  v5 = core::fmt::builders::DebugStruct::field(v9, (int)aId_0, 2u, (int)v10, (int)&off_2E97B8);
  v6 = v3[3];
  v11[0] = v3[2];
  v11[1] = v6 - 1;
  v7 = core::fmt::builders::DebugStruct::field(v5, (int)aName_0, 4u, (int)v11, (int)&off_2E97C8);
