void __fastcall sub_201594(int *a1, int *a2)
{
  int *v2; // r11
  _BYTE *v4; // r6
  size_t v5; // r7
...
LABEL_24:
    ...
    v88[6] = 0;
    v2 = v68;
    sub_1FBFF8(&v79, (int)&v73, dest, (int)v88);
    a1 = v67;
    v24 = v81;
    if ( v81 )
      goto LABEL_25;
LABEL_84:
  ...
  if ( v21 && *bytes_at == 47 )
  {
    is_file = std::path::Path::is_file(bytes_at, v21);
    if ( is_file )
    {
      if ( v21 <= -1 )
        alloc::raw_vec::capacity_overflow(is_file, v36);
      v37 = (_BYTE *)_rust_alloc(v21);
      if ( !v37 )
...
LABEL_59:
    ...
    v56 = (void *)v88[1];
    v88[2] = v55 + v21;
    if ( !std::path::Path::is_file((_BYTE *)v88[1], v55 + v21) )
    {
      if ( v88[0] )
        _rust_dealloc(v56);
      if ( v43 )
...
LABEL_71:
  ...
  src[21] = v38;
  src[20] = v39;
  sub_1FCC28(v84, v38, v40);
  if ( v84[0] != 1 )
    goto LABEL_79;
  if ( v76 == 1 )
    core::panicking::panic((int)aAssertionFaile_21, 36, (int)&off_2EAE94);
  len = v84[2];
  addr = (void *)v84[1];
  v76 = 1;
  sub_201F04(v85);
