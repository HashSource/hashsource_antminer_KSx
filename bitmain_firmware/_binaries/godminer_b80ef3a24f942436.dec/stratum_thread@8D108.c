int __fastcall stratum_thread(int a1)
{
  ...
  __time_t v30; // [sp+48h] [bp-107Ch]
  int v31; // [sp+60h] [bp-1064h] BYREF
  _BYTE v32[28]; // [sp+80h] [bp-1044h] BYREF
  int v33; // [sp+A0h] [bp-1024h] BYREF
        ...
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            while ( 1 )
            {
              ...
              pool_died(v5);
              v14 = sub_27061C(v27, HIDWORD(v27), 50, 0);
              if ( !v15 )
              {
                V_LOCK(v14);
                V_INT((int)&v31, "poolno", v5->__lock);
...
LABEL_11:
          ...
          if ( stratum_socket_full((int)v5, v30) )
            break;
          V_LOCK(0);
          V_INT((int)v32, "poolno", v5->__lock);
...
LABEL_19:
          ...
          v23 = pool_died(v5);
          V_LOCK(v23);
          V_INT((int)&v33, "poolno", v5->__lock);
