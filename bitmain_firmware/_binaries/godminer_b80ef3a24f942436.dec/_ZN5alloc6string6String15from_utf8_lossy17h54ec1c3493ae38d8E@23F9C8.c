void *__fastcall alloc::string::String::from_utf8_lossy(_DWORD *a1, int a2, size_t a3)
{
  ...
  <core::str::lossy::Utf8Chunks as core::iter::traits::iterator::Iterator>::next(&v25, (int *)&v20);
  if ( v25 )
  {
    v29 = v25;
    v30 = v26;
    ...
    if ( v6 )
    {
      ...
      *(_BYTE *)(v13 + v10 + 2) = -67;
      ...
      while ( 1 )
      {
        <core::str::lossy::Utf8Chunks as core::iter::traits::iterator::Iterator>::next(&v25, (int *)&v24);
        if ( !v25 )
          break;
        v29 = v25;
        v30 = v26;
        ...
        {
          sub_7D3CC(&v21, v12, SHIDWORD(v16));
          v11 = v22;
          v12 = v23;
        }
