int bitmain_get_sample_voltage()
{
  ...
  if ( dword_3114C8 != 255 )
  {
    result = sub_11D17C(dword_3114C8, (unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u);
    if ( !result )
      return result;
...
LABEL_8:
  ...
  result = sub_11D014((unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u);
  if ( result )
  {
    strcpy(s, "get sample N failed");
    V_LOCK(*(_DWORD *)"get sample N failed");
