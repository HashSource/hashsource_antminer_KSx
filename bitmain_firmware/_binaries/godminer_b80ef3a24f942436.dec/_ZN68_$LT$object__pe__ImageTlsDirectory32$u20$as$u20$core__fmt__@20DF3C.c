int __fastcall <object::pe::ImageTlsDirectory32 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2EB638;
  v3[1] = &off_2EB638;
  return core::fmt::Formatter::debug_struct_fields_finish(
           a2,
           (int)aImagetlsdirect_0,
           19,
           (int)&off_2EBF50,
           6,
           (int)v3,
