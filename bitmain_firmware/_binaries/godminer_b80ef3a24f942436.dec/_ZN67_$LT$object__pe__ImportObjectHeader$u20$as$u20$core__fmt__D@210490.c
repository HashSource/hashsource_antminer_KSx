int __fastcall <object::pe::ImportObjectHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[11] = &off_2EB638;
  v3[9] = &off_2EB638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2B5280, 18, (int)&off_2EC518, 8, (int)v3, 8);
}
