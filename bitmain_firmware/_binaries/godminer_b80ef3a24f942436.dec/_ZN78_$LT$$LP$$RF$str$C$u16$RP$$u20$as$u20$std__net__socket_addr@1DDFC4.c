        ...
        unsigned int a4)
{
  ...
  if ( v4 <= 0xF )
  {
    ...
    *(_DWORD *)v18 = v6;
    sub_1DB534((int)&v16, (unsigned __int8 **)v18);
    if ( !*(_DWORD *)&v18[4] )
    {
      if ( (_BYTE)v16 )
      {
...
LABEL_17:
  ...
  else
  {
    ...
    if ( v20 )
    {
      HIDWORD(v16) = dword_2EA158;
      LODWORD(v16) = 1;
      LODWORD(v17) = &off_2EA14C;
LABEL_14:
      v13 = v17;
      *a1 = HIDWORD(v16);
      a1[1] = v13;
    ...
    sub_1FA5B4((int)&v16, v7, name);
    if ( (_DWORD)v16 )
      goto LABEL_14;
  }
  v14 = HIDWORD(v16);
  v15 = v17;
  return sub_1DDC4C(a1, (int)&v14);
}
