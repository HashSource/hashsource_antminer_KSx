int __fastcall sub_117754(unsigned int a1, int a2)
{
  int *v4; // r7
  int v5; // r0
  int v6; // r0
  ...
  if ( v4 )
  {
    ...
    else
    {
      ...
      if ( a2 == 1 )
      {
        sub_1174FC(v4, (int *)dword_3113E0);
        v8 = gpio_write((int)v4, 0);
      }
      else if ( a2 == 2 )
      {
        v16 = v4;
        ...
        {
          v8 = -1;
          if ( exists_c_map((int *)dword_3113E0, (int)&v16) )
          {
