unsigned int __fastcall sub_FD7CC(int a1, int a2, void *a3)
{
  int v5; // r4
  ...
  int v10; // r0
  unsigned int v11; // r3
  int v14; // [sp+4Ch] [bp-1038h] BYREF
  __int64 v15; // [sp+50h] [bp-1034h] BYREF
  __int64 v16; // [sp+58h] [bp-102Ch]
  char v17[32]; // [sp+60h] [bp-1024h] BYREF
  _BYTE v18[4100]; // [sp+80h] [bp-1004h] BYREF
