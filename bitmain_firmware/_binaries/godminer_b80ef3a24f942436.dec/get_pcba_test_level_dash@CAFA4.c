int __fastcall get_pcba_test_level_dash(_DWORD *a1, _DWORD *a2)
{
  ...
  _QWORD v21[4]; // [sp+70h] [bp-1040h] BYREF
...
LABEL_2:
  ...
  v6 = dev_ctrl((int)a1);
  v7 = (char *)(*(int (__fastcall **)(_DWORD, int, int, int *))(v6 + 100))(a1[60], 52, 393216, &v18);
  if ( !v7 )
  {
    v8 = (unsigned __int16 *)&unk_2983DC;
    v9 = 700;
    v10 = (unsigned __int16)v18;
    v11 = HIWORD(v18);
    for ( i = (unsigned __int16 *)&unk_2983DC; ; v9 = i[2] )
    {
