bool __fastcall sub_1F6944(size_t *a1, int a2, _BYTE *src, size_t n)
{
  int v5; // r1
  _BOOL4 v9; // r0
  int v10; // r4
...
LABEL_21:
    ...
    {
      sub_1EF278((int)&v32, v39[1], v39[2], (int)fd);
      if ( (unsigned __int8)v32 != 4 )
        goto LABEL_21;
    }
  }
...
LABEL_23:
  ...
  if ( *(_DWORD *)a2 - v28 < v27 )
    sub_79590((size_t *)a2, v28, v27);
  sub_1D9E70((int *)&dest, fd[0], (size_t *)a2);
  if ( (unsigned __int8)dest == 4 )
  {
    close(fd[0]);
    v29 = (unsigned __int8 *)sub_1B3448(*(char **)(a2 + 4), *(_DWORD *)(a2 + 8));
