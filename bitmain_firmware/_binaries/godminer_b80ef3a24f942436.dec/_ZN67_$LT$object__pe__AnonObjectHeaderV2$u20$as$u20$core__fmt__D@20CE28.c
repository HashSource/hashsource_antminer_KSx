int __fastcall <object::pe::AnonObjectHeaderV2 as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[11] = &off_2EBD18;
  v3[9] = &off_2EB638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2B42FD, 18, (int)&off_2EBD28, 10, (int)v3, 10);
}
