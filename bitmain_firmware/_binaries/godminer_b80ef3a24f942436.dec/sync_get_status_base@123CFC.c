int __fastcall sync_get_status_base(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  int v22[2]; // [sp+2Ch] [bp-1018h] BYREF
  char v23[2]; // [sp+34h] [bp-1010h] BYREF
  ...
  v8 = 0;
  v22[1] = 1000000 * v9;
  v22[0] = sub_2704F8(a5, a6, 1000, 0);
  while ( v8 < a2 )
  {
    while ( 1 )
    {
      v12 = queue_dequeue_for(*(_DWORD *)(a1 + 868), v23, 0xAu, v22);
      if ( v12 == 110 )
      {
        v6 = 3;
        goto LABEL_14;
      ...
      zlog(
        ...
        20,
        v29);
      if ( (unsigned __int8)v23[0] != 170 || v23[1] != 85 || v24 != 8 || (v28 & 0x40) != 0 )
      {
        v6 = 1;
        *a4 = v8;
