int __fastcall <std::thread::scoped::Scope as core::fmt::Debug>::fmt(int *a1, _DWORD *a2)
{
  ...
  v3 = *a1;
  v10 = *(_DWORD *)(v3 + 8);
  v4 = core::fmt::builders::DebugStruct::field(v9, (int)aNumRunningThre, 0x13u, (int)&v10, (int)&off_2E9748);
  v5 = *(_BYTE *)(v3 + 16);
  v11 = v5 != 0;
  v6 = core::fmt::builders::DebugStruct::field(v4, (int)&unk_2B045C, 0x11u, (int)&v11, (int)&off_2E9758);
  v7 = core::fmt::builders::DebugStruct::field(v6, (int)aMainThread, 0xBu, v3 + 12, (int)&off_2E9768);
