int __fastcall <object::pe::ImageHotPatchBase as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2EB638;
  v3[1] = &off_2EB638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)aImagehotpatchb, 17, (int)&off_2EC2D8, 8, (int)v3, 8);
}
