  ...
  while ( 1 )
  {
    ...
    if ( v13 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v19 = (int *)v17[10];
          core::str::converts::from_utf8((int)&v55, *(_DWORD *)(v36 + v14 + 36), (unsigned int)v19);
          v20 = 2;
          if ( !v55 )
          {
            if ( v56 )
            {
              rustc_demangle::try_demangle(&v55, (int)v56, (int)v57);
              if ( v55 != 2 )
              {
                v20 = v55;
                v48 = v56;
...
LABEL_26:
        ...
        v55 = 2;
LABEL_27:
        v24 = sub_1EC964(&v45, v15, v47, &v55, v17[4], v17[5], v17[6], v17[7]);
        ++v46[2];
        if ( v24 )
          goto LABEL_40;
        v14 += 44;
    ...
    v47[0] = (int *)3;
    v55 = 2;
    v26 = sub_1EC964(&v48, v25, v47, &v55, 0, v31, 0, v32);
    ++v49[2];
    if ( v26 )
      break;
LABEL_34:
