int __fastcall <object::pe::ImageSeparateDebugHeader as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[3] = &off_2EB110;
  v3[1] = &off_2EB110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2B521B, 24, (int)&off_2EC458, 13, (int)v3, 13);
}
