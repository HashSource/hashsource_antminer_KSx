char **__fastcall std::thread::available_parallelism(_DWORD *a1)
{
  ...
  *(_WORD *)v235 = 0;
  ...
  if ( !v217 )
  {
    sub_1EF278(&v224, v218, v219, &v232);
    v201 = a1;
...
LABEL_47:
      ...
      if ( !v217 )
      {
        ...
        s[1] = v219;
        s[0] = 0;
        for ( i = (const void *)sub_1B3718(s); i; i = (const void *)sub_1B3718(s) )
        {
...
LABEL_14:
  ...
  if ( (v8 & 1) == 0 )
  {
    ...
    while ( 2 )
    {
      ((void (__fastcall *)(size_t *, _BYTE *, int))off_2EAB4C[v31])(s, ptr, v1);
      if ( s[0] == 2 )
        goto LABEL_72;
      v33 = 0;
      v34 = s[3];
...
LABEL_92:
          ...
          if ( !v44 && v43 != 0 )
          {
            ...
            {
              v126 = sub_1F6944((int)&v221, (int)&v224, &unk_2B0B6C, 0x10u);
              v128 = v127;
              v129 = sub_1F6944((int)&v221, (int)&v224, aCpuCfsPeriodUs, 0x11u);
              v131 = v126 == 1;
              if ( v126 == 1 )
                v131 = v129 == 1;
              if ( v131 && v130 )
              {
                v132 = sub_270BA8(v128, v130);
                v133 = nb;
                if ( nb >= v132 )
                  v133 = v132;
                nb = v133;
    ...
    *(_WORD *)v235 = 0;
    ...
    if ( (unsigned int)(v150 + 7) >> 7 <= 2 )
    {
      ...
      *((_BYTE *)s + v122) = 0;
      ...
      {
        v229 = dword_2EA158;
        v230 = (void **)&off_2EA14C;
        if ( (unsigned __int8)dword_2EA158 == 4 )
          goto LABEL_207;
        goto LABEL_198;
      }
      sub_1EF278(&v229, v218, v219, &v232);
    }
    else
    {
      sub_7B218(&v229, v222, v150 + 7, (int)&v232);
    }
...
LABEL_208:
    ...
    v155 = sub_1D12FC(s);
    if ( v224 - v226 < v155 )
      sub_79590((size_t *)&v224, v226, v155);
    sub_1D9E70(&v227, s[0], &v224);
    close(s[0]);
    v152 = v227 & 7;
    if ( v152 == 4 )
    {
LABEL_200:
      ...
      s[1] = v154;
      s[0] = 0;
      v159 = (unsigned __int8 *)sub_1B3718(s);
      v149 = v158;
      if ( !v159 )
        break;
      v160 = v158;
