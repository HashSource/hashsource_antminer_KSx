int __fastcall memchr::memmem::SearcherRev::new(int result, _BYTE *a2, unsigned int a3, int a4)
{
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v25 >= a3 )
LABEL_70:
        core::panicking::panic_bounds_check(v25, a3, (int)&off_2EC7B8);
      v26 = v24;
      v24 += ~v22;
      if ( v24 >= a3 )
        break;
      ...
      if ( v24 <= v22 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v20 <= v30 )
          {
            ...
            {
              if ( v6 > a3 )
                core::panicking::panic((int)aAssertionFaile_22, 35, (int)&off_2EC788);
              if ( v6 < v21 )
...
LABEL_57:
        ...
        v48 = v20;
LABEL_73:
        core::panicking::panic_bounds_check(v48, a3, (int)&off_2EC7C8);
      }
    }
    v48 = v24;
    goto LABEL_73;
