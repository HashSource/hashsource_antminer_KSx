int __fastcall <object::elf::Ident as core::fmt::Debug>::fmt(int a1, _DWORD *a2)
{
  ...
  v3[13] = &off_2EB628;
  v3[1] = &off_2EB618;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, (int)&unk_2B3B7C, 5, (int)&off_2EB5E0, 7, (int)v3, 7);
}
