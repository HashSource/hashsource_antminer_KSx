bool __fastcall sub_EFC54(int a1, int a2, char **a3)
{
  char v3; // r3
  _DWORD *v5; // r9
  int v6; // r0
...
LABEL_9:
  ...
  *a3 = v38;
  ...
  v16 = (*(int (__fastcall **)(int, __int64 *, int, _WORD *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int))(a1 + 300))(
          a1,
          &v41,
          v15,
          ptr,
