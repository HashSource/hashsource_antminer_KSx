int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned __int16 a3, int a4)
{
  ...
  zlog(
    ...
    v50);
  v33 = malloc(0x1800u);
  sub_107648(a1, a3, 86, 3670024);
  usleep(0x12Cu);
  sub_107648(a1, a3, 85, 109905420);
  usleep(0x12Cu);
  sub_107648(a1, a3, 101, -268374016);
  usleep(0x12Cu);
  ...
  sub_107648(a1, a3, 98, -1426085121);
  usleep(0x64u);
  ...
  sub_107648(a1, a3, 133, 255);
  usleep(0x64u);
  sub_107648(a1, a3, 134, 255);
  usleep(0x64u);
  sub_107648(a1, a3, 132, -2147483647);
  sleep(6u);
    ...
    if ( v19 )
    {
      ...
      do
      {
        ...
        v19 = zlog(
                ...
                "ease/build/godminer-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_phy_set.c",
                190,
                "phy_internal_bist_rvn",
                21,
                963,
  ...
  while ( 1 )
  {
    ...
    if ( v24 )
    {
      ...
      do
      {
        ...
        V_INT((int)v48, "chain", *(int *)(a1 + 248));
