        ...
        int a5)
{
  ...
  v6 = *a2;
  if ( !*a2 )
    core::panicking::panic((int)aAssertionFaile_32, 28, (int)&off_2EED64);
  if ( HIDWORD(v6) > 0x1FFFFFFF )
    core::panicking::panic((int)aAssertionFaile_40, 36, (int)&off_2EED74);
  if ( !a4 )
    core::panicking::panic((int)aAssertionFaile_39, 33, (int)&off_2EED84);
  ...
  if ( v15 >= 0x51 )
    core::panicking::panic_bounds_check(v15, 81, (int)&off_2EEC94);
  ...
  if ( v37 <= (__int16)a5 )
  {
    ...
    if ( v70 >= 0 )
      v46 = 0;
    return sub_245758(a1, a3, a4, 0, v37, a5, v44, HIDWORD(v44), v46, v45, v33, v32);
  }
  else
  {
    v64 = v32;
    ...
    while ( 1 )
    {
      v43 = sub_270BA8(v31, v35);
      if ( a4 == v42 )
        core::panicking::panic_bounds_check(a4, a4, (int)&off_2EEDA4);
      v31 -= v43 * v35;
      a3[v42] = v43 + 48;
      if ( v41 == v42 )
      {
        ...
        return sub_245758(v65, a3, a4, v66, v62, a5, v51 + v39, (__PAIR64__(v48, v51) + v39) >> 32, v50, v49, v63, v64);
      }
      if ( v34 == v42 )
        break;
      ++v42;
      ...
      if ( !v26 )
        core::panicking::panic((int)aAttemptToDivid, 25, (int)&off_2EED94);
    }
    v52 = v42 + 1;
    v53 = a4;
    v54 = 1;
    ...
    while ( 1 )
    {
      ...
      if ( v57 )
        break;
      if ( v53 == v52 )
        core::panicking::panic_bounds_check(v53, a4, (int)&off_2EEDB4);
      v58 = v54;
      v54 *= 10;
      ...
      HIDWORD(v39) = v59 & v67;
      if ( v66 == v52 )
        return sub_245758(v65, a3, a4, v66, v62, a5, v39, HIDWORD(v39), v63, v64, v54, v56);
    }
    *v65 = 0;
    return 0;
  }
