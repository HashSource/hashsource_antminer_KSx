int __fastcall <std::backtrace_rs::backtrace::Frame as core::fmt::Debug>::fmt(_DWORD *a1, _DWORD *a2)
{
  ...
  {
    v9 = a1[1];
    v4 = core::fmt::builders::DebugStruct::field(v8, (int)aIp, 2u, (int)&v9, (int)&off_2EA478);
    v5 = a1[3];
  }
  else
  {
  ...
  v10 = v5;
  v6 = core::fmt::builders::DebugStruct::field(v4, (int)aSymbolAddress, 0xEu, (int)&v10, (int)&off_2EA478);
