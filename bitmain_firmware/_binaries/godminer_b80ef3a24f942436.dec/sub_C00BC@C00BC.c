int __fastcall sub_C00BC(_DWORD *a1)
{
  _DWORD *v1; // r0
  _DWORD *v2; // r6
  int v3; // r0
  ...
  _DWORD *v64; // [sp+14h] [bp-1010h]
  _BYTE v65[4100]; // [sp+20h] [bp-1004h] BYREF
  ...
  v14 = *(_DWORD *)(dword_312D50 + 88) - 1;
  v15 = *(_DWORD *)(dword_312D50 + 88) != 1;
  *(_DWORD *)(dword_312D50 + 64) = v13;
  if ( v14 != 1 && v15 )
    return 0;
  ...
  if ( v17 && *v17 == 1 )
  {
    ...
    for ( i = 0; i < (unsigned int)json_array_size(v64); ++i )
    {
      ...
      v22 = (_DWORD *)json_object_get(v19, "index");
      v23 = (int)v22;
      if ( !v22 || *v22 != 3 )
      {
        V_LOCK(v22);
      ...
      V_LOCK(v22);
      json_integer_value(v23);
      v24 = logfmt_raw((int)v65, 0x1000u);
      V_UNLOCK(v24);
      zlog(
        g_zc,
        ...
        20,
        v65);
      v25 = json_integer_value(v23);
      v26 = (_DWORD *)(*(_DWORD *)(dword_312D50 + 84) + 24 * v25);
      *v26 = v25;
      v26[2] = 0;
      v27 = (_DWORD *)json_object_get(v20, "type");
      v28 = v27;
      if ( !v27 || *v27 != 2 )
      {
        V_LOCK(v27);
      ...
      zlog(
        ...
        20,
        v65);
      v30 = (const char *)json_string_value(v28);
      if ( strcmp(v30, "TMP451") )
      {
        do
          ++v21;
        while ( v21 != 5 && strcmp(v30, *(const char **)&aJ[4 * v21]) );
      }
      v26[1] = v21;
