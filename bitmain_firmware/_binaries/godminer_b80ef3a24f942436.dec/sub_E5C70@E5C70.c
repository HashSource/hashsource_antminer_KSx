int __fastcall sub_E5C70(int a1, int a2)
{
  int v2; // r2
  _DWORD *v3; // r7
  int *v5; // r9
...
LABEL_6:
      *v5 = v14;
      v15 = v35;
      v16 = v6 + 2 * *(_DWORD *)(a1 + 240);
      v17 = v14 - *(unsigned __int8 *)(a1 + 988) - v35;
      v18 = 4 * v16;
      if ( v17 < 0 )
        v17 = v35 - (v14 - *(unsigned __int8 *)(a1 + 988));
      v19 = v17 <= 3;
      v20 = dword_2F0C7C[v16];
      v21 = *(_DWORD *)((char *)&dword_2F0C7C[6] + v18);
      if ( v19 )
        goto LABEL_18;
      v22 = v20 == -64;
      if ( v20 == -64 )
      ...
      if ( v23 > v24 )
      {
        ...
        zlog(
          ...
          v45);
        v14 = v36;
        v15 = v36 - *(unsigned __int8 *)(a1 + 988);
        *(v5 - 1) = v15;
        v32 = *(_DWORD *)(a1 + 240);
        v35 = v15;
LABEL_34:
      ...
      if ( v23 < v24 )
      {
        ...
        zlog(
          ...
          v45);
        v15 = v35;
        v14 = *(unsigned __int8 *)(a1 + 988) + v35;
        *v5 = v14;
        v36 = v14;
        v32 = *(_DWORD *)(a1 + 240);
        goto LABEL_34;
...
LABEL_18:
      if ( v20 != v15 )
        dword_2F0C7C[v16] = v15;
      if ( v21 != v14 )
        v18 += (int)dword_2F0C7C;
      ++v6;
      v3 += 6;
      v5 += 2;
      if ( v21 != v14 )
