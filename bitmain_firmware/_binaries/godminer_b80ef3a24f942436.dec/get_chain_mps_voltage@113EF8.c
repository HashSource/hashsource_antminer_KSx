int __fastcall get_chain_mps_voltage(int a1, _WORD *a2)
{
  ...
  *a2 = -1;
  result = sub_113E7C(a1, 0);
  if ( !result )
    goto LABEL_3;
  src = 8562;
  v13 = 2;
  result = sub_113A98(a1, 60, &src, 3u, &v10, 2u);
  if ( result
    || (v6 = v10, v7 = v11, (result = sub_113E7C(a1, 2)) == 0)
    || (v13 = 2, src = 3442, (result = sub_113A98(a1, 60, &src, 3u, &v10, 2u)) != 0) )
  {
LABEL_3:
    V_LOCK(result);
    ...
    *a2 = v8;
    if ( 10 * ((v6 | (unsigned __int16)(v7 << 8)) & 0x1FF) + 490 != v8 )
    {
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-new/backend/device/hal/drv_pic/mps2973.c",
        180,
        "get_chain_mps_voltage",
        21,
        189,
