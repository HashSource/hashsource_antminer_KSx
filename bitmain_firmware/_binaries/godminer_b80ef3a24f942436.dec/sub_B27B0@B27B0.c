int __fastcall sub_B27B0(int a1, int *a2)
{
  int *v2; // r10
  int v3; // r7
  int v4; // r6
  ...
  if ( v2 )
  {
    ...
    if ( v22 )
    {
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-new/dhash_content/rvn/rvn_2044/rvn_2044_content.c",
        189,
        "push_work_rvn_2044",
        18,
        82,
    ...
    {
      v30 = memcmp(dword_2F3D38, &v33, 0x20u);
      v24 = memcmp(dword_2F3D58, &v41, 0x20u) | v30;
      if ( !(_BYTE)v24 )
      {
LABEL_4:
        qword_2F3D78 = v5;
