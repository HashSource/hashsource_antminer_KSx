int __fastcall std::process::Command::output(int *a1, int a2)
{
  ...
  unsigned int v17; // [sp+28h] [bp+0h] BYREF
  ...
  if ( v11 )
  {
    ...
    if ( (unsigned __int8)v31 != 4 )
    {
      stat_loc = v31;
      v34 = v32;
      core::result::unwrap_failed((int)&unk_2AFC2A, 43, (int)&stat_loc, (int)&off_2E9308, (int)&off_2EA1C4);
    }
    goto LABEL_13;
  }
  if ( v10 == -1 )
  {
    ...
    if ( (unsigned __int8)v31 != 4 )
    {
      stat_loc = v31;
      v34 = v32;
      core::result::unwrap_failed((int)&unk_2AFC2A, 43, (int)&stat_loc, (int)&off_2E9308, (int)&off_2EA1B4);
    }
LABEL_13:
    close(fd);
    goto LABEL_14;
  }
  sub_1F3728((int)&v31, v9, (int)&v27, v10, (int)&v17);
  if ( (unsigned __int8)v31 != 4 )
  {
    stat_loc = v31;
    v34 = v32;
    core::result::unwrap_failed((int)&unk_2AFC2A, 43, (int)&stat_loc, (int)&off_2E9308, (int)&off_2EA1A4);
  }
LABEL_14:
  if ( v3 == 1 )
    goto LABEL_19;
