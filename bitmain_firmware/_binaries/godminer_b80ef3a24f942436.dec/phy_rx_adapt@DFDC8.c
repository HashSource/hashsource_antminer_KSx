unsigned int __fastcall phy_rx_adapt(int a1, unsigned int a2, int a3)
{
  ...
  zlog(
    ...
    60,
    v34);
  sub_D85AC(a1, a3, 84, -1);
  v8 = sub_D881C(a1, a2, (unsigned __int16)a3, 84, v6);
  if ( v8 )
  {
    v9 = (unsigned int *)v6;
    v10 = 0;
  ...
  sub_D85AC(a1, a3, 84, -16711936);
  v14 = sub_D881C(a1, a2, (unsigned __int16)a3, 84, v6);
  if ( v14 )
  {
    v9 = (unsigned int *)v6;
    v15 = 0;
...
LABEL_18:
  sub_D85AC(a1, a3, 100, (int)&loc_F000C + 3);
  v16 = sub_D881C(a1, a2, (unsigned __int16)a3, 100, v6);
  if ( v16 )
  {
    v9 = (unsigned int *)v6;
    v17 = 0;
...
LABEL_24:
  sub_D85AC(a1, a3, 80, (int)<std::fs::Metadata as std::os::linux::fs::MetadataExt>::st_ctime_nsec + 2);
  v18 = sub_D881C(a1, a2, (unsigned __int16)a3, 80, v6);
  if ( v18 )
  {
    v9 = (unsigned int *)v6;
    v19 = 0;
...
LABEL_30:
  sub_D85AC(a1, a3, 80, 0);
  v20 = sub_D881C(a1, a2, (unsigned __int16)a3, 80, v6);
  if ( v20 )
  {
    v9 = (unsigned int *)v6;
    v21 = 0;
...
LABEL_36:
  ...
  sub_D85AC(a1, a3, 84, -1);
  v23 = sub_D881C(a1, a2, (unsigned __int16)a3, 84, v6);
  if ( v23 )
  {
    v9 = (unsigned int *)v6;
    v24 = 0;
