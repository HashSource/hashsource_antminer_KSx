int __fastcall sync_get_dag_node_rvn(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v6; // r6
  ...
  char v26[2]; // [sp+2Ch] [bp-1110h] BYREF
  unsigned __int8 v27[3]; // [sp+2Eh] [bp-110Eh] BYREF
  ...
  v9 = 0;
  v25[1] = 1000000 * v10;
  v25[0] = sub_2704F8(a5, a6, 1000, 0);
  while ( v9 < a2 )
  {
    while ( 1 )
    {
      v13 = queue_dequeue_for(*(_DWORD *)(a1 + 868), v26, 0x10Bu, v25);
      if ( v13 == 110 )
      {
        v6 = 3;
        goto LABEL_12;
      ...
      zlog(
        ...
        20,
        var1004);
      if ( (unsigned __int8)v26[0] != 170 || v26[1] != 85 )
      {
        v6 = 1;
        *a4 = v9;
