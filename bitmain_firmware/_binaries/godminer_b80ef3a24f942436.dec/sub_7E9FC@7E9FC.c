int __fastcall sub_7E9FC(int result, int a2, int a3, int a4)
{
  bool v4; // zf
  _DWORD *v8; // r7
  _DWORD *v9; // r9
  ...
  if ( !v4 )
  {
    ...
    result = json_object_set_new(v8, "STATUS", v9);
    if ( !a2 )
    {
      v20 = json_integer(1);
      return json_object_set_new(v8, "id", v20);
    }
  }
  return result;
}
