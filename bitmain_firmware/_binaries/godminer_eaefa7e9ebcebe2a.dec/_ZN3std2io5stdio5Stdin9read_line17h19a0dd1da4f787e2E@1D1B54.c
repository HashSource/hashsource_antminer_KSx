int __fastcall std::io::stdio::Stdin::read_line(int a1, int *a2, int a3)
{
  int v3; // r4
  _BOOL4 v7; // r7
  int result; // r0
...
LABEL_5:
  ...
  v11 = v7;
  v10 = v3;
  ((void (__fastcall *)(int, int *, int))<std::io::stdio::StdinLock as std::io::BufRead>::read_line)(a1, &v10, a3);
  if ( !v7
