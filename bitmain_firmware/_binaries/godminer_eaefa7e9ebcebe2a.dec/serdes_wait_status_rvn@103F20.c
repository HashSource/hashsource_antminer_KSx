int __fastcall serdes_wait_status_rvn(int a1, int a2, int a3, int a4, int a5)
{
  ...
  LOBYTE(v16) = 5;
  ptr = (unsigned __int8 *)malloc(0x300u);
  while ( 1 )
  {
    sub_103884(a1, a3, 78, v17);
    v7 = sub_1038D4(a1, v18, 79, ptr);
    if ( !v7 )
      break;
    if ( v7 <= 0 )
      goto LABEL_13;
...
LABEL_10:
      ...
      v7 = zlog(
             ...
             "e/build/godminer-origin_godminer-kas_2382/backend/backend_rvn_2044/backend_rvn_phy_set.c",
             195,
