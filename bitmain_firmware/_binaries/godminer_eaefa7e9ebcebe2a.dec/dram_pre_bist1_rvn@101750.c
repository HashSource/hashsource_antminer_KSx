int __fastcall dram_pre_bist1_rvn(int a1, char a2)
{
  ...
  sub_F9838(a1, a2, 254, 6698008);
  sub_F9838(a1, a2, 255, 6698009);
  sub_F9838(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_F9838(a1, a2, 240, 769);
  usleep(0x249u);
  sub_F9838(a1, a2, 245, (int)"s$u20$core..fmt..Debug$GT$3fmt17h4a6fe009a7f9adadE");
  sub_F9838(a1, a2, 246, 270336);
  sub_F9838(a1, a2, 247, (int)"re..fmt..Debug$GT$3fmt17h4a6fe009a7f9adadE");
