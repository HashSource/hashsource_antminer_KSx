...
LABEL_54:
  ...
  if ( !a4 )
LABEL_114:
    core::panicking::panic((int)aAttemptToDivid, 25, (int)&off_2E4558);
  v16 = sub_26CF70(a3, a4);
  v17 = a3 - v16 * a4;
  LOBYTE(v71[0]) = v16 + 48;
  if ( !v17 )
  {
...
LABEL_29:
  ...
  if ( a4 < 0xF4240 )
    goto LABEL_114;
  BYTE2(v71[1]) = sub_26CD14((unsigned __int16)v17, v18) + 48;
  if ( !v24 )
  {
    v27 = 7;
    goto LABEL_52;
  ...
  if ( a4 < 0x989680 )
    goto LABEL_114;
  HIBYTE(v71[1]) = sub_26CD14((unsigned __int16)v24, a4 / 0x989680) + 48;
  if ( !v25 )
  {
    v27 = 8;
    goto LABEL_52;
  ...
  if ( a4 < 0x5F5E100 )
    goto LABEL_114;
  LOBYTE(v71[2]) = sub_26CD14((unsigned __int16)v25, a4 / 0x5F5E100) + 48;
  if ( !v64 )
  {
    a2 = v65;
    v13 = v67;
  ...
  {
    if ( a4 >= 0x3B9ACA00 )
      core::panicking::panic_bounds_check(9, 9, (int)&off_2E4568);
    goto LABEL_114;
  }
  a2 = v65;
  v13 = v67;
  v17 = (unsigned __int16)v64;
  v18 = (unsigned int)(((a4 >> 9) * (unsigned __int64)(unsigned int)"str17h2150493e56166623E") >> 32) >> 7;
LABEL_30:
  v26 = 5 * v18;
  v10 = a6;
  v72 = v15;
...
LABEL_56:
  ...
  if ( !(!v33 | v32) )
  {
    ...
    if ( v75 )
    {
      v42 = sub_26C8C0(v75, HIDWORD(v75), 1410065408, 2);
      v43 = v42;
      v66 = v36;
      v44 = HIDWORD(v42);
...
LABEL_94:
  ...
  if ( v58 == 1114112 || sub_250218(v77, a1) )
    return 1;
  v62 = 0;
  while ( v56 != v62 )
  {
