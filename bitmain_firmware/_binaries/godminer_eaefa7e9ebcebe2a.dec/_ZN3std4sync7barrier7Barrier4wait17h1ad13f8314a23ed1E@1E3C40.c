...
LABEL_34:
    v19 = v3;
    v18 = a1;
    core::result::unwrap_failed((int)&unk_2A44BA, 43, (int)&v18, (int)&off_2DE338, (int)&off_2DF0A4);
  }
...
LABEL_21:
        v19 = v17;
        v18 = a1;
        core::result::unwrap_failed((int)&unk_2A44BA, 43, (int)&v18, (int)&off_2DE338, (int)&off_2DF0B4);
      }
    }
  }
  if ( !v17
