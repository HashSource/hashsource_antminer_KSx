void __fastcall sub_1C04F8(int a1, int a2, int a3, int a4, _DWORD *a5)
{
  int v6; // r1
  int v10; // r1
  const void *v11; // r4
...
LABEL_12:
  ...
  if ( *(_QWORD *)(a3 + 32) )
  {
    if ( --v14 >= *(_DWORD *)(a4 + 112) )
      goto LABEL_28;
LABEL_17:
    sub_1BD3B8((int)&v42, (_DWORD *)(*(_DWORD *)(a4 + 108) + 16 * v14));
    if ( v42 == 46 )
      goto LABEL_28;
    goto LABEL_21;
  }
...
LABEL_21:
  ...
  size = v43;
  v65 = v44;
  sub_1BAC5C((int)&v57, a5, v16, v15, &v63);
  v17 = v57;
  if ( v57 != 75 )
  {
    v35 = v60;
...
LABEL_37:
  ...
  if ( !v22 )
    _rust_dealloc(v19);
LABEL_28:
  sub_1BD3B8((int)&v63, (_DWORD *)(a3 + 16));
  sub_1BAC5C((int)&v57, a5, *(unsigned __int8 *)(a2 + 89), *(_DWORD *)(a2 + 312), &v63);
  v23 = v57;
  if ( v57 != 75 )
  {
    v31 = v59;
