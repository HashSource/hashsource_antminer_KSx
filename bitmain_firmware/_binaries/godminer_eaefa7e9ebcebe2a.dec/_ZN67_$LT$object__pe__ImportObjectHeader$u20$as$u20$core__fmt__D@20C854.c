int __fastcall <object::pe::ImportObjectHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[11] = &off_2E0638;
  v3[9] = &off_2E0638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A9B10, 18, &off_2E1518, 8, v3, 8);
}
