int __fastcall sub_258900(int a1, _DWORD *a2)
{
  int v2; // r2
  int v3; // r12
  unsigned int v4; // r3
  ...
  else
  {
    if ( (v2 & 0x20) == 0 )
    {
      ...
      if ( v4 > 0x270F )
      {
        ...
        v16 = word_2B4047[v7];
        v17 = word_2B4047[(unsigned __int16)(v6 - 100 * v7)];
        v8 = 35;
LABEL_22:
        v14 = v8 - 1;
        v15[v8 - 1] = v5 + 48;
      ...
      else
      {
        ...
        v17 = word_2B4047[(unsigned __int16)(v4 - 100 * v5)];
        v8 = 37;
        if ( v5 < 0xA )
          goto LABEL_22;
      }
      v14 = v8 - 2;
      *(_WORD *)&v15[v8 - 2] = word_2B4047[v5];
      return core::fmt::Formatter::pad_integral(a2, v3 > -1, aLibraryCoreSrc, 0, (int)&v15[v14], 39 - v14);
    }
    v9 = 0;
    do
