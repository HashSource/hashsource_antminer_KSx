...
LABEL_34:
    if ( v4 && <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B0ADA, 2) )
      return 1;
...
LABEL_108:
            ...
            if ( v13 < 2 )
            {
              v38 = 1;
              v13 = 0;
              if ( <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B0ADE, 1) )
                return v38;
              continue;
            }
            if ( (char)*v14 <= -65 )
            ...
            {
LABEL_48:
              if ( <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B0ADA, 2) )
                return 1;
              if ( v13 >= 3 && v20[2] <= -65 )
LABEL_187:
...
LABEL_125:
        ...
        if ( v75 != 1 )
        {
          if ( v75 == 2 )
          {
            v40 = (const char *)&unk_2B0AE1;
            if ( *v34 == 20563
              || (v40 = asc_2B0AE4, *v34 == 20546)
              || (v40 = asc_2B0AE7, *v34 == 18002)
              || (v40 = asc_2B0AEA, *v34 == 21580)
              || (v40 = asc_2B0AED, *v34 == 21575)
              || (v40 = asc_2B0AF0, *v34 == 20556)
              || (v40 = asc_2B0AF3, *v34 == 20562) )
            {
LABEL_105:
              v38 = 1;
