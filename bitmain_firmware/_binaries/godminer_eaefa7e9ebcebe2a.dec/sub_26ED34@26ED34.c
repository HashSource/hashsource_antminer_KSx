unsigned int __fastcall sub_26ED34(unsigned int a1, unsigned int a2, unsigned __int64 a3)
{
  unsigned int v3; // r7
  unsigned int v4; // r9
  unsigned int v5; // r6
  ...
  if ( (_DWORD)a3 && !HIDWORD(a3) )
  {
    ...
    v28 = a2 - sub_26CF70(a2, a3) * a3;
    if ( v4 < 0x10000 )
    {
      v29 = sub_26CF70((v28 << 16) | HIWORD(v6), v4);
      return sub_26CF70((unsigned __int16)v6, v4) | (v29 << 16);
    }
