void *frontend_runtime_eth()
{
  ...
  dword_2E90D8 = (int)sub_9CC00;
  dword_2E90DC = (int)sub_9CB28;
  dword_2E90E0 = (int)sub_9BCF4;
  dword_2E90E4 = (int)stratum_authorize_eth;
  dword_2E90E8 = (int)sub_9C660;
  dword_2E90EC = (int)sub_9C478;
  dword_2E90F0 = (int)sub_9C298;
