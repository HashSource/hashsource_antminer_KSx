        ...
        unsigned int a13)
{
  ...
  *(_QWORD *)&flt_2E9620 = 0;
  ...
  dbl_2E9638 = 0.0;
  dbl_2E9630 = 0.0;
  *(double *)((char *)&dbl_2E9638 + 4) = 0.0;
  if ( a1 == 2 )
  {
    *(_QWORD *)&dbl_2E9628 = qword_2E5E34;
    *(_QWORD *)&dbl_2E9630 = qword_2E5E3C;
    flt_2E9620 = (float)SLODWORD(flt_2E5E28);
    flt_2E961C = (float)dword_2E5E14;
    flt_2E9618 = (float)dword_2E5E18;
  }
  V_LOCK(a9);
