int __fastcall <std::sys::unix::process::process_inner::ExitStatus as core::fmt::Display>::fmt(_DWORD *a1, int a2)
{
  const char *v3; // r1
  int v4; // r2
  unsigned int v5; // r2
  ...
  _DWORD v15[2]; // [sp+10h] [bp-28h] BYREF
  ...
  int (__fastcall *v21)(_DWORD, _DWORD); // [sp+2Ch] [bp-Ch]
  const char **v22; // [sp+30h] [bp-8h]
  int (__fastcall *v23)(_DWORD *, int); // [sp+34h] [bp-4h]
...
LABEL_5:
  ...
  if ( (unsigned __int8)v3 == 127 )
  {
    ...
    {
      v8 = (char)v7;
      v9 = (const char *)*(&off_2E0024 + (char)v7);
      v10 = dword_2A754C[v8];
    }
    v13 = v9;
    v16 = &off_2DFD78;
  ...
  else
  {
    ...
    v18 = &v20;
    v15[1] = 2;
    v23 = (int (__fastcall *)(_DWORD *, int))core::fmt::num::<impl core::fmt::LowerHex for usize>::fmt;
    v22 = (const char **)a1;
    v21 = core::fmt::num::imp::<impl core::fmt::Display for i32>::fmt;
    v20 = (const char **)a1;
    v16 = &off_2DFD68;
