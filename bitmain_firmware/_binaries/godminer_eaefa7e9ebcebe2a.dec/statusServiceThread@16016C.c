...
LABEL_27:
      zlog(
        ...
        "ld/godminer-origin_godminer-kas_2382/common/general/http.c",
        170,
        "statusServiceThread",
        19,
        v30,
  ...
  v6 = zlog(
         ...
         "ild/godminer-origin_godminer-kas_2382/common/general/http.c",
         170,
         "statusServiceThread",
         19,
         67,
...
LABEL_24:
    ...
    zlog(
      ...
      "/godminer-origin_godminer-kas_2382/common/general/http.c",
      170,
      v24,
      19,
      addr_len,
...
LABEL_21:
    ...
    while ( 1 )
    {
      ...
      v37 = zlog(
              ...
              "se/build/godminer-origin_godminer-kas_2382/common/general/http.c",
              170,
              "statusServiceThread",
              19,
              159,
