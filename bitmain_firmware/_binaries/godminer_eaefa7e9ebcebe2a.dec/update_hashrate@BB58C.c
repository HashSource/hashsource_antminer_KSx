_QWORD *__fastcall update_hashrate(int a1, int a2, _QWORD *a3)
{
  ...
  *(_QWORD *)(a2 + 64) = v8;
  ...
  {
    v9 = 16 * v7;
    if ( !*((_BYTE *)&unk_2EADD8 + v7) )
    {
      clock_gettime(1, (struct timespec *)((char *)&unk_2EADE8 + v9));
      clock_gettime(1, (struct timespec *)((char *)&unk_2EAEE8 + v9));
      clock_gettime(1, (struct timespec *)((char *)&unk_2EAFE8 + v9));
      *((_BYTE *)&unk_2EADD8 + v7) = 1;
      *((_QWORD *)&unk_2EADD8 + v7 + 98) = 0;
    }
    if ( *(_QWORD *)(a1 + 448) )
    {
      if ( !byte_2EB168 )
    ...
    else if ( !byte_2EB168 )
    {
      ...
      clock_gettime(1, (struct timespec *)((char *)&unk_2EAEE8 + v9));
      clock_gettime(1, (struct timespec *)((char *)&unk_2EAFE8 + v9));
      *((_QWORD *)&unk_2EADD8 + v7 + 98) = v46;
      return a3;
    }
    clock_gettime(1, (struct timespec *)((char *)&unk_2EADE8 + v9 + 8));
    v10 = 1000LL * (*(_DWORD *)((char *)&unk_2EADD8 + v9 + 24) - *(_DWORD *)((char *)&unk_2EADD8 + v9 + 16))
        + (*(_DWORD *)((char *)&unk_2EADD8 + v9 + 28) - *(_DWORD *)((char *)&unk_2EADD8 + v9 + 20)) / 1000000;
    v11 = (char *)&unk_2EB170 + 2896 * v7;
    v12 = sub_26C8E8(v10, HIDWORD(v10)) / 1000.0;
    if ( v12 >= 5.0 )
    {
      v32 = *(_QWORD *)(a1 + 448);
      v33 = *((_QWORD *)&unk_2EADD8 + v7 + 98);
      ...
      else
      {
        ...
        v44 = vshld_u64(1u, v3);
        v45 = COERCE_FLOAT(((int (__fastcall *)(_DWORD, _DWORD))sub_26C764)(v44, HIDWORD(v44)));
        v34 = sub_26C764(v35, HIDWORD(v35));
      ...
      zlog(
        ...
        v55);
      clock_gettime(1, (struct timespec *)((char *)&unk_2EADE8 + v9));
      v38 = (char *)&unk_2EB170 + 2896 * v7;
      *((_QWORD *)&unk_2EADD8 + v7 + 98) = v32;
      v39 = v38 + 2880;
      v40 = *((_DWORD *)v38 + 720);
      v41 = *((_QWORD *)v38 + 361);
      v47 = v41 + 1;
      *((float *)&unk_2EB170 + 724 * v7 + v40) = v36;
      *((_DWORD *)v38 + 720) = (v40 + 1) % 720;
      v42 = v36 + (float)(sub_26C764(v41, HIDWORD(v41)) * *(float *)(a2 + 48));
      *(float *)(a2 + 48) = v42 / sub_26C764(v47, HIDWORD(v47));
      *((_QWORD *)v39 + 1) = v47;
    }
    sub_BB4F0((int)v11);
    *(float *)(a2 + 36) = 5.0;
    ...
    *(_QWORD *)(a2 + 88) = v14;
    clock_gettime(1, (struct timespec *)((char *)&unk_2EAEE8 + v9 + 8));
    v19 = 1000LL * (*(_DWORD *)((char *)&unk_2EADD8 + v9 + 280) - *(_DWORD *)((char *)&unk_2EADD8 + v9 + 272))
        + (*(_DWORD *)((char *)&unk_2EADD8 + v9 + 284) - *(_DWORD *)((char *)&unk_2EADD8 + v9 + 276)) / 1000000;
    if ( (float)(sub_26C8E8(v19, HIDWORD(v19)) / 1000.0) >= 900.0 )
    {
      sub_BB4F0((int)v11);
      v21 = *(_DWORD *)(a2 + 208);
      if ( v21 > 23 )
