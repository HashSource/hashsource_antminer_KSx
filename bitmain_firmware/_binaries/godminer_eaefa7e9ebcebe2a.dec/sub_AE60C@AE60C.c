int __fastcall sub_AE60C(int a1)
{
  unsigned int v1; // r4
  ...
  v4 = zlog(
         ...
         "ild/godminer-origin_godminer-kas_2382/machine_runtime/zec_1746/machine_runtime_zec_1746.c",
         200,
         "set_voltage_MP2973",
         18,
         45,
  ...
  if ( v1 != v13 )
  {
    ...
    zlog(
      ...
      "/godminer-origin_godminer-kas_2382/machine_runtime/zec_1746/machine_runtime_zec_1746.c",
      200,
      "set_voltage_MP2973",
      18,
      48,
  ...
  do
  {
    ...
    do
    {
      v10 = set_chain_mps_voltage(*(_DWORD *)(*(_DWORD *)(all_created_runtime + 4 * v7) + 248), (unsigned __int16)v13);
      if ( !v10 )
      {
        V_LOCK(0);
        V_INT((int)&v17, "chain");
        ...
        zlog(
          ...
          "uild/godminer-origin_godminer-kas_2382/machine_runtime/zec_1746/machine_runtime_zec_1746.c",
          200,
          "set_voltage_MP2973",
          18,
          59,
