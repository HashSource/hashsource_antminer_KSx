void *__fastcall runtime_ctrl_ltc_1489(int a1)
{
  ...
  LODWORD(s[11]) = sub_F5E98;
  HIDWORD(s[11]) = sub_F5D80;
  LODWORD(s[12]) = sub_F4090;
  HIDWORD(s[12]) = sub_F3B20;
  LODWORD(s[13]) = sub_F3B28;
  HIDWORD(s[13]) = sub_F5AB4;
  LODWORD(s[14]) = sub_F4E70;
  HIDWORD(s[14]) = sub_F56D4;
  LODWORD(s[15]) = sub_F56AC;
