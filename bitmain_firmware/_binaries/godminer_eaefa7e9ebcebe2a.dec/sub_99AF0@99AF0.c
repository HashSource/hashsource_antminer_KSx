int __fastcall sub_99AF0(int a1, int a2, _DWORD *a3, unsigned int a4)
{
  _DWORD *v7; // r0
  char *v8; // r4
  _DWORD *v9; // r0
  ...
  if ( !v8 )
  {
    ...
    zlog(
      ...
      "/godminer-origin_godminer-kas_2382/frontend/frontend_dash/frontend_dash.c",
      187,
    ...
    if ( v16 )
    {
      ...
      *v16 = v11;
      ...
      zlog(
        ...
        "ld/godminer-origin_godminer-kas_2382/frontend/frontend_dash/frontend_dash.c",
        187,
        "stratum_parse_extranonce_dash",
        29,
        257,
