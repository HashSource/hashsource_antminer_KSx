int __fastcall sub_1C5A64(int a1, int *a2, int a3, int a4, int a5, unsigned int *a6, unsigned int *a7, int a8)
{
  int v8; // r4
  int v9; // r8
  int v11; // r10
...
LABEL_13:
        ...
        sub_1B9AFC((int)v141, (unsigned int *)a2, *(_DWORD *)(a2[3] + 40), v23, SHIDWORD(v23));
        result = v141[0];
        if ( v141[0] == 75 )
        {
          while ( 1 )
      ...
      sub_1B9AFC((int)v141, (unsigned int *)a2, *(_DWORD *)(a2[3] + 40), v15, SHIDWORD(v15));
      result = v141[0];
      if ( v141[0] != 75 )
      {
        v105 = *(_DWORD *)&v141[1];
    ...
    *(_DWORD *)(v64 + 32 * v63) = v28;
    ...
    if ( v128 == 1 )
    {
      ...
      *(_QWORD *)&v141[16] = v76;
      ...
      v143 = v75;
      v142 = v74;
      sub_1BB594((int)&v145, (unsigned __int8 **)v141);
      v78 = v145;
      v79 = v68;
      v80 = a7;
      if ( v145 == 2 )
...
LABEL_140:
    ...
    sub_1C5A64(&v135, a2, v120, v26, a5, v61, v80, a8 + 1);
LABEL_121:
    v9 = a1;
    v11 = a3;
...
LABEL_6:
  ...
  while ( 2 )
  {
    ...
    *(_QWORD *)((char *)&v136 + 4) = __PAIR64__(v33, v32);
    ...
    HIDWORD(v136) = v35;
    sub_1B8160((int)v141, (unsigned int *)a2, v34, (int)&v145);
    if ( *(_QWORD *)v141 == 46 )
    {
      v135 = *(_OWORD *)&v141[8];
      goto LABEL_121;
    ...
    switch ( *(_WORD *)&v141[16] )
    {
      case 3:
        if ( !v28 )
        {
          ...
          LODWORD(v41) = &v145;
          sub_1BA1A0(v41);
          sub_1BAC5C((int)&v136, (_DWORD *)(v42 + 8), *(unsigned __int8 *)(a4 + 41), *(_DWORD *)(a4 + 264), &v145);
          v28 = DWORD1(v136);
...
LABEL_90:
      ...
      default:
        ...
        if ( v37 )
        {
          ...
          LODWORD(v38) = &v145;
          sub_1BA1A0(v38);
          sub_1BAC5C((int)&v136, (_DWORD *)(v39 + 8), *(unsigned __int8 *)(a4 + 41), *(_DWORD *)(a4 + 264), &v145);
          v40 = v134;
          if ( (unsigned __int8)v136 == 75 )
          {
            v40 = DWORD2(v136);
