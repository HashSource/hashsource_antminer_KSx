int __fastcall core::unicode::unicode_data::lowercase::lookup(unsigned int a1)
{
  ...
  if ( a1 >> 10 <= 0x7A )
  {
    v2 = byte_2B8BF7[a1 >> 10];
    if ( v2 >= 0x14 )
      core::panicking::panic_bounds_check(byte_2B8BF7[a1 >> 10], 20, (int)&off_2E4C00);
    v3 = byte_2B8C72[16 * v2 + ((a1 >> 6) & 0xF)];
    if ( v3 >= 0x37 )
    {
      v6 = v3 - 55;
      if ( v6 >= 0x15 )
        core::panicking::panic_bounds_check(v6, 21, (int)&off_2E4C10);
      v8 = (unsigned __int8 *)&unk_2B8F70 + 2 * v6;
      v7 = *v8;
      if ( v7 >= 0x37 )
        core::panicking::panic_bounds_check(v7, 55, (int)&off_2E4C20);
      v9 = (char)v8[1];
      v10 = dword_2B8DB8[2 * v7];
      v11 = dword_2B8DB8[2 * v7 + 1];
      v12 = (char)(2 * v9);
      v13 = v10 ^ (v12 >> 7);
      v14 = v11 ^ (v12 >> 7);
      if ( v9 <= -1 )
    ...
    {
      v4 = dword_2B8DB8[2 * v3];
      v5 = dword_2B8DB8[2 * v3 + 1];
    }
    v21 = a1 & 0x3F;
    v22 = 32 - v21;
    v23 = v4 >> v21;
