...
LABEL_25:
      if ( signal(13, (__sighandler_t)v9) == (__sighandler_t)-1 )
      {
        ...
        fds.sa_handler = 0;
        sub_1D6904(stacksize, stackaddr, v35);
        sub_1AF2E0((int)stacksize);
        goto LABEL_46;
      }
LABEL_26:
      v10 = &fds;
      ...
      if ( !fds.sa_handler )
      {
        ...
        fds.sa_handler = (__sighandler_t)sub_1F2144;
        sigaction(11, &fds, 0);
        byte_307C7C = 1;
      }
      sigaction(7, 0, &fds);
...
LABEL_37:
      ...
      if ( v29 )
      {
        ...
        fds.sa_handler = 0;
        stacksize[1] = (size_t)sub_1BD12C;
        stacksize[0] = (size_t)&p_p_fds;
        sub_1D6904(v31, stackaddr, v35);
        v24 = v31[0];
        if ( v31[0] != 4 )
          sub_1AE57C((int)v31);
LABEL_46:
