int bitmain_power_version()
{
  ...
  if ( dword_306CA0 == 255 )
  {
    if ( sub_11923C((unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u) )
    {
      v0 = -2147482880;
  ...
  else if ( sub_1193DC(dword_306CA0, (unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u) )
  {
    v0 = -2147482880;
    strcpy(s, "get power version failed");
    V_LOCK(*(_DWORD *)"n failed");
