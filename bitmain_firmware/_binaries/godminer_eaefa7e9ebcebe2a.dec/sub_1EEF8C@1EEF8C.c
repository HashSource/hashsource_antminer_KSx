int __fastcall sub_1EEF8C(_DWORD *a1, char *name)
{
  _BOOL4 v5; // r7
  int v6; // r5
  unsigned int v7; // r0
...
LABEL_4:
  ...
  v6 = (unsigned __int8)byte_307C9C;
  if ( unsetenv(name) == -1 )
  {
    v10 = *_errno_location();
    *a1 = 0;
...
LABEL_8:
      ...
      do
      {
        ...
        v8 = v7 - 0x3FFFFFFF;
        result = __strex(v7 - 0x3FFFFFFF, (unsigned int *)&dword_307C94);
      }
      while ( result );
      goto LABEL_18;
    }
  ...
  do
  {
    v11 = __ldrex((unsigned int *)&dword_307C94);
    v8 = v11 - 0x3FFFFFFF;
    result = __strex(v11 - 0x3FFFFFFF, (unsigned int *)&dword_307C94);
  }
  while ( result );
LABEL_18:
  if ( v8 >= 0x40000000 )
    return std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_307C94, v8);
  return result;
}
