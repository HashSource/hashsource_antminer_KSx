int __fastcall sub_25A46C(unsigned int a1, unsigned int a2, int a3, int a4, _DWORD *a5)
{
  unsigned int v7; // r4
  unsigned int v8; // r7
  unsigned int v9; // r10
  ...
  if ( __PAIR64__(v7, v8) >= 0xA && !v10 )
  {
    ...
    do
    {
      v15 = sub_26C8C0(v8, v7, 10, 0);
      v14 = HIDWORD(v15);
      v13 = v15;
      sub_26C8C0(v15, HIDWORD(v15), 10, 0);
      ++v12;
...
LABEL_7:
  ...
  if ( __PAIR64__(v14, v13) >= 0xA )
  {
    ...
    do
    {
      v20 = sub_26C8C0(v19, HIDWORD(v19), 10, 0);
      ++v18;
      v21 = v19 <= 0x63;
      v19 = v20;
    }
...
LABEL_40:
  ...
  do
  {
    v32 = sub_26C8C0(v30, v29, 100, 0);
    v33 = &v44[v31 + 38];
    v31 -= 2;
    *v33 = word_2B4047[v30 - 100 * (_DWORD)v32];
