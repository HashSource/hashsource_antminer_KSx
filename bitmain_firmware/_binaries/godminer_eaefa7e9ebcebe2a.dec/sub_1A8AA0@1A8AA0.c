int __fastcall sub_1A8AA0(int a1, int a2, int *a3, int a4, __int64 a5)
{
  char v7; // r5
  unsigned int v8; // r10
  int v9; // r0
  ...
  if ( v8 > 0xFF )
    core::panicking::panic_bounds_check(v9, 4, (int)&off_2DDF40);
  v10 = v7 & 0x3F;
  v11 = 0xFFFFLL * src[0];
  v41 = a2;
  v12 = v10 - 32;
  ...
  do
  {
    v58 = v50;
    v59 = 0;
    sub_26E2A8(v57, &v58, &v59);
    memcpy(src, v57, sizeof(src));
    if ( sub_26D4F8(src) == 64 )
      break;
  }
  while ( v34++ < 0x400 );
  ...
  *(_DWORD *)(a1 + 68) = v39 ^ 0x1BA5A4A3;
  memcpy((void *)(a1 + 80), &unk_2A4110, 0xA0u);
  *(_DWORD *)(a1 + 32) = 0;
  *(_DWORD *)(a1 + 36) = 0;
  *(_DWORD *)(a1 + 240) = v41;
  *(_DWORD *)(a1 + 244) = v37;
