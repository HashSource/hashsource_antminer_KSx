int __fastcall miner_monitor_init(int a1)
{
  ...
  add_new_task(dword_2EADB8, sub_B9D88, &stru_1D4C0);
  v14 = add_new_task(dword_2EADB8, sub_BA4FC, 60000);
  if ( !is_test_pool )
  {
  ...
  add_new_task(dword_2EADBC, sub_B9CC0, 5000);
  add_new_task(dword_2EADBC, sub_B9BF8, 1000);
