...
LABEL_9:
    ...
    *(_WORD *)&v14[HIDWORD(v6)] = word_2B4047[(unsigned __int16)(v2 - 100 * v6)];
...
LABEL_10:
  ...
  do
  {
    v6 = sub_26C8C0(v2, v3, 10000, 0);
    v7 = v2 - 10000 * v6;
    v8 = &v14[v5];
    v5 -= 4;
    v9 = (unsigned int)(5243 * (v7 >> 2)) >> 17;
    *(_WORD *)(v8 + 35) = word_2B4047[v9];
    *(_WORD *)(v8 + 37) = word_2B4047[(unsigned __int16)(v7 - 100 * v9)];
...
LABEL_7:
  v11 = HIDWORD(v6) - 2;
  *(_WORD *)&v14[v11] = word_2B4047[(_DWORD)v6];
  return core::fmt::Formatter::pad_integral(v4, 1, aLibraryCoreSrc, 0, (int)&v14[v11], 39 - v11);
}
