int __fastcall <object::pe::ImageTlsDirectory32 as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2E0638;
  v3[1] = &off_2E0638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aImagetlsdirect_0, 19, &off_2E0F50, 6, v3, 6);
}
