_BYTE *__fastcall core::fmt::builders::DebugStruct::field(_BYTE *a1, int a2, unsigned int a3, int a4, int a5)
{
  ...
  if ( (v12 & 4) != 0 )
  {
    ...
    {
      v6 = 1;
      if ( (*(int (__fastcall **)(int, const char *, int))(v8[1] + 12))(*v8, asc_2B3F5F, 3) )
        goto LABEL_2;
      v12 = v8[6];
    }
    v6 = 1;
    ...
    if ( !<core::fmt::builders::PadAdapter as core::fmt::Write>::write_str(v24, a2, a3)
      && !<core::fmt::builders::PadAdapter as core::fmt::Write>::write_str(v24, (int)asc_2B3F5D, 2u)
      && !(*(int (__fastcall **)(int, int **))(a5 + 12))(a4, &v26) )
    {
      v15 = ((int (__fastcall *)(int *, int, unsigned int))v27[3])(v26, (int)asc_2B3F62, 2u);
      goto LABEL_18;
    }
  }
  else
  {
    ...
    if ( !(*(int (__fastcall **)(int, const char *, int))(v8[1] + 12))(*v8, v14, v13) )
    {
      ...
      {
        v6 = 1;
        if ( !(*(int (__fastcall **)(int, const char *, int))(v8[1] + 12))(*v8, asc_2B3F5D, 2) )
        {
