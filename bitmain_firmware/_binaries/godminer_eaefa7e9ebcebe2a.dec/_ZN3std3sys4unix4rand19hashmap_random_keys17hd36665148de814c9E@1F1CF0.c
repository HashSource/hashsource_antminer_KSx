...
LABEL_15:
  ...
  if ( v2 != 11 )
  {
    if ( v2 != 38 )
    {
      ...
      v15 = v22;
      core::panicking::panic_fmt((int)v21, (int)&off_2DFA50);
    }
LABEL_22:
    byte_307C59 = 1;
  }
...
LABEL_27:
    ...
    if ( (unsigned __int8)v19 != 4 )
    {
      v21[0] = v19;
      v21[1] = fd;
      core::result::unwrap_failed((int)aFailedToOpenDe, 27, (int)v21, (int)&off_2DE308, (int)&off_2DFA60);
    }
  }
  else
  {
    sub_1EB63C((int)&v19, v22[1], v22[2], (int)&v15);
    if ( (unsigned __int8)v19 != 4 )
      goto LABEL_27;
LABEL_25:
    v3 = fd;
...
LABEL_41:
        v21[1] = v6;
        v21[0] = v11;
        core::result::unwrap_failed((int)&unk_2A6A77, 27, (int)v21, (int)&off_2DE308, (int)&off_2DFA70);
      }
      break;
    }
    if ( !v9 )
