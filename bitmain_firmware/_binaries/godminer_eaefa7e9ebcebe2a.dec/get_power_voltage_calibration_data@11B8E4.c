int get_power_voltage_calibration_data()
{
  ...
  if ( (unsigned __int16)dword_306CA8 != 106 )
  {
    if ( (unsigned __int16)dword_306CA8 <= 0x6Au )
    {
      if ( (unsigned __int16)dword_306CA8 != 98 )
      {
        if ( (unsigned __int16)dword_306CA8 > 0x62u )
        {
          if ( (unsigned int)(unsigned __int16)dword_306CA8 - 100 > 2 )
            return -1;
        }
        else if ( (unsigned __int16)dword_306CA8 != 26 )
        {
          if ( (unsigned __int16)dword_306CA8 != 65 )
            return -1;
          goto LABEL_7;
        }
      }
    ...
    {
      if ( (unsigned __int16)dword_306CA8 <= 0x78u )
      {
        if ( (unsigned __int16)dword_306CA8 < 0x75u
          && (unsigned __int16)dword_306CA8 != 113
          && (unsigned __int16)dword_306CA8 != 115 )
        {
          return -1;
        }
LABEL_7:
      ...
      if ( (unsigned int)(unsigned __int16)dword_306CA8 - 193 > 1 )
        return -1;
    }
  }
  v0 = 0;
LABEL_8:
  v1 = (unsigned int)dword_306CA8 > 0x62;
  if ( dword_306CA8 != 98 )
    v1 = (unsigned int)(dword_306CA8 - 100) > 2;
  if ( !v1 )
  {
    V_LOCK(v0);
    v33 = -1;
  ...
  if ( v10 == POWER_CRC16(&v35, 30) )
  {
    ...
    *v2 = v13;
    memset(&v45[1], 0, 14);
    sub_119A90((int)v45, 12, v13 & 0x1FFFFFFFFFFFFFFLL);
    sub_119A90((int)&v45[2] + 3, 7, v11);
    v14 = (char *)v2 - 19;
