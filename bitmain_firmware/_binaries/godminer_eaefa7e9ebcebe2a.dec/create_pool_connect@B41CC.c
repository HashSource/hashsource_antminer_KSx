int create_pool_connect()
{
  ...
  int v24; // r0
  int v25; // r0
  _DWORD v26[1025]; // [sp+20h] [bp-1004h] BYREF
  ...
  if ( pool_stratum_threads )
  {
    ...
    v4 = logfmt_raw((int)v26, 0x1000u);
    V_UNLOCK(v4);
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KS5_CVCtrl_godminer_release/build/rootfs/buildroot/tmp/release/build"
      "/godminer-origin_godminer-kas_2382/miner_util/check_pool.c",
      172,
      "create_pool_connect",
      19,
      153,
  ...
  else
  {
    ...
    v11 = (const char *)zlog(
                          ...
                          "ot/tmp/release/build/godminer-origin_godminer-kas_2382/miner_util/check_pool.c",
                          172,
                          "create_pool_connect",
                          19,
                          167,
    ...
    if ( v26[0] > 0 )
    {
      v20 = (_DWORD *)(all_created_runtime - 4);
      do
      {
        v21 = v20[1];
        ++v20;
    ...
    if ( v19 )
      fan_pwm_set(20);
    v22 = green_led_on();
    for ( i = red_led_on(v22); !pools_active; i = sleep(1u) )
      ;
    v24 = red_led_off(i);
    V_LOCK(v24);
