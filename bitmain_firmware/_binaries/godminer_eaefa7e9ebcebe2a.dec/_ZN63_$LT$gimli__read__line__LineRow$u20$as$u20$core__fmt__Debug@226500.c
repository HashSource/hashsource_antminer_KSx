int __fastcall <gimli::read::line::LineRow as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[13] = &off_2E1C74;
  v3[11] = &off_2E1C74;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2AF9AD, 7, &off_2E1E8C, 12, v3, 12);
}
