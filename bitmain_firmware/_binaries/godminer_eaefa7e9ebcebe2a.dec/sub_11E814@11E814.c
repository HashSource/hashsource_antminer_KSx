int __fastcall sub_11E814(pthread_mutex_t *a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  v11 = 0;
  sub_26C8C0(a5, a6, 1000, 0);
  v12 = 0;
  v19[1] = 1000000 * v13;
  v19[0] = sub_26C8C0(a5, a6, 1000, 0);
  while ( a2 > v12 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[36].__lock, v20, 10, v19) == 110 )
      {
        v11 = 3;
        goto LABEL_11;
      }
