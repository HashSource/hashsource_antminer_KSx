int __fastcall sub_11E4F4(pthread_mutex_t *a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  v10 = 0;
  v25[1] = 1000000 * v11;
  v25[0] = sub_26C8C0(a5, a6, 1000, 0);
  while ( a2 > v10 )
  {
    while ( 1 )
    {
      v14 = queue_dequeue_for(a1[36].__lock, v26, 74, v25);
      if ( v14 == 110 )
      {
        v9 = 3;
        goto LABEL_10;
