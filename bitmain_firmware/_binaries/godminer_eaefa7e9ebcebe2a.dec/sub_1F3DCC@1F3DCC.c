__int64 __fastcall sub_1F3DCC(clockid_t a1)
{
  ...
  if ( &__clock_gettime64 )
  {
    if ( _clock_gettime64(a1, &clock_id) == -1 )
    {
      ...
      tp.tv_sec = 0;
      core::result::unwrap_failed((int)&unk_2A44BA, 43, (int)&tp, (int)&off_2DE308, (int)&off_2DFC10);
    }
    if ( v3 <= 0x3B9AC9FF )
      return clock_id;
LABEL_9:
  ...
  if ( clock_gettime(a1, &tp) == -1 )
  {
    ...
    LODWORD(clock_id) = 0;
    core::result::unwrap_failed((int)&unk_2A44BA, 43, (int)&clock_id, (int)&off_2DE308, (int)&off_2DFC00);
  }
