int __fastcall sub_E267C(int a1)
{
  int v2; // r6
  int v3; // r0
  ...
  zlog(
    ...
    20,
    v45);
  v4 = *(int (__fastcall **)(int, _DWORD *))(a1 + 264);
  v36[1] = 0;
  v37 = 0;
  while ( 1 )
  {
    ...
    v10 = (*(int (__fastcall **)(int, _DWORD *, int, int *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int, int, int))(a1 + 292))(
            a1,
            v36,
            v9,
            ptr,
