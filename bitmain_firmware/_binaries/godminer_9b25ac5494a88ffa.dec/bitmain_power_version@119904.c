int bitmain_power_version()
{
  ...
  if ( dword_309CD0 == 255 )
  {
    if ( sub_118F7C((unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u) )
    {
      v0 = -2147482880;
  ...
  else if ( sub_11911C(dword_309CD0, (unsigned __int8 *)&v6, 6u, (unsigned __int8 *)&v8, 8u) )
  {
    v0 = -2147482880;
    strcpy(s, "get power version failed");
    V_LOCK(*(_DWORD *)"n failed");
