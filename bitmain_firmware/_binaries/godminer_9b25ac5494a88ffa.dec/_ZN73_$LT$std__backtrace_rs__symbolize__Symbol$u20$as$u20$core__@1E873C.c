int __fastcall <std::backtrace_rs::symbolize::Symbol as core::fmt::Debug>::fmt(int *a1, int a2)
{
  ...
  if ( v6[0] != 3 )
  {
    ...
    v7[8] = v6[8];
    v7[9] = v6[9];
    core::fmt::builders::DebugStruct::field(v5, aName, 4, v7, &off_2DE4B0);
  }
  v3 = a1[4];
  if ( v3 != 3 )
  {
    v7[0] = a1[8];
    core::fmt::builders::DebugStruct::field(v5, aAddr, 4, v7, &off_2DE478);
    if ( v3 == 1 )
    {
      v7[0] = a1[5];
      core::fmt::builders::DebugStruct::field(v5, aLineno, 6, v7, &off_2DE4C0);
    }
  }
