int __fastcall sub_F4350(int a1, int a2, char a3)
{
  void *v4; // r6
  int v5; // r0
  _WORD *v6; // r4
  ...
  v4 = calloc(0xCu, 1u);
  ptr = v4;
  v5 = (*(int (__fastcall **)(int, __int64 *, int, void *, int *))(a1 + 292))(a1, &v18, 1, v4, &v17);
  if ( v17 <= 0 )
  {
    v13 = v12;
  }
  ...
  LODWORD(v18) = v13;
  WORD1(v19) = 255;
  result = (*(int (__fastcall **)(int, __int64 *))(a1 + 264))(a1, &v18);
  if ( result < 0 )
  {
    V_LOCK(result);
    V_INT((int)&v22, "chain");
