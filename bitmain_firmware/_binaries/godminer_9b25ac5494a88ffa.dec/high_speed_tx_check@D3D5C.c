int __fastcall high_speed_tx_check(int a1)
{
  ...
  do
  {
    ...
    do
    {
      ...
      v44 = 0;
      v11 = malloc(0x4Cu);
      v12 = *(void (__fastcall **)(int, _DWORD *, int, _QWORD *, int *, int, int, _DWORD, int, int, int, int, const char *, const char *))(a1 + 284);
      v13 = (char *)v11;
      *v11 = 0;
      v14 = (int *)((char *)v11 + 74);
      *(_QWORD *)((char *)v11 + 4) = 0;
      ...
      if ( v44 )
      {
        ...
        v31 = zlog(
                ...
                "ease/build/godminer-origin_godminer-kas_2382/backend/backend_eth_2280/backend_eth_2280.c",
                192,
                "high_speed_tx_check",
                19,
                386,
