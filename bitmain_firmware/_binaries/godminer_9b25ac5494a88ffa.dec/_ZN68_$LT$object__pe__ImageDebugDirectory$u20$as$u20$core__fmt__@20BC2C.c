int __fastcall <object::pe::ImageDebugDirectory as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[7] = &off_2DF110;
  v3[5] = &off_2DF110;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A9318, 19, &off_2E03C8, 8, v3, 8);
}
