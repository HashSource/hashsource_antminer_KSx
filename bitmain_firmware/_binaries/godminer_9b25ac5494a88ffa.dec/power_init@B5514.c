...
LABEL_12:
  ...
  if ( opt_custom_voltage_swith || (v17 = is_eeprom_loaded(v17)) != 0 )
    dword_2E85D4 = opt_custom_voltage;
  byte_2E85CC = platform_is_adjustable_power(v17);
  byte_2E85D8 = platform_is_check_asic_voltage_enable();
  dword_2E85DC = platfrom_get_check_asic_voltage();
  V_LOCK(dword_2E85DC);
...
LABEL_28:
  ...
  {
    v33 = usleep((__useconds_t)"20$core..fmt..UpperExp$u20$for$u20$i32$GT$3fmt17h8434dc95ce0e7ecdE");
    if ( v101 > 0 )
    {
      for ( j = 0; j < v101; ++j )
      {
        ...
        v92 = usleep((__useconds_t)"st_cnt_for_pcba_test_eth");
        v93 = dev_ctrl(v92);
        (*(void (__fastcall **)(int))(v93 + 36))(j);
        v94 = sleep(1u);
        v95 = dev_ctrl(v94);
        (*(void (__fastcall **)(int))(v95 + 40))(j);
        v96 = usleep((__useconds_t)"st_cnt_for_pcba_test_eth");
        v97 = dev_ctrl(v96);
