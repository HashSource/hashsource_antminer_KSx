void __fastcall sub_7B170(_DWORD *a1)
{
  void *v2; // r3
  char *v3; // r5
  unsigned int v4; // r2
...
LABEL_17:
  ...
  if ( (unsigned int)dword_30ACC4 > 0x3FFFFFFF || (dword_30ACC4 & 0x3FFFFFFE) == 0x3FFFFFFE )
    goto LABEL_9;
  v4 = __ldrex((unsigned int *)&dword_30ACC4);
  if ( v4 != dword_30ACC4 )
  {
    __clrex();
    goto LABEL_9;
  ...
  {
LABEL_9:
    std::sys::unix::locks::futex_rwlock::RwLock::read_contended(&dword_30ACC4);
    goto LABEL_10;
  }
  __dmb(0xBu);
LABEL_10:
  ...
  *(_BYTE *)a1 = 4;
  ...
  do
  {
    v5 = __ldrex((unsigned int *)&dword_30ACC4);
    v6 = v5 - 1;
  }
  while ( __strex(v6, (unsigned int *)&dword_30ACC4) );
