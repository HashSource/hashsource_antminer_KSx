...
LABEL_17:
  ...
  while ( 2 )
  {
    for ( j = v12 - 48; ; v13 = *(_DWORD *)((char *)&unk_290D64 + j) )
    {
      v15 = v13 - 1;
      if ( v13 - 1 >= 0 && *(_DWORD *)(a1 + 328) > v15 )
        break;
      j += 4;
      if ( j == v12 )
        goto LABEL_27;
LABEL_23:
    ...
    v16 = pthread_mutex_lock((pthread_mutex_t *)(*(_DWORD *)(a1 + 520) + 44 * v15 + 20));
    v17 = *(float *)((char *)&unk_290B7C + j);
    j += 4;
    *(float *)(*(_DWORD *)(a1 + 520) + 44 * v15 + 8) = (float)(v11 * v17) + 0.0;
    V_LOCK(v16);
    v21 = *(float *)(*(_DWORD *)(a1 + 520) + 44 * v15 + 8);
    ...
    zlog(
      ...
      20,
      v25);
    pthread_mutex_unlock((pthread_mutex_t *)(*(_DWORD *)(a1 + 520) + 44 * v15 + 20));
    if ( j != v12 )
      goto LABEL_23;
LABEL_27:
    if ( v12 != 384 )
    {
      v13 = *(_DWORD *)((char *)&unk_290D64 + v12);
      v12 += 48;
      continue;
    }
    return 0;
