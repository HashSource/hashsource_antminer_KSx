int __fastcall sub_10E544(int a1, int a2)
{
  int v2; // r5
  void *v5; // r0
  int v6; // r0
  ...
  v7 = (*(int (__fastcall **)(int, _QWORD *, int, unsigned __int16 *, int *, int, int, _DWORD))(a1 + 280))(
         a1,
         v31,
         a2,
         ptr,
    ...
    do
    {
      while ( 1 )
      {
        ...
        v9 = zlog(
               ...
               20,
               v38);
        if ( *(_DWORD *)(a1 + 320) == (unsigned __int16)__rev16(v11) )
          break;
        v10 += 6;
        if ( v30 <= v2 )
          goto LABEL_7;
      ...
      v10 += 6;
      ++v26;
      v28 = sub_26CA90(*((unsigned __int8 *)v10 - 8), *(_DWORD *)(a1 + 420));
      ++s[v28];
      V_LOCK(v28);
      V_INT((int)&v33, "chain");
