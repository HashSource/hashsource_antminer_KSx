int __fastcall sub_1E6484(int a1, unsigned __int8 *a2, int a3)
{
  int v4; // r0
...
LABEL_2:
    if ( v18 == (char *)&loc_110000 + 3 )
      goto LABEL_5;
LABEL_3:
    v4 = <core::char::EscapeDebug as core::iter::traits::iterator::Iterator>::next(&v17);
    if ( v4 == 1114112 )
      break;
...
LABEL_25:
    ...
    else
    {
      if ( v7 == 1114112 )
        break;
LABEL_22:
      if ( core::unicode::unicode_data::grapheme_extend::lookup(v7, v8) || !core::unicode::printable::is_printable(v7) )
      {
...
LABEL_28:
  ...
  {
    v13 = <core::char::EscapeDebug as core::iter::traits::iterator::Iterator>::next(&v20);
    if ( v13 != 1114112 )
    {
