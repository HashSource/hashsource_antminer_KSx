int __fastcall dram_pre_bist1_rvn(int a1, char a2)
{
  ...
  sub_F9570(a1, a2, 254, 6698008);
  sub_F9570(a1, a2, 255, 6698009);
  sub_F9570(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_F9570(a1, a2, 240, 769);
  usleep(0x249u);
  sub_F9570(a1, a2, 245, (int)"..UpperExp$u20$for$u20$u128$GT$3fmt17h0ef7e8ef8b103f63E");
  sub_F9570(a1, a2, 246, 270336);
  sub_F9570(a1, a2, 247, (int)"xp$u20$for$u20$u128$GT$3fmt17h0ef7e8ef8b103f63E");
