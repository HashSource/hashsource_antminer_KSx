int __fastcall <object::pe::ImageDelayloadDescriptor as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2DF638;
  v3[1] = &off_2DF638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &unk_2A8A6B, 24, &off_2DFF80, 8, v3, 8);
}
