    ...
    if ( v26 > v29 )
    {
      ...
      if ( v6 > v39 )
      {
        do
        {
          v41 = v6 - 1;
          if ( v6 - 1 >= 0x80 )
            core::panicking::panic_bounds_check(v6 - 1, 128, (int)&off_2E1B84);
          --v6;
          *v40 = *(v40 - 1);
          --v40;
        }
      ...
      if ( v39 >= 0x80 )
        core::panicking::panic_bounds_check(v39, 128, (int)&off_2E1B94);
      v62[v39] = v37;
      if ( v18 != v61 )
      {
        v42 = sub_26CA90(v25, v51);
        v43 = sub_26CA90(v42, v35) + v42;
        v44 = 0;
        v60 = *v18;
        if ( v43 < 0x1C8 )
        {
        ...
        v53 = v39 + 1;
        v19 = v44 + sub_26CA90((unsigned __int16)(36 * v47), (unsigned __int16)(v47 + 38));
        ++v54;
        v52 = v45 + 4;
        v51 = 2;
        v6 = v35;
...
LABEL_15:
  ...
  if ( v59 )
  {
    if ( <core::fmt::Formatter as core::fmt::Write>::write_str(v58, v56, v59) )
      return v16;
    v16 = 1;
    if ( <core::fmt::Formatter as core::fmt::Write>::write_str(v58, asc_2B058B, 1) )
      return v16;
  }
  v16 = 1;
  if ( <core::fmt::Formatter as core::fmt::Write>::write_str(v58, v57, v15) )
    ...
    return <core::fmt::Formatter as core::fmt::Write>::write_str(v58, asc_2B058C, 1);
}
