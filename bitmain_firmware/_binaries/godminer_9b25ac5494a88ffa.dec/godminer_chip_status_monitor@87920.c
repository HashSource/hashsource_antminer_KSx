int __fastcall godminer_chip_status_monitor(int a1)
{
  ...
  if ( (*(_DWORD *)(flag_from_monitor + 48) & 2) != 0 )
  {
    ...
    {
      set_miner_6060info_runtime_bad_asic_err(*(_DWORD *)(a1 + 244), 1);
  ...
  {
    set_miner_6060info_runtime_bad_asic_err(*(_DWORD *)(a1 + 244), 0);
  }
  ...
  {
    LODWORD(v5) = set_miner_6060info_runtime_bad_asic_err(*(_DWORD *)(a1 + 244), 0);
  }
  return v5;
}
