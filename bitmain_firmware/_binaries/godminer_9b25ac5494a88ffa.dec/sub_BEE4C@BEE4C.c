int __fastcall sub_BEE4C(_DWORD *a1)
{
  _DWORD *v1; // r0
  _DWORD *v2; // r6
  int v3; // r0
  ...
  v14 = *(_DWORD *)(dword_30B5C8 + 88) - 1;
  v15 = *(_DWORD *)(dword_30B5C8 + 88) != 1;
  *(_DWORD *)(dword_30B5C8 + 64) = v13;
  if ( v14 != 1 && v15 )
    return 0;
  ...
  if ( v17 && *v17 == 1 )
  {
    ...
    for ( i = 0; i < (unsigned int)json_array_size(v64); ++i )
    {
      ...
      v25 = (_DWORD *)(*(_DWORD *)(dword_30B5C8 + 84) + 24 * v24);
      *v25 = v24;
      v25[2] = 0;
