int __fastcall sub_1B3D08(_DWORD *a1, unsigned int a2)
{
  ...
  v4 = v2[135];
  if ( v4 + a2 > 0xB )
    core::panicking::panic((int)aAssertionFaile_7, 51, (int)&off_2DD478);
  v30 = a1[1];
  v5 = *(unsigned __int16 *)(v30 + 270);
  if ( v5 < a2 )
    core::panicking::panic((int)aAssertionFaile_8, 39, (int)&off_2DD488);
  v24 = v2[135];
  v6 = v5 - a2;
  *(_WORD *)(v30 + 270) = v5 - a2;
  v2[135] = v4 + a2;
  ...
  *(_DWORD *)(v18 + 8) = v14;
  if ( v20 )
  {
    if ( !result )
      return result;
LABEL_12:
    core::panicking::panic((int)aInternalErrorE_0, 40, (int)&off_2DD498);
  }
  if ( !result )
    goto LABEL_12;
