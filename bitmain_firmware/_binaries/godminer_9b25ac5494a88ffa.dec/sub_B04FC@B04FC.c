int __fastcall sub_B04FC(int a1, int *a2, int a3)
{
  size_t *v3; // r7
  const void *v6; // r8
  int v7; // r0
  ...
  {
    v6 = a2 + 116;
    if ( a3 && memcmp(&unk_2E83B8, a2 + 116, 0x116u) )
    {
      dbl_2E84D8 = 0.0;
      memcpy(&unk_2E83B8, v6, 0x11Eu);
    }
    ...
    if ( v8 && v8 == *v3 )
    {
      ...
      zlog(
        ...
        20,
        v19);
      memcpy(v3 + 1, &dbl_2E84D8, *v3);
      v18 = dbl_2E84D8;
      if ( *(_QWORD *)&dbl_2E84D8 > 0xFFu )
      {
        dbl_2E84D8 = 0.0;
      }
      else
      {
        ++LODWORD(dbl_2E84D8);
        HIDWORD(dbl_2E84D8) = (unsigned __int64)(*(_QWORD *)&v18 + 1LL) >> 32;
      }
    }
