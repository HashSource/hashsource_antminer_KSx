int task_check_miner_status()
{
  ...
  pthread_mutex_lock(&stru_2E864C);
  v2 = 0;
  v3 = (unsigned __int8)byte_2E8644 ^ 1;
  v166[0] = 0;
...
LABEL_26:
  ...
  if ( v129 > 0 )
  {
    ...
    {
      v20 = *v18++;
      v3 = (unsigned __int8)(v3 & *(_BYTE *)(v20 + 250));
    }
    while ( v19 != v18 );
  }
  v21 = 0;
...
LABEL_109:
      ...
      if ( v168[0] > 0 )
      {
        ...
        do
        {
          ...
          v87 = (*(int (**)(void))(v86 + 20))();
          v88 = dev_ctrl(v87);
          (*(void (__fastcall **)(_DWORD))(v88 + 28))(*(_DWORD *)(*v84 + 240));
        }
        while ( v81 < v168[0] );
        v121 = v83;
        v119 = v85;
...
LABEL_61:
  ...
  v36 = pthread_mutex_unlock(&stru_2E864C);
