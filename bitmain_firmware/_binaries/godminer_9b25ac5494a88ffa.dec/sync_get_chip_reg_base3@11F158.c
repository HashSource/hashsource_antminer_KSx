int __fastcall sync_get_chip_reg_base3(int a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  int v9; // r5
  char v13; // r3
  int v14; // r10
  ...
  v26[1] = 1000000 * v18;
  v26[0] = sub_26C3E0(a7, a8, 1000, 0);
  while ( v14 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 856), v27, 10, v26) == 110 )
      {
        v9 = 3;
        goto LABEL_15;
      }
