int __fastcall hs_header_print(_DWORD *a1, const char *a2)
{
  ...
  hs_hex_encode(a1 + 4, 20, &v5);
  hs_hex_encode(a1 + 9, 32, v7);
  hs_hex_encode(a1 + 17, 32, v8);
  hs_hex_encode(a1 + 25, 32, v9);
  hs_hex_encode(a1 + 33, 24, v6);
  hs_hex_encode(a1 + 39, 32, v10);
  hs_hex_encode(a1 + 47, 32, v11);
  hs_hex_encode(a1 + 55, 32, v12);
  printf("%sheader\n", a2);
  printf("%s  nonce=%u\n", a2, *a1);
  printf("%s  time=%u\n", a2, a1[2]);
