int __fastcall <std::net::ip_addr::Ipv6Addr as core::fmt::Display>::fmt(unsigned __int16 *a1, int a2)
{
  ...
  if ( core::fmt::Formatter::precision(a2) == 1 || core::fmt::Formatter::width(a2) == 1 )
  {
    ...
    v39 = &v35;
    v40 = 0;
    if ( core::fmt::write(&v39, &off_2DD068, &v40) )
      core::result::unwrap_failed((int)&unk_2A3E8A, 43, (int)&v40, (int)&off_2DD318, (int)&off_2DDD38);
    if ( v35 >= 0x28 )
  ...
  if ( !(v16 | v12 | v11) )
    return <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2A51DD, 2);
...
LABEL_41:
      ...
      {
LABEL_42:
        if ( sub_1D72D8(a2, &v40, v24, v33) || <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2A51DD, 2) )
          return 1;
        if ( v20 + v24 >= 9 )
          core::slice::index::slice_start_index_len_fail();
        return sub_1D72D8(a2, (char *)&v40 + 2 * v20 + 2 * v24, 8 - (v20 + v24), v31);
      }
      return sub_1D72D8(a2, &v40, 8, v33);
    }
LABEL_66:
    if ( !v30 )
      v24 = 7;
  ...
  {
    if ( v17 != 0xFFFF )
      core::panicking::panic((int)aInternalErrorE_0, 40, (int)&off_2DDD18);
    v27 = &off_2DDD28;
  }
  else
  {
