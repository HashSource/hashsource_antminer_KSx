void __fastcall std::sys::unix::fs::rename(int *a1, const void *a2, unsigned int a3, const void *a4, size_t n)
{
  const char *v8; // r7
  int v9; // r0
