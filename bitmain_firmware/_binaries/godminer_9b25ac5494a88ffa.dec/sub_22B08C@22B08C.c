int __fastcall sub_22B08C(int a1, int a2)
{
  int v3; // r0
  unsigned int v5; // r1
  int v6; // r2
  ...
  if ( !v3 )
  {
    v8 = *(_DWORD *)(a1 + 16);
    if ( v8 )
      return <str as core::fmt::Display>::fmt(asc_2B0689, 1, v8);
    else
      return 0;
  }
  v5 = *(_DWORD *)(a1 + 12) + 1;
  *(_DWORD *)(a1 + 12) = v5;
  ...
  if ( v11 < v10 )
  {
    ...
    *(_DWORD *)(a1 + 8) = v11 + 1;
    ...
    {
      case 'B':
        v15 = sub_229C64((_DWORD *)a1, a2);
        v7 = 1;
        goto LABEL_98;
      case 'C':
        sub_229624((int)&v65, (int *)a1);
        if ( (_BYTE)v65 )
          goto LABEL_18;
        v64[0] = v67;
        v22 = *(_DWORD *)a1 == 0;
        ...
        if ( !v34 || core::fmt::Formatter::alternate(v34) )
          goto LABEL_99;
        v7 = 1;
        if ( <core::fmt::Formatter as core::fmt::Write>::write_str(*(_DWORD *)(a1 + 16), asc_2B069B, 1)
          || core::fmt::num::<impl core::fmt::LowerHex for u64>::fmt(v64, *(_DWORD *)(a1 + 16)) )
        {
          return v7;
        }
        v15 = <core::fmt::Formatter as core::fmt::Write>::write_str(*(_DWORD *)(a1 + 16), asc_2B069C, 1);
        goto LABEL_98;
      case 'I':
        v7 = 1;
        if ( sub_22B08C(a1, a2) )
        ...
        if ( !v22 && <str as core::fmt::Display>::fmt(asc_2B04AA, 2, v21) )
          return v7;
        v23 = *(_DWORD *)(a1 + 16);
        if ( v23 )
        {
          v7 = 1;
          if ( <str as core::fmt::Display>::fmt(asc_2B04BA, 1, v23) )
            return v7;
        }
        v7 = 1;
        if ( sub_22AFE8((int *)a1) )
          return v7;
        goto LABEL_96;
      case 'M':
      case 'X':
...
LABEL_89:
        ...
        {
          v7 = 1;
          if ( <str as core::fmt::Display>::fmt(asc_2B04BA, 1, v46) )
            return v7;
        }
        v7 = 1;
        if ( sub_22BAF4(a1) )
...
LABEL_96:
        ...
        if ( !v48 )
          goto LABEL_99;
        v7 = 1;
        v15 = <str as core::fmt::Display>::fmt(asc_2B04BD, 1, v48);
LABEL_98:
        if ( !v15 )
          goto LABEL_99;
        return v7;
      case 'N':
          ...
          && (v25 = (unsigned int)(v24 - 97), v24 = (_BYTE *)&loc_110000, v25 >= 0x1A) )
        {
          ...
          {
            v20 = 1;
            if ( <str as core::fmt::Display>::fmt(&unk_2B0669, 16, v26) )
              return v20 != 0;
          }
          v20 = 0;
          *(_BYTE *)(a1 + 4) = 0;
...
LABEL_38:
        ...
        if ( !*(_DWORD *)a1 )
        {
          ...
          if ( !v50 )
            return v20 != 0;
          if ( <str as core::fmt::Display>::fmt(asc_2B04AA, 2, v50) )
            goto LABEL_38;
          if ( !*(_DWORD *)a1 )
          {
            v44 = *(_DWORD *)(a1 + 16);
            if ( !v44 )
              return v20 != 0;
LABEL_81:
            v20 = <str as core::fmt::Display>::fmt(asc_2B0689, 1, v44);
            return v20 != 0;
          }
        }
        sub_229624((int)&v65, (int *)a1);
...
LABEL_80:
          ...
          if ( v65 )
          {
            ...
            if ( v24 == (char *)&loc_110000 )
            {
              ...
              if ( !v42 )
              {
                if ( <str as core::fmt::Display>::fmt(asc_2B04AA, 2, v37) )
                  goto LABEL_38;
                v43 = *(_DWORD *)(a1 + 16);
                v68 = v41;
                v67 = v40;
            ...
            v51 = *(_DWORD *)(a1 + 16);
            if ( v51 && <str as core::fmt::Display>::fmt(asc_2B068F, 3, v51) )
              goto LABEL_38;
            v63 = v40;
            if ( v24 == (char *)67 )
            {
...
LABEL_124:
                ...
                if ( !v57 )
                {
                  ...
                  if ( !v58 )
                    goto LABEL_99;
                  v20 = 1;
                  if ( <str as core::fmt::Display>::fmt(asc_2B0699, 1, v58) )
                    return v20 != 0;
                  v59 = *(_DWORD *)(a1 + 16);
                  v68 = v41;
                  v67 = v63;
                ...
                {
                  v20 = 1;
                  if ( <str as core::fmt::Display>::fmt(asc_2B069A, 1, v60) )
                    return v20 != 0;
                  v61 = *(_DWORD *)(a1 + 16);
                  v66 = v36;
                  v65 = v35;
                  if ( v61 )
                  {
                    ...
                    {
                      v20 = 1;
                      if ( <str as core::fmt::Display>::fmt(asc_2B058C, 1, v62) )
                        return v20 != 0;
                    }
                  }
                }
...
LABEL_102:
  ...
  {
    v7 = 1;
    if ( <str as core::fmt::Display>::fmt(&unk_2B0669, 16, v49) )
      return v7;
  }
  *(_BYTE *)(a1 + 4) = 0;
  *(_DWORD *)a1 = 0;
