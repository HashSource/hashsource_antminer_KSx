int __fastcall get_all_chip_temp_kas(_DWORD *a1)
{
  ...
  v33[0] = -2147424757;
  v34 = 0;
  v2 = (void (__fastcall *)(_DWORD *, _DWORD *))a1[65];
  strcpy((char *)&v34 + 2, "l");
  LOBYTE(v34) = 1;
  v2(a1, v33);
  v3 = a1[82];
  v4 = (char *)malloc(12 * v3);
  v5 = (void (__fastcall *)(_DWORD *, _QWORD *, int, char *, int *))a1[70];
  v35[0] = 0;
  v35[1] = 7340033;
  v6 = v4;
  v5(a1, v35, v3, v4, &v32);
  usleep((__useconds_t)&elf_hash_chain[4398]);
  ((void (__fastcall *)(_DWORD *, _QWORD *, int, char *, int *, int, int, _DWORD))a1[70])(
    a1,
    v35,
    v3,
    v6,
