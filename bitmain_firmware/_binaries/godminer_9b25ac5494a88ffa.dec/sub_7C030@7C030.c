unsigned int *__fastcall sub_7C030(unsigned int *a1, int **a2)
{
...
LABEL_27:
        ...
        if ( v11 == 2 )
          syscall(240, &dword_30AC58, 129, 1);
LABEL_33:
        result = v16;
        v15 = 4;
        __dmb(0xBu);
      ...
      case 1u:
        ...
        v15 = 0;
        v19 = aRustc9eb3afe9e;
        core::panicking::panic_fmt(&v15, &off_2DD854);
      case 2u:
        result = (unsigned int *)__ldrex(a1);
...
LABEL_11:
      ...
      default:
        ...
        v19 = aRustc9eb3afe9e;
        v15 = 0;
        core::panicking::panic_fmt(v13, &off_2DD854);
    }
  }
}
