int print_summary()
{
  ...
  v0 = sub_26C670(LODWORD(total_accepted), HIDWORD(total_accepted));
  V_LOCK(LODWORD(v0));
  ...
  if ( *(_QWORD *)&total_accepted || *(_QWORD *)&total_rejected )
  {
    ...
    sub_26C670(v55, HIDWORD(v55));
    sub_26C670(LODWORD(total_accepted) + LODWORD(v54), (*(_QWORD *)&total_accepted + *(_QWORD *)&v54) >> 32);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *(v60 - 1) || *v60 )
        {
          ...
          sub_26C670(v75, HIDWORD(v75));
          sub_26C670(*((_DWORD *)v60 - 2) + v74, (unsigned __int64)(*(v60 - 1) + v74) >> 32);
