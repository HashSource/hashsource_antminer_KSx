int __fastcall dram_post_bist0_rvn(int a1, char a2)
{
  ...
  sub_F9570(a1, a2, 252, 0);
  sub_F9570(a1, a2, 253, 0);
  sub_F9570(a1, a2, 254, 14948360);
  sub_F9570(a1, a2, 255, 14948361);
  sub_F9570(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_F9570(a1, a2, 240, 769);
  usleep(0x249u);
  sub_F9570(a1, a2, 245, 0x40000);
  sub_F9570(a1, a2, 246, (int)"ktrace..BacktraceStatus$u20$as$u20$core..fmt..Debug$GT$3fmt17h850c777f35e3350cE");
  sub_F9570(a1, a2, 247, (int)"std..backtrace..BacktraceStatus$u20$as$u20$core..fmt..Debug$GT$3fmt17h850c777f35e3350cE");
