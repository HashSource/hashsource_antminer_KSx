int __fastcall set_frequency_with_voltage_base(int a1)
{
  ...
  v4 = *(float *)(*(_DWORD *)all_created_runtime + 956);
  v5 = *(float *)(*(_DWORD *)all_created_runtime + 952);
  if ( v4 > *(float *)(a1 + 108) )
    v4 = *(float *)(a1 + 108);
...
LABEL_29:
      ...
      if ( v44 > 0 )
      {
        ...
        for ( i = 0; i < v44; ++i )
        {
          v27 = v25[1];
          ++v25;
          if ( api_get_eeprom_fmt_version(*(_DWORD *)(v27 + 240)) == 4 )
          {
            eeprom_asic_freqs = api_get_eeprom_asic_freqs(*(_DWORD *)(*v25 + 240), &dest);
            if ( !eeprom_asic_freqs )
            {
              ...
              v37 = v31 / (float)v30;
              (*(void (__fastcall **)(int, float *))(v29 + 212))(v29, &dest);
              v38 = *v25;
              *(_DWORD *)(v38 + 456) = (int)v37;
              *(float *)(v38 + 956) = (float)(int)v37;
...
LABEL_16:
      ...
      if ( working_voltage + 20 < v42 && v8 < v5 && v13 - v43 <= v41 )
      {
        ...
        if ( v2 )
          return v2;
        current_voltage = usleep((__useconds_t)"tal_ro");
      }
      v12 = v13;
      if ( v13 == ++v41 )
        goto LABEL_22;
