...
LABEL_47:
            v45 = v10;
            buf = 0;
            core::result::unwrap_failed((int)&unk_2A3E8A, 43, (int)&buf, (int)&off_2DD308, (int)&off_2DE094);
          }
        }
        v15 = v14;
        if ( v11 > v14 )
...
LABEL_49:
  ...
  else if ( v6 == -1 )
  {
    ...
    if ( (unsigned __int8)v42 != 4 )
    {
      buf = v42;
      v45 = v43;
      core::result::unwrap_failed((int)&unk_2A3E8A, 43, (int)&buf, (int)&off_2DD308, (int)&off_2DE084);
    }
    close(fd);
  }
  else
  {
    sub_1EF60C((int)&v42, v5, (int)&v35, v6, (int)&v38);
    if ( (unsigned __int8)v42 != 4 )
    {
      buf = v42;
      v45 = v43;
      core::result::unwrap_failed((int)&unk_2A3E8A, 43, (int)&buf, (int)&off_2DD308, (int)&off_2DE074);
    }
  }
