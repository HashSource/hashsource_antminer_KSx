int __fastcall sub_248CC4(__int64 a1, unsigned __int64 a2, int a3, int a4)
{
  unsigned int v4; // r5
  unsigned int v5; // r9
  __int64 v6; // r6
  ...
  {
    v6 = sub_26C3E0(a1 >> 19, (HIDWORD(a1) >> 19) | ((_DWORD)a2 << 13), -463433411, 4440);
    v7 = 0;
  }
  v26 = a3;
  sub_248798(0x7538DCFB76180000LL * v6 + __PAIR64__(v5, v4), (int)v32, &v33);
  if ( (unsigned int)v6 | v7 | HIDWORD(v6) )
  {
    memset(&v32[20], 48, v33 - 20);
    v33 = 20;
    v27 = sub_26C3E0(v6 >> 19, (HIDWORD(v6) >> 19) | (v7 << 13), -463433411, 4440);
    v28 = v27;
    sub_248798(0x7538DCFB76180000LL * v27 + v6, (int)v32, &v33);
    v26 = a3;
