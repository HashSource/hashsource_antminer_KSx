int __fastcall <std::io::stdio::StdoutLock as std::io::Write>::write_all(int a1, _DWORD *a2, char *buf, size_t n)
{
  ...
  v6 = (_DWORD *)(*a2 + 12);
  if ( *v6 )
    core::result::unwrap_failed((int)aAlreadyBorrowe, 16, (int)&v26, (int)&off_2DD2E8, (int)&off_2DDB24);
  v7 = v4 + 4;
  v8 = n;
  v9 = buf;
  v4[3] = -1;
  if ( n && (v10 = memrchr(buf, 10, n)) != 0 )
  {
    v11 = v10 - (_DWORD)v9 + 1;
    if ( v11 > v8 )
      core::panicking::panic((int)aAssertionFaile, 35, (int)&off_2DDA10);
    v12 = v4[6];
    if ( v12 )
    {
      if ( *v7 - v12 <= v11 )
      {
        sub_79B74((int)&v26, (int)(v4 + 4), v9, v11);
        v14 = v26;
        if ( v26 != 4 )
          goto LABEL_32;
      }
