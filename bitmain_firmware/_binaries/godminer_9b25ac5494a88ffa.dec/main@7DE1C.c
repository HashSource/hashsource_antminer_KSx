...
LABEL_50:
    ...
    while ( 1 )
    {
      v16 = getopt_long(argc, argv, "a:c:hp:Po:u:v:F", &off_270258, 0);
      if ( v16 < 0 )
        break;
    ...
    if ( !v11 )
    {
      ...
      *(_DWORD *)s = 0;
      ...
      if ( v11 )
        return v11;
      signal(2, (__sighandler_t)sub_87CE4);
      signal(3, (__sighandler_t)sub_87CE4);
      signal(15, (__sighandler_t)sub_87CE4);
      signal(11, (__sighandler_t)sub_87CE4);
      signal(10, (__sighandler_t)sub_87CE4);
      ...
      if ( create_pool_connect(v36) == 35 )
        return 1;
      thr_info = 0;
      pthread_attr_init(&stru_30AD60);
      v57 = pthread_create(dword_30AD5C, &stru_30AD60, (void *(*)(void *))work_generator_thread, &thr_info);
      v37 = pthread_attr_destroy(&stru_30AD60);
      if ( v57 )
      {
        V_LOCK(v37);
      ...
      {
        dword_30AD88 = 1;
        pthread_attr_init((pthread_attr_t *)&dword_30AD8C[1]);
        v11 = pthread_create(
                dword_30AD8C,
                (const pthread_attr_t *)&dword_30AD8C[1],
                (void *(*)(void *))nonce_submit_thread,
                &dword_30AD88);
        v38 = pthread_attr_destroy((pthread_attr_t *)&dword_30AD8C[1]);
        if ( v11 )
        {
          V_LOCK(v38);
        ...
        else
        {
          ...
          v45 = pthread_join(dword_30AD5C[0], 0);
          V_LOCK(v45);
