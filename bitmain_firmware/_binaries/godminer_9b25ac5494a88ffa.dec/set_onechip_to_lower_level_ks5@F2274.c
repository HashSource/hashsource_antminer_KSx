int __fastcall set_onechip_to_lower_level_ks5(int a1, int a2)
{
  ...
  v5 = *(_DWORD *)(a1 + 348);
  *(_QWORD *)v19 = 0;
  v6 = *(void (__fastcall **)(int, int *))(a1 + 260);
  ...
  *(_QWORD *)&v19[4] = 0xFF000A0000LL;
  ...
  sub_EECF0(a1, 37);
  v9 = 44 * (__int16)a2;
  pthread_mutex_lock((pthread_mutex_t *)(*(_DWORD *)(a1 + 520) + v9 + 20));
  v10 = *(_DWORD *)(a1 + 520) + v9;
  v11 = *(float *)(v10 + 4);
  pthread_mutex_unlock((pthread_mutex_t *)(v10 + 20));
  v12 = *(float *)(a1 + 956) - 50.0;
  ...
  if ( (double)v13 > 0.01 )
  {
    do
    {
      ...
      (*(void (__fastcall **)(int, _DWORD, int))(a1 + 208))(a1, 0, a2);
