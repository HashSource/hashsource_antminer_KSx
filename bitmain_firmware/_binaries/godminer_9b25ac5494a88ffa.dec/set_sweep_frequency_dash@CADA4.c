  ...
  if ( v13 > 0 )
  {
    ...
    do
    {
            ...
            do
            {
              ...
              if ( v19 > *v17 )
              {
                ...
                zlog(
                  ...
                  20,
                  v38);
                (*(void (__fastcall **)(int, __int64 *))(a1 + 260))(a1, &v34);
      ...
      domain_asic_num = zlog(
                          ...
                          "ot/tmp/release/build/godminer-origin_godminer-kas_2382/backend/backend_dash_1766/backend_dash_1766.c",
                          194,
