void __fastcall __noreturn sub_1E7CD0(_DWORD *a1)
{
  _DWORD *v2; // r0
  int v3; // r2
  int v4; // r1
...
LABEL_5:
      ...
      std::panicking::rust_panic_with_hook(&v18, &off_2DE3C4, v9, v8, can_unwind);
    }
    v13 = 0;
    v12 = aRustc9eb3afe9e;
  }
  ...
  std::panicking::rust_panic_with_hook(&v18, &off_2DE3D8, v15, v16, v17);
}
