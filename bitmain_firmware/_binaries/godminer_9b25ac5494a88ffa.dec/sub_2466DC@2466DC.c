int __fastcall sub_2466DC(unsigned __int8 *a1, int a2, int a3)
{
  int result; // r0
  _DWORD *v5; // r7
  int v8; // r0
  ...
  if ( (v8 & 4) != 0 )
  {
    if ( !a1[5] )
    {
      result = (*(int (__fastcall **)(_DWORD, const char *, int))(v5[1] + 12))(*v5, asc_2B3950, 1);
      if ( result )
        goto LABEL_2;
      v8 = v5[6];
    }
    ...
    if ( !result )
    {
      result = ((int (__fastcall *)(_DWORD *, const char *, int))v21[3])(v20, asc_2B3932, 2);
      goto LABEL_12;
    }
LABEL_2:
    a1[5] = 1;
  ...
  if ( a1[5] )
  {
    result = (*(int (__fastcall **)(_DWORD, const char *, int))(v5[1] + 12))(*v5, asc_2B3934, 2);
    if ( result )
      goto LABEL_2;
  }
