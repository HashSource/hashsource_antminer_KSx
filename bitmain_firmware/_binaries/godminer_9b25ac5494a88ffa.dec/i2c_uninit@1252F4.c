int __fastcall i2c_uninit(int a1)
{
  ...
  {
    if ( find_c_map((_DWORD *)dword_30A790, (int)&v11, (int)&ptr) == 1 )
    {
      v5 = (char *)ptr;
      remove_c_map((_DWORD *)dword_30A790);
      v6 = new_iterator_c_map(dword_30A790);
      if ( ((int (*)(void))*v6)() )
      {
        v7 = v5 + 12;
        while ( 1 )
...
LABEL_13:
    ...
    if ( ptr )
      free(ptr);
    return pthread_mutex_unlock(&stru_30A774);
  }
}
