...
LABEL_7:
  ...
  addr = (unsigned int *)_tls_get_addr(&dword_2E4454);
  v13 = *addr + 1;
  *addr = v13;
  if ( v13 > 2 )
    goto LABEL_7;
...
LABEL_20:
        ...
        {
          v22 = v15(a1);
          (*(void (__fastcall **)(int, __int64 *))(dword_30AC78 + 20))(dword_30AC74, &v22);
        }
        else
        {
          v22 = v15(a1);
