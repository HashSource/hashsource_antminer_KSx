int __fastcall <object::pe::ImageResourceDirectory as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[3] = &off_2DF638;
  v3[1] = &off_2DF638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, aImageresourced, 22, &off_2DFFC0, 6, v3, 6);
}
