int __fastcall <object::pe::AnonObjectHeader as core::fmt::Debug>::fmt(int a1, int a2)
{
  ...
  v3[11] = &off_2DFD18;
  v3[9] = &off_2DF638;
  return core::fmt::Formatter::debug_struct_fields_finish(a2, &aE32Lastpagesiz[48], 16, &off_2DFCE0, 7, v3, 7);
}
