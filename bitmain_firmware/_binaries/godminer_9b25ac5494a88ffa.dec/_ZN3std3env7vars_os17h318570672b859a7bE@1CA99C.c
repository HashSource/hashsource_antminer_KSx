int __fastcall std::env::vars_os(unsigned int *a1)
{
  ...
  {
    v2 = __ldrex((unsigned int *)&dword_30ACC4);
    if ( v2 == dword_30ACC4 )
    {
...
LABEL_6:
  ...
  do
  {
    v28 = __ldrex((unsigned int *)&dword_30ACC4);
    v29 = v28 - 1;
  }
  while ( __strex(v29, (unsigned int *)&dword_30ACC4) );
  if ( (v29 & 0xBFFFFFFF) == 0x80000000 )
    std::sys::unix::locks::futex_rwlock::RwLock::wake_writer_or_readers((unsigned int *)&dword_30ACC4, v29);
  *a1 = v5;
  a1[1] = v32;
  result = v32 + 24 * v3;
  a1[2] = result;
