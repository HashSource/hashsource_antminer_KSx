...
LABEL_178:
        core::panicking::panic((int)aCalledOptionUn_1, 43, (int)&off_2E1B24);
      }
      v5 = (char)v3[v8 + 1];
      if ( v5 <= -65 )
        goto LABEL_179;
...
LABEL_17:
    ...
    if ( (_BYTE)v76 )
    {
      ...
      core::result::unwrap_failed((int)aCalledResultUn_0, 43, (int)&v74, (int)&off_2E19C4, (int)&off_2E1A54);
    }
    v13 = v77;
    v14 = &v3[v8];
    v3 += v8;
...
LABEL_34:
    if ( v4 && <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B04AA, 2) )
      return 1;
...
LABEL_108:
            ...
            if ( v13 < 2 )
            {
              v38 = 1;
              v13 = 0;
              if ( <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B04AE, 1) )
                return v38;
              continue;
            }
            if ( (char)*v14 <= -65 )
            ...
            {
LABEL_48:
              if ( <core::fmt::Formatter as core::fmt::Write>::write_str(a2, asc_2B04AA, 2) )
                return 1;
              if ( v13 >= 3 && v20[2] <= -65 )
LABEL_187:
...
LABEL_188:
        ...
        v76 = (char *)(v14 + 1);
        v81 = 36;
        sub_227D34(&v74, (int *)&v76);
        if ( v74 != 1 )
          goto LABEL_153;
        v35 = v75;
        v36 = v75 + 1;
        if ( v75 == -1 )
          core::str::traits::str_index_overflow_fail((int)&off_2E1AD4);
...
LABEL_125:
        ...
        if ( v75 != 1 )
        {
          if ( v75 == 2 )
          {
            v40 = (const char *)&unk_2B04B1;
            if ( *v34 == 20563
              || (v40 = asc_2B04B4, *v34 == 20546)
              || (v40 = asc_2B04B7, *v34 == 18002)
              || (v40 = asc_2B04BA, *v34 == 21580)
              || (v40 = asc_2B04BD, *v34 == 21575)
              || (v40 = asc_2B04C0, *v34 == 20556)
              || (v40 = asc_2B04C3, *v34 == 20562) )
            {
LABEL_105:
              v38 = 1;
