...
void __fastcall sub_1F0EA0(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  int v8; // r4
  ...
  v17 = v9 ^ 1;
  v16 = v9;
  v10 = core::ffi::c_str::CStr::from_ptr::strlen_rt(aD_4);
  sub_1EB15C((int)&v22, (int)aD_4, v10 + 1, (int)v15);
  if ( v22 == 4 )
  {
    v11 = v25;
    *(_DWORD *)v8 = 2;
