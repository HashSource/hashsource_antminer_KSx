...
LABEL_31:
      if ( working_voltage + 20 < v58 && v22 > v15 && v16 - v59 <= v23 )
      {
        ...
        if ( v28 )
          return v28;
        v18 = usleep((__useconds_t)"tal_ro");
      }
      if ( ++v23 == v16 )
        goto LABEL_37;
    }
  ...
  if ( v60 > 0 )
  {
    ...
    for ( m = 0; m < v60; ++m )
    {
      ...
      if ( api_get_eeprom_fmt_version(*(_DWORD *)(v48 + 240)) == 4
        && !api_get_eeprom_asic_freqs(*(_DWORD *)(*v46 + 240), dest) )
      {
        v49 = *v46;
        v50 = 0.0;
        v51 = *(_DWORD *)(*v46 + 328);
        if ( v51 )
        {
          ...
          do
          {
            ...
            v50 = v50 + v54;
            printf("%-6.1f ", v54);
            if ( (v52 & 0xF) == 0xF || (v49 = *v46, v51 = *(_DWORD *)(*v46 + 328), v51 - 1 == v52) )
            {
              putchar(10);
              v49 = *v46;
              v51 = *(_DWORD *)(*v46 + 328);
        ...
        v55 = v50 / (float)v51;
        *(_DWORD *)(v49 + 456) = (int)v55;
        *(float *)(v49 + 956) = (float)(int)v55;
