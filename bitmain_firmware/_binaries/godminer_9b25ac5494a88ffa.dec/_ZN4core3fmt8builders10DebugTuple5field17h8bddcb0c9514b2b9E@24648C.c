int *__fastcall core::fmt::builders::DebugTuple::field(int *a1, int a2, int a3)
{
  ...
  if ( (v9 & 4) != 0 )
  {
    if ( !v4 )
    {
      if ( (*(int (__fastcall **)(_DWORD, const char *, int))(v6[1] + 12))(*v6, asc_2B394C, 2) )
      {
        v5 = 1;
        v4 = 0;
        goto LABEL_17;
    ...
    if ( v21(a2, &v25) )
      goto LABEL_17;
    v12 = ((int (__fastcall *)(_DWORD *, const char *, int))v26[3])(v25, asc_2B3932, 2);
LABEL_16:
    v5 = v12;
    goto LABEL_17;
  }
  v10 = (const char *)&unk_2B394E;
  if ( v4 )
    v10 = asc_2B3934;
  v11 = 2;
  if ( !v4 )
