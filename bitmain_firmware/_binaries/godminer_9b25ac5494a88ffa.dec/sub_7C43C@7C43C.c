int __fastcall sub_7C43C(int **a1)
{
  int result; // r0
  unsigned int v3; // r1
  int v4; // r5
  ...
  while ( 2 )
  {
    switch ( result )
    {
      case 0:
      case 1:
        v3 = __ldrex((unsigned int *)&dword_30AC24);
        if ( v3 != result )
        {
          __clrex();
LABEL_11:
        ...
        if ( __strex(2u, (unsigned int *)&dword_30AC24) )
          goto LABEL_11;
        __dmb(0xBu);
        v4 = **a1;
        **a1 = 0;
        ...
        *(_BYTE *)(v4 + 4) = 0;
        ...
        __dmb(0xBu);
        do
          v6 = __ldrex((unsigned int *)&dword_30AC24);
        while ( __strex(4u, (unsigned int *)&dword_30AC24) );
        if ( v6 == 3 )
          return syscall(240, v10, 129, 0x7FFFFFFF);
        return result;
      case 2:
        result = __ldrex((unsigned int *)&dword_30AC24);
        if ( result != 2 )
        {
          __clrex();
LABEL_13:
        ...
        if ( __strex(3u, (unsigned int *)&dword_30AC24) )
          goto LABEL_13;
LABEL_14:
        v9 = 0;
        while ( dword_30AC24 == 3 && syscall(240, &dword_30AC24, 137, 3, v9, 0, -1) <= -1 && *_errno_location() == 4 )
          ;
        result = dword_30AC24;
        __dmb(0xBu);
        continue;
