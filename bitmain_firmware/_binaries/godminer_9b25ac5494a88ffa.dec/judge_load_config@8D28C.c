int __fastcall judge_load_config(int a1)
{
  ...
  if ( a1 )
  {
    file = (_DWORD *)json_load_file(a1, 0, v43);
    v5 = file;
    if ( !file || *file )
    {
      V_LOCK(file);
    ...
    v21 = (char *)&unk_2E76F8;
    v42 = v5;
    dword_2E76F4 = json_array_size(v10);
    while ( json_array_size(v11) > v20 )
    {
      v22 = (_DWORD *)json_array_get(v11, v20);
      v23 = v22;
      if ( !v22 )
        break;
      v24 = __clz(v20 - 3);
    ...
    v5 = v42;
    v34 = (const char *)&unk_2E76F8;
    v35 = total_pools;
    if ( total_pools == dword_2E76F4 )
    {
      if ( total_pools <= 0 )
      {
LABEL_8:
