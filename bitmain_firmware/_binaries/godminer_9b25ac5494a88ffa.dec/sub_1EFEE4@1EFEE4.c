int __fastcall sub_1EFEE4(int result, int a2)
{
  int v2; // r2
  int v3; // r10
  bool v4; // zf
  ...
  if ( !v2 )
  {
    ...
    if ( v134 != v135 )
    {
      ...
      while ( 1 )
      {
        ...
        v125 = v12;
        v124 = v11;
        sub_1B1BE8(&v145, &v142, (size_t *)&v118, (size_t *)&v124);
        v13 = ptr == 0;
        if ( ptr )
          v13 = v145 == 0;
        if ( !v13 )
...
LABEL_26:
  while ( 1 )
  {
    ...
    if ( v21 )
    {
      ...
      v134 = (char *)v23;
      v133 = v29;
      sub_1B1BE8((size_t *)&v118, &v142, (size_t *)&v124, (size_t *)&v133);
      v30 = v119 == 0;
      if ( v119 )
        v30 = v118 == 0;
      if ( !v30 )
...
LABEL_64:
        ...
        {
          if ( !v106 )
            core::panicking::panic((int)aAssertionFaile_5, 33, (int)&off_2DD438);
          v61 = (_DWORD *)v108[68];
          *v61 = 0;
          v142 = (char *)(v106 - 1);
          v143 = v61;
  ...
  *v69 = 0;
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      v126 = v82;
      sub_1B5CE0(&v118, v81, v81 >= 0, (int)&v124);
      v73 = (_DWORD *)v118;
      if ( v118 )
      {
        v75 = v120;
...
LABEL_102:
    ...
    *((_BYTE *)v73 + v76) = 61;
    ...
    {
      sub_79740((size_t *)&v142, v76 + 1, v77);
      v84 = (int)v142;
      v83 = v144;
    }
    v85 = v143;
...
LABEL_109:
      ...
      v119 = v89;
      if ( !v115 )
        core::panicking::panic_bounds_check(v92, 0, (int)&off_2DE938);
      v93 = v114;
      v4 = v115 == (_DWORD)v113;
      *(_DWORD *)(v114 + 4 * v92) = v91;
      if ( v4 )
      {
        sub_1B5FC8((unsigned int *)&v113, v90);
        v93 = v114;
        v90 = v115;
      }
      v94 = v110;
      ...
      *(_DWORD *)(v93 + 4 * v90) = 0;
      ...
      if ( v95 == v94 )
      {
        sub_1B5DA8((unsigned int *)&v110, v95);
        v95 = v112;
      }
      v71 = v111;
