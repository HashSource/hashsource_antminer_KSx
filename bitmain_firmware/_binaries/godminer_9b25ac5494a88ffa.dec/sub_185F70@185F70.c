unsigned int __fastcall sub_185F70(unsigned int *a1, char a2, char a3, _BYTE *a4, int a5)
{
  unsigned int v5; // lr
  int v7; // r6
  unsigned int v8; // r8
  ...
  *((_BYTE *)a1 + v5) = (128 >> a3) | a2 & -(128 >> a3);
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v34 == 8 )
        break;
      v161 = dword_2A1B48[v34];
      v35 = dword_2A1B68[v34];
    }
    v211 = v32;
    v70 = 23617341;
    v206 = v30;
    ...
    while ( 1 )
    {
      ...
      if ( v71 == 8 )
        break;
      v162 = dword_2A1B88[v71];
      v70 = dword_2A1BA8[v71];
    }
    v195 = v72;
    v197 = v73;
    v199 = v74;
    ...
    while ( 1 )
    {
      ...
      if ( v110 == 8 )
        break;
      v163 = dword_2A1BC8[v110];
      v111 = dword_2A1BE8[v110];
    }
    v186 = v114;
    v182 = v112;
    v184 = v113;
