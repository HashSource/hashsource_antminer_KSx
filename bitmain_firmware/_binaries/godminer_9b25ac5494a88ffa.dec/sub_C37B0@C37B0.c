bool __fastcall sub_C37B0(int a1, int a2, char **a3)
{
  char v3; // r3
  _DWORD *v5; // r9
  int v6; // r0
  ...
  v3 = 0;
  v40 = 0;
  if ( a2 != -1 && *(_DWORD *)(a1 + 328) >= a2 )
    v3 = *(_BYTE *)(*(_DWORD *)(a1 + 480) + a2);
  v41 = 0;
  v42 = 3932160;
  BYTE1(v42) = v3;
  v5 = calloc(0xCu, 1u);
  v6 = (*(int (__fastcall **)(int, __int64 *, int, _DWORD *, int *))(a1 + 280))(a1, &v41, 1, v5, &v40);
  if ( v40 <= 0 )
  {
    v38 = 0;
  }
...
LABEL_9:
  ...
  *a3 = v38;
  ...
  v16 = (*(int (__fastcall **)(int, __int64 *, int, _WORD *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int))(a1 + 292))(
          a1,
          &v41,
          v15,
          ptr,
