void __fastcall std::panicking::default_hook(int a1)
{
  ...
  v2 = *(_DWORD *)_tls_get_addr(&dword_2E4454);
  backtrace_style = 1;
  if ( v2 <= 1 )
  ...
  if ( !v4 )
    core::panicking::panic((int)aCalledOptionUn, 43, (int)&off_2DE34C);
  v38 = v4;
...
LABEL_43:
    v32 = 0;
    sub_1E777C(v42, &v45, &off_2DE2FC);
    goto LABEL_44;
  }
  byte_30AC20 = 1;
  addr = (_DWORD *)_tls_get_addr(&dword_2E4434);
  v21 = *addr;
  ...
  if ( !v21 )
  {
    v20 = sub_1C704C(0);
    if ( !v20 )
      core::result::unwrap_failed((int)aCannotAccessAT, 70, (int)&v45, (int)&off_2DD2F8, (int)&off_2DD778);
  }
  v22 = (int)*v20;
  *v20 = 0;
...
LABEL_26:
  ...
  sub_1E777C(v42, v22 + 16, &off_2DE324);
  if ( !v25
  ...
  v27 = v44;
  byte_30AC20 = 1;
  v28 = (_DWORD *)_tls_get_addr(&dword_2E4434);
  v45 = v27;
