int __fastcall sub_22A428(_DWORD *a1)
{
  int v2; // r0
  unsigned int v3; // r8
  unsigned int v4; // r9
...
LABEL_24:
          v18 = a1[4];
          if ( !v18 || !<str as core::fmt::Display>::fmt(&unk_2B0669, 16, v18) )
          {
            *((_BYTE *)a1 + 4) = 0;
            *a1 = 0;
            return 0;
    ...
    if ( v19 )
    {
      if ( v4 | v6 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v28 || !<str as core::fmt::Display>::fmt(asc_2B068B, 2, v25) )
          {
            ++a1[5];
            if ( !sub_22A2F0((int)a1, v27, 1u, 0) )
              continue;
          }
          return 1;
        }
        ...
        if ( v30 )
        {
          if ( <str as core::fmt::Display>::fmt(asc_2B068D, 2, v30) )
            return 1;
        }
      }
      v31 = *a1;
      if ( *a1 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !v35 && <str as core::fmt::Display>::fmt(asc_2B069D, 3, v33) || sub_22C9EC(a1) )
          {
            v36 = 1;
            goto LABEL_66;
          }
...
LABEL_66:
    ...
    else
    {
      for ( i = 0; ; --i )
      {
        ...
        if ( !v23 && <str as core::fmt::Display>::fmt(asc_2B069D, 3, v21) || sub_22C9EC(a1) )
          return 1;
        v2 = *a1;
        if ( !*a1 )
          return 0;
