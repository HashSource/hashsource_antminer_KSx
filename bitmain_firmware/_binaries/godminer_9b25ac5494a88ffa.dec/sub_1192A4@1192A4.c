int __fastcall sub_1192A4(int a1, unsigned __int8 a2)
{
  int v3; // r0
  int v4; // r0
  ...
  if ( a1 == 255 )
  {
    if ( !sub_118F7C((unsigned __int8 *)&v5, 8u, (unsigned __int8 *)&v9, 8u) )
      return WORD2(v9);
  ...
  {
    if ( !sub_11911C(a1, (unsigned __int8 *)&v5, 8u, (unsigned __int8 *)&v9, 8u) )
      return WORD2(v9);
    strcpy(v10, "set watchdog failed");
    V_LOCK(*(_DWORD *)"set watchdog failed");
