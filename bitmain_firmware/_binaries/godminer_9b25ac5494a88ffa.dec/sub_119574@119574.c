int __fastcall sub_119574(int a1, __int16 a2)
{
  int v3; // r0
  int v4; // r0
  ...
  if ( a1 == 255 )
  {
    if ( !sub_118F7C((unsigned __int8 *)&v5, 8u, (unsigned __int8 *)&v7 + 2, 8u) )
      return HIWORD(v7);
  ...
  {
    if ( !sub_11911C(a1, (unsigned __int8 *)&v5, 8u, (unsigned __int8 *)&v7 + 2, 8u) )
      return HIWORD(v7);
    strcpy(v9, "set DA conversion N failed");
    V_LOCK(*(_DWORD *)"n N failed");
