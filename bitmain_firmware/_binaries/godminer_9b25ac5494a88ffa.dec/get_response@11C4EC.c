int __fastcall get_response(int a1)
{
  ...
  v4 = snprintf(v3, 0x40u, "%.10s_%d", "get_response", *(_DWORD *)(a1 + 240));
  V_LOCK(v4);
  syscall(224);
  v5 = 0;
  v17 = 1;
  ...
  {
    v8 = dev_ctrl((int)v7);
    v9 = (*(int (__fastcall **)(_DWORD, _BYTE *, int))(v8 + 60))(*(_DWORD *)(a1 + 240), s, 256);
    v10 = v9;
    if ( *(_BYTE *)(a1 + 877) )
      break;
    if ( v9 <= 0 )
    ...
    {
      v2 = 64;
      if ( !queue_enqueue(*(_DWORD *)(a1 + 848), s, v9) && v17 <= ++v5 )
      {
        V_LOCK(0);
        ...
        v14 = zlog(
                ...
                "ease/build/godminer-origin_godminer-kas_2382/backend/backend_base.c",
                171,
                "get_response",
                12,
                276,
        ...
        zlog(
          ...
          "uild/godminer-origin_godminer-kas_2382/backend/backend_base.c",
          171,
          "get_response",
          12,
          277,
