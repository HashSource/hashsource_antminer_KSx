int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_D0B38(a1, v30, 12, 1);
    usleep((__useconds_t)"20$core..fmt..UpperExp$u20$for$u20$i32$GT$3fmt17h8434dc95ce0e7ecdE");
    sub_D0B38(a1, v30, 160, -2147483647);
    usleep(0xC3500u);
    memset(s, 0, 0x600u);
    v3 = sub_D0DD0(a1, (unsigned __int16)v30, 161, s);
    v4 = v3;
    if ( v3 == 8
      || (V_LOCK(v3),
          V_INT((int)&v32, "chain"),
...
LABEL_10:
    memset(s, 0, 0x600u);
    v9 = sub_D0DD0(a1, (unsigned __int16)v30, 162, s);
    v10 = v9;
    if ( v9 == 8
      || (V_LOCK(v9),
          V_INT((int)v35, "chain"),
...
LABEL_18:
  ...
  *(_QWORD *)v26 = 0;
  ...
  while ( v15 != 8 );
  v20 = dev_ctrl(v16);
  (*(void (__fastcall **)(_DWORD))(v20 + 80))(*(_DWORD *)(a1 + 240));
  qword_2F9950 = v44;
  qword_2F9958 = v45;
  qword_2F9960 = *(_QWORD *)&v46;
  qword_2F9968 = *(_QWORD *)&v47;
  return 0;
}
