int __fastcall sub_E3DC4(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r7
  int v9; // r6
  int v12; // r3
  ...
  *(_DWORD *)(a3 + 12) = *(_BYTE *)(a2 + 8) & 0x3F;
  v20 = BM_CRC5(a2 + 2, 75);
  if ( v20 != (*(_BYTE *)(a2 + 11) & 0x1F) && *(_BYTE *)(a1 + 250) )
  {
    v22 = *(_DWORD *)(a1 + 244);
    v23 = dword_2F9970[v22];
    dword_2F9970[v22] = v23 + 1;
    if ( v23 <= 9 )
    {
      V_LOCK(v20);
      V_INT((int)&v26, "chain");
