int __fastcall sub_1E8848(int *a1, int a2, _DWORD *a3, int *a4, int a5, int a6, int a7, char **a8)
{
  int *v9; // r6
  bool v10; // zf
  int v11; // r11
  ...
  if ( v11 )
  {
    ...
    {
      v17 = v9[3];
      v18 = core::fmt::ArgumentV1::from_usize(&unk_2A44DC);
      v63 = 2;
      v70 = v18;
      v62 = &v68;
      v61 = 1;
...
LABEL_19:
  ...
  if ( core::fmt::Formatter::write_fmt(v31, &v58) )
    return 1;
LABEL_20:
  if ( <core::fmt::Formatter as core::fmt::Write>::write_str(v9[3], asc_2A4601, 1) )
    return 1;
  if ( a5 == 1 && v14 != 2 )
  {
