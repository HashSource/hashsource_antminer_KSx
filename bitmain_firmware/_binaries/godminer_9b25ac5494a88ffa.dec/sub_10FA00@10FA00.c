int __fastcall sub_10FA00(int a1, int a2, void *src, size_t a4, void *a5, size_t a6)
{
  char *v7; // r0
  size_t v8; // r9
  int v11; // r8
  ...
  *((_BYTE *)&v34 + v11 + 3) = v13;
  sub_10F924((int)"pic tx", (int)v35, v11);
  pthread_mutex_lock(&i2c_mutex_all);
  v16 = iic_write(g_bitmain_pic_state[2 * a1], v35, v11);
  if ( v16 != v11 )
  {
    V_LOCK(v16);
...
LABEL_12:
  ...
  v28 = sub_10F924((int)"pic rx", (int)v35, v23);
  if ( LOBYTE(v35[0]) != v23 )
    goto LABEL_18;
  if ( HIBYTE(v35[0]) != a2 )
    goto LABEL_18;
