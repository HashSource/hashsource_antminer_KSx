int __fastcall packet_2_nonce_ks5(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v11; // r0
  int v13; // r2
  int v14; // r3
  ...
  if ( (*(_BYTE *)(a2 + 13) & 0x80) == 0 )
    return 10;
  if ( v11 == (*(_BYTE *)(a2 + 13) & 0x1F) || !*(_BYTE *)(a1 + 250) )
  {
    ...
    else
    {
      ...
      *a7 = v16;
      if ( v16 != -1 )
      {
        ...
        *(_BYTE *)(a3 + 16) = v13;
        *(_BYTE *)(a3 + 17) = v21;
        v22 = sub_26CA90(*(unsigned __int8 *)(a2 + 6), *(_DWORD *)(a1 + 420));
        if ( v22 >= *(_DWORD *)(a1 + 328) )
        {
          v41 = rand();
          sub_26C784(v41, *(_DWORD *)(a1 + 328));
          v22 = v42;
        }
        *a6 = v22;
        *(_DWORD *)(a3 + 8) = v22;
        ...
        if ( *((_DWORD *)v25 + 5) == 999 )
        {
          ...
          *((_DWORD *)v25 + 5) = 0;
          ...
          else
          {
            ...
            v36 = 8 * v24;
            v37 = *(_QWORD *)&byte_301A58[8 * v24 + 88];
            if ( v37 >= v35 || v35 - v37 > 0x63 )
              goto LABEL_28;
            for ( i = 0; i < v29; ++i )
            {
              v39 = *v50;
              v40 = qword_301B30[256 * v24 + i];
              ++v50;
              if ( v39 > v40 && v39 - v40 > 0x190 )
              {
                close_one_chip_cores_ks5(a1, i);
                v24 = *(_DWORD *)(a1 + 240);
                v29 = *(_DWORD *)(a1 + 328);
              }
            }
...
LABEL_28:
              v43 = (__int64 *)s;
              v44 = (char *)&qword_301B30[256 * v24 - 1];
              v45 = 0;
              do
              {
                ++v45;
  ...
  v26 = &byte_301A58[4 * *(_DWORD *)(a1 + 244)];
  v27 = *((_DWORD *)v26 + 2);
  *((_DWORD *)v26 + 2) = v27 + 1;
  if ( v27 <= 9 )
  {
