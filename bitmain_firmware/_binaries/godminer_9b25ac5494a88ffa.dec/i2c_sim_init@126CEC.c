...
LABEL_2:
    ...
    else
    {
      ...
      else
      {
        ...
        if ( dword_2E5C84 > 0 )
          close(dword_2E5C84);
        dword_2E5C84 = open64("/sys/class/gpio/gpio459/value", 1);
        if ( dword_2E5C84 < 0 )
        {
        ...
        else
        {
          if ( dword_2E5C7C > 0 )
            close(dword_2E5C7C);
          dword_2E5C7C = open64("/sys/class/gpio/gpio461/value", 1);
          if ( dword_2E5C7C < 0 )
          {
          ...
          else
          {
            if ( dword_2E5C80 > 0 )
              close(dword_2E5C80);
            dword_2E5C80 = open64("/sys/class/gpio/gpio461/direction", 1);
            if ( dword_2E5C80 >= 0 )
            {
              v1 = 255;
